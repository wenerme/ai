---
title: "Installation | Grafana Plugins documentation"
description: "This document explains the installation process of JSON API data source"
---

> For a curated documentation index, see [llms.txt](/llms.txt). For the complete documentation index, see [llms-full.txt](/llms-full.txt).

[Documentation](/docs/)[breadcrumb arrow] [Plugins](/docs/plugins/)[breadcrumb arrow] [JSON API data source](/docs/plugins/marcusolsson-json-datasource/latest/)[breadcrumb arrow] Installation

Open source Grafana Cloud

You can install the plugin using [grafana-cli](/docs/grafana/latest/administration/cli/), or by downloading the plugin manually.
...
4. Unarchive the plugin into the Grafana plugins directory.
   ...
   powershell [Copy code to clipboard] Copy

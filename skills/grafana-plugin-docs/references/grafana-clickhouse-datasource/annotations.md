---
title: "ClickHouse annotations | Grafana Plugins documentation"
...
For an overview of annotations in Grafana, see [Annotate visualizations](/docs/grafana/latest/dashboards/build-dashboards/annotate-visualizations/).
...
If the dashboard has [ad hoc filters](/docs/plugins/grafana-clickhouse-datasource/latest/template-variables/#ad-hoc-filters) enabled for the ClickHouse data source, those filters are also applied to annotation queries. This means annotation results change as users adjust ad hoc filter values.
...
- [ClickHouse query editor](/docs/plugins/grafana-clickhouse-datasource/latest/query-editor/) — Macros such as `$__timeFilter` and building queries.
- [Annotate visualizations](/docs/grafana/latest/dashboards/build-dashboards/annotate-visualizations/) — Grafana annotation options (colors, which panels show annotations, filters).

---
title: "Tracing | Grafana Plugins documentation"
...
For general information about the Traces panel, refer to [Traces](/docs/grafana/latest/panels-visualizations/visualizations/traces/).

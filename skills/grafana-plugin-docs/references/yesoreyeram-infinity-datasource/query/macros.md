...
For more information about Grafana’s built-in time variables, refer to [Global variables](/docs/grafana/latest/dashboards/variables/add-template-variables/#__from-and-__to).
...
For more information about URL configuration and allowed hosts, refer to [URL configuration](/docs/plugins/yesoreyeram-infinity-datasource/latest/advanced-features/url/).

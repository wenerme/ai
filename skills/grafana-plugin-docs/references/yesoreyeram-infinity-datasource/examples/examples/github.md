---
title: "GitHub GraphQL API | Grafana Plugins documentation"
...
- For comprehensive GitHub analytics with built-in pagination, consider the [GitHub data source](/grafana/plugins/grafana-github-datasource).

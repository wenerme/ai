...
The differences between annotation types are explained in the [Grafana Crash Course](/docs/plugins/volkovlabs-echarts-panel/latest/exploring-annotations/).
...
[](/media/docs/grafana/panels-visualizations/business-charts/annotations.png)

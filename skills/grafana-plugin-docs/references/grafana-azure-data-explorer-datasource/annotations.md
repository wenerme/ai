---
title: "Azure Data Explorer annotations | Grafana Plugins documentation"
...
- A [dashboard](/docs/grafana/latest/dashboards/) to add annotations to.
...
3. Enter a name for the annotation query.
4. Select the Azure Data Explorer data source.
5. Write a Kusto query that returns the required columns, as described in the following section.
...
For more information about adding and using annotations, refer to [Annotations](/docs/grafana/latest/dashboards/build-dashboards/annotate-visualizations/).

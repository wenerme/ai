---
title: "Configure the AWS IoT TwinMaker app and data source | Grafana Plugins documentation"
...
2. Search for **AWS IoT TwinMaker App**.
3. Click **Install**.
...
3. Type `AWS IoT TwinMaker` in the search bar. The data source is listed in the **Industrial &amp; IoT** section.
4. Select **AWS IoT TwinMaker**.
5. Click **Add new data source**.

## Configure connection details

The **Connection Details** section uses the standard Grafana AWS authentication settings. For details about each authentication provider, refer to [AWS authentication](/docs/grafana/latest/datasources/aws-cloudwatch/aws-authentication/).
...
2. Open the **Workspace** drop-down and select your workspace. Any query that uses this data source has access to resources within the selected workspace.
3. Click **Save &amp; test** again.

## Verify the connection

When the connection succeeds, **Save &amp; test** returns the message `TwinMaker datasource successfully configured` followed by your workspace name. If the health check fails, refer to [Troubleshooting](/docs/plugins/grafana-iot-twinmaker-app/latest/troubleshooting/) for common errors such as `Assume Role ARN is required`.
...
For setup instructions, refer to [Private data source connect](/docs/grafana-cloud/connect-externally-hosted/private-data-source-connect/) and [Configure Grafana private data source connect](/docs/grafana-cloud/connect-externally-hosted/private-data-source-connect/configure-pdc/).
...
- [Build queries with the query editor](/docs/plugins/grafana-iot-twinmaker-app/latest/query-editor/)
- [Set up the Scene Viewer and other panels](/docs/plugins/grafana-iot-twinmaker-app/latest/panels/)

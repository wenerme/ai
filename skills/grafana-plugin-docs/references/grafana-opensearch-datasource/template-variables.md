---
title: "OpenSearch template variables | Grafana Plugins documentation"
...
For an introduction to template variables, refer to the [Grafana template variables documentation](/docs/grafana/latest/dashboards/variables/).
...
4. Select the OpenSearch data source.
5. Enter one of the JSON queries from the following table in the **Query** field.
...
| `date`    | Date and date\_nanos fields.                         |

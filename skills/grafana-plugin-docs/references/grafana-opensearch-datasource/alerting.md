---
title: "OpenSearch alerting | Grafana Plugins documentation"
...
For more information about Grafana alerting, refer to the [Grafana alerting documentation](/docs/grafana/latest/alerting/).

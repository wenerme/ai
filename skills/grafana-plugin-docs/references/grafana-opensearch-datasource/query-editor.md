---
title: "OpenSearch query editor | Grafana Plugins documentation"
...
- **PPL (Piped Processing Language):** An alternative query language that uses a pipe syntax for data exploration. PPL must be [enabled in the data source configuration](/docs/plugins/grafana-opensearch-datasource/latest/configure/).
...
The fields used for log messages and log levels are configured in the [data source settings](/docs/plugins/grafana-opensearch-datasource/latest/configure/).
...
To use PPL, ensure it’s [enabled in the data source configuration](/docs/plugins/grafana-opensearch-datasource/latest/configure/).
...
To narrow down field suggestions, specify an index name in the [data source settings](/docs/plugins/grafana-opensearch-datasource/latest/configure/).
...
For more information about ad hoc filters, refer to the [Grafana ad hoc filters documentation](/docs/grafana/latest/dashboards/variables/add-template-variables/#add-ad-hoc-filters).

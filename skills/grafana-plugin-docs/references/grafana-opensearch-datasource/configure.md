---
title: "Configure the OpenSearch data source | Grafana Plugins documentation"
...
1. Enable SigV4 in your Grafana [configuration](/docs/grafana/latest/setup-grafana/configure-grafana/#sigv4_auth_enabled).
...
For more information about AWS authentication options, refer to [AWS authentication](/docs/grafana/latest/datasources/aws-cloudwatch/aws-authentication/).
...
These optional settings control how log data is displayed in [Explore](/docs/grafana/latest/explore/).
...
Use private data source connect (PDC) to connect to and query data within a secure network without opening that network to inbound traffic from Grafana Cloud. For more information, refer to [Private data source connect](/docs/grafana-cloud/connect-externally-hosted/private-data-source-connect/) and [Configure PDC](/docs/grafana-cloud/connect-externally-hosted/private-data-source-connect/configure-pdc/).
...
Click **Save &amp; test** to verify the connection. If you encounter errors, refer to [Troubleshoot OpenSearch data source issues](/docs/plugins/grafana-opensearch-datasource/latest/troubleshooting/).
...
You can define and configure the data source in YAML files as part of Grafana’s provisioning system. For more information, refer to [Provisioning Grafana](/docs/grafana/latest/administration/provisioning/#data-sources).

---
title: "Amazon Managed Service for Prometheus query editor | Grafana Plugins documentation"
...
Reference a [template variable](/docs/plugins/grafana-amazonprometheus-datasource/latest/template-variables/) to make a query interactive. For example, filter by a selected `instance` value:
...
- [Use template variables](/docs/plugins/grafana-amazonprometheus-datasource/latest/template-variables/)
- [Add annotations](/docs/plugins/grafana-amazonprometheus-datasource/latest/annotations/)
- [Set up alerting](/docs/plugins/grafana-amazonprometheus-datasource/latest/alerting/)

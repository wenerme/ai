---
title: "Amazon Managed Service for Prometheus annotations | Grafana Plugins documentation"
...
5. Enter a PromQL query in the code query field. Any series the query returns becomes an annotation marker.
6. Configure the field mappings, then click **Apply**.

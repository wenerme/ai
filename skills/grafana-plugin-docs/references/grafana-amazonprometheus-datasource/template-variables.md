---
title: "Amazon Managed Service for Prometheus template variables | Grafana Plugins documentation"
...
- [Configured the Amazon Managed Service for Prometheus data source](/docs/plugins/grafana-amazonprometheus-datasource/latest/configure/).
...
4. Select the Amazon Managed Service for Prometheus data source.

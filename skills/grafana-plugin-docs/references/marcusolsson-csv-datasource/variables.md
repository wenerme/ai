...
[Documentation](/docs/)[breadcrumb arrow] [Plugins](/docs/plugins/)[breadcrumb arrow] [CSV data source](/docs/plugins/marcusolsson-csv-datasource/latest/)[breadcrumb arrow] Variables

---
title: "Zabbix query editor | Grafana Plugins documentation"
...
For a complete list of available functions, refer to the [functions reference](/docs/plugins/alexanderzobnin-zabbix-app/latest/functions/).
...
- [Apply functions to transform query results](/docs/plugins/alexanderzobnin-zabbix-app/latest/functions/)
- [Use template variables for dynamic dashboards](/docs/plugins/alexanderzobnin-zabbix-app/latest/template-variables/)

...
2. Add a **Reduce** expression (**B**): **Function** `Last`, **Input** `A`.
3. Add a **Threshold** expression (**C**): **Input** `B`, **IS ABOVE** `5`.
4. Set **C** as the alert condition.
...
2. Add a **Reduce** expression (**B**): **Function** `Last`, **Input** `A`.
3. Add a **Threshold** expression (**C**): **Input** `B`, **IS BELOW** `524288000`.
...
1. Add an **Item ID** query (**A**):
   ...
   - **Item Ids:** `23456`
2. Add a **Reduce** expression (**B**): **Function** `Mean`, **Input** `A`.
3. Add a **Threshold** expression (**C**): **Input** `B`, **IS ABOVE** your threshold value.
...
- [Build Metrics queries with the Zabbix query editor](/docs/plugins/alexanderzobnin-zabbix-app/latest/query-editor/#metrics)

...
3. Enable [Direct DB Connection](./configure/#configure-direct-db-connection) for better performance on wide time ranges.
...
3. Enable [Direct DB Connection](./configure/#configure-direct-db-connection) for server-side aggregation, which reduces data transfer.

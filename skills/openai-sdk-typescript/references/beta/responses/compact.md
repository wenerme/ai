...
`client.beta.responses.compact(ResponseCompactParamsparams, RequestOptionsoptions?): BetaCompactedResponse`
...
const betaCompactedResponse = await client.beta.responses.compact({ model: 'gpt-5.6-sol' });

console.log(betaCompactedResponse.id);
```

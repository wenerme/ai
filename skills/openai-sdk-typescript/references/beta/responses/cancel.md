...
`client.beta.responses.cancel(stringresponseID, ResponseCancelParamsparams?, RequestOptionsoptions?): BetaResponse`
...
const betaResponse = await client.beta.responses.cancel('resp_677efb5139a88190b512bc3fef8e535d');

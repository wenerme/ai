...
`client.beta.responses.retrieve(stringresponseID, ResponseRetrieveParamsparams?, RequestOptionsoptions?): BetaResponse | Stream<BetaResponseStreamEvent>`
...
- `BetaResponse`
  ...
  - `tool_choice: BetaToolChoiceOptions | BetaToolChoiceAllowed | BetaToolChoiceTypes | 6 more`
  ...
  - `prompt?: BetaResponsePrompt | null`
    ...
    - `variables?: Record<string, string | BetaResponseInputText | BetaResponseInputImage | BetaResponseInputFile> | null`
...
const betaResponse = await client.beta.responses.retrieve('resp_677efb5139a88190b512bc3fef8e535d');

console.log(betaResponse.id);
```

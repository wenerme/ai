...
`client.beta.responses.inputTokens.count(InputTokenCountParamsparams?, RequestOptionsoptions?): InputTokenCountResponse`
...
- `params: InputTokenCountParams`
  ...
  - `tool_choice?: BetaToolChoiceOptions | BetaToolChoiceAllowed | BetaToolChoiceTypes | 6 more | null`
...
const response = await client.beta.responses.inputTokens.count();

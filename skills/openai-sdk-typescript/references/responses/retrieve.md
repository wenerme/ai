...
`client.responses.retrieve(stringresponseID, ResponseRetrieveParamsquery?, RequestOptionsoptions?): Response | Stream<ResponseStreamEvent>`
...
- `ResponseRetrieveParams = ResponseRetrieveParamsNonStreaming | ResponseRetrieveParamsStreaming`
...
- `Response`
  ...
  - `tool_choice: ToolChoiceOptions | ToolChoiceAllowed | ToolChoiceTypes | 5 more`

...
Use the Member Roles API to manage custom roles for GitLab.com groups or GitLab Self-Managed instances. List, create, and delete custom member roles programmatically.

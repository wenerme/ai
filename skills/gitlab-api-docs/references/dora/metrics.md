...
Retrieve project and group DORA metrics with the REST API.
...
|:---------------------|:-----------------|:---------|:------------|
| `id`                 | integer or string   | yes      | The ID or [URL-encoded path of the project](../rest/_index.md#namespaced-paths) that can be accessed by the authenticated user. |

...
- [Introduced](https://gitlab.com/groups/gitlab-org/-/work_items/9290) in GitLab 17.2 [with a feature flag](../../administration/feature_flags/_index.md) named `work_item_epics`. Disabled by default. [The new look for epics](../../user/group/epics/_index.md#epics-as-work-items) must be enabled. Introduced in [beta](../../policy/development_stages_support.md#beta).
...
- If you use the [epic REST API](../epics.md), you can continue using it, but you should migrate to future-proof your integrations.
...
For all available widgets, see the [work item widget reference](reference/_index.md#workitemwidget).

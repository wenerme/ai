...
- [Introduced](https://gitlab.com/groups/gitlab-org/-/epics/9290) in GitLab 17.2 [with a feature flag](../../administration/feature_flags/_index.md) named `work_item_epics`. Disabled by default. [The new look for epics](../../user/group/epics/_index.md#epics-as-work-items) must be enabled. Introduced in [beta](../../policy/development_stages_support.md#beta).

...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/37911) in GitLab 13.6 [with a feature flag](../../administration/feature_flags/_index.md) named `custom_emoji`. Disabled by default.

...
| `tls`                    | A [`tls` configuration map](../securing\_nats/tls.md) for securing gateway connections. `verify` is always enabled. Unless otherwise specified in a [`gateway`](gateway.md#gateway-entry), `cert_file` will be the default client certificate. [Certificate pitfalls](../securing\_nats/tls.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |         |
...
To apply changes (even when only changing the content of those files) the server configuration needs to be reloaded. [Configuration reloading](https://docs.nats.io/running-a-nats-service/configuration#configuration-reloading)

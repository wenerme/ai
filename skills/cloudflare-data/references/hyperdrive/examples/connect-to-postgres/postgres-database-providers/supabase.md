...
-- Here, you are granting it the postgres role. In practice, you want to create a role with lesser privileges.GRANT postgres to hyperdrive_user;
```
...
* [ Dashboard ](#tab-panel-8903)
* [ Wrangler CLI ](#tab-panel-8904)

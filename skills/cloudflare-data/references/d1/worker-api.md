...
<sup>1</sup> D1 types correspond to the underlying [SQLite types ↗](https://www.sqlite.org/datatype3.html).
...
<sup>4</sup> `ArrayBuffer` and [`ArrayBuffer` views ↗](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer/isView) are converted using [`Array.from` ↗](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/from).

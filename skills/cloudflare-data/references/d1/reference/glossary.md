...
| Term | Definition |
| --- | --- |
| bookmark | A bookmark represents the state of a database at a specific point in time.<ul><li>Bookmarks are lexicographically sortable. Sorting orders a list of bookmarks from oldest-to-newest.</li></ul> |

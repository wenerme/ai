...
| 10009 | TooManyBuckets | 400 | Account bucket limit exceeded (default: 1,000,000 buckets). | Request a limit increase via the [Limits Increase Request Form ↗︎](https://forms.gle/eX6pXvit1wBv77Yw5). |
...
| Error Code | S3 Code | HTTP Status | Details | Recommended Fix |
| --- | --- | --- | --- | --- |
| 10001 | InternalError | 500 | An internal error occurred. | Retry the request. If persistent, check [Cloudflare Status ↗︎](https://www.cloudflarestatus.com) or contact support. |
| 10043 | ServiceUnavailable | 503 | Service is temporarily unavailable. | Retry with exponential backoff. Check [Cloudflare Status ↗︎](https://www.cloudflarestatus.com). |

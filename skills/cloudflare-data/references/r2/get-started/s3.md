...
1. Install [boto3 ↗︎](https://boto3.amazonaws.com/v1/documentation/api/latest/index.html):
...
1. Install the [@aws-sdk/client-s3 ↗︎](https://www.npmjs.com/package/@aws-sdk/client-s3) package:

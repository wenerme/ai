...
<InferenceSnippet
    ...
    providersMapping={ {"fal-ai":{"modelId":"Alissonerdx/LTX-Best-Face-ID","providerModelId":"fal-ai/ltx-2-19b/text-to-video/lora"},"replicate":{"modelId":"Wan-AI/Wan2.2-TI2V-5B","providerModelId":"wan-video/wan-2.2-5b-fast"},"together":{"modelId":"Wan-AI/Wan2.2-T2V-A14B","providerModelId":"Wan-AI/Wan2.2-T2V-A14B"},"wavespeed":{"modelId":"Wan-AI/Wan2.2-TI2V-5B","providerModelId":"wavespeed-ai/wan-2.2/t2v-5b-720p"}} }
/>

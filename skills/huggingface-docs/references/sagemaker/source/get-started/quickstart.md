...
<div class="flex justify-center my-6">
  [The Deploy on AWS modal on a Hugging Face model page]
</div>
...
<div class="flex justify-center my-6">
  [One-click deployment of a Hugging Face model to SageMaker AI Studio with the JumpStart integration]
</div>
...
<div class="flex justify-center my-6">
  [The SageMaker SDK tab in the Deploy on AWS modal]
</div>

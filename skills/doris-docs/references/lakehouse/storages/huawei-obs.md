...
> **info**: Starting from versions 3.0.5 and 4.1.0, Doris natively integrates the Huawei Cloud OBS SDK. Users can access OBS data (such as Paimon Catalog) directly with the `obs://` prefix, enabling better support for Huawei Cloud's Parallel File System (PFS).

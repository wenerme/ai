...
[Apache Doris Data Cache & Page Cache: Two caching layers for lakehouse reads: a local-disk cache for remote file bytes and an in-memory cache for decompressed column pages.]

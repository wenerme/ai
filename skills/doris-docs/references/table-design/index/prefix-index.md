...
> **tip**: If a high-frequency query condition cannot hit the prefix index by adjusting the sort key, see the section [Alternatives When the Prefix Index Cannot Be Hit](#alternatives-when-the-prefix-index-cannot-be-hit) below.

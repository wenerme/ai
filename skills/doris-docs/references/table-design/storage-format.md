...
> **tip**: This feature is supported starting from Apache Doris 4.1.0. Set `"storage_format" = "V3"` in the `PROPERTIES` clause when creating a table to enable it.
...
[Wide table storage format - Segment file layout comparison]
...
[Wide table storage format - Metadata opening efficiency]

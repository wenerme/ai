...
> **note**: Duplicate tables must set `"store_row_column" = "true"` and do not support specifying a subset of columns via `row_store_columns`. All columns are stored in the row store.

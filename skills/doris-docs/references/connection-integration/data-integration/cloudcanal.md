...
> **info**: For more features and parameter settings, refer to [CloudCanal Data Link Documentation](https://www.clougence.com/cc-doc/dataMigrationAndSync/connection/mysql2?target=Doris).

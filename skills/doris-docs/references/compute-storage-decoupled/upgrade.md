...
> **caution**: If the Recycler component is not deployed separately, skip this step.
...
> **tip**: Before upgrading BE, confirm that all MetaService and Recycler (if applicable) instances have been upgraded.
...
> **tip**: Before upgrading FE, confirm that all BE instances have been upgraded.

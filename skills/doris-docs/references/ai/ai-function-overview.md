...
> **note**: All large language models must be provided externally to Doris and must support text analysis. The results and cost of AI function calls depend on the external AI vendor and the model used.
...
> **tip**: The following examples are minimal runnable implementations. For more complete steps, see [AI Functions Overview](../sql-manual/sql-functions/ai-functions/overview.md).

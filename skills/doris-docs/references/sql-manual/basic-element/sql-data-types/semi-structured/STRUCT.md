...
> **caution**: As no other database or query engine provides such a function, `STRUCT_ELEMENT` has been removed since version 4.1.3. Use `ELEMENT_AT` or the subscript / dot operators instead.

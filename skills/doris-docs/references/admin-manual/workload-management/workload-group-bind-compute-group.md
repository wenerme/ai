...
[Earlier version: Workload Group takes effect globally]
...
[Current version: Workload Group isolated by Compute Group]
...
> **note**: The `ALTER` statement is used only to modify the properties of a Workload Group. **It cannot modify the binding relationship between a Workload Group and a Compute Group.**

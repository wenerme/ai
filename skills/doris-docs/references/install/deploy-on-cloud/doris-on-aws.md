...
> **tip**: Compilation and deployment of the storage-compute decoupled mode is not supported yet.

> **caution**: - The current CloudFormation template only supports three regions: **us-east-1**, **us-west-1**, and **us-west-2**.

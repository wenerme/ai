...
Input [Open](https://developers.cloudflare.com/workers-ai/models/aura-2-en/schema-input.json) [Download](https://developers.cloudflare.com/workers-ai/models/aura-2-en/schema-input.json)

Output [Open](https://developers.cloudflare.com/workers-ai/models/aura-2-en/schema-output.json) [Download](https://developers.cloudflare.com/workers-ai/models/aura-2-en/schema-output.json)

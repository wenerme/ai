...
Input [Open](https://developers.cloudflare.com/workers-ai/models/stable-diffusion-xl-lightning/schema-input.json) [Download](https://developers.cloudflare.com/workers-ai/models/stable-diffusion-xl-lightning/schema-input.json)

Output [Open](https://developers.cloudflare.com/workers-ai/models/stable-diffusion-xl-lightning/schema-output.json) [Download](https://developers.cloudflare.com/workers-ai/models/stable-diffusion-xl-lightning/schema-output.json)

...
Input [Open](https://developers.cloudflare.com/workers-ai/models/bart-large-cnn/schema-input.json) [Download](https://developers.cloudflare.com/workers-ai/models/bart-large-cnn/schema-input.json)

Output [Open](https://developers.cloudflare.com/workers-ai/models/bart-large-cnn/schema-output.json) [Download](https://developers.cloudflare.com/workers-ai/models/bart-large-cnn/schema-output.json)

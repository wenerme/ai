...
Last updated Sep 15, 2026|Copy as Markdown| [View as Markdown](https://developers.cloudflare.com/workers-ai/get-started/rest-api/index.md)| [Agent setup](https://developers.cloudflare.com/agent-setup/)
...
1. In the Cloudflare dashboard, go to the **Workers AI** page. [Go to **Workers AI** ↗](https://dash.cloudflare.com/?to=/:account/ai/workers-ai)
...
3. Get your API token:
   ...
   5. Save that value for future use. This token will be visible [on your profile](https://developers.cloudflare.com/fundamentals/api/get-started/create-token/).

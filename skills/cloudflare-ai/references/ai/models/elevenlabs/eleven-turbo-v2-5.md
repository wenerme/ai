---
description: ElevenLabs' Turbo v2.5 text-to-speech model balancing high-quality voice generation with low latency across 32 languages.
...
Input [Open](https://developers.cloudflare.com/ai/models/elevenlabs/eleven-turbo-v2-5/schema-input.json) [Download](https://developers.cloudflare.com/ai/models/elevenlabs/eleven-turbo-v2-5/schema-input.json)

Output [Open](https://developers.cloudflare.com/ai/models/elevenlabs/eleven-turbo-v2-5/schema-output.json) [Download](https://developers.cloudflare.com/ai/models/elevenlabs/eleven-turbo-v2-5/schema-output.json)

...
Copy as Markdown| [View as Markdown](https://developers.cloudflare.com/ai/models/%40cf/moonshotai/kimi-k2.7-code/index.md)| [Agent setup](https://developers.cloudflare.com/agent-setup/)
...
SynchronousInput [Open](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/sync-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/sync-input.json)

SynchronousOutput [Open](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/sync-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/sync-output.json)

StreamingInput [Open](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/streaming-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/streaming-input.json)

StreamingOutput [Open](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/streaming-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/streaming-output.json)

BatchInput [Open](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/batch-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/batch-input.json)

BatchOutput [Open](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/batch-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/moonshotai/kimi-k2.7-code/batch-output.json)
...
```json
{"@context":"https://schema.org","@type":"TechArticle","@id":"https://developers.cloudflare.com/ai/models/%40cf/moonshotai/kimi-k2.7-code/#page","headline":"kimi-k2.7-code","description":"Kimi K2.7 is a frontier-scale open-source 1T parameter model with a 262.1k context window, multi-turn tool calling, vision inputs, and structured outputs for agentic workloads.","url":"https://developers.cloudflare.com/ai/models/%40cf/moonshotai/kimi-k2.7-code/","inLanguage":"en","image":"https://developers.cloudflare.com/og-docs.png","publisher":{"@type":"Organization","name":"Cloudflare","description":"One platform for your apps, agents, and workforce. Build, secure, and scale without managing infrastructure","url":"https://www.cloudflare.com/","sameAs":["https://github.com/cloudflare","https://www.linkedin.com/company/cloudflare","https://x.com/cloudflare"],"logo":{"@type":"ImageObject","url":"https://developers.cloudflare.com/logo.svg"},"address":{"@type":"PostalAddress","streetAddress":"101 Townsend St","addressLocality":"San Francisco","addressRegion":"CA","postalCode":"94107","addressCountry":"US"},"contactPoint":[{"@type":"ContactPoint","contactType":"Customer Support","url":"https://support.cloudflare.com/","availableLanguage":["English"]},{"@type":"ContactPoint","contactType":"Sales","url":"https://www.cloudflare.com/contact/","availableLanguage":["English"]}]},"isPartOf":{"@type":"WebSite","@id":"https://developers.cloudflare.com/#website","name":"Cloudflare Docs","url":"https://developers.cloudflare.com/"}}
```

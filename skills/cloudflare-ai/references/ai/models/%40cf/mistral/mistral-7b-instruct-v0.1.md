...
SynchronousInput [Open](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/sync-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/sync-input.json)

SynchronousOutput [Open](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/sync-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/sync-output.json)

StreamingInput [Open](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/streaming-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/streaming-input.json)

StreamingOutput [Open](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/streaming-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/mistral/mistral-7b-instruct-v0.1/streaming-output.json)

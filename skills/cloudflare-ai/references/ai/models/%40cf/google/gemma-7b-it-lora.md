...
Synchronous Input [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/sync-input.json "Open") [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/sync-input.json "Download")

Synchronous Output [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/sync-output.json "Open") [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/sync-output.json "Download")

Streaming Input [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/streaming-input.json "Open") [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/streaming-input.json "Download")

Streaming Output [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/streaming-output.json "Open") [ ](https://developers.cloudflare.com/ai/models/@cf/google/gemma-7b-it-lora/streaming-output.json "Download")

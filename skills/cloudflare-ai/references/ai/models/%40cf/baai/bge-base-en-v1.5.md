...
SynchronousInput [Open](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/sync-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/sync-input.json)

SynchronousOutput [Open](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/sync-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/sync-output.json)

BatchInput [Open](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/batch-input.json) [Download](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/batch-input.json)

BatchOutput [Open](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/batch-output.json) [Download](https://developers.cloudflare.com/ai/models/@cf/baai/bge-base-en-v1.5/batch-output.json)

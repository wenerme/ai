...
Input [Open](https://developers.cloudflare.com/ai/models/krea/krea-2-medium/schema-input.json) [Download](https://developers.cloudflare.com/ai/models/krea/krea-2-medium/schema-input.json)

Output [Open](https://developers.cloudflare.com/ai/models/krea/krea-2-medium/schema-output.json) [Download](https://developers.cloudflare.com/ai/models/krea/krea-2-medium/schema-output.json)

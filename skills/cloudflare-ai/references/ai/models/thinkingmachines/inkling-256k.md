...
| Pricing | <ul><li>Input (per 1M tokens)$3.74</li><li>Output (per 1M tokens)$9.36</li><li>Cached input (per 1M tokens)$0.748</li><li>Cache creation (per 1M tokens)$3.74</li></ul> |

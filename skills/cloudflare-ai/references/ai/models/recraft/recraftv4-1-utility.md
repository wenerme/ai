...
<summary>**Product Mockup** — Generate a product concept image</summary>
...
<summary>**With Color Controls** — Guide generation with specific colors</summary>
...
Input [Open](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility/schema-input.json) [Download](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility/schema-input.json)

Output [Open](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility/schema-output.json) [Download](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility/schema-output.json)

...
Input [Open](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-vector/schema-input.json) [Download](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-vector/schema-input.json)

Output [Open](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-vector/schema-output.json) [Download](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-vector/schema-output.json)

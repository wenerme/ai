...
<summary>**Illustration** — Vector illustration for general use</summary>
...
Input [Open](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility-vector/schema-input.json) [Download](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility-vector/schema-input.json)

Output [Open](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility-vector/schema-output.json) [Download](https://developers.cloudflare.com/ai/models/recraft/recraftv4-1-utility-vector/schema-output.json)

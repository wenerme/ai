...
* [ Workers R2 binding ](#tab-panel-6694)
* [ AWS SDK ](#tab-panel-6695)
* [ Wrangler CLI ](#tab-panel-6696)
...
```
await env.MY_BUCKET.put("docs/document.pdf", fileContent, {  customMetadata: {    category: "documentation",    version: "2.5",    is_public: "true",  },});
```
...
await client.send(  new PutObjectCommand({    Bucket: "your-bucket",    Key: "docs/document.pdf",    Body: fileContent,    Metadata: {      category: "documentation",      version: "2.5",      is_public: "true",    },  }),);
```
...
```
wrangler r2 object put your-bucket/docs/document.pdf \  --file=./document.pdf \  --header="x-amz-meta-category:documentation" \  --header="x-amz-meta-version:2.5" \  --header="x-amz-meta-is_public:true"
```

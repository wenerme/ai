...
Last updated Sep 17, 2026|Copy as Markdown| [View as Markdown](https://developers.cloudflare.com/ai-search/api/migration/rest-api/index.md)| [Agent setup](https://developers.cloudflare.com/agent-setup/)
...
| --- | --- | --- |
| Chat completions | `/ai-search/namespaces/{namespace}/instances/{id}/chat/completions` | [API reference](https://developers.cloudflare.com/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/chat_completions/) |
| Search | `/ai-search/namespaces/{namespace}/instances/{id}/search` | [API reference](https://developers.cloudflare.com/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/search/) |
...
- [Chat Completions API reference](https://developers.cloudflare.com/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/chat_completions/)
- [Search API reference](https://developers.cloudflare.com/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/search/)

...
> **info**: This does not work with vite v5.0.0+ and wails v2 due to changes in vite. 
...
> **warning**: Exposing your filesystem in this way is a security risk. It is recommended that you properly manage access
to your filesystem.

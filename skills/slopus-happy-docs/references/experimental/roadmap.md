...
- Fix markdown image rendering in session/chat messages so absolute-path screenshot syntax like `` previews inline on web instead of failing silently during manager review.

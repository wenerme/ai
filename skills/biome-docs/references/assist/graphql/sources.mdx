...
### GraphQL-ESLint
| GraphQL-ESLint Actions name | Biome Actions name |
| ---- | ---- |
| [alphabetize](https://the-guild.dev/graphql/eslint/rules/alphabetize) |[useSortedEnumMembers](/assist/actions/use-sorted-enum-members/graphql) (inspired) |

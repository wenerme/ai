...
editUrl: false
title: noEmptySource (GraphQL)
description: GraphQL documentation for noEmptySource
---

<RuleLanguageLinks current="graphql" languages={[{"id":"css","label":"CSS","href":"/linter/rules/no-empty-source/css/"},{"id":"graphql","label":"GraphQL","href":"/linter/rules/no-empty-source/graphql/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-empty-source/javascript/"}]} />

...
- Diagnostic Category: [`lint/nursery/useLoneAnonymousOperation`](/reference/diagnostics#diagnostic-category)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_graphql_analyze/src/lint/nursery/use_lone_anonymous_operation.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_graphql_analyze/tests/specs/nursery/useLoneAnonymousOperation)

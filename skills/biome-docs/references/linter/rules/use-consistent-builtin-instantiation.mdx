...
description: Learn more about useConsistentBuiltinInstantiation
---
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/style/use_consistent_builtin_instantiation.rs)

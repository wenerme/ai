...
title: noEmptyObjectKeys
description: Learn more about noEmptyObjectKeys
---
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_json_analyze/src/lint/nursery/no_empty_object_keys.rs)

...
editUrl: false
title: noNonoctalDecimalEscape (JavaScript)
description: JavaScript (and super languages) documentation for noNonoctalDecimalEscape
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-nonoctal-decimal-escape/javascript/"}]} />

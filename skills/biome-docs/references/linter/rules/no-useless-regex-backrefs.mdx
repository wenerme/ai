...
title: noUselessRegexBackrefs
description: Learn more about noUselessRegexBackrefs
---
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/suspicious/no_useless_regex_backrefs.rs)

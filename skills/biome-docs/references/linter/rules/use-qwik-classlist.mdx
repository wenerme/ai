...
editUrl: false
title: useQwikClasslist
description: Learn more about useQwikClasslist
---

## Summary
- Rule available since: `v2.1.4`
- Diagnostic Category: [`lint/correctness/useQwikClasslist`](/reference/diagnostics#diagnostic-category)
...
- Sources: 
  - Same as [`qwik/prefer-classlist`](https://qwik.dev/docs/advanced/eslint/#prefer-classlist)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/correctness/use_qwik_classlist.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/correctness/useQwikClasslist)

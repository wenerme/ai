...
<pre class="language-text"><code class="language-text">code-block.js:2:16 <a href="https://biomejs.dev/linter/rules/no-redundant-default-export/javascript">lint/complexity/noRedundantDefaultExport</a> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  <strong><span style="color: Orange;">⚠</span></strong> <span style="color: Orange;">Default export exports the same symbol as a named export.</span>      <strong>1 │ </strong>export const foo = 42;  <strong><span style="color: Tomato;">&gt;</span></strong> <strong>2 │ </strong>export default foo;   <strong>   │ </strong>               <strong><span style="color: Tomato;">^</span></strong><strong><span style="color: Tomato;">^</span></strong><strong><span style="color: Tomato;">^</span></strong>    <strong>3 │ </strong>    <strong><span style="color: lightgreen;">ℹ</span></strong> <span style="color: lightgreen;">Exporting the same identifier as both a named export and a default export is redundant.</span>    <strong><span style="color: lightgreen;">ℹ</span></strong> <span style="color: lightgreen;">Remove either the default export or the named export to avoid redundancy.</span>  </code></pre>

...
editUrl: false
title: useDefaultParameterLast (JavaScript)
description: JavaScript (and super languages) documentation for useDefaultParameterLast
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-default-parameter-last/javascript/"}]} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/style/use_default_parameter_last.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/style/useDefaultParameterLast)

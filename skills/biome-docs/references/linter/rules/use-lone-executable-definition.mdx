...
- Diagnostic Category: [`lint/style/useLoneExecutableDefinition`](/reference/diagnostics#diagnostic-category)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_graphql_analyze/src/lint/style/use_lone_executable_definition.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_graphql_analyze/tests/specs/style/useLoneExecutableDefinition)

...
editUrl: false
title: useExpect (JavaScript)
description: JavaScript (and super languages) documentation for useExpect
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-expect/javascript/"}]} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/nursery/use_expect.rs)

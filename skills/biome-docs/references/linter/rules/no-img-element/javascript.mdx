...
editUrl: false
title: noImgElement (JavaScript)
description: JavaScript (and super languages) documentation for noImgElement
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-img-element/javascript/"}]} />

## Summary
- Rule available since: `v1.9.4`
- Diagnostic Category: [`lint/performance/noImgElement`](/reference/diagnostics#diagnostic-category)
...
- Sources: 
  - Same as [`@next/next/no-img-element`](https://nextjs.org/docs/messages/no-img-element)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/performance/no_img_element.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/performance/noImgElement)

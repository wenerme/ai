...
editUrl: false
title: useQwikMethodUsage (JavaScript)
description: JavaScript (and super languages) documentation for useQwikMethodUsage
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-qwik-method-usage/javascript/"}]} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/correctness/use_qwik_method_usage.rs)

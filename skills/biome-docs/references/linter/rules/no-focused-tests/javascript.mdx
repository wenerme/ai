...
editUrl: false
title: noFocusedTests (JavaScript)
description: JavaScript (and super languages) documentation for noFocusedTests
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-focused-tests/javascript/"}]} />
...
- Sources: 
  ...
  - Inspired from [`vitest/no-focused-tests`](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rules/no-focused-tests.md)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/suspicious/no_focused_tests.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/suspicious/noFocusedTests)

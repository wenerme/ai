...
title: useSolidForComponent
description: Learn more about useSolidForComponent
---
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/performance/use_solid_for_component.rs)

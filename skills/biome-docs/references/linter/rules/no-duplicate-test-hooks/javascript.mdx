...
editUrl: false
title: noDuplicateTestHooks (JavaScript)
description: JavaScript (and super languages) documentation for noDuplicateTestHooks
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-duplicate-test-hooks/javascript/"}]} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/suspicious/no_duplicate_test_hooks.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/suspicious/noDuplicateTestHooks)

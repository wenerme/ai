...
title: noProcessEnv
description: Learn more about noProcessEnv
---
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/style/no_process_env.rs)

...
editUrl: false
title: noHeaderScope (HTML)
description: HTML documentation for noHeaderScope
localized: false
---

<RuleLanguageLinks current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/no-header-scope/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-header-scope/javascript/"}]} />

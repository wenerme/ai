...
editUrl: false
title: useNamedCaptureGroup (JavaScript)
description: JavaScript (and super languages) documentation for useNamedCaptureGroup
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-named-capture-group/javascript/"}]} />

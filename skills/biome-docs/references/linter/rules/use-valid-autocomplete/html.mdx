...
editUrl: false
title: useValidAutocomplete (HTML)
description: HTML documentation for useValidAutocomplete
---

<RuleLanguageLinks current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-valid-autocomplete/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-valid-autocomplete/javascript/"}]} />

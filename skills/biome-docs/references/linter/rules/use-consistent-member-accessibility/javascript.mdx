...
editUrl: false
title: useConsistentMemberAccessibility (JavaScript)
description: JavaScript (and super languages) documentation for useConsistentMemberAccessibility
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-consistent-member-accessibility/javascript/"}]} />

...
editUrl: false
title: noRestrictedImports (JavaScript)
description: JavaScript (and super languages) documentation for noRestrictedImports
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-restricted-imports/javascript/"}]} />

...
- Sources: 
  - Same as [`no-unused-labels`](https://eslint.org/docs/latest/rules/no-unused-labels)
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/correctness/no_unused_labels.rs)

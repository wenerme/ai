...
- Sources: 
  - Same as [`@next/next/no-head-element`](https://nextjs.org/docs/messages/no-head-element)
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/style/no_head_element.rs)

...
- [noInvalidPropertyInitValue](/linter/rules/no-invalid-property-init-value) 
- [noUnusedClasses](/linter/rules/no-unused-classes) 
...
| ---- | ---- |
| [no-duplicate-keyframe-selectors](https://github.com/eslint/css/blob/main/docs/rules/no-duplicate-keyframe-selectors.md) |[noDuplicateSelectorsKeyframeBlock](/linter/rules/no-duplicate-selectors-keyframe-block) |
| [no-empty-blocks](https://github.com/eslint/css/blob/main/docs/rules/no-empty-blocks.md) |[noEmptyBlock](/linter/rules/no-empty-block) |
| [no-important](https://github.com/eslint/css/blob/main/docs/rules/no-important.md) |[noImportantStyles](/linter/rules/no-important-styles) |
| [no-invalid-named-grid-areas](https://github.com/eslint/css/blob/main/docs/rules/no-invalid-named-grid-areas.md) |[noInvalidGridAreas](/linter/rules/no-invalid-grid-areas) |
| [use-baseline](https://github.com/eslint/css/blob/main/docs/rules/use-baseline.md) |[useBaseline](/linter/rules/use-baseline) (inspired) |
...
| ---- | ---- |
| [use-baseline](https://html-eslint.org/docs/rules/use-baseline) |[useBaseline](/linter/rules/use-baseline) (inspired) |
### Stylelint
...
| [declaration-no-important](https://github.com/stylelint/stylelint/blob/main/lib/rules/declaration-no-important/README.md) |[noImportantStyles](/linter/rules/no-important-styles) |
...
| [no-duplicate-selectors](https://github.com/stylelint/stylelint/blob/main/lib/rules/no-duplicate-selectors/README.md) |[noDuplicateSelectors](/linter/rules/no-duplicate-selectors) |
| [no-empty-source](https://github.com/stylelint/stylelint/blob/main/lib/rules/no-empty-source/README.md) |[noEmptySource](/linter/rules/no-empty-source) |
...
| [selector-max-class](https://github.com/stylelint/stylelint/blob/main/lib/rules/selector-max-class/README.md) |[noExcessiveSelectorClasses](/linter/rules/no-excessive-selector-classes) |

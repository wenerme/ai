...
> **caution**: If you pass a glob as a parameter, your shell will expand it. **Biome doesn't support globs**.
...
> **caution**: Rules that belong to this group are not subject to semantic version.

...
> **note**: `RUST_BACKTRACE` is a Rust environment variable, not a Biome-specific option. Biome supports it because it is built with Rust and uses Rust's backtrace support when reporting a panic.

...
Use this reporter to print diagnostics in a compact, single-line format.
...
Use this reporter to emit diagnostics that follow the [SARIF format](https://sarifweb.azurewebsites.net/).

...
> **note**: From here onwards, JavaScript is used to explain suppression comments, and the `lint` category is used.
...
> **note**: Range suppressions must have a matching `biome-ignore-end` suppression.

...
> **note**: You can also export `biome.jsonc` files!
...
> **caution**: Due to the different nature of `.prettierignore` globs and Biome’s globs, it’s **highly advised** to make sure that those globs still work under Biome.

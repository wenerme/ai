...
```
> **note**: We plan to fade out this option and make it the default. The option will be removed once the HTML parser becomes stable and supports more language-specific features.

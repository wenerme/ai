...
excerpt: Biome continues Rome's legacy; in this blog post, we explain why the fork, with some context and history.
authors:
  - ema
  - core
date: 2023-08-29
cover:
  light: "@/assets/social-logo.png"
  dark: "@/assets/social-logo.png"
...
Biome will embrace the same [philosophy](/internals/philosophy) of the old Rome and the same mission. Although, the roadmap will likely change, and the core team could decide to focus on making the current features more stable instead of releasing new ones.

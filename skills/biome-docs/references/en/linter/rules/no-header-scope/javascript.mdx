...
editUrl: false
title: noHeaderScope (JavaScript)
description: JavaScript (and super languages) documentation for noHeaderScope
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"html","label":"HTML","href":"/linter/rules/no-header-scope/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-header-scope/javascript/"}]} />
...
- <RulePlaygroundLink rule="noHeaderScope" category="lint" language="jsx" code={"<div scope={scope} />\n"} />

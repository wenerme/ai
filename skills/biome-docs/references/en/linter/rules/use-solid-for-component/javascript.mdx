...
editUrl: false
title: useSolidForComponent (JavaScript)
description: JavaScript (and super languages) documentation for useSolidForComponent
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-solid-for-component/javascript/"}]} />

## Summary
- Rule available since: `v2.0.0`
- Diagnostic Category: [`lint/performance/useSolidForComponent`](/reference/diagnostics#diagnostic-category)
...
- Sources: 
  - Inspired from [`solid/prefer-for`](https://github.com/solidjs-community/eslint-plugin-solid/blob/main/packages/eslint-plugin-solid/docs/prefer-for.md)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/performance/use_solid_for_component.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/performance/useSolidForComponent)
- <RulePlaygroundLink rule="useSolidForComponent" category="lint" language="jsx" code={"let Component = (props) => <ol>{props.data.map(d => <li>{d.text}</li>)}</ol>;\n"} />

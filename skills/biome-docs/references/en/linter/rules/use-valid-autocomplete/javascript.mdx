...
editUrl: false
title: useValidAutocomplete (JavaScript)
description: JavaScript (and super languages) documentation for useValidAutocomplete
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-valid-autocomplete/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-valid-autocomplete/javascript/"}]} />
...
- <RulePlaygroundLink rule="useValidAutocomplete" category="lint" language="jsx" code={"<input type=\"text\" autocomplete=\"incorrect\" />\n"} />

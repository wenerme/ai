...
editUrl: false
title: noSolidDestructuredProps (JavaScript)
description: JavaScript (and super languages) documentation for noSolidDestructuredProps
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-solid-destructured-props/javascript/"}]} />

## Summary
- Rule available since: `v2.0.0`
- Diagnostic Category: [`lint/correctness/noSolidDestructuredProps`](/reference/diagnostics#diagnostic-category)
...
- Sources: 
  - Inspired from [`solid/no-destructure`](https://github.com/solidjs-community/eslint-plugin-solid/blob/main/packages/eslint-plugin-solid/docs/no-destructure.md)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/correctness/no_solid_destructured_props.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/correctness/noSolidDestructuredProps)
- <RulePlaygroundLink rule="noSolidDestructuredProps" category="lint" language="jsx" code={"let Component = ({}) => <div />;\n"} />

...
editUrl: false
title: noParameterAssign (JavaScript)
description: JavaScript (and super languages) documentation for noParameterAssign
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-parameter-assign/javascript/"}]} />
...
- <RulePlaygroundLink rule="noParameterAssign" category="lint" language="js" code={"function f(param) {\n    param = 13;\n}\n"} />

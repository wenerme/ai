...
editUrl: false
title: useQwikClasslist (JavaScript)
description: JavaScript (and super languages) documentation for useQwikClasslist
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-qwik-classlist/javascript/"}]} />
...
- <RulePlaygroundLink rule="useQwikClasslist" category="lint" language="jsx" code={"<div class={classnames({ active: true, disabled: false })} />\n"} />

...
editUrl: false
title: noDuplicateCustomProperties (CSS)
description: CSS documentation for noDuplicateCustomProperties
localized: false
---

<RuleLanguageLinks current="css" languages={[{"id":"css","label":"CSS","href":"/linter/rules/no-duplicate-custom-properties/css/"}]} />
...
- Sources: 
  - Same as [`declaration-block-no-duplicate-custom-properties`](https://github.com/stylelint/stylelint/blob/main/lib/rules/declaration-block-no-duplicate-custom-properties/README.md)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_css_analyze/src/lint/suspicious/no_duplicate_custom_properties.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_css_analyze/tests/specs/suspicious/noDuplicateCustomProperties)
- <RulePlaygroundLink rule="noDuplicateCustomProperties" category="lint" language="css" code={"a { --custom-property: pink; --custom-property: orange;  }\n"} />

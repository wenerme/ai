...
editUrl: false
title: noQwikUseVisibleTask (JavaScript)
description: JavaScript (and super languages) documentation for noQwikUseVisibleTask
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-qwik-use-visible-task/javascript/"}]} />

## Summary
- Rule available since: `v2.1.4`
- Diagnostic Category: [`lint/correctness/noQwikUseVisibleTask`](/reference/diagnostics#diagnostic-category)
...
- Sources: 
  - Same as [`qwik/no-use-visible-task`](https://qwik.dev/docs/advanced/eslint/#no-use-visible-task)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/correctness/no_qwik_use_visible_task.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/correctness/noQwikUseVisibleTask)
- <RulePlaygroundLink rule="noQwikUseVisibleTask" category="lint" language="js" code={"useVisibleTask$(() => {\n  console.log('Component is visible');\n});\n"} />

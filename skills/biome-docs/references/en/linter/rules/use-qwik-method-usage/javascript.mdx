...
- <RulePlaygroundLink rule="useQwikMethodUsage" category="lint" language="js" code={"import { useSignal } from \"@builder.io/qwik\";\n\nexport const Counter = () => {\n  const count = useSignal(0);\n};\n"} />

...
editUrl: false
title: noUndeclaredDependencies (JavaScript)
description: JavaScript (and super languages) documentation for noUndeclaredDependencies
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-undeclared-dependencies/javascript/"}]} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/correctness/no_undeclared_dependencies.rs)
...
- <RulePlaygroundLink rule="noUndeclaredDependencies" category="lint" language="js" code={"import \"vite\";\n"} />

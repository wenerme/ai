...
- <RulePlaygroundLink rule="useHookAtTopLevel" category="lint" language="js" code={"function Component1({ a }) {\n    if (a == 1) {\n        useEffect();\n    }\n}\n"} />

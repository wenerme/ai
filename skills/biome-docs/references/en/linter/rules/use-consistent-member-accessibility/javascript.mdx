...
- <RulePlaygroundLink rule="useConsistentMemberAccessibility" category="lint" language="ts" code={"class Animal {\n  public constructor(breed, name) {\n    // ...\n  }\n}\n"} />

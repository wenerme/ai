...
- <RulePlaygroundLink rule="noDuplicateInputFieldNames" category="lint" language="graphql" code={"query {\n  field(arg: { f1: \"value\", f1: \"value\" })\n}\n"} />

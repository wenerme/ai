...
editUrl: false
title: useAltText (JavaScript)
description: JavaScript (and super languages) documentation for useAltText
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-alt-text/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-alt-text/javascript/"}]} />
...
- Sources: 
  ...
  - Inspired from [`@html-eslint/require-img-alt`](https://html-eslint.org/docs/rules/require-img-alt)
...
<Fragment set:html={"<pre class=\"language-text\"><code class=\"language-text\">code-block.astro:1:10 <a href=\"https://biomejs.dev/linter/rules/use-alt-text\">lint/a11y/useAltText</a> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  <strong><span style=\"color: Tomato;\">✖</span></strong> <span style=\"color: Tomato;\">Provide a text alternative through the </span><span style=\"color: Tomato;\"><strong>alt</strong></span><span style=\"color: Tomato;\">, </span><span style=\"color: Tomato;\"><strong>aria-label</strong></span><span style=\"color: Tomato;\"> or </span><span style=\"color: Tomato;\"><strong>aria-labelledby</strong></span><span style=\"color: Tomato;\"> attribute</span>    <strong><span style=\"color: Tomato;\">&gt;</span></strong> <strong>1 │ </strong>&#123;show &amp;&amp; &lt;img src=&quot;image.png&quot; /&gt;&#125;   <strong>   │ </strong>         <strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong><strong><span style=\"color: Tomato;\">^</span></strong>    <strong>2 │ </strong>    <strong><span style=\"color: lightgreen;\">ℹ</span></strong> <span style=\"color: lightgreen;\">Meaningful alternative text on elements helps users relying on screen readers to understand content's purpose within a page.</span>    <strong><span style=\"color: lightgreen;\">ℹ</span></strong> <span style=\"color: lightgreen;\">If the content is decorative, redundant, or obscured, consider hiding it from assistive technologies with the </span><span style=\"color: lightgreen;\"><strong>aria-hidden</strong></span><span style=\"color: lightgreen;\"> attribute.</span>  </code></pre>"} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/a11y/use_alt_text.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/a11y/useAltText)
- <RulePlaygroundLink rule="useAltText" category="lint" language="jsx" code={"\n"} />

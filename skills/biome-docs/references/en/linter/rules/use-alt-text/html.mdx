...
editUrl: false
title: useAltText (HTML)
description: HTML documentation for useAltText
localized: false
---

<RuleLanguageLinks current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-alt-text/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-alt-text/javascript/"}]} />
...
- <RulePlaygroundLink rule="useAltText" category="lint" language="html" code={"\n"} />

...
editUrl: false
title: useReactFunctionComponents (JavaScript)
description: JavaScript (and super languages) documentation for useReactFunctionComponents
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-react-function-components/javascript/"}]} />

## Summary
- Rule available since: `v2.1.3`
- Diagnostic Category: [`lint/style/useReactFunctionComponents`](/reference/diagnostics#diagnostic-category)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/style/use_react_function_components.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/style/useReactFunctionComponents)
- <RulePlaygroundLink rule="useReactFunctionComponents" category="lint" language="jsx" code={"class Foo extends React.Component {\n  render() {\n    return (\n      <div>This is a class component.</div>\n    );\n  }\n}\n"} />

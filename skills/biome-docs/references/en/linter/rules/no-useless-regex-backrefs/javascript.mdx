...
editUrl: false
title: noUselessRegexBackrefs (JavaScript)
description: JavaScript (and super languages) documentation for noUselessRegexBackrefs
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-useless-regex-backrefs/javascript/"}]} />

## Summary
- Rule available since: `v2.0.0`
- Diagnostic Category: [`lint/suspicious/noUselessRegexBackrefs`](/reference/diagnostics#diagnostic-category)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/suspicious/no_useless_regex_backrefs.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/suspicious/noUselessRegexBackrefs)
- <RulePlaygroundLink rule="noUselessRegexBackrefs" category="lint" language="js" code={"/(a)|b\\1/;\n"} />

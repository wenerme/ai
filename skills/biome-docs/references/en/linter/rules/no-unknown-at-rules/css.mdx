...
editUrl: false
title: noUnknownAtRules (CSS)
description: CSS documentation for noUnknownAtRules
localized: false
---

<RuleLanguageLinks current="css" languages={[{"id":"css","label":"CSS","href":"/linter/rules/no-unknown-at-rules/css/"}]} />
...
- Sources: 
  ...
  - Inspired from [`css/no-invalid-at-rules`](https://github.com/eslint/css/blob/main/docs/rules/no-invalid-at-rules.md)
...
- <RulePlaygroundLink rule="noUnknownAtRules" category="lint" language="css" code={"@uNkNoWn {}\n"} />

...
editUrl: false
title: noSvgWithoutTitle (JavaScript)
description: JavaScript (and super languages) documentation for noSvgWithoutTitle
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"html","label":"HTML","href":"/linter/rules/no-svg-without-title/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-svg-without-title/javascript/"}]} />

## Summary
- Rule available since: `v1.0.0`
- Diagnostic Category: [`lint/a11y/noSvgWithoutTitle`](/reference/diagnostics#diagnostic-category)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/a11y/no_svg_without_title.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/a11y/noSvgWithoutTitle)
- <RulePlaygroundLink rule="noSvgWithoutTitle" category="lint" language="jsx" code={"<svg>foo</svg>\n"} />

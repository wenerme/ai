...
editUrl: false
title: noSvgWithoutTitle (HTML)
description: HTML documentation for noSvgWithoutTitle
localized: false
---

<RuleLanguageLinks current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/no-svg-without-title/html/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-svg-without-title/javascript/"}]} />
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_html_analyze/src/lint/a11y/no_svg_without_title.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_html_analyze/tests/specs/a11y/noSvgWithoutTitle)
- <RulePlaygroundLink rule="noSvgWithoutTitle" category="lint" language="html" code={"<svg>foo</svg>\n"} />

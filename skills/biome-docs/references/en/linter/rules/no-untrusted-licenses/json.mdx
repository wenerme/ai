...
editUrl: false
title: noUntrustedLicenses (JSON)
description: JSON (and super languages) documentation for noUntrustedLicenses
localized: false
---

<RuleLanguageLinks current="json" languages={[{"id":"json","label":"JSON (and super languages)","href":"/linter/rules/no-untrusted-licenses/json/"}]} />
...
> **note**: This rule catches only dependencies that are actually used in your project (i.e., imported by some code).

...
editUrl: false
title: noDuplicateObjectKeys (JavaScript)
description: JavaScript (and super languages) documentation for noDuplicateObjectKeys
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"json","label":"JSON (and super languages)","href":"/linter/rules/no-duplicate-object-keys/json/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-duplicate-object-keys/javascript/"}]} />
...
- <RulePlaygroundLink rule="noDuplicateObjectKeys" category="lint" language="js" code={"const obj = {\n   \ta: 1,\n   \ta: 2,\n}\n"} />

...
editUrl: false
title: useBaseline (CSS)
description: CSS documentation for useBaseline
localized: false
---

<RuleLanguageLinks current="css" languages={[{"id":"css","label":"CSS","href":"/linter/rules/use-baseline/css/"}]} />
...
- Diagnostic Category: [`lint/nursery/useBaseline`](/reference/diagnostics#diagnostic-category)
...
- <RulePlaygroundLink rule="useBaseline" category="lint" language="css" code={"a {\n  backdrop-filter: blur(4px);\n}\n"} />

...
editUrl: false
title: noNonNullAssertedOptionalChain (JavaScript)
description: JavaScript (and super languages) documentation for noNonNullAssertedOptionalChain
localized: false
---

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-non-null-asserted-optional-chain/javascript/"}]} />

## Summary
- Rule available since: `v2.1.4`
- Diagnostic Category: [`lint/suspicious/noNonNullAssertedOptionalChain`](/reference/diagnostics#diagnostic-category)
...
- [Source Code (Edit this Page)](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/suspicious/no_non_null_asserted_optional_chain.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/suspicious/noNonNullAssertedOptionalChain)
- <RulePlaygroundLink rule="noNonNullAssertedOptionalChain" category="lint" language="ts" code={"obj?.prop!;\n"} />

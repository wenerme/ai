...
Configuration for the GitLab.com instance.
...
| Maximum registered runners                                                       | Free tier: `50` for each group and `50`for each projectAll paid tiers: `1000` for each group and `1000` for each project | See [Number of registered runners for each scope](../../administration/cicd/limits.md#number-of-registered-runners-for-groups-and-projects). |
| Limit of dotenv variables                                                        | Free tier: `50`Premium tier: `100`Ultimate tier: `150`                                             | See [Limit dotenv variables](../../administration/cicd/limits.md#limit-dotenv-variables). |

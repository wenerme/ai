...
View compliance frameworks applied to projects and groups, with options to manage, filter, and export framework assignments.
...
1. In the left sidebar, select **Secure** > **Compliance center**.
1. On the page, select the **Projects** tab.
1. Next to the project you want to add the compliance framework to, select  action.
...
1. In the left sidebar, select **Secure** > **Compliance center**.
1. On the page, select the **Projects** tab.
1. Next to the compliance framework to remove from the project, select  on the framework label.

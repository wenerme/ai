...
1. In the upper-right corner, select **More actions** (), then select **Change type**.
...
1. On a task, in the upper-right corner, select **More actions** ().
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**, then filter by **Type** = **Task** and select your task.
1. In the upper-right corner, select **More actions** (), then select **Copy Reference**.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**, then filter by **Type** = **Task** and select your task.
1. In the upper-right corner, select the vertical ellipsis ().
...
Wherever tasks are listed, you can see the confidential () icon
...
Likewise, while inside the task, you can see the confidential () icon right next to
the breadcrumbs.
...
1. In the **Linked items** section of a task, next to each item, select the vertical
   ellipsis () and then select **Remove**.
...
1. In the **Description** box, find and add the task.
   ...
   - If your task is in a different project, with a task open, copy the URL from the browser or
     copy the task's reference by selecting the vertical ellipsis () in the upper-right corner, then **Copy Reference**.

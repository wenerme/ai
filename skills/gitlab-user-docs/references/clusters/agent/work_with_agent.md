...
1. To delete the token you're no longer using, return to the token list and select **Revoke** ().
...
1. In the top bar, select **Search or go to** and find the project that contains your agent configuration file.
1. Select **Operate** > **Kubernetes clusters**.
1. In the table, in the row for your agent, in the **Options** column, select the vertical ellipsis ().

...
[The basic SAML configuration settings in Azure Active Directory.]

### User claims and attributes

[The user claims and attributes configuration in Azure Active Directory.]

### SCIM mapping

Provisioning:

[The SCIM provisioning settings in Azure Active Directory.]

### Attribute mapping

[The SCIM attribute mapping configuration in Azure Active Directory.]

### Group Sync

[The group claims configuration for SAML in Azure Active Directory.]
...
[The basic SAML app configuration settings in Google Workspace.]

### User claims and attributes

[The user claims and attributes configuration in Google Workspace.]

### IdP links and certificate

[The identity provider links and certificate settings in Google Workspace.]

## Okta

### Basic SAML app configuration for GitLab.com groups

[The basic SAML app configuration settings for GitLab.com groups in Okta.]

### Basic SAML app configuration for GitLab Self-Managed

[The basic SAML app configuration settings for GitLab Self-Managed in the Okta admin panel.]

### User claims and attributes

[The user claims and attributes configuration in Okta.]

### Group Sync

[The group attribute configuration for group sync in Okta.]

### Advanced SAML app settings (defaults)

[The advanced SAML app settings and their default values in Okta.]

### IdP links and certificate

[The identity provider links and certificate settings in Okta.]

### SAML sign on settings

[The SAML sign-on settings in the Okta configuration.]

### SCIM settings

Setting the username for the newly provisioned users when assigning them the SCIM app:

[The interface for assigning a SCIM application to users and setting their username in Okta.]

## OneLogin

### Basic SAML app configuration

[The basic application details and configuration settings in OneLogin.]

### Parameters

[The application parameters and attribute mapping settings in OneLogin.]

### Adding a user

[The interface for adding a user to an application in OneLogin.]

### SSO settings

[The single sign-on settings and certificate configuration in OneLogin.]

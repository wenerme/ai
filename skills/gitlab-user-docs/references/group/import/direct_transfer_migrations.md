...
1. Create either:
   - A new group. In the upper-right corner, select **Create new** () and **New group**. Then select **Import group**.
   - A new subgroup. On existing group's page, either:
     - Select **Create subgroup**.
     - In the upper-right corner, select **Create new** () and **New subgroup**. Then select the **import an existing group** link.

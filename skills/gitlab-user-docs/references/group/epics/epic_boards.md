...
Manage and visualize group epics in GitLab with Epic Boards. Create, organize, filter, and track progress using labels and weights.
...
[An epic board displaying epics in lists.]
...
1. Select **New list**.
   ...
   [The new list panel inserted between two existing lists.]
...
[The inline form used to create a new epic on a board list.]
...
weight, hover over the work items icon , weight icon , or
progress icon .

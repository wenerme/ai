...
> [!warning]
> This feature was [deprecated](https://gitlab.com/groups/gitlab-org/configure/-/work_items/8) in GitLab 14.5. To connect clusters to GitLab,
...
1. In the left sidebar, select **Operate** > **Kubernetes**.

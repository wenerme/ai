...
Use comments and threads to discuss and manage work item conversations.
...
1. Start a comment:
   - To comment on an entire file, find the file you want to comment on and,
     in the file header, select **Comment on this file** ().
   - To comment on specific lines, find the line number you want to comment on. Hover over the line number,
     then select **Comment** (). To select more lines,
     drag the **Comment** () icon.
...
1. Select **Edit line range** () to start editing. A handle
...
1. On the comment, select **Edit comment** ().
1. Make your edits.
...
1. In the upper-right corner of the comment, select **Reply to comment** ()
...
1. Enter a comment.
1. Below the comment, to the right of **Comment**, select the down arrow ().

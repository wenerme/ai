...
<a>View the complete list of supported CWEs for Vulnerability Resolution</a>
...
1. Select a merge request.
   - Vulnerability findings supported by Vulnerability Resolution are indicated by the tanuki AI icon ().

...
1. In the profile's row select the **More actions** () menu, then select **Edit**.
...
1. In the **Dynamic Application Security Testing (DAST)** section, select **Manage profiles**.
1. Select the **Site Profiles** tab.
1. In the profile's row, select the **More actions** () menu, then select **Delete**.
...
1. In the scanner's row, select the **More actions** () menu, then select **Edit**.
1. Edit the form.
1. Select **Save profile**.
...
1. In the **Dynamic Application Security Testing (DAST)** section, select **Manage profiles**.
1. Select the **Scanner profiles** tab.
1. In the scanner's row, select the **More actions** () menu, then select **Delete**.
1. Select **Delete**.

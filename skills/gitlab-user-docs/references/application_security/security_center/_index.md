...
Configurable space to view vulnerabilities across multiple projects.
...
1. Select **Remove project from dashboard** ().
...
- Generally available in GitLab 18.5. Feature flag `vulnerabilities_pdf_export` removed.

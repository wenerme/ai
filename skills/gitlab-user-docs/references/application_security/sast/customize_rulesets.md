...
Customize SAST analyzer rules in GitLab by disabling, overriding, or replacing default rules.
...
star icon () and have the tooltip **Finding found with the Semgrep Pro Engine**.

...
- [Pipeline execution policy](pipeline_execution_policies.md). Enforce CI/CD jobs as part of project pipelines.
  - [Scheduled pipeline execution policy](scheduled_pipeline_execution_policies.md). Enforce custom CI/CD jobs on a scheduled cadence across projects, independent of commit activity.
...
| `business_impact` | `object` | `including`, `excluding` | [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/228920) in GitLab 18.11 with a flag named `security_attributes_policy_scope`. Enabled by default. Feature flag [removed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/241805) in GitLab 19.5. List the IDs of the Business Impact [security attribute](../attributes/_index.md) values to include or exclude, in an array of objects with key `id`. |
| `application` | `object` | `including`, `excluding` | [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/229939) in GitLab 19.0 with a flag named `security_attributes_policy_scope`. Enabled by default. Feature flag [removed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/241805) in GitLab 19.5. List the IDs of the Application [security attribute](../attributes/_index.md) values to include or exclude, in an array of objects with key `id`. |
| `business_unit` | `object` | `including`, `excluding` | [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/232179) in GitLab 19.0 with a flag named `security_attributes_policy_scope`. Enabled by default. Feature flag [removed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/241805) in GitLab 19.5. List the IDs of the Business Unit [security attribute](../attributes/_index.md) values to include or exclude, in an array of objects with key `id`. |
| `exposure` | `object` | `including`, `excluding` | [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/234105) in GitLab 19.0 with a flag named `security_attributes_policy_scope`. Enabled by default. Feature flag [removed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/241805) in GitLab 19.5. List the IDs of the Exposure [security attribute](../attributes/_index.md) values to include or exclude, in an array of objects with key `id`. |

...
1. Copy a pre-populated OpenTofu `init` command:
   ...
   1. Next to the environment you want to use, select **Actions**
      () and select **Copy Terraform init command**.
...
1. In the left sidebar, select **Operate** > **Terraform states**.
1. In the **Actions** column, select **Actions** () > **Remove state file and versions**.
...
1. In the left sidebar, select **Operate** > **Terraform states**.
1. In the **Actions** column, select **Actions** () > **Lock** to lock or **Actions** () > **Unlock**.
...
1. In the left sidebar, select **Operate** > **Terraform states**.
1. In the **Actions** column, select **Actions** () > **Download JSON**.

...
1. In the upper-right corner of the user's profile select the vertical ellipsis (), then **Report abuse**.
...
1. On the task, in the upper-right corner, select **More actions** ().
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the objective, in the upper-right corner, select **More actions** ().
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the key result, in the upper-right corner, select **More actions** ().
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the agent detail view, in the upper-right corner, select **More actions** ().
...
1. On the flow detail view, in the upper-right corner, select **More actions** ().
1. Select **Report to admin**.

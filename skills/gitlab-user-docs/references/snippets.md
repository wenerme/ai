...
[A code snippet showing sample content in GitLab.]
...
1. Select the kind of snippet you want to create:
   - To create a personal snippet, do one of the following:
     ...
     - From a project: In the left sidebar, select **Create new** (). Below **In GitLab**, select **New snippet**.
     - From any other page: In the upper-right corner, select **Create new** () and then **New snippet**.
   ...
   - To create a project snippet: Go to your project's page. Select
     **Create new** (). Below **In this project**, select **New snippet**.
...
[A tooltip displaying details of a GitLab snippet.]

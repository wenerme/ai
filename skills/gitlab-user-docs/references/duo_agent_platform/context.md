...
Understand what context is available to GitLab Duo features and how to control what information they can access.
...
1. Optional. To delete an existing exclusion, select **Delete** () for the appropriate exclusion.

...
1. Select **AI** > **Flows**.
1. Find the flow you want to remove and select **Actions** () > **Disable**.
...
1. In the top bar, select **Search or go to** and find your group or project.
1. Select **AI** > **Flows**.
1. Find the flow you want to hide and select **Actions** () > **Hide**.
...
1. In the top bar, select **Search or go to** and find your group or project.
1. Select **AI** > **Flows**.
1. Find the flow you want to delete and select **Actions** () > **Delete**.

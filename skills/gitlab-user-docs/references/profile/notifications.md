...
Configure global, group, and project notification levels to control which issue, merge request, epic, and design events send you email.
...
1. Select the notification dropdown list, next to the bell icon ().
1. Select the desired [notification level](#notification-levels).
...
1. At the top of the right sidebar, select:
   - **Notifications on** () to turn on notifications.
   - **Notifications off** () to turn off notifications.

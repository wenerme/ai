...
1. In the left sidebar, select **Comment templates** ().
1. Select **Add new**.
...
1. In the editor toolbar for a comment, select **Comment templates**
   (), then select **Manage group comment templates**.
1. Select **Add new**.
1. Provide a **Name** for your comment template.
1. Enter the **Content** of your reply. You can use any formatting you use in
   other GitLab text areas.
...
1. In the editor toolbar for a comment, select **Comment templates**
   (), then select **Manage project comment templates**.
1. Select **Add new**.
1. Provide a **Name** for your comment template.
1. Enter the **Content** of your reply. You can use any formatting you use in
   other GitLab text areas.
...
1. To edit, select **Edit** ().
1. To delete, select **Delete** (), then select **Delete** again on the dialog.

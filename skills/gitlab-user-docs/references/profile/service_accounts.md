...
1. Select the vertical ellipsis () > **Edit**.
...
1. Go to the [Service accounts](#view-and-manage-service-accounts) page.
1. Identify a service account.
1. Select the vertical ellipsis () > **Delete account**.
...
1. Go to the [Service accounts](#view-and-manage-service-accounts) page.
1. Identify a service account.
1. Select the vertical ellipsis () > **Delete account and contributions**.
1. Enter the name of the service account.
...
1. Go to the [Service accounts](#view-and-manage-service-accounts) page.
1. Identify a service account.
1. Select the vertical ellipsis () > **Manage access tokens**.

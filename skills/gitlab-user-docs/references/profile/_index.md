...
1. On the profile page, in the upper-right corner, select **Actions** ().
...
1. Select **Edit profile**.
1. In the left sidebar, select **Emails**.
1. Select **Delete** () and confirm you want to **Remove**.
...
1. For **Visibility Level**, select **Public**.
   [Proper project path for an individual on the hosted product]

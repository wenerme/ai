...
Publish static websites from your repository with automatic CI/CD deployment.
...
- [Introduced](https://gitlab.com/groups/gitlab-org/-/epics/9347) in GitLab 15.9 [with a feature flag](../../../administration/feature_flags/_index.md) named `pages_unique_domain`. Disabled by default.

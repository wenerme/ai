...
1. In the most right column, select the vertical ellipsis () and **Delete model**.
...
1. Select the vertical ellipsis () and **Delete model**.
...
1. In the most right column, select the vertical ellipsis () and **Delete version**.
...
1. Select the vertical ellipsis () and **Delete version**.
1. Confirm the deletion.

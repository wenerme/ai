...
[Upper-right corner displaying user activity summary.]

This user has:

- 8 open issues ()
- 3 active merge requests ()
- 6 to-do items ()
...
[The three homepage tabs shown at the top of the screen.]
...
[The 'Returned to you' section of the Active tab, showing a table with information about three merge requests.]

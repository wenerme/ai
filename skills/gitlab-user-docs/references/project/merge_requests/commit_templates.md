...
| `%{description}`                        | Description of the merge request.                                                                                                                                                                                                             | `Merge request description.``Can be multiline.`                                                                                                                                              |
...
| `%{first_multiline_commit}`             | Full message of the first commit that's not a merge commit and has more than one line in the message body. Merge request title if all commits aren't multiline.                                                                                   | `Update README.md``Improved project description in readme file.`                                                                                                                         |
...
| `%{reviewed_by}`                        | Line-separated list of the merge request reviewers, based on users who submit a review by using batch comments, in a `Reviewed-by` Git commit trailer format.                                                                                 | `Reviewed-by: Sidney Jones <sjones@example.com>`  `Reviewed-by: Zhang Wei <zwei@example.com>`                                                                                                |
| `%{approved_by}`                        | Line-separated list of the merge request approvers in a `Approved-by` Git commit trailer format.                                                                                                                                              | `Approved-by: Sidney Jones <sjones@example.com>`  `Approved-by: Zhang Wei <zwei@example.com>`                                                                                                |

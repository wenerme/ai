...
Use merge request title validation to enforce naming conventions and block merges when titles do not match a configured regex pattern.
...
[Title validation settings fields for a project.]
...
[Merge request blocked by title validation check.]

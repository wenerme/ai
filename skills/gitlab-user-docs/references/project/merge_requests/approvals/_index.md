...
1. Go to the merge request widget to see the approval status. In this example, you can approve the merge request:
   ...
   [The approval status section where a reviewer can approve the merge request.]
...
To check if your approval satisfies Code Owner requirements, select **Expand eligible approvers** ().
...
|                                       Example                                       | Description |
|:-----------------------------------------------------------------------------------:|-------------|
|         [The indicator for missing approvals.]         | Required approvals are missing. () |
|            [The indicator for satisfied approvals.]            | Approvals are satisfied. () |
| [The indicator showing you have personally approved.] | Approvals are satisfied, and you are one of the approvers. () |
...
Approved merge requests display a green check mark () next to the user's name in the reviewer list.

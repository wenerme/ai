...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Settings** > **Merge requests**.
1. In the **Merge request approvals** section, next to the rule you want to delete, select the trash can ().
...
[The Security Approvals section displaying a policy rule that requires one approval when a scanner finds vulnerabilities.]

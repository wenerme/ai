...
[A merge request showing the draft status with merge blocked until marked as ready.]
...
1. Select **Yes** to include drafts, or **No** to exclude, and press **Return**
   ...
   [The merge request filter dropdown list showing draft filter options with selection options.]

...
1. In the upper-right corner, select **Create new** () and **New merge request**.
...
1. Select the branch actions menu ().
1. Select **Create merge request**.
1. Complete the fields on the **New merge request** page, then select **Create merge request**.
...
1. For **Target branch**:
   ...
   1. Select a branch from the upstream repository:
      ...
      [The dropdown list for selecting the target branch in the upstream repository.]

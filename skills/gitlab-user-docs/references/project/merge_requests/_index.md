...
Create merge requests to review code changes, manage discussions, and merge branches.
...
1. Repeat this process to filter by more attributes, joined by a logical
   `AND`.
1. Select a **Sort direction**, either  for descending order,
...
1. Optional. Select **Sort** () to reverse the sort order.

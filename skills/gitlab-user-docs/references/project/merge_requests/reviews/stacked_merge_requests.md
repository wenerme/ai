...
Navigate between chained merge requests that build on each other to deliver a feature.
...
[A dropdown list in the merge request header, expanded to show the merge requests in the stack.]

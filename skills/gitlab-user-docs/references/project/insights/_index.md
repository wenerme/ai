...
1. Optional. Filter the results:
   - To display data only from a subset of the 90-day range, select the pause icons () and slide them along the horizontal axis.
...
| `bar` (time series with `group_by`) | [Insights example bar time series chart] |

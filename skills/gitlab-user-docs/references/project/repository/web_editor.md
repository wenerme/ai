...
1. Next to the directory name, select the plus icon () > **New file**.
...
The **Actions** () menu consolidates file operations into the
...
1. In the upper-right corner, next to a filename, select **Actions** ().
...
1. Next to the directory name, select the plus icon () > **New directory**.
...
1. In the top bar, select **Search or go to** and find your project.
1. Next to the repository name, select the plus icon () > **New branch**.
...
1. In the top bar, select **Search or go to** and find your project.
1. Next to the repository name, select the plus icon () > **New tag**.
1. Complete the fields.
1. Select **Create tag**.

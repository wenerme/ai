...
- A [**Create release**](../../releases/_index.md#create-a-release) () link.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Code** > **Tags**.
1. In the upper-right corner, select the feed symbol ().
...
1. Commits with a tag are labeled with a tag icon () and the name of the tag.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Code** > **Tags**.
1. Next to the tag name, select **Copy tag name** ().

...
[An example of a repository's commits list]
...
To view a commit's full description, select the expand () icon
on the right side of the commit. To collapse the description, select the expand () icon again.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Code** > **Commits**.
1. In the upper-right corner, select the vertical ellipsis () to open the actions menu.
...
screens, the action moves to the actions menu () in the
upper-right corner.

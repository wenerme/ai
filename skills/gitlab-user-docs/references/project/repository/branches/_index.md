...
- See merge request links that point to the default branch.
  ...
  Branches with merge requests that do not point to the default branch display the  **New** merge request button.
...
1. Below the issue description, select **Create merge request**  to display the dropdown list.
1. Select **Create branch**.
...
1. Below the task description, select **Create merge request**  to display the dropdown list.
1. Select **Create branch**.
1. In the dialog, from the **Source branch or tag** dropdown list, select a source branch or tag.
1. Review the suggested branch name. It's based on your project's
   [default branch name pattern](#configure-default-pattern-for-branch-names-from-issues).
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Code** > **Branches**.
1. In the upper-right corner of the page, select **More** .

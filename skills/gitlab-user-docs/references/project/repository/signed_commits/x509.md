...
- The GitLab instance requires a full trust chain
  ...
  This chain might include intermediate certificates supplied in the signature. You might
...
> commits might temporarily show as "unverified" until you [re-verify them](#re-verify-commits).
...
- Certificates without `authorityKeyIdentifier`,
  ...
  [RFC 5280](https://www.rfc-editor.org/info/rfc5280/).

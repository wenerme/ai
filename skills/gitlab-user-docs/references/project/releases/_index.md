...
1. For all projects:
   ...
   1. In the right sidebar, select **Releases** ().
...
1. After the deploy freeze is saved, you can edit it by selecting the edit button () and remove it by selecting the delete button ().

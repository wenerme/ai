...
Learn about file path patterns, owners, comments, sections, and how rules are evaluated.
...
[The merge request widget displaying Code Owners grouped by section.]
...
[The merge request widget displaying optional Code Owners sections.]
...
- The `group-name` contains the following direct members:
  ...
  [The group members list showing users eligible for Code Owner status.]

- In the merge request approval widget, the same direct members are listed as `Maintainers`:

  [The merge request approval widget listing the group members as Maintainers.]

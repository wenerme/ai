...
[A pipeline deploying the application to EKS.]
...
[The deployed environment status and access options.]
...
1. The account ID and
   ...
   [Trust relationship settings for the AWS IAM role used for EKS cluster creation.]

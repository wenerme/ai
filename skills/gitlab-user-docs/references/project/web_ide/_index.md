...
The Web IDE interface displays a merge request icon () next to
...
1. On the left side of the Web IDE, select **Explorer** (), or
...
- On the left side of the Web IDE, select **Source Control** (), or
...
1. On the left side of the Web IDE, select **Source Control** (), or
   press <kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>G</kbd>.
1. Select the ellipsis menu () in the upper-right side of the
...
1. Select the action button menu or select the ellipsis ().
...
1. On the bottom status bar, on the right, select the bell icon ()

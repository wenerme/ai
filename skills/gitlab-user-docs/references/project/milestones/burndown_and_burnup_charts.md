...
Visualize milestone progress with burndown and burnup charts to track remaining and completed issues over time.
...
[Burndown and burnup chart, showing milestone progress with burndown chart displaying remaining issues over time and burnup chart showing total versus completed issues.]
...
[Burndown chart, showing declining trend of remaining issues over milestone duration.]
...
| Legacy | Fixed |
| ----- | ----- |
| [Legacy burndown chart, showing downward trending line representing remaining issues decreasing.] | [Fixed burndown chart, showing a jump when a lot of issues were added to the milestone.] |
...
[Burnup chart, displaying two lines with a blue total issues line remaining relatively stable and an orange completed issues line steadily increasing.]

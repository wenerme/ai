...
Learn how to manage GitLab issues including editing, moving, closing, bulk operations, and using various issue features like assignees, health status, and automation.
...
1. Above the **Description** text box, select **GitLab Duo** () > **Generate issue description**.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**, then filter by **Type** = **Issue** and select your issue.
1. In the upper-right corner, select **More actions** () > **Move**.
...
- From any other page in the GitLab UI:
  ...
  1. In the upper-right corner, select **More actions** () and then **Close issue**.
...
To reopen a closed issue, in the upper-right corner, select **More actions** () and then **Reopen issue**.
...
1. On an issue, in the upper-right corner, select **More actions** ().
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**, then filter by **Type** = **Issue** and select your issue.
1. In the upper-right corner, select **More actions** ().
...
- In the upper-right corner, select **Assigned work items** ().
...
- To close the panel, select the close icon () or press **Escape**.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**, then filter by **Type** = **Issue** and select your issue.
1. In the upper-right corner, select **More actions** () > **Copy Reference**.
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**, then filter by **Type** = **Issue** and select your issue.
1. In the upper-right corner, select **More actions** () > **Copy issue email address**.

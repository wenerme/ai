...
1. In the upper-right corner, select **Create new** ().
...
1. In the upper-right corner, select **Issue actions** () and then **Turn on confidentiality** (or **Turn off confidentiality** to make the issue non-confidential).
...
In the **Issues** and **Issue boards** pages, you can see the confidential () icon
...
Likewise, while inside the issue, you can see the confidential () icon right next to

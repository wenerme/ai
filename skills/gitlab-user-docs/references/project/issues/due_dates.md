...
[An issue with a due date in 2024.]
...
1. Optional. To reverse the sort order, in the display preferences drawer, next to the **Sort by** dropdown list, select **Sort direction** ().
...
1. On the right, from the **Actions** () dropdown list, select **Subscribe to calendar** to display the `.ics` file.

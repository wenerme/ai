...
1. Either:
   ...
   - In the upper-right corner, select the plus sign () and then, under **In this project**,
...
1. In an existing issue, select **Issue actions** ().
...
1. At the top of a board list, select **Create new issue** ().
...
1. In the top bar, select **Search or go to** and find your project.
1. In the left sidebar, select **Plan** > **Work items**.
1. In the upper-right corner, select **More actions** (), then select **Email work item to this project**.
1. To copy the email address, select **Copy** ().

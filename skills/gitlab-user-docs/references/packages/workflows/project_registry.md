# Manage packages with dedicated, type-specific registries
...
1. In the top bar, select **Create new** () and **New group**.
...
1. In the left sidebar, select **Create new** () and **New project/repository**.

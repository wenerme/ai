...
Use the GitLab virtual registry to proxy, cache, and distribute packages from multiple upstream registries.
...
1. In the row of the registry you want to edit, select **Edit** ().
...
1. Select **Deploy** > **Virtual registry**.
1. Under **Registry types**, select **View registries**.
1. Under the **Registries** tab, in the row of the registry you want to delete, select **Edit** ().
...
1. In the row of the upstream you want to edit, select **Edit** ().
1. Make your changes and select **Save changes**.

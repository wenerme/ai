...
Protected container repositories in GitLab limit which user roles can push or delete images.
...
1. In the left sidebar, select **Settings** > **Packages and registries**.
1. Expand **Container registry**.
1. Under **Protected container repositories**, next to the protection rule you want to delete, select **Delete** ().

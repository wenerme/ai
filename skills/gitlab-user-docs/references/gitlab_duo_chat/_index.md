...
Use GitLab Duo Chat to ask questions about your code, get help with GitLab, and complete tasks in the GitLab UI or your IDE.
...
1. In the history, select **Delete this chat** ().
...
- For GitLab Duo Chat in the left sidebar, select **GitLab Duo Chat** ().
...
- In an open file in your IDE, select some code,
  then, in the floating toolbar, select **GitLab Duo Quick Chat** ().
...
1. In the upper right corner, select **GitLab Duo Chat** (), or use the keyboard shortcut:

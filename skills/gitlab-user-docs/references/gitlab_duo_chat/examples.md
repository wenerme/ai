...
1. In GitLab Duo Chat, type `/explain`.
   ...
   [Selecting code and asking GitLab Duo Chat to explain using the /explain slash command.]
...
1. Open the job details drawer by completing either of the following options:
   ...
   - Select the vertical ellipsis () next to the scanner, then select **Troubleshoot failure**.
1. In the drawer footer, select **Troubleshoot failure** ().

...
In the upper-right corner, select **To-do items** ().
...
1. In the upper-right corner, select **Add a to-do item** ().
...
1. In the upper-right corner, select **To-do items** ().
1. At the top, select **Done**.
1. Find the to-do item you want to re-add.
1. Next to this to-do item, select **Undo** .
...
1. In your To-Do List, next to the to-do item you want to snooze, select Snooze ().

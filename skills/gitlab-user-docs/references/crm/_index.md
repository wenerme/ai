...
1. In the top bar, select **Search or go to** and find your group.
1. In the left sidebar, select **Plan** > **Customer relations**.
1. Next to the contact you wish to edit, select **Edit** ().
...
1. In the left sidebar, select **Plan** > **Customer relations**.
1. In the upper right, select **Organizations**.
1. Next to the organization you wish to edit, select **Edit** ().
1. Edit the required fields.
1. Select **Save changes**.
...
1. In the top bar, select **Search or go to** and find your group.
1. In the left sidebar, select **Plan** > **Customer relations**.
1. Next to the contact whose work items you wish to view, select **View work items** ().
...
1. In the left sidebar, select **Plan** > **Customer relations**.
1. In the upper right, select **Organizations**.
1. Next to the organization whose work items you wish to view, select **View work items** ().

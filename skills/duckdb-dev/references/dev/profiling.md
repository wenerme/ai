...
For a high-level example of using `EXPLAIN`, see the [“Inspect Query Plans” page](https://duckdb.org/docs/current/guides/meta/explain.html).
...
The [`EXPLAIN`](https://duckdb.org/docs/current/guides/meta/explain.html) statement shows the query plan and describes what is going on under the hood.
...
The [`EXPLAIN ANALYZE`](https://duckdb.org/docs/current/guides/meta/explain_analyze.html) statement enables obtaining these, as it pretty-prints the query plan and also executes the query.
...
For more information, see the [“Profiling”](https://duckdb.org/docs/current/configuration/pragmas.html#profiling) section of the pragmas page.

| Setting                                                                                                                                                                            | Description                                     | Default                                                  | Options                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|----------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`enable_profiling`](https://duckdb.org/docs/current/configuration/pragmas.html#enable_profiling), [`enable_profile`](https://duckdb.org/docs/current/configuration/pragmas.html#enable_profiling)     | Turn on profiling                               | `query_tree`                                             | `query_tree`, `json`, `query_tree_optimizer`, `no_output`                                                                                                          |
| [`profiling_coverage`](https://duckdb.org/docs/current/configuration/pragmas.html#profiling_coverage)                                                                                        | Set the operators to profile                    | `SELECT`                                                 | `SELECT`, `ALL`                                                                                                                                                    |
| [`profiling_output`](https://duckdb.org/docs/current/configuration/pragmas.html#profiling_output)                                                                                            | Set a profiling output file                     | Console                                                  | A filepath                                                                                                                                                         |
| [`profiling_mode`](https://duckdb.org/docs/current/configuration/pragmas.html#profiling_mode)                                                                                                | Toggle additional optimizer and planner metrics | `standard`                                               | `standard`, `detailed`, `all`                                                                                                                                       |
| [`configure_profiling`](https://duckdb.org/docs/current/configuration/pragmas.html#custom_profiling_metrics)                                                                                 | Enable or disable specific metrics              | All metrics except those activated by detailed profiling | A JSON object that matches the following: `{"METRIC_NAME": "boolean", ...}`. ([List of all available metrics](https://duckdb.org/docs/current/dev/metrics.html#all_metrics)) |
| [`disable_profiling`](https://duckdb.org/docs/current/configuration/pragmas.html#disable_profiling), [`disable_profile`](https://duckdb.org/docs/current/configuration/pragmas.html#disable_profiling) | Turn off profiling                              |                                                          |                                                                                                                                                                    |
...
DuckDB supports a wide range of metrics that can be enabled or disabled independently. To learn more and to see the full list of available metrics, refer to the [metrics documentation](https://duckdb.org/docs/current/dev/metrics.html#all_metrics).
...
These include all the metrics in the [Phase timing](https://duckdb.org/docs/current/dev/metrics.html#phase_timing_metrics) metric group.

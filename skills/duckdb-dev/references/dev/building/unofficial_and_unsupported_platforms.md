...
DuckDB is built and distributed for several platforms with [different levels of support](https://duckdb.org/docs/current/dev/building/overview.html).
...
For example, see the build instructions for [32-bit Raspberry Pi boards](https://duckdb.org/docs/current/dev/building/raspberry_pi.html#raspberry-pi-32-bit).

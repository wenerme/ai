...
1. If you would like to use the [Ninja build system](https://duckdb.org/docs/current/dev/building/overview.html#prerequisites), make sure it is installed and available on the `PATH`.
...
1. To build the [command line client](https://duckdb.org/docs/current/clients/cli/overview.html) in the [Termux application](https://termux.dev/), install the following packages:

...
[Core DuckDB extensions](https://duckdb.org/docs/current/core_extensions/overview.html) are the ones maintained by the DuckDB team. These are hosted in the `duckdb` GitHub organization and are served by the `core` extension repository.
...
More on this topic at [building DuckDB extensions](https://duckdb.org/docs/current/dev/building/building_extensions.html).
...
When this flag is set, the [Python](https://duckdb.org/docs/current/clients/python/overview.html) package is built.

### `BUILD_SHELL`

When this flag is set, the [CLI](https://duckdb.org/docs/current/clients/cli/overview.html) is built, this is usually enabled by default.
...
When this flag is set, the [ODBC](https://duckdb.org/docs/current/clients/odbc/overview.html) package is built.

...
[Extensions](https://duckdb.org/docs/current/extensions/overview.html) can be built from source and installed from the resulting local binary.
...
This option also accepts out-of-tree extensions such as [`delta`](https://duckdb.org/docs/current/core_extensions/delta.html):
...
When this flag is set, the [`jemalloc`](https://duckdb.org/docs/current/internals/jemalloc.html) is built.

...
DuckDB binaries are available for _stable_ and _preview_ builds on the [installation page](https://duckdb.org/install/index.html).
In most cases, it's recommended to use these binaries.
When you are running on an experimental platform (e.g., [Raspberry Pi](https://duckdb.org/docs/current/dev/building/raspberry_pi.html)) or you would like to build the project for an unmerged pull request,
...
See [Build Configuration](https://duckdb.org/docs/current/dev/building/build_configuration.html) for targets and configuration flags.
...
* [Linux](https://duckdb.org/docs/current/dev/building/linux.html)
* [macOS](https://duckdb.org/docs/current/dev/building/macos.html)
* [Windows](https://duckdb.org/docs/current/dev/building/windows.html)

### Platforms with Partial Support

There are several partially supported platforms.
For some platforms, DuckDB binaries and extensions (or a [subset of extensions](https://duckdb.org/docs/current/extensions/extension_distribution.html#platforms)) are distributed.
...
* [Android](https://duckdb.org/docs/current/dev/building/android.html)
* [Raspberry Pi](https://duckdb.org/docs/current/dev/building/raspberry_pi.html)
...
See also the [“Unofficial and Unsupported Platforms” page](https://duckdb.org/docs/current/dev/building/unofficial_and_unsupported_platforms.html) for details.
...
* [Generic issues](https://duckdb.org/docs/current/dev/building/troubleshooting.html)
* [Python](https://duckdb.org/docs/current/dev/building/python.html)
* [R](https://duckdb.org/docs/current/dev/building/r.html)

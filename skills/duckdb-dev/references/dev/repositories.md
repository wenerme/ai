...
* Core extension repositories are linked in the [Official Extensions page](https://duckdb.org/docs/current/core_extensions/overview.html)
* Community extensions are served from the [Community Extensions repository](https://duckdb.org/community_extensions/)

...
Optimizer metrics sit at the `QUERY_ROOT` level, and measure the time taken by each [optimizer](https://duckdb.org/docs/current/internals/overview.html#optimizer).

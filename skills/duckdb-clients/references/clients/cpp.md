...
> If you would like to build an application on DuckDB, we recommend using the [C API](https://duckdb.org/docs/current/clients/c/overview.html).
...
> Warning Do **not** use prepared statements to insert large amounts of data into DuckDB. See the [data import documentation](https://duckdb.org/docs/current/data/overview.html) for better options.

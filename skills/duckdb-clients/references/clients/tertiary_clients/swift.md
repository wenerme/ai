...
DuckDB has a Swift client. See the [announcement post](https://duckdb.org/2023/04/21/swift.html) for details.
...
The rest of the page is based on the example of our [announcement post](https://duckdb.org/2023/04/21/swift.html), which uses raw data from [NASA's Exoplanet Archive](https://exoplanetarchive.ipac.caltech.edu) loaded directly into DuckDB.

...
> The DuckDB PHP client is a [tertiary client](https://duckdb.org/docs/current/clients/overview.html) and is maintained by a third-party.
...
Appenders are the preferred method to load data in DuckDB. See [Appender page](https://duckdb.org/docs/current/clients/c/appender.html)

...
* [Troubleshoot](https://duckdb.org/docs/current/clients/java/troubleshoot.html) — the Native Image errors that indicate missing metadata or a missing shared library.
* [Define Connections](https://duckdb.org/docs/current/clients/java/connecting.html) — driver registration and connection configuration.
* [Java (JDBC) Client](https://duckdb.org/docs/current/clients/java/overview.html) — installing the driver from Maven Central.

...
>
> The latest stable version of the DuckDB Go client is current release.
...
The DuckDB Go client supports the [DuckDB Appender API](https://duckdb.org/docs/current/data/appender.html) for bulk inserts. You can obtain a new Appender by supplying a DuckDB connection to `NewAppenderFromConn()`. For example:

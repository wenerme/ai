...
The shell offers context-aware autocomplete of SQL queries through the [`autocomplete` extension](https://duckdb.org/docs/current/core_extensions/autocomplete.html). autocomplete is triggered by pressing `Tab`.

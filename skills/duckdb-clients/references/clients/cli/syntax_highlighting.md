...
There are several components of a query that are highlighted in different colors. The colors can be configured using [dot commands](https://duckdb.org/docs/current/clients/cli/dot_commands.html).

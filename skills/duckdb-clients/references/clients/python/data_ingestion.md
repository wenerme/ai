...
See the [CSV Import](https://duckdb.org/docs/current/data/csv/overview.html) page for more information.
...
Read a Parquet file over [https](https://duckdb.org/docs/current/core_extensions/httpfs/overview.html):
...
See the [Parquet Loading](https://duckdb.org/docs/current/data/parquet/overview.html) page for more information.
...
These types include the following: Pandas DataFrame, Polars DataFrame, Polars LazyFrame, NumPy arrays, [relations](https://duckdb.org/docs/current/clients/python/relational_api.html) and Arrow objects.

Only variables that are visible to Python code at the location of the `sql()` or `execute()` call can be used in this manner.
Accessing these variables is made possible by [replacement scans](https://duckdb.org/docs/current/clients/c/replacement_scans.html). To disable replacement scans entirely, use:

```sql
SET python_enable_replacements = false;
```

DuckDB supports querying multiple types of Apache Arrow objects including [tables](https://arrow.apache.org/docs/python/generated/pyarrow.Table.html), [datasets](https://arrow.apache.org/docs/python/generated/pyarrow.dataset.Dataset.html), [RecordBatchReaders](https://arrow.apache.org/docs/python/generated/pyarrow.ipc.RecordBatchStreamReader.html) and [scanners](https://arrow.apache.org/docs/python/generated/pyarrow.dataset.Scanner.html). See the Python [guides](https://duckdb.org/docs/current/guides/overview.html#python-client) for more examples.
...
- [Replacement scans](https://duckdb.org/docs/current/clients/c/replacement_scans.html)

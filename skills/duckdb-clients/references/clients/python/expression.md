...
The `Expression` class represents an instance of an [expression](https://duckdb.org/docs/current/sql/expressions/overview.html).
...
| `.isin(*exprs: Expression)`    | Creates an [`IN` expression](https://duckdb.org/docs/current/sql/expressions/in.html#in) against the provided expressions as the list         |
| `.isnotin(*exprs: Expression)` | Creates a [`NOT IN` expression](https://duckdb.org/docs/current/sql/expressions/in.html#not-in) against the provided expressions as the list  |

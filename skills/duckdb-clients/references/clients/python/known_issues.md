...
In Python, the output of the [`EXPLAIN` statement](https://duckdb.org/docs/current/guides/meta/explain.html) contains hard line breaks (`\n`):
...
Please also check out the [Jupyter guide](https://duckdb.org/docs/current/guides/python/jupyter.html) for tips on using Jupyter with JupySQL.
...
Passing query parameters to the [`sql()`](https://duckdb.org/docs/current/clients/python/relational_api.html#sql), [`query()`](https://duckdb.org/docs/current/clients/python/relational_api.html#query), or [`from_query()`](https://duckdb.org/docs/current/clients/python/relational_api.html#from_query) methods has significant performance overhead.
...
Instead, use [`execute()`](https://duckdb.org/docs/current/clients/python/dbapi.html#prepared-statements) for the parameterized query, then feed the result into the relational API via a [replacement scan](https://duckdb.org/docs/current/clients/python/relational_api.html#sql):

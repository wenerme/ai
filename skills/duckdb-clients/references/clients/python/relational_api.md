...
> **Warning.** Passing `params` to this method is [discouraged](https://duckdb.org/docs/current/clients/python/known_issues.html#parameterized-queries-in-relational-api) due to significant performance overhead. Use [`execute()`](https://duckdb.org/docs/current/clients/python/dbapi.html#prepared-statements) for parameterized queries instead.
...
- **params** : object
    ...
    Optional query parameters. **Discouraged** due to [significant performance overhead](https://duckdb.org/docs/current/clients/python/known_issues.html#parameterized-queries-in-relational-api). Use [`execute()`](https://duckdb.org/docs/current/clients/python/dbapi.html#prepared-statements) for parameterized queries instead.

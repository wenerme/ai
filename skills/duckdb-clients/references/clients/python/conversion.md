...
This is a mapping of Python object types to DuckDB [Logical Types](https://duckdb.org/docs/current/sql/data_types/overview.html):
...
If the dict is returned by a [function](https://duckdb.org/docs/current/clients/python/function.html),
...
If the dict is returned by a [function](https://duckdb.org/docs/current/clients/python/function.html),
the function will return a `MAP`, due to [automatic conversion](https://duckdb.org/docs/current/clients/python/types.html#dictkey_type-value_type).
...
Below are some examples using this functionality. See the [Python guides](https://duckdb.org/docs/current/guides/overview.html#python-client) for more examples.

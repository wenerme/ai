...
[Autoloading](https://duckdb.org/docs/current/extensions/overview.html), i.e., the possibility for DuckDB to add extension functionality on-the-fly, is enabled by default in DuckDB-Wasm.

## Available Extensions

A growing subset of extensions is supported for DuckDB-Wasm, spanning [core extensions](https://duckdb.org/docs/current/core_extensions/overview.html), [community extensions](https://duckdb.org/docs/current/extensions/community_extensions.html), and external extensions. Most are fetched on the fly when they are autoloaded or explicitly loaded, rather than being bundled into the DuckDB-Wasm binary. For example:
...
| ----------------------------------------------------------------------- | ---------------------------------------------------------------- | --------------- |
| [autocomplete](https://duckdb.org/docs/current/core_extensions/autocomplete.html) | Adds support for autocomplete in the shell                       |                 |
| [excel](https://duckdb.org/docs/current/core_extensions/excel.html)               | Adds support for Excel-like format strings                       |                 |
| [fts](https://duckdb.org/docs/current/core_extensions/full_text_search.html)      | Adds support for Full-Text Search indexes                        |                 |
| [icu](https://duckdb.org/docs/current/core_extensions/icu.html)                   | Adds support for time zones and collations using the ICU library |                 |
| [inet](https://duckdb.org/docs/current/core_extensions/inet.html)                 | Adds support for IP-related data types and functions             |                 |
| [json](https://duckdb.org/docs/current/data/json/overview.html)                   | Adds support for JSON operations                                 |                 |
| [parquet](https://duckdb.org/docs/current/data/parquet/overview.html)             | Adds support for reading and writing Parquet files               |                 |
| [spatial](https://duckdb.org/docs/current/core_extensions/spatial/overview.html)  | Adds support for geospatial data types and functions             |                 |
| [sqlite](https://duckdb.org/docs/current/core_extensions/sqlite.html)             | Adds support for reading SQLite database files                   | sqlite, sqlite3 |
| [tpcds](https://duckdb.org/docs/current/core_extensions/tpcds.html)               | Adds TPC-DS data generation and query support                    |                 |
| [tpch](https://duckdb.org/docs/current/core_extensions/tpch.html)                 | Adds TPC-H data generation and query support                     |                 |
...
* [Deploy](https://duckdb.org/docs/current/clients/wasm/deploying_duckdb_wasm.html) — serving and mirroring extensions from a custom endpoint.

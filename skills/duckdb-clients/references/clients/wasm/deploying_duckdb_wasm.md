...
Please review the [Extension Distribution page](https://duckdb.org/docs/current/extensions/extension_distribution.html) for general information about extensions.
...
* [Instantiate](https://duckdb.org/docs/current/clients/wasm/instantiation.html) — how the library, worker, and WebAssembly components served here are wired together at runtime.

...
>
> The latest stable version of the DuckDB ODBC client is current release.
...
The ODBC driver is available for all operating systems. Visit the [installation page](https://duckdb.org/install/index.html) for direct links.

...
For platform-specific details, see the pages for [Linux](https://duckdb.org/docs/current/clients/odbc/linux.html), [macOS](https://duckdb.org/docs/current/clients/odbc/macos.html), and [Windows](https://duckdb.org/docs/current/clients/odbc/windows.html).

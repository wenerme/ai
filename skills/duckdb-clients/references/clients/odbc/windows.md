...
2. <!-- markdownlint-disable MD034 --> DuckDB releases the ODBC driver as an asset. For Windows, download it from the [Windows ODBC asset (x86_64/AMD64)](https://github.com/duckdb/duckdb-odbc/releases). <!-- markdownlint-enable MD034 -->
...
Furthermore, the ODBC driver supports all the [configuration options](https://duckdb.org/docs/current/configuration/overview.html)
included in DuckDB.
...
For the details of the configuration parameters, see the [ODBC configuration page](https://duckdb.org/docs/current/clients/odbc/configuration.html).

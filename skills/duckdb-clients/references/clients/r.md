...
>
> The latest stable version of the DuckDB R client is current release
...
Please see the [installation page](https://duckdb.org/install/index.html?environment=r) and [CRAN](https://cran.r-project.org/web/packages/duckdb/index.html) for details.
...
Also refer to the [data import documentation](https://duckdb.org/docs/current/data/overview.html) for more options of efficiently importing data.
...
You can use the [`memory_limit` configuration option](https://duckdb.org/docs/current/configuration/pragmas.html) to limit the memory use of DuckDB, e.g.:

...
> **warning**: In Deno, it is possible to use a different version of middleware than the Hono version, but this can lead to bugs.
...
> **info**: Type generics can be used with `createMiddleware`:

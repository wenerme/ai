...
> **caution**: _For profiling to be effective, the issue you are diagnosing must be actively occurring._
...
> **tip**: If you want to use a version of spark newer than the bundled one, simply place a standalone spark plugin JAR

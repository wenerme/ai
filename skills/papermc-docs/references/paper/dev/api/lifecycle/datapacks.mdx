...
> **note**: This feature requires you to have a basic understanding of the [Lifecycle API](/paper/dev/lifecycle),
...
> **tip**: The following code examples are assumed to be executed inside a `PluginBootstrap`'s `bootstrap(BootstrapContext context)` method.
...
> **tip**: This section assumes that you already have a working datapack. If you do not have one, but still want to play around with datapack inclusion in your plugin,

...
> **note**: To see a comparison between the new Brigadier system and the old Bukkit system, [click here](/paper/dev/command-api/misc/comparison-bukkit-brigadier).

## Guide

> **tip**: If the Brigadier API seems too complicated, you can start with

...
> **note**: You do not need to register the recipe within your plugin's `onEnable` method, You can register it
...
> **caution**: You cannot use Air as a material in a shaped recipe, this will cause an error.

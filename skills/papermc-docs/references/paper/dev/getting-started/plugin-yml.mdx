...
> **note**: The fields in this section are not in any particular order.
...
> **note**: If this is not specified, the plugin will be loaded as a legacy plugin and a warning will be printed to the console.
...
> **note**: If the plugin is not found, your plugin will not load.

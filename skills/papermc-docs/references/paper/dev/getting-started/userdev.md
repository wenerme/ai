...
> **note**: This guide is written using the Gradle Kotlin DSL and assumes you have some basic knowledge of Gradle.
...
> **tip**: You should remove any dependency on the Paper API, as the dev bundle includes that.
...
> **note**: This is the preferred option, as the one-time plugin remapping process during server startup will be skipped and it
...
> **note**: If you are using Gradle with the Groovy DSL, you should instead access the fields via static methods like `getMOJANG_PRODUCTION()`.

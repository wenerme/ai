...
> **caution**: Some implementations may not use the `GlobalTranslator` in every area, or at all.
...
> **caution**: If you are overriding the component `translate` method, you should be careful not to unintentionally lose the children of the translatable component.

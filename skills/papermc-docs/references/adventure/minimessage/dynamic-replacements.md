...
> **tip**: Styling placeholders can be used to sanitize input from players in click events. Instead of using a parsed placeholder the string can be used directly.
...
> **tip**: You can change the style such as the color by a more complex pattern:

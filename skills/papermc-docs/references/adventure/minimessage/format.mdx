...
> **caution**: Since the introduction of chat signatures in 1.19.1, the client no longer executes commands that require signed arguments
...
> **note**: The fallback option is only available since Minecraft 1.19.4.
...
> **note**: The score component requires *rendering* on the server to be seen by clients. This is a platform-specific operation.
...
> **note**: The produced NBT component requires *rendering* on the server to be seen by clients. This is a platform-specific operation.

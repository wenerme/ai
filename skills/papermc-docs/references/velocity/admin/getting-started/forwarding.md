...
> **note**: You may choose between only one of these forwarding formats. It is not currently possible to "mix
...
> **caution**: Modern forwarding is incompatible with Minecraft versions below 1.13 and the
...
> **note**: If you are using Paper 1.18.2 or lower, you will find these options as `settings.velocity-support.enabled`,
...
> **danger**: Legacy forwarding is **fundamentally insecure**. If you must use it, you should understand
...
> **caution**: There are no longer any actively supported mods that support legacy forwarding. Please use Velocity

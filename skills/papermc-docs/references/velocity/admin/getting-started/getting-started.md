...
> **tip**: Make sure to change the `velocity.jar` to the name of the Velocity JAR that you downloaded, or
...
> **caution**: The following setup is generic and is intended to apply to any Minecraft server. This setup is not

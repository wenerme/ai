...
> **caution**: This command generates a heap dump which contains detailed information about your Velocity instance
...
> **note**: This command can only be executed from console.

...
2. Enforce ordering. For example, you can use the [`ORDER BY ALL` clause](https://duckdb.org/docs/current/sql/query_syntax/orderby.html#order-by-all):
   ...
   You can also sort lists using [`list_sort`](https://duckdb.org/docs/current/sql/functions/list.html#list_sortlist):
   ...
   It's also possible to introduce a [deterministic shuffling](https://duckdb.org/2024/08/19/duckdb-tricks-part-1.html#shuffling-data).

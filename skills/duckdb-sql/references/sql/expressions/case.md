...
The `SWITCH` expression is syntactic sugar for the `CASE` expression. It takes an expression, a [`MAP`](https://duckdb.org/docs/current/sql/data_types/map.html) of values to results, and an optional default value.

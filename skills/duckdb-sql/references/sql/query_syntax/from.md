...
Examples include [`read_csv`](https://duckdb.org/docs/current/data/csv/overview.html#csv-functions), [`read_parquet`](https://duckdb.org/docs/current/data/parquet/overview.html#read_parquet-function), [`range`](https://duckdb.org/docs/current/sql/functions/list.html#rangestart-stop-step), [`generate_series`](https://duckdb.org/docs/current/sql/functions/list.html#generate_seriesstart-stop-step), [`repeat`](https://duckdb.org/docs/current/sql/functions/utility.html#repeat_rowvarargs-num_rows), [`unnest`](https://duckdb.org/docs/current/sql/query_syntax/unnest.html), and [`glob`](https://duckdb.org/docs/current/sql/functions/utility.html#globsearch_path) (note that some of the examples here can be used as both scalar and table functions).
...
Note that the same result could be achieved using the [`row_number` window function](https://duckdb.org/docs/current/sql/functions/window_functions.html#row_numberorder-by-ordering).
...
Semi joins provide the same logic as the [`IN` operator](https://duckdb.org/docs/current/sql/expressions/in.html) statement.

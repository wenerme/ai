...
Comments can be read by querying the `comment` column of the respective [metadata functions](https://duckdb.org/docs/current/sql/meta/duckdb_table_functions.html):

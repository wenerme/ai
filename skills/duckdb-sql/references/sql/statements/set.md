...
The `SET` statement modifies the provided DuckDB [configuration option](https://duckdb.org/docs/current/configuration/overview.html) at the specified scope.
...
See the [Configuration](https://duckdb.org/docs/current/configuration/overview.html) page for the full list of configuration options.

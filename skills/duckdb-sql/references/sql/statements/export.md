...
For details regarding the writing of Parquet files, see the [Parquet Files page in the Data Import section](https://duckdb.org/docs/current/data/parquet/overview.html#writing-to-parquet-files) and the [`COPY` Statement page](https://duckdb.org/docs/current/sql/statements/copy.html).

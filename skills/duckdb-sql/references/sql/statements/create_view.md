...
The SQL query behind an existing view can be read using the [`duckdb_views()` function](https://duckdb.org/docs/current/sql/meta/duckdb_table_functions.html#duckdb_views) like this:

...
* `UNION`
* `USING SAMPLE`
* Whole-table aggregation (the input order, that is, the order in which rows are fed into [order-sensitive aggregate functions](https://duckdb.org/docs/current/sql/functions/aggregates.html#order-by-clause-in-aggregate-functions) is not guaranteed unless explicitly specified in the aggregate function)
...
* [CSV reader](https://duckdb.org/docs/current/data/csv/overview.html#order-preservation) (`read_csv` function)
* [JSON reader](https://duckdb.org/docs/current/data/json/overview.html#order-preservation) (`read_json` function)
* [Parquet reader](https://duckdb.org/docs/current/data/parquet/overview.html#order-preservation) (`read_parquet` function)

Preservation of insertion order is controlled by the `preserve_insertion_order` [configuration option](https://duckdb.org/docs/current/configuration/overview.html).

...
For example, interchangeability with data frame libraries necessitates [order preservation of inserts](https://duckdb.org/docs/current/sql/dialect/order_preservation.html) to be supported by default.

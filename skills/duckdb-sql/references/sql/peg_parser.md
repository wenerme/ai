...
We are planning to make the switch to the new parser in the [DuckDB v2.0](https://duckdb.org/release_calendar.html) release.

> As a tradeoff, the parser has a slight performance overhead, however, this is in the range of milliseconds and is thus negligible for analytical queries. For more details on the rationale for using a PEG parser and benchmark results, please refer to the [CIDR 2026 paper](https://duckdb.org/_library/2025-01-19-runtime-extensible-parsers.html) by Hannes Mühleisen and Mark Raasveldt, or their [blog post](https://duckdb.org/2024/11/22/runtime-extensible-parsers.html) summarizing the paper.

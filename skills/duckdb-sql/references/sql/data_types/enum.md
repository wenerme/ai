...
Anonymous enums can be created on the fly during [casting](https://duckdb.org/docs/current/sql/expressions/cast.html):
...
See [Enum Functions](https://duckdb.org/docs/current/sql/functions/enum.html).

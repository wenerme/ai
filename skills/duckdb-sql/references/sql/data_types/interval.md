...
See the [Date Part Functions page](https://duckdb.org/docs/current/sql/functions/datepart.html) for a list of available date parts for use with an `INTERVAL`.

See the [Interval Operators page](https://duckdb.org/docs/current/sql/functions/interval.html) for functions that operate on intervals.

...
For details, see the [Boolean Type documentation](https://duckdb.org/docs/current/sql/data_types/boolean.html).

## `NULL` and `IN` / `NOT IN`

The behavior of `... IN ⟨something with a NULL⟩` is different from `... IN ⟨something with no NULLs⟩`.
For details, see the [`IN` documentation](https://duckdb.org/docs/current/sql/expressions/in.html).

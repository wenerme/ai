...
* [string literals](https://duckdb.org/docs/current/sql/data_types/literal_types.html#string-literals)
* [casting](https://duckdb.org/docs/current/sql/expressions/cast.html#explicit-casting) expressions to a text type
* applying a [string operator](https://duckdb.org/docs/current/sql/functions/text.html#text-functions-and-operators), or invoking a function that returns a text type value

## Strings with Special Characters

To use special characters in a string, use [escape string literals](https://duckdb.org/docs/current/sql/data_types/literal_types.html#escape-string-literals) or [dollar-quoted string literals](https://duckdb.org/docs/current/sql/data_types/literal_types.html#dollar-quoted-string-literals). Alternatively, you can use concatenation and the [`chr` character function](https://duckdb.org/docs/current/sql/functions/text.html):
...
See [Text Functions](https://duckdb.org/docs/current/sql/functions/text.html) and [Pattern Matching](https://duckdb.org/docs/current/sql/functions/pattern_matching.html).

...
See [Logical Operators](https://duckdb.org/docs/current/sql/expressions/logical_operators.html) and [Comparison Operators](https://duckdb.org/docs/current/sql/expressions/comparison_operators.html).

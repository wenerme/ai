...
| [`list[begin[:end][:step]]`](#listbeginendstep) | Extracts a sublist using [slice conventions](https://duckdb.org/docs/current/sql/functions/list.html#slicing). Negative values are accepted. |
...
| [`list_any_value(list)`](#list_any_valuelist) | Applies aggregate function [`any_value`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_approx_count_distinct(list)`](#list_approx_count_distinctlist) | Applies aggregate function [`approx_count_distinct`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_avg(list)`](#list_avglist) | Applies aggregate function [`avg`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_bit_and(list)`](#list_bit_andlist) | Applies aggregate function [`bit_and`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_bit_or(list)`](#list_bit_orlist) | Applies aggregate function [`bit_or`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_bit_xor(list)`](#list_bit_xorlist) | Applies aggregate function [`bit_xor`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_bool_and(list)`](#list_bool_andlist) | Applies aggregate function [`bool_and`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_bool_or(list)`](#list_bool_orlist) | Applies aggregate function [`bool_or`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_count(list)`](#list_countlist) | Applies aggregate function [`count`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_entropy(list)`](#list_entropylist) | Applies aggregate function [`entropy`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_first(list)`](#list_firstlist) | Applies aggregate function [`first`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_histogram(list)`](#list_histogramlist) | Applies aggregate function [`histogram`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_kurtosis(list)`](#list_kurtosislist) | Applies aggregate function [`kurtosis`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_kurtosis_pop(list)`](#list_kurtosis_poplist) | Applies aggregate function [`kurtosis_pop`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_last(list)`](#list_lastlist) | Applies aggregate function [`last`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_mad(list)`](#list_madlist) | Applies aggregate function [`mad`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_max(list)`](#list_maxlist) | Applies aggregate function [`max`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_median(list)`](#list_medianlist) | Applies aggregate function [`median`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_min(list)`](#list_minlist) | Applies aggregate function [`min`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_mode(list)`](#list_modelist) | Applies aggregate function [`mode`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_product(list)`](#list_productlist) | Applies aggregate function [`product`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_sem(list)`](#list_semlist) | Applies aggregate function [`sem`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_skewness(list)`](#list_skewnesslist) | Applies aggregate function [`skewness`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_slice(list, begin, end)`](#list_slicelist-begin-end) | Extracts a sublist or substring using [slice conventions](https://duckdb.org/docs/current/sql/functions/list.html#slicing). Negative values are accepted. |
...
| [`list_stddev_pop(list)`](#list_stddev_poplist) | Applies aggregate function [`stddev_pop`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_stddev_samp(list)`](#list_stddev_samplist) | Applies aggregate function [`stddev_samp`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_string_agg(list)`](#list_string_agglist) | Applies aggregate function [`string_agg`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_sum(list)`](#list_sumlist) | Applies aggregate function [`sum`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`list_var_pop(list)`](#list_var_poplist) | Applies aggregate function [`var_pop`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| [`list_var_samp(list)`](#list_var_samplist) | Applies aggregate function [`var_samp`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| [`unnest(list)`](#unnestlist) | Unnests a list by one level. Note that this is a special function that alters the cardinality of the result. See the [unnest page](https://duckdb.org/docs/current/sql/query_syntax/unnest.html) for more details. |
...
| **Description** | Extracts a sublist using [slice conventions](https://duckdb.org/docs/current/sql/functions/list.html#slicing). Negative values are accepted. |
| **Example** | `[4, 5, 6][3]` |
| **Result** | `6` |
| **Alias** | `list_slice` |
...
| **Description** | Applies aggregate function [`any_value`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`approx_count_distinct`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_approx_count_distinct([3,3,9])` |
| **Result** | `2` |

#### `list_avg(list)`

| **Description** | Applies aggregate function [`avg`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_avg([3,3,9])` |
| **Result** | `5.0` |

#### `list_bit_and(list)`

| **Description** | Applies aggregate function [`bit_and`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_bit_and([3,3,9])` |
| **Result** | `1` |

#### `list_bit_or(list)`

| **Description** | Applies aggregate function [`bit_or`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_bit_or([3,3,9])` |
| **Result** | `11` |

#### `list_bit_xor(list)`

| **Description** | Applies aggregate function [`bit_xor`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_bit_xor([3,3,9])` |
| **Result** | `9` |

#### `list_bool_and(list)`

| **Description** | Applies aggregate function [`bool_and`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_bool_and([true, false])` |
| **Result** | `false` |

#### `list_bool_or(list)`

| **Description** | Applies aggregate function [`bool_or`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`count`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`entropy`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`first`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`histogram`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`kurtosis`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_kurtosis([3,3,9])` |
| **Result** | `NULL` |

#### `list_kurtosis_pop(list)`

| **Description** | Applies aggregate function [`kurtosis_pop`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_kurtosis_pop([3,3,9])` |
| **Result** | `-1.4999999999999978` |

#### `list_last(list)`

| **Description** | Applies aggregate function [`last`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_last([3,3,9])` |
| **Result** | `9` |

#### `list_mad(list)`

| **Description** | Applies aggregate function [`mad`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_mad([3,3,9])` |
| **Result** | `0.0` |

#### `list_max(list)`

| **Description** | Applies aggregate function [`max`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_max([3,3,9])` |
| **Result** | `9` |

#### `list_median(list)`

| **Description** | Applies aggregate function [`median`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_median([3,3,9])` |
| **Result** | `3.0` |

#### `list_min(list)`

| **Description** | Applies aggregate function [`min`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_min([3,3,9])` |
| **Result** | `3` |

#### `list_mode(list)`

| **Description** | Applies aggregate function [`mode`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`product`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`sem`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_sem([3,3,9])` |
| **Result** | `1.6329931618554523` |

#### `list_skewness(list)`

| **Description** | Applies aggregate function [`skewness`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`stddev_pop`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_stddev_pop([3,3,9])` |
| **Result** | `2.8284271247461903` |

#### `list_stddev_samp(list)`

| **Description** | Applies aggregate function [`stddev_samp`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_stddev_samp([3,3,9])` |
| **Result** | `3.4641016151377544` |

#### `list_string_agg(list)`

| **Description** | Applies aggregate function [`string_agg`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_string_agg([3,3,9])` |
| **Result** | `3,3,9` |

#### `list_sum(list)`

| **Description** | Applies aggregate function [`sum`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Applies aggregate function [`var_pop`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
| **Example** | `list_var_pop([3,3,9])` |
| **Result** | `8.0` |

#### `list_var_samp(list)`

| **Description** | Applies aggregate function [`var_samp`](https://duckdb.org/docs/current/sql/functions/aggregates.html#general-aggregate-functions) to the `list`. |
...
| **Description** | Unnests a list by one level. Note that this is a special function that alters the cardinality of the result. See the [unnest page](https://duckdb.org/docs/current/sql/query_syntax/unnest.html) for more details. |
...
For details, see the [lambda functions page](https://duckdb.org/docs/current/sql/functions/lambda.html).

## Related Functions

* The [aggregate functions](https://duckdb.org/docs/current/sql/functions/aggregates.html) `list` and `histogram` produce lists and lists of structs.
* The [`unnest` function](https://duckdb.org/docs/current/sql/query_syntax/unnest.html) is used to unnest a list by one level.

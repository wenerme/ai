...
This section describes functions and operators for examining and manipulating [`BLOB` values](https://duckdb.org/docs/current/sql/data_types/blob.html).
...
| [`read_blob(source)`](#read_blobsource) | Returns the content from `source` (a filename, a list of filenames, or a glob pattern) as a `BLOB`. See the [`read_blob` guide](https://duckdb.org/docs/current/guides/file_formats/read_file.html#read_blob) for more details. |
...
| **Description** | Returns the content from `source` (a filename, a list of filenames, or a glob pattern) as a `BLOB`. See the [`read_blob` guide](https://duckdb.org/docs/current/guides/file_formats/read_file.html#read_blob) for more details. |

...
| [`union_tag(union)`](#union_tagunion) | Retrieve the currently selected tag of the union as an [Enum](https://duckdb.org/docs/current/sql/data_types/enum.html). |
...
| **Description** | Retrieve the currently selected tag of the union as an [Enum](https://duckdb.org/docs/current/sql/data_types/enum.html). |

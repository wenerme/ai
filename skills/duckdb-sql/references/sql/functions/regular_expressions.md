...
DuckDB offers [pattern matching operators](https://duckdb.org/docs/current/sql/functions/pattern_matching.html)
([`LIKE`](https://duckdb.org/docs/current/sql/functions/pattern_matching.html#like),
[`SIMILAR TO`](https://duckdb.org/docs/current/sql/functions/pattern_matching.html#similar-to),
[`GLOB`](https://duckdb.org/docs/current/sql/functions/pattern_matching.html#glob)),

...
This section describes functions and operators for examining and manipulating [`INTERVAL`](https://duckdb.org/docs/current/sql/data_types/interval.html) values.
...
| Name | Description |
|:--|:-------|
| [`date_part(part, interval)`](#date_partpart-interval) | Extract [datepart component](https://duckdb.org/docs/current/sql/functions/datepart.html) (equivalent to `extract`). See [`INTERVAL`](https://duckdb.org/docs/current/sql/data_types/interval.html) for the sometimes surprising rules governing this extraction. |
...
> Only the documented [date part components](https://duckdb.org/docs/current/sql/functions/datepart.html) are defined for intervals.

#### `date_part(part, interval)`

| **Description** | Extract [datepart component](https://duckdb.org/docs/current/sql/functions/datepart.html) (equivalent to `extract`). See [`INTERVAL`](https://duckdb.org/docs/current/sql/data_types/interval.html) for the sometimes surprising rules governing this extraction. |

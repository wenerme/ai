...
All [`LIST` functions](https://duckdb.org/docs/current/sql/functions/list.html) work with the [`ARRAY` data type](https://duckdb.org/docs/current/sql/data_types/array.html). Additionally, several `ARRAY`-native functions are also supported.

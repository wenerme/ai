...
This section describes functions and operators for examining and manipulating [`DATE`](https://duckdb.org/docs/current/sql/data_types/date.html) values.
...
Adding to or subtracting from [infinite values](https://duckdb.org/docs/current/sql/data_types/date.html#special-values) produces the same infinite value.

## Date Functions

The table below shows the available functions for `DATE` types.
Dates can also be manipulated with the [timestamp functions](https://duckdb.org/docs/current/sql/functions/timestamp.html) through type promotion.

| Name                                                                                | Description                                                                                                                                                                                                                                                 |
| :---------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`date_add(date, interval)`](#date_adddate-interval)                                | Add the interval to the date and return a `DATETIME` value.                                                                                                                                                                                                 |
| [`date_diff(part, startdate, enddate)`](#date_diffpart-startdate-enddate)           | The number of [`part`](https://duckdb.org/docs/current/sql/functions/datepart.html) boundaries between `startdate` and `enddate`, inclusive of the larger date and exclusive of the smaller date.                                                                     |
| [`date_part(part, date)`](#date_partpart-date)                                      | Get [subfield](https://duckdb.org/docs/current/sql/functions/datepart.html) (equivalent to `extract`).                                                                                                                                                                |
| [`date_sub(part, startdate, enddate)`](#date_subpart-startdate-enddate)             | The signed length of the interval between `startdate` and `enddate`, truncated to whole multiples of [`part`](https://duckdb.org/docs/current/sql/functions/datepart.html).                                                                                           |
| [`date_trunc(part, date)`](#date_truncpart-date)                                    | Truncate to specified [precision](https://duckdb.org/docs/current/sql/functions/datepart.html).                                                                                                                                                                       |
...
| [`extract(part from date)`](#extractpart-from-date)                                 | Get [subfield](https://duckdb.org/docs/current/sql/functions/datepart.html) from a date.                                                                                                                                                                              |
...
| [`strftime(date, format)`](#strftimedate-format)                                    | Converts a date to a string according to the [format string](https://duckdb.org/docs/current/sql/functions/dateformat.html).                                                                                                                                          |
...
| **Description** | The number of [`part`](https://duckdb.org/docs/current/sql/functions/datepart.html) boundaries between `startdate` and `enddate`, inclusive of the larger date and exclusive of the smaller date. |
...
| **Description** | Get the [subfield](https://duckdb.org/docs/current/sql/functions/datepart.html) (equivalent to `extract`). |
...
| **Description** | The signed length of the interval between `startdate` and `enddate`, truncated to whole multiples of [`part`](https://duckdb.org/docs/current/sql/functions/datepart.html). |
...
| **Description** | Truncate to specified [precision](https://duckdb.org/docs/current/sql/functions/datepart.html). Always returns a `TIMESTAMP`, even when the input is a `DATE`. |
...
| **Description** | Get [subfield](https://duckdb.org/docs/current/sql/functions/datepart.html) from a date. |
...
| **Description** | Converts a date to a string according to the [format string](https://duckdb.org/docs/current/sql/functions/dateformat.html). |
...
There are also dedicated extraction functions to get the [subfields](https://duckdb.org/docs/current/sql/functions/datepart.html#part-functions).

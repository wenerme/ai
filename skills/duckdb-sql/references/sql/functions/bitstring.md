...
This section describes functions and operators for examining and manipulating [`BITSTRING`](https://duckdb.org/docs/current/sql/data_types/bitstring.html) values.

...
4. To configure the consent screen:
   ...
   6. Select **Create**.
5. The OAuth overview page will load. On the OAuth overview screen, select **Create OAuth client**.![Location to create an OAuth client in the Google Cloud Platform console.](https://developers.cloudflare.com/cdn-cgi/image/onerror=redirect,width=3776,height=1106,format=webp/_astro/create-oauth-client.BkzE5MZU.png)

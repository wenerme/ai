...
- <a href="#authoritative-nameserver-ip">Authoritative Nameserver IP</a>
- <a href="#content-categories">Content Categories</a>
- <a href="#dns-cname-record">DNS CNAME Response Value</a>
- <a href="#dns-mx-record">DNS MX Response Value</a>
- <a href="#dns-ptr-record">DNS PTR Response Value</a>
- <a href="#dns-resolver-ip">DNS Resolver IP</a>
- <a href="#dns-txt-record">DNS TXT Response Value</a>
- <a href="#doh-subdomain">DOH Subdomain</a>
- <a href="#domain">Domain</a>
- <a href="#host">Host</a>
- <a href="#indicator-feeds">Indicator Feeds</a>
- <a href="#location">Location</a>
- <a href="#query-record-type">Query Record Type</a>
- <a href="#resolved-continent">Resolved Continent IP Geolocation</a>
- <a href="#resolved-country">Resolved Country IP Geolocation</a>
- <a href="#resolved-ip">Resolved IP</a>
- <a href="#request-context-categories">Request Context Categories</a>
- <a href="#security-categories">Security Categories</a>

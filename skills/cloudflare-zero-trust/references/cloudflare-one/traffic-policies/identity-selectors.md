...
- In the Cloudflare One Client, re-authenticate the session by going to **Profile** > **Account information** > **Re-authenticate** <sup>[1](#user-content-fn-1)</sup>. This will open a browser window and prompt the user to log in.

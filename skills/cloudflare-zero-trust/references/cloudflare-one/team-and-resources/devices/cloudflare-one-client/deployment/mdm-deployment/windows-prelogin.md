...
| --- | --- | --- | --- |
| User email | in | <code>non_identity@&lt;team-name&gt;.cloudflareaccess.com</code> | And |
...
| Selector | Operator | Value | Logic |
| --- | --- | --- | --- |
| Destination IP | in list | <code>Active Directory servers</code> | And |
| User email | in | <code>non_identity@&lt;team-name&gt;.cloudflareaccess.com</code> | And |
| Passed Device Posture Checks | in | <code>Windows 10 or higher (OS version)</code> | |

...
| `installed_cert.pem` | [Root certificate](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/user-side-certificates/) installed on the system. |
...
| `local_policy.redacted.txt`<br> `mdm.plist` <br> `mdm.xml` | [Managed deployment parameters](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/cloudflare-one-client/deployment/mdm-deployment/parameters/) on the device. |

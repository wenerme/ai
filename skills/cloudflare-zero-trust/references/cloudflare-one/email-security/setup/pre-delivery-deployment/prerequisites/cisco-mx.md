...
| Host | Location | Note |
| --- | --- | --- |
| <li>`mailstream-central.mxrecord.mx`</li><li>`mailstream-east.mxrecord.io`</li><li>`mailstream-west.mxrecord.io`</li> | US | Best option to ensure all email traffic processing happens in the US. |

...
Gateway supports non-Latin characters by converting all domains and hostnames to [Punycode ↗︎](https://www.rfc-editor.org/rfc/rfc3492.txt). Once you save a list with non-Latin characters, Gateway will display the entry as Punycode.

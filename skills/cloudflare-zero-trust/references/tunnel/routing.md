...
Last updated Sep 2, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/tunnel/routing/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)
...
| HTTPS        | Proxies incoming HTTPS requests directly to your local web service. You can [disable TLS verification](https://developers.cloudflare.com/tunnel/advanced/origin-parameters/#notlsverify) for self-signed certificates.                                                                                                                                                                                                         | https://localhost:8000              |

...
| Syntax | Default | Environment Variable |
| --- | --- | --- |
| `cloudflared tunnel --metrics <IP:PORT> run <UUID or NAME>` | Refer to [Tunnel metrics](https://developers.cloudflare.com/tunnel/observability/#metrics) | `TUNNEL_METRICS` |

...
Cloudflare WAN (formerly Magic WAN) is compatible with any device that supports IPsec
 ...
 with the [supported configuration parameters](https://developers.cloudflare.com/cloudflare-wan/reference/gre-ipsec-tunnels/#supported-configuration-parameters) or supports GRE.

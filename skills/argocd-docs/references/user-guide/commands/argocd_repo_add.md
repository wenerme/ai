...
```
  ...
  argocd repo add ssh://git@github.com/argoproj/argocd-example-apps --ssh-private-key-path ~/id_rsa --proxy socks5://EXAMPLE_USER:EXAMPLE_PASSWORD@your.proxy.server.ip:1080

...
```
{  "$schema": "./node_modules/wrangler/config-schema.json",  "name": "hijack-alerts",  "main": "src/index.js",  // Set this to today's date  "compatibility_date": "2026-06-24",  "triggers": {    "crons": [      "*/5 * * * *"    ]  }}
```

TOML

```
"$schema" = "./node_modules/wrangler/config-schema.json"name = "hijack-alerts"main = "src/index.js"# Set this to today's datecompatibility_date = "2026-06-24"
[triggers]crons = [ "*/5 * * * *" ]
```
...
* [  wrangler.jsonc ](#tab-panel-10064)
* [  wrangler.toml ](#tab-panel-10065)

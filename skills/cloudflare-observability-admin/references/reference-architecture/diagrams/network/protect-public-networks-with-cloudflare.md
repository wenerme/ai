...
1. Using Border Gateway Protocol ([BGP ↗︎](https://www.cloudflare.com/learning/security/glossary/what-is-bgp/)) and [IP anycast ↗︎](https://www.cloudflare.com/learning/cdn/glossary/anycast-network/), Cloudflare advertises customer's protected IP prefixes to the Internet from all of Cloudflare's global data centers. Internet traffic destined to these protected IP prefixes will always be routed to the Cloudflare data center that is closest to the source of the traffic.

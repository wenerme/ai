...
Moreover, Cloudflare Gateway eliminates concerns around availability, performance, and scalability, as it is built on [Cloudflare's 1.1.1.1 public DNS resolver](https://developers.cloudflare.com/1.1.1.1/), one of the [fastest ↗︎](https://www.dnsperf.com/#!dns-providers) and most widely-used DNS resolvers in the world.
...
Cloudflare Gateway, like all Cloudflare services, utilizes [anycast technology ↗︎](https://www.cloudflare.com/learning/cdn/glossary/anycast-network/), ensuring that all service provider DNS queries are directed to the nearest Cloudflare point of presence.
...
- [Cloudflare Blog: Using the power of Cloudflare's global network to detect malicious domains using machine learning ↗︎](https://blog.cloudflare.com/threat-detection-machine-learning-models/)

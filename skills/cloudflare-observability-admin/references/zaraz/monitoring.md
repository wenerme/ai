...
1. In the Cloudflare dashboard, go to the **Monitoring** page. [Go to **Monitoring** ↗](https://dash.cloudflare.com/?to=/:account/tag-management/monitoring)

...
Last updated Sep 14, 2026|Copy as Markdown| [View as Markdown](https://developers.cloudflare.com/logs/logpush/logpush-job/datasets/account/dns_firewall_logs/index.md)| [Agent setup](https://developers.cloudflare.com/agent-setup/)

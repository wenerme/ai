...
1. In the Cloudflare dashboard, go to your zone's **DNS Settings**. [Go to **Settings** ↗](https://dash.cloudflare.com/?to=/:account/:zone/dns/settings)

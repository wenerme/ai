...
| [Bot Management](https://developers.cloudflare.com/bots/)<sup>[1](#user-content-fn-1)</sup> | Provides bot identification and protection for a domain. Only supports certain Machine Learning (ML) models. |
...
| [Rules](https://developers.cloudflare.com/rules/)<sup>[2](#user-content-fn-2)</sup> | Make adjustments to requests and responses, configure Cloudflare settings, and trigger specific actions for matching requests. |
...
| [R2](https://developers.cloudflare.com/r2/)<sup>[3](#user-content-fn-3)</sup> | Object storage for all your data. |

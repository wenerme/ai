...
> **note**: Migrating from AI SDK v4 to v5? See the [migration guide](/reference/migrations/ai-sdk-v4-to-v5).

> **tip**: Want to see more examples? Visit Mastra's [**UI Dojo**](https://ui-dojo.mastra.ai/) or the [Next.js quickstart guide](/guides/getting-started/next-js).

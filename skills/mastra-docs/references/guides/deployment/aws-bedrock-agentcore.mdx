...
> **info**: For a Lambda-based deployment of the full Mastra server, see the [AWS Lambda guide](/guides/deployment/aws-lambda). For a long-lived virtual machine, see the [Amazon EC2 guide](/guides/deployment/amazon-ec2).

...
> **note**: This guide covers splitting workers into their own containers. If you only need workers to run in-process alongside the API, see [Workers](/docs/deployment/workers). No extra setup is required.

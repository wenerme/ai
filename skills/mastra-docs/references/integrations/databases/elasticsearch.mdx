...
description: "Store Mastra agent memory, workflow snapshots, and scores in Elasticsearch with URL, authentication, or shared client connection configuration."
packages:
  - "@mastra/core"
  - "@mastra/memory"

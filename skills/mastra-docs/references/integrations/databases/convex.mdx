...
description: "Store Mastra application data in Convex by defining schemas, deploying storage handlers, configuring the client, and enabling real-time serverless persistence."
packages:
  - "@mastra/convex"
---

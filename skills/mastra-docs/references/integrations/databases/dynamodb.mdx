...
description: "Persist Mastra data in Amazon DynamoDB with a single-table ElectroDB design, configurable indexes, TTL support, credentials, and table initialization."
packages:
  - "@mastra/dynamodb"
  - "@mastra/libsql"
  - "@mastra/memory"

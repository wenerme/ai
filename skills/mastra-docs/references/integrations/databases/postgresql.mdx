...
description: "Persist Mastra application data in PostgreSQL with PostgresStore, configure connections and pools, initialize schemas, and enable observability."
packages:
  - "@mastra/core"
  - "@mastra/memory"
  - "@mastra/pg"

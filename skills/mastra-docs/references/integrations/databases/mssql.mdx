...
description: "Persist Mastra application data in Microsoft SQL Server with MSSQL connection options, schema initialization, and direct database or pool access."
packages:
  - "@mastra/core"
  - "@mastra/mssql"
---

...
<PropertiesTable
  content={[
  {
    name: 'type',
    type: 'string',
    description: 'OpenAI Realtime client event type, such as conversation.item.create.',
    isOptional: false,
  },
  {
    name: 'data',
    type: 'Record<string, unknown>',
    description: 'Event payload sent alongside the type.',
    isOptional: true,
    defaultValue: '{}',
  },
]}
...
<PropertiesTable
  content={[
  {
    name: 'open',
    type: 'event',
    description: 'Emitted when the WebSocket connection to OpenAI opens.',
  },
  {
    name: 'close',
    type: 'event',
    description:
      'Emitted when the WebSocket connection closes, including when OpenAI closes it. Callback receives { code: number, reason: string }.',
  },
]}
/>

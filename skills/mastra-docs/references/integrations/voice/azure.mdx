---
title: "Azure | Voice"
description: "Add text-to-speech and speech-to-text to Mastra with Azure Speech Services, configurable voices, audio formats, transcription, and credentials."
packages:
  - "@mastra/voice-azure"
---

...
description: "Build real-time voice interactions with Mastra and the xAI Grok Voice Agent API, including audio streaming, tools, turn handling, and authentication."
packages:
  - "@mastra/node-audio"

---
title: "Mistral | Voice"
description: "Add Mistral Voxtral text-to-speech and speech-to-text to Mastra with buffered or streaming audio, batch transcription, and voice configuration."
packages:

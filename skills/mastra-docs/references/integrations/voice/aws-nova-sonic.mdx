...
description: "Add real-time speech-to-speech to Mastra with AWS Bedrock Nova 2 Sonic, bidirectional audio, transcripts, tool calls, interruptions, and session controls."
packages:
  - "@mastra/node-audio"

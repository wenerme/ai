---
title: "WorkOS | Auth"
description: "Authenticate Mastra with WorkOS access tokens, configure default or fine-grained authorization, load memberships, and support custom JWT templates."
packages:
  - "@mastra/auth-workos"
  - "@mastra/client-js"
  - "@mastra/core"

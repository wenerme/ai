---
title: "Clerk | Auth"
description: "Authenticate Mastra server requests with Clerk, configure the @mastra/auth-clerk provider, retrieve access tokens, and connect MastraClient securely."
packages:
  - "@mastra/auth-clerk"
  - "@mastra/client-js"
  - "@mastra/core"

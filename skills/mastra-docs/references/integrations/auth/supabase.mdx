---
title: "Supabase | Auth"
description: "Authenticate Mastra server requests with Supabase Auth, configure the provider, retrieve user access tokens, and connect MastraClient securely."
packages:

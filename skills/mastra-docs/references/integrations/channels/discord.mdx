...
description: "Connect a Mastra agent to Discord interactions and bot messages by installing the adapter, configuring the agent, and exposing a webhook route."
packages:
  - "@mastra/core"
---

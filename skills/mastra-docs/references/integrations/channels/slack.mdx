...
description: "Connect a Mastra agent to Slack channels and direct messages, configure the Slack app and webhook route, and test threaded agent conversations."
packages:
  - "@mastra/core"
---

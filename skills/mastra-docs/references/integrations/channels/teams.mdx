...
description: "Connect a Mastra agent to Microsoft Teams mentions and conversation events by installing the adapter and configuring agent webhook handling."
packages:
  - "@mastra/core"
---

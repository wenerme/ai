...
description: "Give Mastra agents remote browser automation with Firecrawl Browser Sandbox sessions, deterministic interaction tools, and self-hosted configuration."
packages:

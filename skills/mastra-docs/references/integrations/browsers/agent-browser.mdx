...
description: "Automate websites from Mastra agents with AgentBrowser, using Playwright, accessibility-tree element refs, screenshots, recordings, and deterministic tools."
packages:

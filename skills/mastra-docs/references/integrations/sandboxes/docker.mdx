...
description: "Run Mastra workspace commands in long-lived local Docker containers with environment variables, bind mounts, background processes, and reconnection."
packages:
  - "@mastra/docker"
---

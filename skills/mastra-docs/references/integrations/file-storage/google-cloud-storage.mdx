...
description: "Store Mastra workspace files in Google Cloud Storage using application default credentials or key files, and mount buckets in agent sandboxes."
packages:
  - "@mastra/gcs"
---

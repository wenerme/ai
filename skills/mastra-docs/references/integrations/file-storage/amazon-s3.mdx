...
description: "Store Mastra workspace files in Amazon S3 or compatible services such as Cloudflare R2 and MinIO, with credentials, endpoints, and read-only mounts."
packages:
  - "@mastra/s3"
---

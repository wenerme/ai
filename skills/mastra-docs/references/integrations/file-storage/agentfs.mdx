...
description: "Store Mastra workspace files in a persistent AgentFS SQLite database, using a database path or existing client for durable agent file access."
packages:
  - "@mastra/agentfs"
---

...
description: "Store Mastra workspace files in Azure Blob Storage using account keys, SAS tokens, or DefaultAzureCredential, with container and mount configuration."
packages:
  - "@mastra/azure"
---

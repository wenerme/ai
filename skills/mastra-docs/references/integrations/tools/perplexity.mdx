...
description: "Add Perplexity Search API tools to Mastra agents with typed schemas, configurable search options, result metadata, and citation-ready web results."
packages:
  - "@mastra/perplexity"
---

...
description: "Use Mastra Quick Checks as zero-LLM, composable micro-scorers for text matching, tool usage, tool ordering, latency, and other deterministic assertions."
packages:
  - "@mastra/evals"
---

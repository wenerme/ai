...
description: "Use createAnswerRelevancyScorer() to evaluate how directly an LLM response addresses the input query, with configurable model and scoring options."
packages:
  - "@mastra/core"
  - "@mastra/evals"
---

...
description: "Configure MastraAuthAuth0 for Auth0 authentication, including access-token validation and authenticated user resolution from request headers."
packages:
  - "@mastra/auth-auth0"
  - "@mastra/core"
---

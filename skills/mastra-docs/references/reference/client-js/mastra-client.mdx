...
description: "The Mastra Client SDK provides a type-safe interface for interacting with your Mastra Server from your client environment."
packages:
  - "@mastra/client-js"
---
...
<PropertiesTable
  ...
  {
    name: 'listAgentControllers()',
    type: 'Promise<AgentControllerInfo[]>',
    description: 'Returns the agent controllers hosted on the connected Mastra instance.',
  },
  {
    name: 'getAgentController(controllerId)',
    type: 'AgentController',
    description:
      'Retrieves a specific agent controller by ID. `.session(resourceId)` returns a session client; call `await session.create()` to create or resume the server session.',
  },
  {
  ...
  },
  {
    ...
    type: 'Promise<GetAgentBuilderActionsResponse>',
    description:
  ...
  {
    name: 'deleteTraces(params)',
    type: 'Promise<{ success: true }>',
    description: 'Deletes traces by ID and cascades deletion to their trace-linked observability signals.',
  },
]}
/>

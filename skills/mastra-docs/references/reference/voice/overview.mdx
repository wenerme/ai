...
Each voice provider can be configured with different models and options. Below are the detailed configuration options for all supported providers:
    ...
    Visit the [Gladia Voice integration](/integrations/voice/gladia) for configuration and transcription options.
    ...
    Visit the [ModelsLab Voice integration](/integrations/voice/modelslab) for configuration and synthesis options.

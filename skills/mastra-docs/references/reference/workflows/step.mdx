...
> **note**: Visit the [Scorers overview](/docs/evals/overview) to learn how live evaluations run and where results are stored, and [Custom scorers](/docs/evals/custom-scorers) to build your own.

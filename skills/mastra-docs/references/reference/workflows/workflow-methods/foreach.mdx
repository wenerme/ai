...
description: "The .foreach() method creates a loop that executes a step for each item in an array. It always returns an array containing the output from each iteration, preserving the original order."
packages:
  - "@mastra/core"
---

...
description: "Use workflow state reader helpers to inspect WorkflowState status, step inputs and outputs, suspended paths, and resume labels without parsing snapshots."
packages:
  - "@mastra/core"
---

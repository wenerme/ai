...
description: "Configure ArizeExporter for Mastra tracing with Arize Phoenix or Arize AX, plus OpenTelemetry platforms supporting OpenInference semantic conventions."
packages:
  - "@mastra/arize"
---

...
description: "Configure DeepEvalExporter from @mastra/deepeval to send Mastra traces to Confident AI for evaluations and observability with the DeepEval SDK."
packages:
  - "@mastra/deepeval"
---

...
description: "Configure SentryExporter to send Mastra traces to Sentry for AI monitoring and analysis through OpenTelemetry-compatible semantic conventions."
packages:
  - "@mastra/sentry"

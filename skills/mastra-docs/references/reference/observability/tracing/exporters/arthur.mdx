...
description: "Configure ArthurExporter to send Mastra traces to Arthur Engine through OpenTelemetry with OpenInference semantic conventions and metadata."
packages:
  - "@mastra/arthur"
---

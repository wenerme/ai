...
:::warning[Thread grouping is deprecated]

The `group` option remains supported until the next major release. Use [`queryTraceThreads()`](/reference/client-js/observability) to retrieve matching thread identities in new code.

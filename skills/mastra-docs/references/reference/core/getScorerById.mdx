...
description: "The getScorerById() method retrieves a scorer by searching for its id property (or name property as a fallback) rather than the registration key."
packages:
  - "@mastra/core"
---

...
description: "The .listLogsByRunId() method is used to retrieve logs for a specific run ID and transport ID. This method requires a configured logger that supports the listLogsByRunId operation."
packages:
  - "@mastra/core"
---

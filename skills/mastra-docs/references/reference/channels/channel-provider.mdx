...
description: "API reference for ChannelProvider, the interface that platform integrations implement to provision apps, route webhooks, and wire adapters to agents."
packages:
  - "@mastra/core"
---

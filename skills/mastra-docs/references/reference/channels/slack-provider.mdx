...
description: "SlackProvider is the managed path for connecting agents to Slack. Register it on Mastra.channels and it provisions Slack apps through the Manifest API and runs the OAuth install flow."
packages:
  - "@mastra/slack"
---

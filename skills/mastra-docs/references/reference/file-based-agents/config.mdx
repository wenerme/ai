...
description: "An agent's config.ts sets its model and runtime options. Use it for options that belong to the Agent itself, while sibling files provide instructions, tools, skills, et cetera."
packages:
  - "@mastra/core"
---

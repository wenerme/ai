...
description: "RAG in Mastra helps you enhance LLM outputs by incorporating relevant context from your own data sources, improving accuracy and grounding responses in real information."
packages:
  - "@mastra/core"
  - "@mastra/oracledb"
  - "@mastra/pg"

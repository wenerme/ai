...
description: "Use Agent.listSkills() to return metadata for every configured agent-level and workspace skill, including the names and descriptions available to the agent."
packages:
  - "@mastra/core"
---

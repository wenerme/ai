...
description: "The StagehandBrowser class provides AI-powered browser automation using Stagehand. It uses natural language instructions for interactions instead of element refs."
packages:
  - "@mastra/stagehand"
---

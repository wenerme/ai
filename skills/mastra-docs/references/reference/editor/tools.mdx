...
description: "Configure Editor agent tools from Mastra, MCP, workspace, and provider sources, including descriptions, display conditions, and resolution order."
packages:
  - "@mastra/core"
  - "@mastra/editor"
  - "@mastra/mcp"

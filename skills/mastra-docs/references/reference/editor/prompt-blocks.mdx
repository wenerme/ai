...
description: "Use Editor prompt blocks to define reusable instruction templates, typed values, display conditions, version history, and agent prompt-block APIs."
packages:
  - "@mastra/core"
  - "@mastra/editor"
---

...
description: "The createACPTool() function creates a Mastra tool that sends a task string to an Agent Client Protocol (ACP)-compatible coding agent and returns the final ACP response as output."
packages:
  - "@mastra/acp"
  - "@mastra/core"
---

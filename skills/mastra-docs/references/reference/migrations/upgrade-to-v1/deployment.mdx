...
description: "The OpenAPI spec endpoint has moved to /api/openapi.json, and the CloudflareDeployer configuration has been updated to use standard wrangler.json property names."
packages:

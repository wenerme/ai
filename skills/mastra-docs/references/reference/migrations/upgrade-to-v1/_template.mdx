...
description: "Use this migration-page template to document v1 breaking changes with package versions, before-and-after examples, migration steps, and verification guidance."
packages:
  - "@mastra/core"
---

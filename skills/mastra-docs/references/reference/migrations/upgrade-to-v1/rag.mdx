...
description: "Migrate RAG code to Mastra v1 with renamed chunking parameters and narrowed option types, including updates to related document-processing APIs."
packages:
  - "@mastra/rag"
---

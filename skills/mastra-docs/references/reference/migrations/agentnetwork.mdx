...
description: "Migrate deprecated AgentNetwork usage to supervisor agents and the standard Agent.generate() or Agent.stream() APIs in current Mastra releases."
packages:
  - "@mastra/core"
  - "@mastra/memory"
---

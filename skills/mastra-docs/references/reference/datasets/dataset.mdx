...
description: "The Dataset class provides methods for item CRUD, versioning, and experiment management on a single dataset."
packages:
  - "@mastra/core"
---
...
- [dataset.deleteExperiment()](/reference/datasets/deleteExperiment)

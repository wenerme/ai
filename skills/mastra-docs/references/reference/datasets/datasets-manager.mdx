...
description: "The DatasetsManager class provides the public API for managing datasets, including CRUD operations and cross-dataset experiment comparisons."
packages:
  - "@mastra/core"
---
...
See [`DatasetsManager.deleteExperiment()`](/reference/datasets/deleteExperiment) for tenancy behavior and trace cascade details.

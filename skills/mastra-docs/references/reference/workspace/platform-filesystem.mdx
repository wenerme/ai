...
description: "Use PlatformFilesystem to give Mastra agents read, write, list, delete, and move access to a workspace bucket in a Mastra Platform environment."
packages:
...
> **note**: For interface details, see [WorkspaceFilesystem interface](/reference/workspace/filesystem).

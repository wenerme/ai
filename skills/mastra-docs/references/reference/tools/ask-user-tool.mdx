...
description: "A built-in, agent-agnostic tool that asks the user a question and waits for their response. The tool supports free-text questions, single-select prompts, and multi-select prompts."
packages:
  - "@mastra/core"
---

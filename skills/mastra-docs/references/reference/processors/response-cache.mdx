...
See [Response caching](/docs/agents/response-caching) for the conceptual overview, scoping rules, and recommended deployment patterns.
...
- [Response caching](/docs/agents/response-caching)

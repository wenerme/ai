...
description: "The BatchPartsProcessor is an output processor that batches multiple stream parts together to reduce the frequency of emissions during streaming."
packages:
  - "@mastra/core"
---

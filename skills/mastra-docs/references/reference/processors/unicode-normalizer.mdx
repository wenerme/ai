...
description: "Use UnicodeNormalizer to standardize input text into a selected Unicode form and remove problematic characters before messages reach the language model."
packages:
  - "@mastra/core"
---

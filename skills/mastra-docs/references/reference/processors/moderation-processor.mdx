...
description: "Use ModerationProcessor for LLM-based input and output moderation across configurable content categories, thresholds, strategies, and model settings."
packages:
  - "@mastra/core"
---

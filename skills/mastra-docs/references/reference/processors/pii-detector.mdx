...
description: "The PIIDetector is a hybrid processor that can be used for both input and output processing to detect and redact personally identifiable information (PII) for privacy compliance."
packages:
  - "@mastra/core"
---
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: "'warn' | 'strict'",
            description:
              "How to handle failures from the internal model call. 'warn' is fail-open: it logs the failure and allows the content through unchanged. 'strict' is fail-closed: it stops processing with a tripwire. This option doesn't affect regex-only streaming detection.",
            isOptional: true,
            default: "'warn'",
          },
          {

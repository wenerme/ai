...
description: "Configure UpstashVector for serverless similarity and hybrid search, metadata filtering, index management, and vector operations with Upstash Vector."
packages:
  - "@mastra/core"
  - "@mastra/fastembed"
  - "@mastra/memory"

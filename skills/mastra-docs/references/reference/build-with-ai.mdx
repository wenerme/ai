...
> **warning**: The MCP docs server isn't recommended for everyday development. Use the [Mastra skill](/docs/develop#mastra-skill) instead because it's more up to date and performs better.

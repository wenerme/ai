...
> **note**: See [Observational Memory](../memory/observational-memory) for details on how observations and reflections work, and [the reference](/reference/memory/observational-memory) for all configuration options.
...
> **note**: Visit [Request Context](/docs/server/request-context) for more information.

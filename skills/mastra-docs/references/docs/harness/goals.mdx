...
description: "Set a durable goal for a Mastra agent so an execution loop evaluates progress and continues working until the objective completes or its run budget ends."
packages:
  - "@mastra/core"
  - "@mastra/memory"
---

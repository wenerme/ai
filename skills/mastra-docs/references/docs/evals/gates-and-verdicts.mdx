...
description: "Define mandatory gates and score thresholds for Mastra evals, compute passed, scored, or failed verdicts, and enforce quality requirements in CI."
packages:
  - "@mastra/core"
---

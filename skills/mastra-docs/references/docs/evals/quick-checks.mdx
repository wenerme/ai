...
description: "Add fast, deterministic Quick Checks to Mastra evals for assertions on output text and tool calls without using an LLM or changing scorer workflows."
packages:
  - "@mastra/evals"
---

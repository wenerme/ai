...
description: "Run Mastra scorer experiments in CI with runEvals, define test cases for agents or workflows, inspect aggregate results, and track quality over time."
packages:
  - "@mastra/core"
---
...
```typescript title="tests/weather-agent.test.ts"

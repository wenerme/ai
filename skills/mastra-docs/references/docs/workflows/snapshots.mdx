...
description: "Store and retrieve Mastra workflow snapshots so suspended executions preserve step results and state and can resume reliably across processes."
packages:
  - "@mastra/core"
  - "@mastra/libsql"
---

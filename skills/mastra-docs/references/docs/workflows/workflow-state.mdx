...
description: "Share typed global state across Mastra workflow steps, initialize and update values, preserve state through suspension, and pass it into nested workflows."
packages:
  - "@mastra/core"
---

...
> **info**: Visit [Step Class](/reference/workflows/step) for a full list of configuration options.
...
> **info**: Visit [Workflow Class](/reference/workflows/workflow) for a full list of configuration options.
...
> **info**: Visit [Workflow State](/docs/workflows/workflow-state) for complete documentation on state schemas, initial state, persistence across suspend/resume, and nested workflows.
...
> **info**: Visit [Request Context](/docs/server/request-context) for more information.

> **tip**: For type-safe request context schema validation, see [Schema Validation](/docs/server/request-context#schema-validation).

## Testing with Studio

Use [Studio](/docs/getting-started/studio) to run workflows with different inputs, visualize the execution lifecycle, see the inputs and outputs for each step, and inspect each part of the workflow in more detail.

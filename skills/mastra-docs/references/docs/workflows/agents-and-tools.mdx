...
> **info**: Visit [Input Data Mapping](/docs/workflows/control-flow#input-data-mapping) for more information.
...
> **info**: Visit [Structured Output](/docs/agents/structured-output) for more options like error handling strategies and streaming with structured output.
...
> **info**: Visit [Calling Tools](/docs/workflows/agents-and-tools#calling-tools) for more examples.

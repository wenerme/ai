...
description: "Call Mastra agents and tools from workflow steps, compose them directly with createStep, and choose between execute functions and typed step composition."
packages:
  - "@mastra/core"
---

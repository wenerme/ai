...
description: "Pause Mastra workflows for approvals, reviews, or user input, then resume with supplied data, reject with bail, or support repeated human interactions."
packages:
  - "@mastra/core"
---

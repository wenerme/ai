...
> **warning**: If you're deploying to a cloud provider, remove any usage of [LibSQLStore](/reference/storage/libsql) from your Mastra configuration. LibSQLStore requires filesystem access and isn't compatible with serverless platforms.

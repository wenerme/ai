...
When you're ready to share Studio with your team, you can deploy it to production using the [Mastra platform](/docs/mastra-platform/overview) or your own infrastructure. Visit the [deployment docs](/docs/studio/deployment) to learn how.

...
description: 'Create, list, delete, aggregate, and export human feedback records in Mastra observability, with ratings and comments linked to specific traces and spans.'
packages:
  - '@mastra/core'

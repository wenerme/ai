...
- [**Configuration**](/docs/observability/config): Configure observability once for traces, logs, and metrics.
- [**Storage**](/docs/observability/storage): Choose storage backends for persisted traces, logs, and metrics aggregation.

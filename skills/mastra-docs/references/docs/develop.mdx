...
> **note**: When you create a project with [create mastra](/docs), the command automatically installs the Mastra skill so your coding agent can discover and use it.

...
> **note**: Visit the [DurableAgent reference](/reference/agents/durable-agent) for the full configuration and method API.
...
> **note**: Visit the [`createInngestAgent()` reference](/reference/agents/inngest-agent) for the full API, including Inngest-specific options like PubSub and cache configuration.
...
> **note**: Visit [Background tasks](/docs/long-running-agents/background-tasks) for the full background task guide, including configuration, subagents, and suspend/resume.

...
description: "Configure Mastra platform project resolution with .mastra-project.json and manage environment variables from platform, stored, and local sources."
---

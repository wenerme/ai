...
description: "Implement a custom Mastra server adapter for unsupported web frameworks by mapping routes, middleware, request parameters, responses, and streams."
packages:
  - "@mastra/core"
  - "@mastra/express"
  - "@mastra/hono"
...
```typescript title="src/my-framework-adapter.test.ts"

...
> **info**: Visit [Middleware](/docs/server/middleware) for how to use server middleware.
...
> **info**: Visit [Agent](/reference/agents/agent) for a full list of configuration options.
...
> **info**: Visit [createStep()](/reference/workflows/step) for a full list of configuration options.
...
> **info**: Visit [createTool()](/reference/tools/create-tool) for a full list of configuration options.

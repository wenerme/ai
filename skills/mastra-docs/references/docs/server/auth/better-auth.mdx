...
> **info**: Visit [MastraAuthBetterAuth](/reference/auth/better-auth) for all available configuration options.
...
> **info**: Visit [Mastra Client SDK](/docs/server/mastra-client) for more configuration options.

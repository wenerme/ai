...
For production applications, consider using [JWT](/docs/server/auth/jwt), [Clerk](/integrations/auth/clerk), [Auth0](/integrations/auth/auth0), or another identity provider.

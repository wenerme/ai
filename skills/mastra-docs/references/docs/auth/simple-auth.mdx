...
description: "Use Mastra SimpleAuth for token-to-user authentication, API key scenarios, custom headers, and lightweight authorization in development environments."
packages:
  - "@mastra/core"
---

...
description: "Secure Mastra APIs with MastraJwtAuth and a shared secret, then create JSON Web Tokens and send authenticated requests through MastraClient."
packages:
  - "@mastra/auth"
  - "@mastra/client-js"
  - "@mastra/core"

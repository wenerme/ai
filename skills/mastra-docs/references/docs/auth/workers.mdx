---
title: "Workers | Auth"
description: "Secure communication between standalone Mastra workers and the API server with bearer tokens, API key headers, or custom authentication credentials."
packages:
  - "@mastra/core"
---

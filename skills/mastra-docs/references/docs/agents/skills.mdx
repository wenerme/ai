...
> **note**: Visit [`createSkill()` reference](/reference/agents/createSkill) for the full API.
...
> **note**: Visit [`.getSkill()` reference](/reference/agents/getSkill) and [`.listSkills()` reference](/reference/agents/listSkills) for the full API.

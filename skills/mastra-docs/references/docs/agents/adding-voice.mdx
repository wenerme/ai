---
title: "Voice | Agents"
description: "Learn how to add voice capabilities to your Mastra agents for text-to-speech and speech-to-text interactions."
packages:
  - "@mastra/core"
  - "@mastra/node-audio"
  - "@mastra/voice-azure"
...
| AWS Nova Sonic | `@mastra/voice-aws-nova-sonic` | Realtime speech-to-speech via AWS Bedrock | [Documentation](/reference/voice/aws-nova-sonic) |

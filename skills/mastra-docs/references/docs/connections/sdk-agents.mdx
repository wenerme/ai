...
description: "Use Claude Agent SDK, Cursor Agent SDK, and OpenAI Agents SDK agents inside Mastra as delegated agents with their native tools and model options."
packages:
  - "@mastra/claude"
  - "@mastra/cursor"
  - "@mastra/openai"

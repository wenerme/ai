...
description: "Connect ACP-compatible coding agents to Mastra as tools or subagents, with configured models and sessions that stream Agent Client Protocol interactions."
packages:
  - "@mastra/acp"
  - "@mastra/core"
---

...
After [setting up your project](/docs/mastra-cloud/setup), select **Deployment** in the sidebar and select **Enable Deployments**.
...
- [Studio](/docs/mastra-cloud/overview): Test your agents in the cloud

...
> **info**: Visit [MCPClient](/reference/tools/mcp-client) for a full list of configuration options.
...
> **info**: Visit [Agent Class](/reference/agents/agent) for a full list of configuration options.
...
> **info**: Visit [MCPServer](/reference/tools/mcp-server) for a full list of configuration options.
...
> **info**: Visit [listTools()](/reference/tools/mcp-client#listtools) for more information.
...
> **info**: Visit [listToolsets()](/reference/tools/mcp-client#listtoolsets) for more information.
...
> **note**: Visit [MCP Apps](/docs/mcp/mcp-apps) for setup instructions and the app bridge API.

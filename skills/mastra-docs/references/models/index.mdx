---
title: "Models"
description: "Access 162+ AI providers and 5107+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 154 more</div>
      </div>
    </CardGridItem>
</CardGrid>

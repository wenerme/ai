---
title: "Models"
description: "Access 187+ AI providers and 6846+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 177 more</div>
      </div>
    </CardGridItem>
</CardGrid>

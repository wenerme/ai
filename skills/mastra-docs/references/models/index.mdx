---
title: "Models"
description: "Access 95+ AI providers and 3605+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 3605 models from 95 providers through a single API.

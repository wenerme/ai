---
title: "Models"
description: "Access 209+ AI providers and 7368+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 7368 models from 209 providers through a single API.

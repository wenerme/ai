---
title: "Models"
description: "Access 101+ AI providers and 3651+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 94 more</div>
      </div>
    </CardGridItem>
</CardGrid>

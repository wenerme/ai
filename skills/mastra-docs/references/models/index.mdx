---
title: "Models"
description: "Access 108+ AI providers and 3868+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 3868 models from 108 providers through a single API.

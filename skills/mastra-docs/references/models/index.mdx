---
title: "Models"
description: "Access 104+ AI providers and 3674+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 3674 models from 104 providers through a single API.

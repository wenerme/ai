---
title: "Models"
description: "Access 171+ AI providers and 5658+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 162 more</div>
      </div>
    </CardGridItem>
</CardGrid>

---
title: "Models"
description: "Access 107+ AI providers and 3878+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 3878 models from 107 providers through a single API.

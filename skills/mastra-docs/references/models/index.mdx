---
title: "Models"
description: "Access 94+ AI providers and 3415+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 3415 models from 94 providers through a single API.

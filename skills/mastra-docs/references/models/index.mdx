---
title: "Models"
description: "Access 136+ AI providers and 4495+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 128 more</div>
      </div>
    </CardGridItem>
</CardGrid>

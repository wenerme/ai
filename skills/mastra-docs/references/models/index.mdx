---
title: "Models"
description: "Access 112+ AI providers and 3911+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 104 more</div>
      </div>
    </CardGridItem>
</CardGrid>

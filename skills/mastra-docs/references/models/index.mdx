---
title: "Models"
description: "Access 172+ AI providers and 5959+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 5959 models from 172 providers through a single API.

---
title: "Models"
description: "Access 135+ AI providers and 4482+ models through Mastra's model router."
---
...
<CardGrid>
    ...
    >
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">+ 127 more</div>
      </div>
    </CardGridItem>
</CardGrid>

---
title: "Models"
description: "Access 156+ AI providers and 4851+ models through Mastra's model router."
---

# Model Providers

Mastra provides a unified interface for working with LLMs across multiple providers, giving you access to 4851 models from 156 providers through a single API.

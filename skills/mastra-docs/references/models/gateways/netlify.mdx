...
description: "Browse 260 Netlify model IDs and learn how to configure authentication and use the gateway in TypeScript with Mastra's model router."
---

# <NetlifyLogo className="inline w-8 h-8 mr-2 align-middle" />Netlify

Netlify AI Gateway provides unified access to multiple providers with built-in caching and observability. Access 260 models through Mastra's model router.

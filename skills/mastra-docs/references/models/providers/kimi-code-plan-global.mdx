---
title: "Kimi For Coding (kimi.ai) Models: IDs, Context & Usage"
description: "Browse Kimi For Coding (kimi.ai) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [Kimi For Coding (kimi.ai) logo]Kimi For Coding (kimi.ai)
...
<ProviderModelsTable
  ...
  {
    "model": "kimi-code-plan-global/kimi-for-coding-highspeed",
    "imageInput": true,
    "audioInput": false,
    "videoInput": true,
    "toolUsage": true,

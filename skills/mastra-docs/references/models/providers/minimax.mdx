---
title: "MiniMax (minimax.io) | Models"
description: "Use MiniMax (minimax.io) models with Mastra. 6 models available."
---
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [MiniMax (minimax.io) documentation](https://platform.minimax.io/docs/guides/quickstart) for details.

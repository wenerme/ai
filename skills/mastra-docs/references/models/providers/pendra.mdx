---
title: "Pendra Models: IDs, Context & Usage"
description: "Browse Pendra model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

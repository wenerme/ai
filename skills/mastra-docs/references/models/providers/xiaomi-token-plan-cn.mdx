---
title: "Xiaomi Token Plan (China) Models: IDs, Context & Usage"
description: "Browse Xiaomi Token Plan (China) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [Xiaomi Token Plan (China) logo]Xiaomi Token Plan (China)
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Xiaomi Token Plan (China) documentation](https://platform.xiaomimimo.com/#/docs) for details.

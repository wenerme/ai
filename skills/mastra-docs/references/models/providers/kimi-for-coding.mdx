...
Learn more in the [Kimi For Coding documentation](https://www.kimi.com/code/docs/en/kimi-code/models.html).
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Kimi For Coding documentation](https://www.kimi.com/code/docs/en/kimi-code/models.html) for details.

...
description: "Use Deep Infra models with Mastra. 57 models available."
---

# [Deep Infra logo]Deep Infra

Access 57 Deep Infra models through Mastra's model router. Authentication is handled automatically using the `DEEPINFRA_API_KEY` environment variable.

---
title: "IO.NET Models: IDs, Pricing & Usage"
description: "Browse IO.NET model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [IO.NET documentation](https://io.net/docs/guides/intelligence/io-intelligence) for details.

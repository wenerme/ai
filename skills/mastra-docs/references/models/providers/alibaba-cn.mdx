...
description: "Use Alibaba (China) models with Mastra. 77 models available."
---

# [Alibaba (China) logo]Alibaba (China)

Access 77 Alibaba (China) models through Mastra's model router. Authentication is handled automatically using the `DASHSCOPE_API_KEY` environment variable.

---
title: "Alibaba (China) Models: IDs, Pricing & Usage"
description: "Browse Alibaba (China) model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Alibaba (China) logo]Alibaba (China)

Access 88 Alibaba (China) models through Mastra's model router. Authentication is handled automatically using the `DASHSCOPE_API_KEY` environment variable.

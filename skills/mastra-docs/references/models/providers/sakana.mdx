---
title: "Sakana AI Models: IDs, Pricing & Usage"
description: "Browse Sakana AI model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Sakana AI logo]Sakana AI
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Sakana AI documentation](https://console.sakana.ai/models) for details.

---
title: "Lynkr Models: IDs, Context & Usage"
description: "Browse Lynkr model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

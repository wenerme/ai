---
title: "Wafer | Models"
description: "Use Wafer models with Mastra. 6 models available."
---

# [Wafer logo]Wafer

Access 6 Wafer models through Mastra's model router. Authentication is handled automatically using the `WAFER_API_KEY` environment variable.

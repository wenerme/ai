...
description: "Use Synthetic models with Mastra. 33 models available."
---
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Synthetic documentation](https://synthetic.new/pricing) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "synthetic/hf:Qwen/Qwen3.5-397B-A17B",
    "imageInput": true,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,
  ...
  {
    "model": "synthetic/hf:zai-org/GLM-5",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,

---
title: "MiniMax Token Plan (minimaxi.com) Models: IDs, Context & Usage"
description: "Browse MiniMax Token Plan (minimaxi.com) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [MiniMax Token Plan (minimaxi.com) logo]MiniMax Token Plan (minimaxi.com)

---
title: "MiniMax Token Plan (minimax.cn) Models: IDs, Context & Usage"
description: "Browse MiniMax Token Plan (minimax.cn) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [MiniMax Token Plan (minimax.cn) logo]MiniMax Token Plan (minimax.cn)

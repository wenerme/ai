---
title: "MiniMax Coding Plan (minimaxi.com) | Models"
description: "Use MiniMax Coding Plan (minimaxi.com) models with Mastra. 6 models available."
---

# [MiniMax Coding Plan (minimaxi.com) logo]MiniMax Coding Plan (minimaxi.com)

...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Privatemode AI documentation](https://docs.privatemode.ai) for details.

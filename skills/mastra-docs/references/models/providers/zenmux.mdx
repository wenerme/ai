---
title: "ZenMux | Models"
description: "Use ZenMux models with Mastra. 119 models available."
---

# [ZenMux logo]ZenMux

Access 119 ZenMux models through Mastra's model router. Authentication is handled automatically using the `ZENMUX_API_KEY` environment variable.
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [ZenMux documentation](https://docs.zenmux.ai) for details.

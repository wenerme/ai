---
title: "Standard Compute Models: IDs, Context & Usage"
description: "Browse Standard Compute model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [Standard Compute logo]Standard Compute

---
title: "SenseNova (China) Models: IDs, Context & Usage"
description: "Browse SenseNova (China) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---
...
<ProviderModelsTable
  ...
  {
    "model": "sensenova/deepseek-v4-pro",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,

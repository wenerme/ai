---
title: "Alibaba Coding Plan Models: IDs, Pricing & Usage"
description: "Browse Alibaba Coding Plan model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Alibaba Coding Plan logo]Alibaba Coding Plan
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Alibaba Coding Plan documentation](https://www.alibabacloud.com/help/en/model-studio/coding-plan) for details.

---
title: "MiniMax Coding Plan (minimax.io) | Models"
description: "Use MiniMax Coding Plan (minimax.io) models with Mastra. 6 models available."
---

# [MiniMax Coding Plan (minimax.io) logo]MiniMax Coding Plan (minimax.io)

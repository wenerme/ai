...
description: "Use NovitaAI models with Mastra. 99 models available."
---
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [NovitaAI documentation](https://novita.ai/docs/guides/introduction) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "novita-ai/qwen/qwen3.6-27b",
    "imageInput": true,
    "audioInput": false,
    "videoInput": true,
    "toolUsage": true,

---
title: "Tencent Coding Plan (China) Models: IDs, Context & Usage"
description: "Browse Tencent Coding Plan (China) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [Tencent Coding Plan (China) logo]Tencent Coding Plan (China)
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Tencent Coding Plan (China) documentation](https://cloud.tencent.com/document/product/1772/128947) for details.

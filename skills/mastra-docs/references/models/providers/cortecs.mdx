...
description: "Use Cortecs models with Mastra. 24 models available."
---

# [Cortecs logo]Cortecs

Access 24 Cortecs models through Mastra's model router. Authentication is handled automatically using the `CORTECS_API_KEY` environment variable.

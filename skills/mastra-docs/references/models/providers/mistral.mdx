---
title: "Mistral Models: IDs, Pricing & Usage"
description: "Browse Mistral model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Mistral logo]Mistral

Access 35 Mistral models through Mastra's model router. Authentication is handled automatically using the `MISTRAL_API_KEY` environment variable.

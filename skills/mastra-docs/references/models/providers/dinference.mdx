---
title: "DInference Models: IDs, Pricing & Usage"
description: "Browse DInference model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [DInference logo]DInference
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [DInference documentation](https://dinference.com) for details.

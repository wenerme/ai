...
description: "Use Together AI models with Mastra. 26 models available."
---

# [Together AI logo]Together AI

Access 26 Together AI models through Mastra's model router. Authentication is handled automatically using the `TOGETHER_API_KEY` environment variable.

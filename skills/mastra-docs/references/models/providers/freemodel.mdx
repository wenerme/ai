---
title: "FreeModel Models: IDs, Pricing & Usage"
description: "Browse FreeModel model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [FreeModel logo]FreeModel
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [FreeModel documentation](https://freemodel.dev) for details.

...
description: "Use OVHcloud AI Endpoints models with Mastra. 11 models available."
---

# [OVHcloud AI Endpoints logo]OVHcloud AI Endpoints

Access 11 OVHcloud AI Endpoints models through Mastra's model router. Authentication is handled automatically using the `OVHCLOUD_API_KEY` environment variable.
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [OVHcloud AI Endpoints documentation](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/catalog//) for details.

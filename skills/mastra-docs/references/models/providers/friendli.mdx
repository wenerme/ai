---
title: "Friendli Models: IDs, Pricing & Usage"
description: "Browse Friendli model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Friendli logo]Friendli
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Friendli documentation](https://friendli.ai/docs/guides/serverless_endpoints/introduction) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "friendli/zai-org/GLM-5.3",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,
  ...
  {
    "model": "friendli/zai-org/GLM-5.3-Flash",
    "imageInput": true,
    "audioInput": false,
    "videoInput": true,
    "toolUsage": true,

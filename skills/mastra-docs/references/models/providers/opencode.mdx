...
description: "Use OpenCode Zen models with Mastra. 58 models available."
---

# [OpenCode Zen logo]OpenCode Zen

Access 58 OpenCode Zen models through Mastra's model router. Authentication is handled automatically using the `OPENCODE_API_KEY` environment variable.

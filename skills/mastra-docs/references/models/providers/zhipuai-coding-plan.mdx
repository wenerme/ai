---
title: "Zhipu AI Coding Plan Models: IDs, Pricing & Usage"
description: "Browse Zhipu AI Coding Plan model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Zhipu AI Coding Plan logo]Zhipu AI Coding Plan
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Zhipu AI Coding Plan documentation](https://docs.bigmodel.cn/cn/coding-plan/overview) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "zhipuai-coding-plan/glm-5.3-highspeed",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,

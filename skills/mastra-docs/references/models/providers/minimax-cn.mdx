---
title: "MiniMax (minimax.cn) Models: IDs, Pricing & Usage"
description: "Browse MiniMax (minimax.cn) model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [MiniMax (minimax.cn) logo]MiniMax (minimax.cn)

---
title: "Xiaomi Token Plan (Europe) Models: IDs, Context & Usage"
description: "Browse Xiaomi Token Plan (Europe) model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [Xiaomi Token Plan (Europe) logo]Xiaomi Token Plan (Europe)
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Xiaomi Token Plan (Europe) documentation](https://platform.xiaomimimo.com/#/docs) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "xiaomi-token-plan-ams/mimo-v2.6-flash",
    "imageInput": true,
    "audioInput": true,
    "videoInput": true,
    "toolUsage": true,

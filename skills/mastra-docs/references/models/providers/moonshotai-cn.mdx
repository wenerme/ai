---
title: "Moonshot AI (China) Models: IDs, Pricing & Usage"
description: "Browse Moonshot AI (China) model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [Moonshot AI (China) logo]Moonshot AI (China)
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Moonshot AI (China) documentation](https://platform.moonshot.cn) for details.

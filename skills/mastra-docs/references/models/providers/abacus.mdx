---
title: "Abacus Models: IDs, Pricing & Usage"
description: "Browse Abacus model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Abacus documentation](https://abacus.ai) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "abacus/gemini-3-pro-image",
    "imageInput": true,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": false,
  ...
  {
    "model": "abacus/gemini-3.1-flash-image",
    "imageInput": true,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": false,
  ...
  {
    "model": "abacus/gemini-3.5-flash-lite",
    "imageInput": true,
    "audioInput": true,
    "videoInput": false,
    "toolUsage": true,
  ...
  {
    "model": "abacus/moonshotai/Kimi-K2.7-Code",
    "imageInput": true,
    "audioInput": false,
    "videoInput": true,
    "toolUsage": true,
  ...
  {
    "model": "abacus/thinkingmachines/Inkling",
    "imageInput": true,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,

---
title: "Abacus | Models"
description: "Use Abacus models with Mastra. 65 models available."
---
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Abacus documentation](https://abacus.ai) for details.

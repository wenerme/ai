---
title: "iFlow Models: IDs, Context & Usage"
description: "Browse iFlow model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [iFlow documentation](https://platform.iflow.cn/en/docs) for details.

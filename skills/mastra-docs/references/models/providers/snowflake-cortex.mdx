---
title: "Snowflake Cortex Models: IDs, Context & Usage"
description: "Browse Snowflake Cortex model IDs, capabilities, and context windows. Learn how to use them in TypeScript with Mastra's model router."
---

# [Snowflake Cortex logo]Snowflake Cortex
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Snowflake Cortex documentation](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-rest-api) for details.
...
<ProviderModelsTable
  ...
  {
    "model": "snowflake-cortex/claude-opus-5",
    "imageInput": true,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,

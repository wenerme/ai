---
title: "Zhipu AI | Models"
description: "Use Zhipu AI models with Mastra. 10 models available."
---
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Zhipu AI documentation](https://docs.z.ai/guides/overview/pricing) for details.

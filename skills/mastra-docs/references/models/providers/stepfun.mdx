---
title: "StepFun (China) Models: IDs, Pricing & Usage"
description: "Browse StepFun (China) model IDs, capabilities, context windows, and pricing. Learn how to use them in TypeScript with Mastra's model router."
---

# [StepFun (China) logo]StepFun (China)
...
> **note**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [StepFun (China) documentation](https://platform.stepfun.com/docs/zh/overview/concept) for details.

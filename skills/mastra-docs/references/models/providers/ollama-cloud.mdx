...
description: "Use Ollama Cloud models with Mastra. 38 models available."
---

# [Ollama Cloud logo]Ollama Cloud

Access 38 Ollama Cloud models through Mastra's model router. Authentication is handled automatically using the `OLLAMA_API_KEY` environment variable.
...
> **info**: Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Ollama Cloud documentation](https://docs.ollama.com/cloud) for details.

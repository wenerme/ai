...
欢迎订阅 [Telegram 频道](https://t.me/StashFeed) 或关注 [X (Twitter)](https://x.com/StashAppDev) 以获取最新消息。

欢迎加入 [Telegram 讨论组](https://t.me/StashFans)，与数万名 Stash 用户在线交流。
...
[<img width="150" src="/app-store/Download_on_the_App_Store_Badge_CNSC_RGB_wht_092917.svg"/>](https://apps.apple.com/app/stash/id1596063349?platform=iphone&l=zh-CN)

## Stash on tvOS

Stash 已经上架于 tvOS App Store。

[<img width="150" src="/app-store/Download_on_Apple_TV_Badge_CNSC_RGB_wht_092917.svg"/>](https://apps.apple.com/app/stash/id1596063349?platform=appleTV&l=zh-CN)

## Stash on macOS

Stash Mac 版本专为 macOS 平台设计，欲了解更多详情，请[点击这里](/stash-mac)。

[请点击这里查看 Stash Mac 的价格信息](https://stash.ws/macos/pricing/)

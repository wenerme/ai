...
This integration lets you build automations in Zapier that create or update Linear records when events happen in other apps or in Linear.
...
<details>
<summary>My comment trigger is not working?</summary>
It triggers on new comments, not comment edits.
</details>

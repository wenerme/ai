...
`Shift` `S` to subscribe to or unsubscribe from selected issues

`Cmd/Ctrl` `Shift` `S` to manage subscribers for selected issues
...
Assigned issues are grouped in a focus order such as urgent work, SLA-bound work, blockers, cycle work, other active work, triage, backlog, and completed work. Some sections only appear when they apply.

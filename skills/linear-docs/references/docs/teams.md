...
Each team includes a team page for team-level resources such as team documents plus pages to organize the team's work:
...
Every team will have a home view to provide the landing page for your team. It gives members a place to create and organize team-level resources, pin important documents and links, and quickly access common team views.

Open any team's home page by clicking on the team's name in your sidebar, or search for a team by pressing `o`, then `t`. From a team's home page, you can pin any resource that exists in its projects or issues within the team, or create a new resource at the team level.

![Team home landing view in Linear showing pinned resources and quick links](https://webassets.linear.app/images/ornj730p/production/1be99fe3cc12b90fb1705763e8e25ff45a9c84a2-1806x911.png?q=95&auto=format&dpr=2)
...
* **Issues are tied to teams**. Think about how you prefer to manage your work and interact with features such as the backlog and archive. Issue sharing can be enabled for public teams, allowing issues from that team to be shared with guests who are not members of the team.

...
### Configure from Salesforce AgentExchange

1. Install the Linear integration from the Salesforce Marketplace
2. Find the **Linear Development** app in the Salesforce **App Launcher**. In order to see this app in the menu launcher, you must have been granted a license to use this integration.
...
Automatically notify your team in Salesforce when an issue linked to a case has been completed or cancelled. Changes will be added to the _All updates_ section of a case.

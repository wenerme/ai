...
Our Zendesk integration lets you create Linear issues from Zendesk or link existing issues to your Zendesk tickets. When linked, Linear issue information is shown inside Zendesk and a link to Zendesk is added to your Linear issue. Automate updates to Zendesk tickets when their related Linear issues are closed (Done or Canceled). Our integration will also re-open the ticket so that your agents will be able to notify the customers.
...
Create a new issue from the Zendesk widget. It will bring up a form which requires a title and a team. Optionally add priority, assignee, or labels from within Zendesk.
...
In the integration settings page, you can automate the reopening of the linked issue when it's completed, canceled, or a comment is made. The integration will post an internal note and re-open the conversation in Zendesk so it's easy to follow up with customers.

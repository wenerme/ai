...
When you move unassigned issues to started, it will automatically assign to you.

For git-related preferences — including Git attachment format and on-branch-copy behaviors — see the [Code & Reviews](https://linear.app/docs/code-and-reviews) account settings page.

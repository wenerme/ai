...
Timeline views are a project planning tool that allows you to visualize and manage projects across time. Timeline is specifically designed to only surface projects to keep project planning work cleanly separated from granular issue implementation.
...
* Use [milestones](https://linear.app/docs/project-milestones) to mark important in-project checkpoints
...
* Plan more effectively across product, engineering, and GTM teams.
...
3. Customize visible project properties such as milestones, dependencies, lead, members, priority, status, and health.
4. Show team cycles as an overlay on the timeline.

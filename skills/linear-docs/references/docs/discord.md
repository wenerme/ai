...
Combine Linear with Discord to keep everyone in sync.
...
A Linear admin must first enable the integration for the workspace. Once they have, you can go to [Settings > Integrations > Discord](https://linear.app/settings/integrations/discord) to connect your Discord account to Linear. Every Linear user must individually link their account in order to use the Linear integration in Discord.

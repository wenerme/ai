...
> **note**: This option is only available if an SMTP server has been configured in the administrator settings.
...
> **tip**: The system administrator can see the usage quota percentage of all users in Server Stats page.

> **info**: External libraries don't take up space from the storage quota.

...
> **note**: For the full list, refer to the [Immich source code](https://github.com/immich-app/immich/blob/main/server/src/utils/mime-types.ts).
...
| `JPEG`      | `.jfif` `.jpeg` `.jpg` `.jpe` `.insp` | :white_check_mark: |                 |

...
> **tip**: In Administration > Settings is a button to copy the current configuration to your clipboard.
So you can just grab it from there, paste it into a file and you're pretty much good to go.

### Step 2 - Specify the file location

> **note**: If you have any `microservices` workers, they will also need to have the config file mounted to their container.

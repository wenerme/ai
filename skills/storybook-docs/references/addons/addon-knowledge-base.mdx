...
> Code snippet: `_snippets/storybook-addon-disable-addon.md`

Then when adding a story, you can pass a disabled parameter.

> Code snippet: `_snippets/button-story-disable-addon.md`
...
> Code snippet: `_snippets/storybook-addon-load-external-addons-preset.md`

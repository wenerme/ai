...
> Code snippet: `_snippets/storybook-addons-local-preset.md`
...
> Code snippet: `_snippets/storybook-addons-root-preset.md`
...
> Code snippet: `_snippets/storybook-addons-preset-babelDefault.md`
...
> Code snippet: `_snippets/storybook-addons-preset-viteFinal.md`
...
> Code snippet: `_snippets/storybook-addons-preset-webpackFinal.md`
...
> Code snippet: `_snippets/storybook-addons-root-preset-manager-entries.md`
...
> Code snippet: `_snippets/storybook-addons-preset-preview.md`
...
> Code snippet: `_snippets/storybook-main-advanced-config-example.md`
...
> Code snippet: `_snippets/storybook-main-register-example-addon.md`
...
> Code snippet: `_snippets/main-config-preview.md`
...
> Code snippet: `_snippets/storybook-custom-manager-head.md`

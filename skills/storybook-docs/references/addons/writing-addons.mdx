...
> Code snippet: `_snippets/storybook-addon-toolkit-types.md`
...
> Code snippet: `_snippets/storybook-addon-run-dev-mode.md`
...
> Code snippet: `_snippets/storybook-addon-tool-initial-setup.md`
...
> Code snippet: `_snippets/storybook-addon-manager-initial-state.md`
...
> Code snippet: `_snippets/storybook-addon-css-helpers.md`

Next, create the file with the styles we want to inject with the following content:

> Code snippet: `_snippets/storybook-addon-css-example.md`
...
> Code snippet: `_snippets/storybook-addon-use-global.md`
...
> Code snippet: `_snippets/storybook-addon-release.md`

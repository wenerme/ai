...
> Code snippet: `_snippets/typed-csf-file.md`
...
> **Renderer: `['angular', 'web-components']`**
...
You can use the [`satisfies`](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-9.html) operator to get stricter type checking. TypeScript will then report missing required args as well as invalid ones.

...
| `manifest` | Yes                 | Stories and docs tagged with `manifest` are included in the [component or docs manifests](../ai/manifests.mdx), on the [frameworks that generate them](../ai/mcp/overview.mdx#framework-support).                                                             |

...
| `-h`, `--host [string]`         | Host to run Storybook. Setting this to `0.0.0.0` binds to all network interfaces. <br/>Extend it with [`core.allowedHosts`](./main-config/main-config-core.mdx#allowedhosts) to restrict which hosts can access your Storybook instance.<br />`storybook dev -h my-host.com` |
...
| `--open`                        | Open Storybook automatically in the browser.<br />`storybook dev --open`                                                                                                                                                                                                     |

...
> Code snippet: `_snippets/main-config-typescript-check.md`
...
> Code snippet: `_snippets/main-config-typescript-check-options.md`
...
> Code snippet: `_snippets/main-config-typescript-react-docgen.md`
...
> Code snippet: `_snippets/main-config-typescript-react-docgen-typescript-options.md`
...
> Code snippet: `_snippets/main-config-typescript-skip-compiler.md`

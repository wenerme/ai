...
> Code snippet: `_snippets/main-config-stories.md`
...
> Code snippet: `_snippets/main-config-stories-ordered.md`
...
> Code snippet: `_snippets/main-config-stories-with-object.md`
...
> Code snippet: `_snippets/main-config-stories-with-logic.md`

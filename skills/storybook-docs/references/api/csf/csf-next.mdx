...
> **Except renderer: `['react', 'vue', 'angular', 'web-components']`**
...
> **Renderer: `['react', 'vue', 'angular', 'web-components']`**
...
> Code snippet: `_snippets/csf-factories-automigrate.md`

#### Monorepos

If your project has multiple Storybook configurations, run the command with the `-c` flag pointing to each config directory:

> Code snippet: `_snippets/csf-factories-automigrate-with-config-directory.md`
...
> Code snippet: `_snippets/portable-stories-csf-factory-render.md`

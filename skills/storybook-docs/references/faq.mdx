...
> Code snippet: `_snippets/angular-framework-options-enable-ivy-false.md`

## How can I opt-out of Angular ngcc?

In case you postinstall ngcc, you can disable it:

> Code snippet: `_snippets/angular-framework-options-enable-ngcc-false.md`
...
If your project is set up within a monorepo, or uses a package manager with a non-standard `node_modules` layout (such as pnpm), you might run into issues with module resolution similar to this when running Storybook:
...
> Code snippet: `_snippets/storybook-main-pnpm-with-module-resolution.md`
...
> Code snippet: `_snippets/react-framework-options-legacy-root-api.md`
...
> Code snippet: `_snippets/main-config-stories-only-mdx.md`

...
- Ecosystem updates
  ...
  - [Preact 10.8.0 or higher](https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#preact-require-v1080-and-up)
  ...
  - [Raised browser support floors for the manager UI](https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#raised-browser-support-floors)
- Changed defaults
  - [`storybook dev` no longer opens a browser by default](https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#storybook-dev-no-longer-opens-a-browser-by-default)
  - [Docs Code panel enabled by default](https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#docs-code-panel-enabled-by-default)
...
- Package removals
  - [`@storybook/react-dom-shim` removed](https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#storybookreact-dom-shim-removed)

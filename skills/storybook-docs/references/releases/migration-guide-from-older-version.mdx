---
title: Migration guide from Storybook 9.x to 10.6
sidebar:
  order: 2
  title: Migrate from 9 to 10
---
...
- [Storybook 8.x to 9.1](../../../release-9-1/docs/migration-guide/index.mdx)
- [Storybook 7.x to 8.6](../../../release-9-1/docs/migration-guide/from-older-version.mdx)
...
> Code snippet: `_snippets/storybook-upgrade-to-prior-major.md`
...
> Code snippet: `_snippets/create-command-for-prior-major.md`

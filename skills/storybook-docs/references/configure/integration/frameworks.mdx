...
| Builder | Framework                                                                  |
| ------- | -------------------------------------------------------------------------- |
| Webpack | React, Angular, Vue 3, Web Components, NextJS, HTML, Ember, Svelte         |
| Vite    | React, Preact, Vue 3, Web Components, HTML, Svelte, SvelteKit, Qwik, Solid |
...
> Code snippet: `_snippets/main-config-framework.md`

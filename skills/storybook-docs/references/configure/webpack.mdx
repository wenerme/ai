...
> Code snippet: `_snippets/my-component-story-import-static-asset.md`

### Import JSON as JavaScript

You can import `.json` files and have them expanded to a JavaScript object:

> Code snippet: `_snippets/my-component-story-import-json.md`
...
> Code snippet: `_snippets/storybook-main-webpack5.md`
...
> Code snippet: `_snippets/storybook-main-webpack5-lazyCompilation.md`
...
> Code snippet: `_snippets/storybook-main-webpack5-fsCache.md`

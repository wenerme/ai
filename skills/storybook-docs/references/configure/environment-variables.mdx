...
> **Renderer: `['angular', 'ember' ]`**

> Code snippet: `_snippets/storybook-read-environment-variables.md`



> **Renderer: `['html', 'react', 'qwik', 'preact','svelte', 'solid', 'vue', 'web-components' ]`**
...
> Code snippet: `_snippets/my-component-with-env-variables.md`
...
> Code snippet: `_snippets/my-component-vite-env-variables.md`
...
> Code snippet: `_snippets/my-component-env-var-config.md`

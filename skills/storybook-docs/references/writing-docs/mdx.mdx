...
> Code snippet: `_snippets/checkbox-story.md`
...
> Code snippet: `_snippets/checkbox-story-csf.md`
...
> Code snippet: `_snippets/storybook-auto-docs-mdx-docs-imports.md`

Imports the components and stories that will be used in the JSX throughout the rest of the file.

> Code snippet: `_snippets/storybook-auto-docs-mdx-docs-meta-block.md`
...
> Code snippet: `_snippets/storybook-auto-docs-mdx-docs-definition.md`
...
> Code snippet: `_snippets/storybook-auto-docs-mdx-docs-story.md`
...
> Code snippet: `_snippets/storybook-auto-docs-mdx-docs-dos-donts.md`
...
> Code snippet: `_snippets/storybook-auto-docs-main-mdx-config.md`
...
> Code snippet: `_snippets/storybook-auto-docs-baseline-example.md`
...
> Code snippet: `_snippets/storybook-auto-docs-mdx-docs-docs-only-page.md`
...
> Code snippet: `_snippets/storybook-auto-docs-custom-file.md`
...
> Code snippet: `_snippets/storybook-auto-docs-standalone-page.md`
...
> Code snippet: `_snippets/storybook-auto-docs-starter-example.md`
...
> Code snippet: `_snippets/storybook-auto-docs-mdx-file.md`
...
> Code snippet: `_snippets/storybook-custom-docs-markdown.md`
...
> Code snippet: `_snippets/storybook-main-config-remark-options.md`

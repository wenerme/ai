...
> Code snippet: `_snippets/your-component.md`
...
- [Presets](../addons/addon-types.mdx) bundle common configurations for various technologies into Storybook. In particular, presets exist for Ant Design.
...
> **Renderer: `[ 'react', 'preact', 'react-native', 'solid' ]`**
...
> **Except renderer: `[ 'react', 'preact', 'react-native', 'solid' ]`**

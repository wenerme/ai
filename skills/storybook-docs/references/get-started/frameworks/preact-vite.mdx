...
> Code snippet: `_snippets/preact-vite-install.md`

Then, update your `.storybook/main.js|ts` to change the framework property:

> Code snippet: `_snippets/preact-vite-add-framework.md`
...
> Code snippet: `_snippets/preact-vite-framework-options.md`

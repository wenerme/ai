...
**`@storybook/nextjs` is deprecated and will be removed in Storybook 12.** Migrate to [`@storybook/nextjs-vite`](./nextjs-vite.mdx) — the automigration is available via `storybook upgrade` (accept the fix) or `storybook migrate nextjs-to-nextjs-vite`. See the [migration instructions](./nextjs-vite.mdx#how-do-i-migrate-from-the-nextjs-webpack-5-addon) for details.
...
> Code snippet: `_snippets/nextjs-image-static-dirs.md`
...
> Code snippet: `_snippets/nextjs-configure-svgr.md`
...
> Code snippet: `_snippets/nextjs-install.md`

Then, update your `.storybook/main.js|ts` to change the framework property:

> Code snippet: `_snippets/nextjs-add-framework.md`

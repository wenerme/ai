...
[A configuration panel for a CI trigger for token 4e19 showing UPLOAD_TO_CI set to true]
...
1. To the left of the trigger token you want to revoke, select **Revoke** ().

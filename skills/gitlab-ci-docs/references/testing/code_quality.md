...
[Lines in a merge request's changes tab marked with a symbol to indicate code quality issues]
...
[List of all issues in the branch, ordered by decreasing severity]
...
[Total number of issues, called violations, followed by the number of issues of each severity]

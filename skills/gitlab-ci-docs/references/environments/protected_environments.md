...
1. Use the UI to [create a new group](../../user/group/_index.md#create-a-group).
   ...
   [Protected access group interface with the New project button highlighted.]
...
To resolve this issue, add the `environment` keyword directly to the trigger job.

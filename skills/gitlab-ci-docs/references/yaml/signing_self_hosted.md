# Sign artifacts and container images with self-hosted Sigstore

Sign CI/CD artifacts and container images with a self-hosted Sigstore stack, including Fulcio configuration and troubleshooting.

...
Refer to our [Security Center API documentation](https://developers.cloudflare.com/api/resources/security_center) to review the action item audit logs by account, domain, or a specific `issue_id`.

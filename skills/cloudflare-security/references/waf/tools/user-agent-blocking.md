...
Last updated Aug 3, 2026|Copy as Markdown|[View as Markdown](https://developers.cloudflare.com/waf/tools/user-agent-blocking/index.md)|[Agent setup](https://developers.cloudflare.com/agent-setup/)

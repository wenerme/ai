...
3. Enter a descriptive name for the rule in **Rule name**.![Custom rule creation page in the Cloudflare dashboard](https://developers.cloudflare.com/cdn-cgi/image/onerror=redirect,width=870,height=535,format=webp/_astro/firewall-custom-rule-create.tVXiVklq.png)

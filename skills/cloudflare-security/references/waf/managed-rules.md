...
[Attack Signature Detection](https://developers.cloudflare.com/waf/detections/attack-signature-detection/#compare-attack-signature-detection-and-managed-rules) uses the same signatures as Cloudflare Managed Rules. It records match metadata without applying an action by itself.

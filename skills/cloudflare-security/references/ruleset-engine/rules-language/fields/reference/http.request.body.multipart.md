---
title: http.request.body.multipart
description: A Map (or associative array) representation of multipart names to multipart values in the request body.

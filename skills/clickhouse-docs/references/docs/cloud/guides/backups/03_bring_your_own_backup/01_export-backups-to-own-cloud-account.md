...
> **note**: Any usage where backups are being exported to a different region in the same cloud provider will incur [data transfer](/cloud/manage/network-data-transfer) charges.  

Cross-Cloud backups are only supported via the backup/restore commands outlined on this page, and not via the UI.

> **warning**: **Performance impact vs. in-place backups**  

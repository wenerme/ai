...
> **important**: AWS PrivateLink supports only connections initiated from your AWS VPC to ClickHouse Cloud. It can't be used for connections initiated from ClickHouse Cloud to services in your VPC, such as a [private database](#connecting-to-a-remote-database).

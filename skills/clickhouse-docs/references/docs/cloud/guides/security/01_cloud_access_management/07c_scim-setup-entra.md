...
<strong>Do I need SAML SSO before I can use SCIM?</strong>
...
<strong>Can I use the same enterprise application for SAML and SCIM?</strong>

Yes. With SAML-based SSO, a single Entra ID enterprise application handles both single sign-on and SCIM provisioning.

<strong>Why is the Secret Token formatted as <code>key:secret</code>?</strong>
...
<strong>How quickly do changes in Entra ID show up in ClickHouse Cloud?</strong>
...
<strong>Where do I get help if I'm stuck?</strong>

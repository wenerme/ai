...
> **note**: Mixing of AWS accounts, GCP projects and Azure subscriptions under the same organization is only possible for customers who aren't set up through a [cloud service provider marketplace](/cloud/marketplace/marketplace-billing).

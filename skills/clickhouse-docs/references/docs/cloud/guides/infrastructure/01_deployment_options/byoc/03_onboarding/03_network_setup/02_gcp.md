...
> **note**: The example steps are for a simple scenario, for advanced scenarios such as peering with on-premises connectivity, some adjustments may be required.
...
> **note**: If you want to allow access from an existing PSC connection, use the existing endpoint dropdown menu.

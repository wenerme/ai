...
> **tip**: Upon the first successful invoice payment, the threshold is raised to \$5,000 USD. A second successful invoice payment raises the threshold to \$10,000 USD. If you wish to adjust your payment threshold amount, [contact support](mailto:support@clickhouse.com). 
...
> **note**: Payment threshold notifications are currently only supported for orgs being billed in arrears (PAYG)

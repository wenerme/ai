...
> **note**: You can’t share another organization’s credit card.
...
> **note**: Your use of ClickHouse Cloud requires your organization to have at least one active and valid billing method configured (either marketplace subscription or credit card). See more information on billing compliance [here](/manage/clickhouse-cloud-billing-compliance#billing-compliance).
...
> **note**: After configuring a backup credit card, you will also have the option to click on the button to edit your credit card and set it as the primary payment method.

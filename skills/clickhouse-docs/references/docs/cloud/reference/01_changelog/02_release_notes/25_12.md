...
> **note**: This section contains a selected subset of important bug fixes. For the complete list of all bug fixes in this release, please refer to the [full changelog](https://github.com/ClickHouse/ClickHouse/blob/master/CHANGELOG.md)

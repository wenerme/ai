...
> **note**: This object should be closed as soon as possible to release a connection because the connection can't be re-used until all data of previous response is fully read.

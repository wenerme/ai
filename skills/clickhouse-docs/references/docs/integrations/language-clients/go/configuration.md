...
> **tip**: For a complete per-option deep dive with defaults, DSN parameters, best practices, and troubleshooting, see [Configuration Reference](/integrations/language-clients/go/config-reference).

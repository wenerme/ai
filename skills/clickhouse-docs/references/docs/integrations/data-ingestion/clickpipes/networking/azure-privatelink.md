...
> **info**: Support for Azure Private Link is planned. [Contact ClickHouse support](https://clickhouse.com/support/program) for updates on the timeline for this feature.

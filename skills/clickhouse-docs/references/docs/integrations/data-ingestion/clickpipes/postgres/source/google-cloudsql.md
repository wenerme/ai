...
> **note**: If your are using SSH Tunneling, then you need to add the [ClickPipes IPs](/integrations/clickpipes/networking/static-ips) to the firewall rules of the Jump Server/Bastion.

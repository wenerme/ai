...
> **note**: ClickPipes doesn't support Azure Private Link yet. To reach an instance that doesn't allow public access, use an SSH tunnel. For more information, see [ClickPipes networking](/integrations/clickpipes/networking).

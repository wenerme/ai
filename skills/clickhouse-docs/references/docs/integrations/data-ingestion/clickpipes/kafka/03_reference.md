...
> **note**: `Array`, `Map`, and `Nullable` variants of all basic types are also supported.
...
> **tip**: For numeric types, exact matching is recommended to avoid overflows or precision loss.

...
> **tip**: Use a long, random password (at least 16 characters), ideally generated by a password manager.
...
> **note**: - For ClickHouse Cloud, connection details can be found in your cloud console

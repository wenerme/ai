...
> **note**: Make sure you download the [clickhouse-jdbc-X.X.X-all-dependencies.jar](https://github.com/ClickHouse/clickhouse-java/releases) JAR file. This artifact is available from version `0.9.2`.
...
> **note**: Don't see the **ClickHouse by ClickHouse** connector in your connectors list? It might be related to an old Tableau Desktop version.
...
> **note**: Our ClickHouse database is named **TPCD**, but you must set the **Database** to **default** in the dialog above, then

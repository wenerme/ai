...
> **note**: We recommend running the command below from a new and empty subdirectory as
...
> **note**: For Mac users: If you're getting errors that the developer of the binary can't

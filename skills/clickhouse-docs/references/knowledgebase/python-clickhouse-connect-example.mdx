...
> **note**: Keep in mind that Python versions and libraries dependencies are constantly evolving. Make also sure to use the latest supported versions of both the driver and Python environment when trying this.
...
> **tip**: If using an older Python version (e.g. `3.9.6`) you might be getting an `ImportError` related to `urllib3` library.

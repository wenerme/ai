...
> **note**: If you installed ClickHouse from a **.deb/.rpm/.tgz** you can also install the package with the debug info to see the line numbers from the source code:
...
> **tip**: For more high-level information, check out some of these other system tables:

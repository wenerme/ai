...
> **note**: This guide assumes that the `<path>` parameter in your config.xml file is set to:
...
> **note**: This command ensures that both the **metadata files**, and the symlink architecture are preserved in the backup.

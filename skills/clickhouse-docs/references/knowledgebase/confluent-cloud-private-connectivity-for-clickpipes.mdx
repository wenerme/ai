...
> **warning**: You cannot currently complete this Confluent Cloud setup with only the ClickHouse Cloud console.
...
> **note**: The `*.{region}.{cloud}.accesspoint.glb.confluent.cloud` mapping is broad and is unique per cloud and region.

...
> **note**: Specifying the settings this way will overwrite the current settings of the user i.e if you had other settings applied to the user but did not specify them in the `ALTER USER` statement, they will be lost.

...
For a more detailed description together with a syntax diagram, see the [page on the `INSERT` statement](https://duckdb.org/docs/current/sql/statements/insert.html).

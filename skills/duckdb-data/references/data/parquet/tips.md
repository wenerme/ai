...
Using a [glob pattern](https://duckdb.org/docs/current/data/multiple_files/overview.html#glob-syntax) upon read or a [Hive partitioning](https://duckdb.org/docs/current/data/partitioning/hive_partitioning.html) structure are good ways to transparently handle multiple files.
...
See the [Performance Guide on “File Formats”](https://duckdb.org/docs/current/guides/performance/file_formats.html#parquet-file-sizes) for more tips.

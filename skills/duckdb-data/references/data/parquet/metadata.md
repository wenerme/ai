...
DuckDB [supports Bloom filters](https://duckdb.org/2025/03/07/parquet-bloom-filters-in-duckdb.html) for pruning the row groups that need to be read to answer highly selective queries.

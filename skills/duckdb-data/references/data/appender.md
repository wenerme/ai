...
For more information, see the [C++ client](https://duckdb.org/docs/current/clients/cpp.html).
...
For more information, see the [Java Appender API](https://duckdb.org/docs/current/clients/java/data_import.html#appender).
...
For more information, see the [Rust Appender API](https://duckdb.org/docs/current/clients/rust/data_import.html#appender).

### C

For more information, see the [C Appender API](https://duckdb.org/docs/current/clients/c/appender.html).
...
You can change this by explicitly using [transactions](https://duckdb.org/docs/current/sql/statements/transactions.html) and surrounding your batches of appended rows by `BEGIN TRANSACTION` and `COMMIT` statements.

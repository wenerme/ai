...
This is equivalent to the SQL construct [`UNION ALL`](https://duckdb.org/docs/current/sql/query_syntax/setops.html#union-all).
...
This is equivalent to the SQL construct [`UNION ALL BY NAME`](https://duckdb.org/docs/current/sql/query_syntax/setops.html#union-all-by-name).

...
See the [combining schemas](https://duckdb.org/docs/current/data/multiple_files/combining_schemas.html) page for tips on reading files with different schemas.

...
#### Count Queries
> **note**: The optimizer accelerates queries that count total records.
...
#### Histogram Queries
> **note**: The optimizer accelerates queries that generate histogram data grouped by time intervals.
...
#### Top N Queries
> **note**: The optimizer accelerates queries that retrieve the top N results based on count, ordered in descending order.
...
#### Distinct Queries
> **note**: The optimizer accelerates queries that retrieve distinct values for a field.

...
To navigate to users in OpenObserve , select preferred organization using organization selection control, then click on [Users] menu , which will take one to users list screen. The screen lists all users for selected organization.  

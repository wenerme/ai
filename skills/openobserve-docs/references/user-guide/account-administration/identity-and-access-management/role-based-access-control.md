...
[Custom role editor permission list showing the LLM Evaluations resources (LLM Providers, Score Configs, Scorers, Online Eval Jobs)]
...
[Entity selection for LLM Providers within the custom role editor]

...
Administrators of the `_meta` organization can view every organization's AI credit consumption and set each organization's credit allowance from the **Organization Management** page. 

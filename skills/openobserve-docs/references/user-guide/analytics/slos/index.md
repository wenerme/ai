...
[SLO list page showing status, budget remaining, burn rate, coverage, and window for each SLO]
...
[New SLO form with the SLI type selector, count configuration, objective, and live preview]
...
[SLO detail page with status tiles and the error budget burndown and burn rate charts]
...
[Configuration tab of an SLO showing SLI type, target, slice interval, grouping, reservation, and owner]

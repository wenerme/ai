...
[New SLO form configured as a time-slice SLI, with aggregate, comparator, threshold, and the slice-value preview]
...
[New time-slice SLO over a metrics stream using a PromQL histogram quantile]

...
[New SLO form configured as a count SLI, with scope, good-when predicate, and the good/bad events preview]
...
> **warning**: SQL can query a metrics stream, but counting its rows usually counts **samples**,
...
[New count SLO over a metrics stream using separate good and total PromQL expressions]
...
> **note**: The selected metrics stream supplies the available **Group by** labels. PromQL
...
[SLO detail page for the api-gateway availability count SLO]

...
[New SLO form configured as an alert-based SLI, with the source alert picker and the measured-uptime preview]
...
[Source alert picker showing one eligible alert and several greyed-out ineligible alerts with reasons]
...
[Alert-based SLO detail page showing the Measuring since banner and the measured uptime timeline]

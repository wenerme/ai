...
[Config panel showing the Configure column formatting button in Field Overrides section]
...
[Column Formatting dialog empty state with Add field dropdown]
...
[Column Formatting dialog with a field selected, showing the three-pane layout]
...
[conditional styling section with multiple rules defined]
...
[a table panel with column filter dropdown open showing checkbox list]

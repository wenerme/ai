...
[Alerts list page with folders, type filter tabs, and alert management table]
...
[Alert creation form showing the two-tab layout with condition sentence, preview, and summary panels]
...
[Advanced tab showing Compare with Past, Deduplication, and Additional Settings sections]

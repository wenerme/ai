...
[Composite alerts list showing the Composite type badge, child counts, and reference chips]
...
[Composite alert form showing the sub-alert selector, trigger expression builder, and child behavior settings]
...
[Advanced expression view showing the raw alert-ID expression form]
...
[Edit composite alert form with the alert type locked and pre-populated expression and children]
...
[Composite alert detail showing the current evaluation, child cards, status timeline, and settings]
...
[Composite references drawer listing the parent composites of a referenced alert]

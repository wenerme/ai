...
[Anomaly Detection list showing configured rules with status, schedule, and training information]
...
[Detection Config tab showing query builder, scheduling parameters, sensitivity chart with Anomaly Score Range slider, and configuration summary]
...
[SQL mode showing the query editor with validation requirements]
...
[Alerting tab showing notifications enabled with a Slack destination configured]
...
1. Navigate to **Alerts > Anomalies** and click **New alert**.
    ...
    [New anomaly detection form showing stream selection, detection config fields, and Save & Train button]
...
[Action menu showing Move, Delete, Export, Trigger Detection, and Re-train options]

...
[Count mode showing "Alert if total events >= 3 matching logs found" with Check every and filters]
...
[Function dropdown showing all available options with tooltip]
...
[SQL mode with editor, Open Full Editor button, and threshold controls]

...
[Empty alert creation form with top bar fields and two-tab layout]
...
[Alert form in count mode showing "Alert if total events >= 3 matching logs found" with preview and summary]
...
[Alert form with a filter condition row added]
...
[Settings section with look back window, cooldown period, destination selector, and creates incident toggle]
...
[SQL mode with inline editor, Open Full Editor button, and threshold controls]
...
[Advanced tab with Compare with Past, Deduplication, and Additional Settings sections]

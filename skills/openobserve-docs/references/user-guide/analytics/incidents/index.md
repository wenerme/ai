...
[Incidents list showing all incidents with severity, status, and alert counts]
...
[Incident detail Overview tab showing hero metrics, incident timeline, alert activity chart, and management panel]
...
[AI-powered Incident Analysis with table of contents and structured report]
...
[Activity timeline showing status changes, AI analysis events, and user actions]
...
[Alert Triggers table showing correlated alerts with firing times and correlation reasons]
...
[Alert Graph showing root cause node (red) connected to downstream alert (blue) via a temporal relationship edge]

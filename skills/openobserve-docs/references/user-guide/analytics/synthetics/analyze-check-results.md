...
[Browser check results with the status timeline, key metric tiles, charts, and runs table]
...
[Steps tab ranking journey steps by fail rate, flaky rate, and duration]
...
[Run detail showing the failing step, its screenshot, and the error message]

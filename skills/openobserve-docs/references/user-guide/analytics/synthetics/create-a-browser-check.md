...
??? "Step 1: Start a new browser check"
    ...
    [Create a Check dialog listing Browser Test and the other check types]
    ...
    [New browser check screen with the Starting URL and Name fields]
...
??? "Step 2: Set up the recorder"
    ...
    [Set up the recorder screen with the install and incognito steps]
    ...
    [Both recorder setup steps complete, with Open and Record enabled]
    ...
    [Recorder attached to an incognito window, showing a captured selector for a link]
...
??? "Step 3: Build the journey"
    ...
    [Empty journey with the Record journey and Add a step manually buttons]
    ...
    [Journey editor recording live, with steps appearing and a Stop button]
    ...
    [Recorded journey of ten steps with the first step expanded]
    ...
    [Journey step expanded with the Action list open]
...
??? "Step 4: Configure the check"
    ...
    [Check Details and Authentication and Network sections of the configure stage]
...
??? "Step 5: Set the Schedule"
    ...
    [Schedule, Alerts, Locations, and Browsers and Devices sections]

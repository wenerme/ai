=== "Overview"
    ...
    **Supported categories**
    ...
    [Inferred dependency nodes showing dotted borders, type icons, and dotted edges in the service graph]
    ...
    **Inferred services in the trace list**
    ...
    [trace list showing inferred service badges in the per-service breakdown]

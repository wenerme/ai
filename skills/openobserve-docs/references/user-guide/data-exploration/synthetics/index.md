...
[Synthetics checks list showing the folder sidebar, health summary, type filters, and the checks table]
...
[Empty Synthetics checks list with Create your first Check and one card per check type]

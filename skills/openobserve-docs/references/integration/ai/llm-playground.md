...
[Playground workbench showing variant columns and case rows]
...
[The variant configuration panel with provider, model, messages, and parameters]
...
[The share snapshot dialog showing the short link]

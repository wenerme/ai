...
[Single node architecture using SQLite and local disk]{ width="60%" }

### SQLite and Object Storage

[Single node architecture using SQLite and s3]{ width="60%" }
...
[HA architecture using NATS and s3]{ width="80%" }

...
![Stripe Projects home page at projects.dev showing stripe projects add openrouter/api provisioning, syncing credentials, and writing env vars to .env](file:b32f0d4d-5144-416e-aced-af90874e1533)

...
![Stripe Projects home page at projects.dev showing stripe projects add openrouter/api provisioning, syncing credentials, and writing env vars to .env](file:2c8c4be2-569e-4d73-964b-b8eaeca70d0d)

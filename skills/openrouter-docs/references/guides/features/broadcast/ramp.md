...
![Search for OpenRouter integration](file:935adb05-abf1-4d72-9188-87cbe9bb7dde)

3. Click the **OpenRouter** integration to view the details, then click **Connect**

![OpenRouter integration detail](file:269b1634-3f1c-4644-b99b-5101cf462eaa)

4. Click **Generate API Key** and copy the token

![Generate API Key](file:3b63bf33-db3a-4eef-852d-955aaafa26b9)
...
![Ramp Configuration](file:db423823-67d2-4f93-b62f-69bf47287561)
...
![Ramp AI Spend Dashboard](file:0d8265c8-3adf-4c39-a8cb-340c91c12040)

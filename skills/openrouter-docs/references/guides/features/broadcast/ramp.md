...
![Search for OpenRouter integration](file:aa52cf7b-2d10-4faf-b7c2-82e40e030481)

3. Click the **OpenRouter** integration to view the details, then click **Connect**

![OpenRouter integration detail](file:f34ce031-1eaa-4ea8-89bf-30d7ad022711)

4. Click **Generate API Key** and copy the token

![Generate API Key](file:c60cbfde-5689-4aaa-85a0-9cb56201bdf4)
...
![Ramp Configuration](file:969b4f78-aad7-45e7-8ca7-6562e86ace4b)
...
![Ramp AI Spend Dashboard](file:10a117c9-7010-4858-8055-4e64fdd4949d)

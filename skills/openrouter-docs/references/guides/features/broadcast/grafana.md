...
![Grafana Cloud Configuration](file:7b95edf7-93a1-41e0-8c8c-df1d2226695f)

## Step 4: Test and save

Click **Test Connection** to verify the setup. The configuration only saves if the test passes.

![Grafana Cloud Configured](file:2259989a-8288-4788-b445-0e3f734ddabb)

## Step 5: Send a test trace

Make an API request through OpenRouter and view the trace in Grafana Cloud.

![Grafana Cloud Trace](file:348c0971-0515-4bab-b814-68e7a6bce77b)

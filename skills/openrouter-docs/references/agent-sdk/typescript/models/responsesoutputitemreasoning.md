...
| ------------------ | ------------------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------ | ----------------------------------------------- |
| `type`             | [models.ResponsesOutputItemReasoningType](/docs/agent-sdk/typescript/models/responsesoutputitemreasoningtype)     | :heavy\_check\_mark: | N/A                                                          |                                                 |
...
| `format`           | [models.ResponsesOutputItemReasoningFormat](/docs/agent-sdk/typescript/models/responsesoutputitemreasoningformat) | :heavy\_minus\_sign: | The format of the reasoning content                          | anthropic-claude-v1                             |

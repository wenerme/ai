...
| `architecture` | [models.Architecture](/agent-sdk/typescript/models/architecture)        | :heavy\_check\_mark: | N/A                                          | `{"tokenizer": "GPT","instruct_type": "chatml","modality": "text-\u003etext","input_modalities": ["text"],"output_modalities": ["text"]}` |
| `endpoints`    | [models.PublicEndpoint](/agent-sdk/typescript/models/publicendpoint)\[] | :heavy\_check\_mark: | List of available endpoints for this model   |                                                                                                                                           |

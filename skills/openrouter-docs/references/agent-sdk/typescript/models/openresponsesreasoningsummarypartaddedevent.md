...
| `part`           | [models.ReasoningSummaryText](/docs/agent-sdk/typescript/models/reasoningsummarytext) | :heavy\_check\_mark: | N/A         | `{"type": "summary_text","text": "Analyzed the problem using first principles"}` |

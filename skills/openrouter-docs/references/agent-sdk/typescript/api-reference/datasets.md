...
| ---------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.GetRankingsDailyRequest](/docs/agent-sdk/typescript/api-reference/operations/getrankingsdailyrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.RankingsDailyResponse](/docs/agent-sdk/typescript/api-reference/models/rankingsdailyresponse)>**

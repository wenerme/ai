...
| ---------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.GetRankingsDailyRequest](/agent-sdk/typescript/api-reference/operations/getrankingsdailyrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |

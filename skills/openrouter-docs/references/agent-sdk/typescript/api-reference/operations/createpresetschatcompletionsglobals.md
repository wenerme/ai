...
# CreatePresetsChatCompletionsGlobals - TypeScript SDK

> CreatePresetsChatCompletionsGlobals type definition
...
import { CreatePresetsChatCompletionsGlobals } from "@openrouter/sdk/models/operations";

let value: CreatePresetsChatCompletionsGlobals = {};
```

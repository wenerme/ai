...
# CreateGuardrailGlobals - TypeScript SDK

> CreateGuardrailGlobals type definition
...
import { CreateGuardrailGlobals } from "@openrouter/sdk/models/operations";

let value: CreateGuardrailGlobals = {};
```

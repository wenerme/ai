...
# DeleteKeysGlobals - TypeScript SDK

> DeleteKeysGlobals type definition
...
import { DeleteKeysGlobals } from "@openrouter/sdk/models/operations";

let value: DeleteKeysGlobals = {};
```

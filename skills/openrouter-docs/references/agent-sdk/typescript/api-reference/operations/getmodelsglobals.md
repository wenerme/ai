...
# GetModelsGlobals - TypeScript SDK

> GetModelsGlobals type definition
...
import { GetModelsGlobals } from "@openrouter/sdk/models/operations";

let value: GetModelsGlobals = {};
```

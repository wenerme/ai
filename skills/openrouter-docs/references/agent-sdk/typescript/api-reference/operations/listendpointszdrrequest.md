...
# ListEndpointsZdrRequest - TypeScript SDK

> ListEndpointsZdrRequest type definition
...
import { ListEndpointsZdrRequest } from "@openrouter/sdk/models/operations";

let value: ListEndpointsZdrRequest = {};
```

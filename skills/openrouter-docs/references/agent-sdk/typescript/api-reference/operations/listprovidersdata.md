...
| ------------------- | -------------------------------------------------------------------------------------- | -------------------- | --------------------------------------------------------------------- | -------------------------------------------------------- |
| `datacenters`       | [operations.Datacenter](/docs/agent-sdk/typescript/api-reference/operations/datacenter)\[]  | :heavy\_minus\_sign: | ISO 3166-1 Alpha-2 country codes of the provider datacenter locations | \[<br />"US",<br />"IE"<br />]                           |
| `headquarters`      | [operations.Headquarters](/docs/agent-sdk/typescript/api-reference/operations/headquarters) | :heavy\_minus\_sign: | ISO 3166-1 Alpha-2 country code of the provider headquarters          | US                                                       |

...
| `encodingFormat` | [operations.EncodingFormat](/docs/agent-sdk/typescript/api-reference/operations/encodingformat)   | :heavy\_minus\_sign: | The format of the output embeddings                      | float                                       |

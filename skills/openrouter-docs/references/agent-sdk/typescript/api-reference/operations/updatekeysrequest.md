...
| `requestBody`   | [operations.UpdateKeysRequestBody](/agent-sdk/typescript/api-reference/operations/updatekeysrequestbody) | :heavy\_check\_mark: | N/A                                                                                                                                                         | `{"disabled": false,"include_byok_in_limit": true,"limit": 75,"limit_reset": "daily","name": "Updated API Key Name"}` |

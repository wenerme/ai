...
# ListGuardrailMemberAssignmentsGlobals - TypeScript SDK

> ListGuardrailMemberAssignmentsGlobals type definition
...
import { ListGuardrailMemberAssignmentsGlobals } from "@openrouter/sdk/models/operations";

let value: ListGuardrailMemberAssignmentsGlobals = {};
```

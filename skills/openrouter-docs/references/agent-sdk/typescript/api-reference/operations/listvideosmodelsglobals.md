...
# ListVideosModelsGlobals - TypeScript SDK

> ListVideosModelsGlobals type definition
...
import { ListVideosModelsGlobals } from "@openrouter/sdk/models/operations";

let value: ListVideosModelsGlobals = {};
```

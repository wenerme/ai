...
# GetCreditsGlobals - TypeScript SDK

> GetCreditsGlobals type definition
...
import { GetCreditsGlobals } from "@openrouter/sdk/models/operations";

let value: GetCreditsGlobals = {};
```

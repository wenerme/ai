...
| `bulkAssignMembersRequest` | [models.BulkAssignMembersRequest](/docs/agent-sdk/typescript/api-reference/models/bulkassignmembersrequest) | :heavy\_check\_mark: | N/A                                                                                                                                                         | `{"member_user_ids": ["user_abc123","user_def456"]}` |

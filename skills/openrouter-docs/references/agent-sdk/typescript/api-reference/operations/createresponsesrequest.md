...
| `xOpenRouterExperimentalMetadata` | [models.MetadataLevel](/agent-sdk/typescript/api-reference/models/metadatalevel)       | :heavy\_minus\_sign: | Opt-in to surface routing metadata on the response under `openrouter_metadata`. Defaults to `disabled`.                                                     | enabled                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

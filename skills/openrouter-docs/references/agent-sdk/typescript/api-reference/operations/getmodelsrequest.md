...
| `category`            | [operations.Category](/docs/agent-sdk/typescript/api-reference/operations/category) | :heavy\_minus\_sign: | Filter models by use case category                                                                                                                                  | programming |

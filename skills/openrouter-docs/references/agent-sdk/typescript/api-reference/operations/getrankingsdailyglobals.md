...
# GetRankingsDailyGlobals - TypeScript SDK

> GetRankingsDailyGlobals type definition
...
import { GetRankingsDailyGlobals } from "@openrouter/sdk/models/operations";

let value: GetRankingsDailyGlobals = {};
```

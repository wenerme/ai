...
| `provider`      | [operations.Provider](/agent-sdk/typescript/api-reference/operations/provider) | :heavy\_minus\_sign: | Optional provider slug to filter by (e.g. `openai`, `anthropic`, `amazon-bedrock`).                                                                         | openai                               |

...
# UpdateWorkspaceGlobals - TypeScript SDK

> UpdateWorkspaceGlobals type definition
...
import { UpdateWorkspaceGlobals } from "@openrouter/sdk/models/operations";

let value: UpdateWorkspaceGlobals = {};
```

...
# ListObservabilityDestinationsGlobals - TypeScript SDK

> ListObservabilityDestinationsGlobals type definition
...
import { ListObservabilityDestinationsGlobals } from "@openrouter/sdk/models/operations";

let value: ListObservabilityDestinationsGlobals = {};
```

...
| `requestBody`   | [operations.CreateEmbeddingsRequestBody](/docs/agent-sdk/typescript/api-reference/operations/createembeddingsrequestbody) | :heavy\_check\_mark: | N/A                                                                                                                                                         | `{"dimensions": 1536,"input": "The quick brown fox jumps over the lazy dog","model": "openai/text-embedding-3-small"}` |

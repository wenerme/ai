...
| `codeChallengeMethod` | [operations.CreateAuthKeysCodeCodeChallengeMethod](/agent-sdk/typescript/api-reference/operations/createauthkeyscodecodechallengemethod) | :heavy\_minus\_sign: | The method used to generate the code challenge                                                                | S256                                                               |
...
| `usageLimitType`      | [operations.UsageLimitType](/agent-sdk/typescript/api-reference/operations/usagelimittype)                                               | :heavy\_minus\_sign: | Optional credit limit reset interval. When set, the credit limit resets on this interval.                     | monthly                                                            |

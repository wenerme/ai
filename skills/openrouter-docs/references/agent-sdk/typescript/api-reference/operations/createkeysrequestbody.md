...
| `limitReset`         | [operations.CreateKeysLimitReset](/docs/agent-sdk/typescript/api-reference/operations/createkeyslimitreset) | :heavy\_minus\_sign: | Type of limit reset for the API key (daily, weekly, monthly, or null for no reset). Resets happen automatically at midnight UTC, and weeks are Monday through Sunday. | monthly                              |

...
| ---------------------- | ------------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.ListProvidersRequest](/docs/agent-sdk/typescript/api-reference/operations/listprovidersrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.ListProvidersResponse](/docs/agent-sdk/typescript/api-reference/operations/listprovidersresponse)>**

...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.CreateAudioTranscriptionsRequest](/docs/agent-sdk/typescript/api-reference/operations/createaudiotranscriptionsrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.STTResponse](/docs/agent-sdk/typescript/api-reference/models/sttresponse)>**

...
| -------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------- | -------------------------------- | ---------------------------------------------------------------------------- |
| `error`              | [models.ForbiddenResponseErrorData](/docs/agent-sdk/typescript/api-reference/models/forbiddenresponseerrordata) | :heavy\_check\_mark: | Error data for ForbiddenResponse | `{"code": 403,"message": "Only management keys can perform this operation"}` |

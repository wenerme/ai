...
| ---------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.CreateAudioSpeechRequest](/docs/agent-sdk/typescript/api-reference/operations/createaudiospeechrequest) | :heavy\_check\_mark: | The request object to use for the request.                                                                                                                                     |

...
| -------------- | ------------------------------------------------------------------------------------- | -------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------ |
| `architecture` | [models.Architecture](/docs/agent-sdk/typescript/api-reference/models/architecture)        | :heavy\_check\_mark: | N/A                                          | `{"instruct_type": "chatml","modality": "text","tokenizer": "GPT"}`                        |
...
| `endpoints`    | [models.PublicEndpoint](/docs/agent-sdk/typescript/api-reference/models/publicendpoint)\[] | :heavy\_check\_mark: | List of available endpoints for this model   |                                                                                            |

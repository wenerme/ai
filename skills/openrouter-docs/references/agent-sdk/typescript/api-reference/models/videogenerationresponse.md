...
| `status`       | [models.VideoGenerationResponseStatus](/agent-sdk/typescript/api-reference/models/videogenerationresponsestatus) | :heavy\_check\_mark: | N/A                                                                                                     |                                  |
| `unsignedUrls` | *string*\[]                                                                                                      | :heavy\_minus\_sign: | N/A                                                                                                     |                                  |
| `usage`        | [models.VideoGenerationUsage](/agent-sdk/typescript/api-reference/models/videogenerationusage)                   | :heavy\_minus\_sign: | Usage and cost information for the video generation. Available once the job has completed.              | `{"cost": 0.5,"is_byok": false}` |

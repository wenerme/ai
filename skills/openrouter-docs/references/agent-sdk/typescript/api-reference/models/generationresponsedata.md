...
| ------------------------------ | ----------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `apiType`                      | [models.ApiType](/docs/agent-sdk/typescript/api-reference/models/apitype)                      | :heavy\_check\_mark: | Type of API used for the generation                                                                     |                                                  |
...
| `providerResponses`            | [models.ProviderResponse](/docs/agent-sdk/typescript/api-reference/models/providerresponse)\[] | :heavy\_check\_mark: | List of provider responses for this generation, including fallback attempts                             |                                                  |

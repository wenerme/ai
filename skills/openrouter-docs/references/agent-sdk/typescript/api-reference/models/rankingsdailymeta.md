...
| `version`   | [models.Version](/agent-sdk/typescript/api-reference/models/version) | :heavy\_check\_mark: | Dataset version. Field names and grain are stable for the life of `v1`.                                                                                       |                      |

...
| `part`           | [models.ReasoningSummaryText](/agent-sdk/typescript/api-reference/models/reasoningsummarytext) | :heavy\_check\_mark: | N/A         | `{"text": "Analyzed the problem using first principles","type": "summary_text"}` |

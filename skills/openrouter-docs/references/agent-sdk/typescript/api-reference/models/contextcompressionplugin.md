...
| `engine`  | [models.ContextCompressionEngine](/docs/agent-sdk/typescript/api-reference/models/contextcompressionengine) | :heavy\_minus\_sign: | The compression engine to use. Defaults to "middle-out".                                   | middle-out |

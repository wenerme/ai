...
| `provider`       | [models.SpeechRequestProvider](/docs/agent-sdk/typescript/api-reference/models/speechrequestprovider) | :heavy\_minus\_sign: | Provider-specific passthrough configuration                                                                   |                            |
| `responseFormat` | [models.ResponseFormatEnum](/docs/agent-sdk/typescript/api-reference/models/responseformatenum)       | :heavy\_minus\_sign: | Audio output format                                                                                           | pcm                        |

...
| `pdf`     | [models.PDFParserOptions](/agent-sdk/typescript/api-reference/models/pdfparseroptions) | :heavy\_minus\_sign: | Options for PDF parsing.                                                           | `{"engine": "cloudflare-ai"}` |

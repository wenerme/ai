...
| `responses`     | [models.ResponseT](/docs/agent-sdk/typescript/api-reference/models/responset)\[]        | :heavy\_minus\_sign: | Slugs of the analysis models that produced a response in this fusion run.                                                                                                                                                                |           |

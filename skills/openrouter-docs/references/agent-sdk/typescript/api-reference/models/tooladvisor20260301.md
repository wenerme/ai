...
| ---------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| `allowedCallers` | [models.AnthropicAllowedCallers](/agent-sdk/typescript/api-reference/models/anthropicallowedcallers)\[]            | :heavy\_minus\_sign: | N/A                                                                                                                                                                                                         | \[<br />"direct"<br />] |
...
| `caching`        | [models.Caching](/agent-sdk/typescript/api-reference/models/caching)                                               | :heavy\_minus\_sign: | N/A                                                                                                                                                                                                         | `{"type": "ephemeral"}` |
| `deferLoading`   | *boolean*                                                                                                          | :heavy\_minus\_sign: | N/A                                                                                                                                                                                                         |                         |
| `maxUses`        | *number*                                                                                                           | :heavy\_minus\_sign: | N/A                                                                                                                                                                                                         |                         |
| `model`          | *string*                                                                                                           | :heavy\_check\_mark: | N/A                                                                                                                                                                                                         |                         |
| `name`           | [models.NameAdvisor](/agent-sdk/typescript/api-reference/models/nameadvisor)                                       | :heavy\_check\_mark: | N/A                                                                                                                                                                                                         |                         |
| `type`           | [models.TypeAdvisor20260301](/agent-sdk/typescript/api-reference/models/typeadvisor20260301)                       | :heavy\_check\_mark: | N/A                                                                                                                                                                                                         |                         |

...
| ------------- | ------------------------------------------------------------------------------------------ | -------------------- | --------------------------------------------------------------------- | ----------------------------------------- |
| `inputAudio`  | [models.STTInputAudio](/docs/agent-sdk/typescript/api-reference/models/sttinputaudio)           | :heavy\_check\_mark: | Base64-encoded audio to transcribe                                    | `{"data": "UklGRiQA...","format": "wav"}` |
...
| `provider`    | [models.STTRequestProvider](/docs/agent-sdk/typescript/api-reference/models/sttrequestprovider) | :heavy\_minus\_sign: | Provider-specific passthrough configuration                           |                                           |

...
| `provider`            | [models.BYOKProviderSlug](/docs/agent-sdk/typescript/api-reference/models/byokproviderslug) | :heavy\_check\_mark: | The upstream provider this credential authenticates against, as a lowercase slug (e.g. `openai`, `anthropic`, `amazon-bedrock`). | openai                                                                            |

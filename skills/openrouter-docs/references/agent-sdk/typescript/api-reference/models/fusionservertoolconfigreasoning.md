...
| ----------- | -------------------------------------------------------------------------------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `effort`    | [models.FusionServerToolConfigEffort](/docs/agent-sdk/typescript/api-reference/models/fusionservertoolconfigeffort) | :heavy\_minus\_sign: | Reasoning effort level for panelist and judge inner calls.                                                                                           |

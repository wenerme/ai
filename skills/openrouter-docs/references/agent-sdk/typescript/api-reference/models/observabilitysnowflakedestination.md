...
# ObservabilitySnowflakeDestination - TypeScript SDK

> ObservabilitySnowflakeDestination type definition
...
import { ObservabilitySnowflakeDestination } from "@openrouter/sdk/models";

let value: ObservabilitySnowflakeDestination = {
  apiKeyHashes: null,
  config: {
    account: "73017229",
    token: "<value>",
...
| `config`       | [models.ObservabilitySnowflakeDestinationConfig](/agent-sdk/typescript/api-reference/models/observabilitysnowflakedestinationconfig) | :heavy\_check\_mark: | N/A                                                                                                                                      |                                      |
...
| `type`         | *"snowflake"*                                                                                                                        | :heavy\_check\_mark: | N/A                                                                                                                                      |                                      |

...
| `resetInterval`    | [operations.ListGuardrailsResetInterval](/agent-sdk/typescript/operations/listguardrailsresetinterval) | :heavy\_minus\_sign: | Interval at which the limit resets (daily, weekly, monthly) | monthly                                                                                                                    |

...
# CreateGuardrailData - TypeScript SDK

> CreateGuardrailData method reference
...
| `resetInterval`    | [operations.CreateGuardrailResetIntervalResponse](/docs/agent-sdk/typescript/operations/createguardrailresetintervalresponse) | :heavy\_minus\_sign: | Interval at which the limit resets (daily, weekly, monthly) | monthly                                                                                                                    |

...
| `resetInterval`    | [operations.GetGuardrailResetInterval](/agent-sdk/typescript/operations/getguardrailresetinterval) | :heavy\_minus\_sign: | Interval at which the limit resets (daily, weekly, monthly) | monthly                                                                                                                    |

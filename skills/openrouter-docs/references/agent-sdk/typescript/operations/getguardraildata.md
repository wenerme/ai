...
# GetGuardrailData - TypeScript SDK

> GetGuardrailData method reference
...
import { GetGuardrailData } from "@openrouter/sdk/models/operations";

let value: GetGuardrailData = {
...
| `resetInterval`    | [operations.GetGuardrailResetInterval](/docs/agent-sdk/typescript/operations/getguardrailresetinterval) | :heavy\_minus\_sign: | Interval at which the limit resets (daily, weekly, monthly) | monthly                                                                                                                    |

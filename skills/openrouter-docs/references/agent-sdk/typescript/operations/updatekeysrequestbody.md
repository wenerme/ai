...
| `limitReset`         | [operations.UpdateKeysLimitReset](/agent-sdk/typescript/operations/updatekeyslimitreset) | :heavy\_minus\_sign: | New limit reset type for the API key (daily, weekly, monthly, or null for no reset). Resets happen automatically at midnight UTC, and weeks are Monday through Sunday. | daily                |

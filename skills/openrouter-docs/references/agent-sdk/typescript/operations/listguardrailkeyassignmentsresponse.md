...
| ------------ | ----------------------------------------------------------------------------------------------------------------- | -------------------- | -------------------------------------------------- | ------- |
| `data`       | [operations.ListGuardrailKeyAssignmentsData](/agent-sdk/typescript/operations/listguardrailkeyassignmentsdata)\[] | :heavy\_check\_mark: | List of key assignments                            |         |

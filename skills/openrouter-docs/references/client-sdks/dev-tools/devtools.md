...
> For a complete documentation index, see https://openrouter.ai/docs/client-sdks/dev-tools/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/client-sdks/dev-tools/llms-full.txt.

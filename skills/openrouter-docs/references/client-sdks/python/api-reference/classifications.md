...
| `window`                   | [Optional\[operations.Window\]](../../operations/window.md)        | :heavy\_minus\_sign: | Trailing time window for the classification data. Currently only `7d` (trailing 7 days) is supported.                                                       | 7d      |
| `retries`                  | [Optional\[utils.RetryConfig\]](../../models/utils/retryconfig.md) | :heavy\_minus\_sign: | Configuration to override the default retry behavior of the client.                                                                                         |         |

### Response

**[components.TaskClassificationResponse](/docs/sdks/python/api-reference/components/taskclassificationresponse)**

...
* [get\_benchmarks\_artificial\_analysis](#get_benchmarks_artificial_analysis) - Artificial Analysis Benchmark Indices
...
## get\_benchmarks\_artificial\_analysis
...
with OpenRouter(
    ...
    res = open_router.datasets.get_benchmarks_artificial_analysis(max_results=20)
...
**[components.BenchmarksAAResponse](/docs/sdks/python/api-reference/components/benchmarksaaresponse)**

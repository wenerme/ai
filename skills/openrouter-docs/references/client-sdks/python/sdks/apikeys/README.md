...
| `external_api_key`         | *Optional\[str]*                                                                                 | :heavy\_minus\_sign: | Optional partner-supplied API key. Stored as a SHA-256 hash and never returned. Accepted only when authenticating with a Connect client secret.                       |                                      |

...
| `task_type`                | [Optional\[operations.TaskType\]](../../operations/tasktype.mdx)    | :heavy\_minus\_sign: | Filter results by task type. For Artificial Analysis, maps to the corresponding index. For Design Arena, maps to the matching category.                                         | coding              |

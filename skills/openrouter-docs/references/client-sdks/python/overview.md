...
> For a complete documentation index, see https://openrouter.ai/docs/client-sdks/python/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/client-sdks/python/llms-full.txt.

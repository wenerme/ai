...
> For a complete documentation index, see https://openrouter.ai/docs/client-sdks/typescript/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/client-sdks/typescript/llms-full.txt.

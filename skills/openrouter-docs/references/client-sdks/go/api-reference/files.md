...
**[\*operations.ListFilesResponse](/docs/sdks/go/api-reference/operations/listfilesresponse), error**
...
| ------------- | ------------------------------------------------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------ | ------------------------------------ |
| `ctx`         | [context.Context](https://pkg.go.dev/context#Context)                                            | :heavy\_check\_mark: | The context to use for the request.                                            |                                      |
| `requestBody` | [operations.UploadFileRequestBody](/docs/sdks/go/api-reference/operations/uploadfilerequestbody) | :heavy\_check\_mark: | N/A                                                                            |                                      |
| `workspaceID` | `*string`                                                                                        | :heavy\_minus\_sign: | Workspace to scope the request to. Defaults to the caller’s default workspace. | a103d8b6-42f0-4e50-9a3c-bf41e2c3c1a7 |
| `opts`        | \[][operations.Option](/docs/sdks/go/api-reference/operations/option)                            | :heavy\_minus\_sign: | The options for this request.                                                  |                                      |

### Response

**[\*components.FileMetadata](/docs/sdks/go/api-reference/models/filemetadata), error**
...
**[\*components.FileDeleteResponse](/docs/sdks/go/api-reference/models/filedeleteresponse), error**

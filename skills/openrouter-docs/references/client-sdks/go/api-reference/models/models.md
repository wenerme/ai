...
func main() {
    ...
    res, err := s.Models.List(ctx, nil, nil, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
| --------------------- | ------------------------------------------------------------------------------------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `ctx`                 | [context.Context](https://pkg.go.dev/context#Context)                                      | :heavy\_check\_mark: | The context to use for the request.                                                                                                                                                                                                                                                                                                                                                                                                                        |             |
| `category`            | [\*operations.GetModelsCategory](/docs/sdks/go/api-reference/operations/getmodelscategory) | :heavy\_minus\_sign: | Filter models by use case category                                                                                                                                                                                                                                                                                                                                                                                                                         | programming |

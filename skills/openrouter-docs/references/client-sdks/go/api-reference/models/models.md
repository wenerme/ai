...
> For a complete documentation index, see https://openrouter.ai/docs/client-sdks/go/api-reference/models/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/client-sdks/go/api-reference/models/llms-full.txt.

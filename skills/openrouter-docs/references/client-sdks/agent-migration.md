...
> For a complete documentation index, see https://openrouter.ai/docs/client-sdks/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/client-sdks/llms-full.txt.

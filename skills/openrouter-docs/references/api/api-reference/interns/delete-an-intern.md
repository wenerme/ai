...
````yaml /openapi/openapi.yaml delete /interns/{internId}
openapi: 3.1.0
info:
  contact:
  ...
  /interns/{internId}:
    delete:
      ...
      description: >-
        ...
        refused with 413. A non-empty body must declare `Content-Type:
        application/json` or it is refused with 415. The API key selects the

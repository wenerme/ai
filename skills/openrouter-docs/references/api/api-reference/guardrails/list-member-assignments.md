...
```java Guardrails_listMemberAssignments_example
...
```php Guardrails_listMemberAssignments_example
<?php
...
```csharp Guardrails_listMemberAssignments_example
using RestSharp;
...
```swift Guardrails_listMemberAssignments_example
import Foundation

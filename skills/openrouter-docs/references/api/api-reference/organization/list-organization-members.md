...
> For a complete documentation index, see https://openrouter.ai/docs/api/api-reference/organization/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/api/api-reference/organization/llms-full.txt.

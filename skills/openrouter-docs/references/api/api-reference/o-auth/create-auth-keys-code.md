...
> For a complete documentation index, see https://openrouter.ai/docs/api/api-reference/o-auth/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/api/api-reference/o-auth/llms-full.txt.

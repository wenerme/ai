...
```go Workspaces_updateWorkspace_example
package main
...
```ruby Workspaces_updateWorkspace_example
require 'uri'
require 'net/http'
...
```java Workspaces_updateWorkspace_example
...
```php Workspaces_updateWorkspace_example
<?php
...
```swift Workspaces_updateWorkspace_example
import Foundation

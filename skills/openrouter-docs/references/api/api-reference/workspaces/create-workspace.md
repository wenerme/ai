...
Reference: https://openrouter.ai/docs/api/api-reference/workspaces/create-workspace
...
const options = {
  ...
  body: '{"name":"Production","slug":"production","default_image_model":"openai/dall-e-3","default_provider_sort":"price","default_text_model":"openai/gpt-4o","description":"Production environment workspace"}'
};

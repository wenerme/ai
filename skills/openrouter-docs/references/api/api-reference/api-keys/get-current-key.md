...
> For a complete documentation index, see https://openrouter.ai/docs/api/api-reference/api-keys/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/api/api-reference/api-keys/llms-full.txt.

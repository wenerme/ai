...
![Grouped tool display](file:967a79ec-0d42-4f84-8187-59873c51a0c2)

**Emoji** — per-call markers with tool name, arguments, and timing:

![Emoji tool display](file:d0e4603b-1a00-44f5-bd5b-45f9419a0bf3)

**Minimal** — aggregated one-liner summaries:

![Minimal tool display](file:46eb82bb-58d1-49ed-af7d-abd4f768b57c)
...
![Block input style](file:ed8cc9d2-be9f-421f-85f4-b94b550497df)

**Bordered** — horizontal line frame that works on any terminal:

![Bordered input style](file:ef2dd7b7-9df1-44d6-bcf2-7b3893fdb6f3)

**Plain** — simple readline prompt, no escape sequences:

![Plain input style](file:ea17c9e4-fffe-42ea-a00b-78fe6d5dc042)
...
![Gradient loader](file:de073c7b-1f44-41ef-8198-15eebfffe2ca)

**Spinner** — braille dot animation:

![Spinner loader](file:ff7ab1ab-a3be-4333-abd0-4eeb13dc8410)

**Minimal** — trailing dots:

![Minimal loader](file:327283f6-8b3c-4481-9e89-f26aa3d165bc)
...
![ASCII banner on startup](file:ca71bb9a-b105-4e75-abc4-1d021b3dc3af)
...
![Agent TUI running in the terminal](file:524a5d81-70f0-4947-a9f1-b9977add2d3a)
...
![A demo app built by the agent TUI](file:e1d67c1e-2798-4f54-b9aa-c5281e8e5f54)

...
Tool calling parameter, following OpenAI's tool calling request shape. For non-OpenAI providers, it will be transformed accordingly. Learn more in the [tool calling guide](/docs/guides/features/tool-calling).

...
| `generate_audio`           | *Optional\[bool]*                                                                                 | :heavy\_minus\_sign: | Whether to generate audio alongside the video. Defaults to true for models that support audio output, false otherwise.                                                                                    | true     |
...
| `provider`                 | [Optional\[components.Provider\]](../../components/provider.md)                                   | :heavy\_minus\_sign: | Provider-specific passthrough configuration                                                                                                                                                               |          |

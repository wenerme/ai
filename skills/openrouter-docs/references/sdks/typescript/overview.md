...
> For a complete documentation index, see https://openrouter.ai/docs/sdks/typescript/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/sdks/typescript/llms-full.txt.

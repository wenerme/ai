...
> For a complete documentation index, see https://openrouter.ai/docs/sdks/typescript/api-reference/models/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/sdks/typescript/api-reference/models/llms-full.txt.

...
> For a complete documentation index, see https://openrouter.ai/docs/sdks/typescript/call-model/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/sdks/typescript/call-model/llms-full.txt.

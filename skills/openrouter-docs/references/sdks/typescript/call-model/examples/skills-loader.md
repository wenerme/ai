...
> For a complete documentation index, see https://openrouter.ai/docs/sdks/typescript/call-model/examples/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/sdks/typescript/call-model/examples/llms-full.txt.

...
> For a complete documentation index, see https://openrouter.ai/docs/sdks/dev-tools/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/sdks/dev-tools/llms-full.txt.

...
> For a complete documentation index, see https://openrouter.ai/docs/sdks/go/api-reference/models/llms.txt.
> For full documentation content, see https://openrouter.ai/docs/sdks/go/api-reference/models/llms-full.txt.

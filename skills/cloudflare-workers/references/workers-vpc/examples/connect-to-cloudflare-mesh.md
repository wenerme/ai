...
* [  wrangler.jsonc ](#tab-panel-11410)
* [  wrangler.toml ](#tab-panel-11411)

JSONC

```
{  "$schema": "./node_modules/wrangler/config-schema.json",  "name": "mesh-gateway",  "main": "src/index.js",  // Set this to today's date  "compatibility_date": "2026-06-24",  "vpc_networks": [    {      "binding": "MESH",      "network_id": "cf1:network",      "remote": true    }  ]}
```

TOML

```
"$schema" = "./node_modules/wrangler/config-schema.json"name = "mesh-gateway"main = "src/index.js"# Set this to today's datecompatibility_date = "2026-06-24"

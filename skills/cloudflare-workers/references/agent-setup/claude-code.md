...
<summary>How do I give Claude Code access to my Cloudflare account?
...
<summary>Can Claude Code deploy to existing Workers projects?
...
<summary>MCP server connection fails or times out

</summary>

Run <code>claude mcp list</code> to verify the server is registered. Try removing and re-adding: <code>claude mcp remove cloudflare</code> then re-add it. Ensure you have <code>npx</code> and <code>mcp-remote</code> available.

</details>

<details>

<summary>Claude cannot authenticate with Cloudflare
...
[![](https://developers.cloudflare.com/icons/agents/codex/light.svg)![](https://developers.cloudflare.com/icons/agents/codex/dark.svg) OpenAI<h3>Codex</h3>

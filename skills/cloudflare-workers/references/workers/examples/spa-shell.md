...
```
{  "name": "my-spa",  "main": "src/worker.ts",  // Set this to today's date  "compatibility_date": "2026-06-24",  "compatibility_flags": ["nodejs_compat"],  "assets": {    "directory": "./dist",    "binding": "ASSETS",    "not_found_handling": "single-page-application",    "run_worker_first": ["/*", "!/assets/*"],  },}
```

TOML

```
name = "my-spa"main = "src/worker.ts"# Set this to today's datecompatibility_date = "2026-06-24"compatibility_flags = [ "nodejs_compat" ]
...
* [  JavaScript ](#tab-panel-11871)
* [  TypeScript ](#tab-panel-11872)
...
```
{  "name": "my-spa-proxy",  "main": "src/worker.ts",  // Set this to today's date  "compatibility_date": "2026-06-24",  "compatibility_flags": ["nodejs_compat"],  "vars": {    "SPA_ORIGIN": "https://my-spa.example-hosting.com",    "API_BASE_URL": "https://api.example.com",  },}
```

TOML

```
name = "my-spa-proxy"main = "src/worker.ts"# Set this to today's datecompatibility_date = "2026-06-24"compatibility_flags = [ "nodejs_compat" ]
...
* [  JavaScript ](#tab-panel-11873)
* [  TypeScript ](#tab-panel-11874)

...
Run `wrangler login`, or set [`CLOUDFLARE_API_TOKEN`](https://developers.cloudflare.com/workers/wrangler/system-environment-variables/) to an API token with Flagship permissions.

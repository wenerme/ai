...
1. Open a terminal and run the `create cloudflare` (C3) CLI tool to create your Worker project:npmyarnpnpm
...
2. Move into your new project directory:
   ...
   What files did C3 create?</summary>

In your project directory, C3 will have generated the following:
   - <code>wrangler.jsonc</code>: Your <a href="https://developers.cloudflare.com/workers/wrangler/configuration/#sample-wrangler-configuration">Wrangler configuration file</a>.
   - <code>src/index.ts</code>: A minimal Worker written in TypeScript.
   - <code>package.json</code>: A minimal Node dependencies configuration file.
   - <code>tsconfig.json</code>: TypeScript configuration.</details>

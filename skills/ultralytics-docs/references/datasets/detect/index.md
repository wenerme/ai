...
<p align="center">[YOLO labeled image with bounding boxes on persons and tie]</p>

The label file corresponding to the above image contains 2 persons (class `0`) and a tie (class `27`):

<p align="center">[YOLO format label file with normalized coordinates]</p>
...
<p align="center">[YOLO dataset directory structure with train and val folders]</p>

...
![Ultralytics Platform Amazon S3 Integration Settings](https://cdn.ul.run/i/8c83dd23d861622b412430667d61c08f.avif)
...
### Why is smart annotation or clustering unavailable on my S3 dataset?
...
Disconnect the integration in **Settings > Integrations** to delete the stored credentials, or deactivate or delete the access key in AWS IAM. Neither action touches the data in your buckets.

...
!!! tip "Performance"
    ...
    === "Detection (COCO)"
        ...
        | Model   | size<sup>(pixels)</sup> | mAP<sup>val50-95</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        | ------- | --------------------------- | -------------------------- | ------------------------------------ | --------------------------------------------------- | ------------------------ | ----------------------- |
    ...
    === "Segmentation (COCO)"
        ...
        | Model       | size<sup>(pixels)</sup> | mAP<sup>box50-95</sup> | mAP<sup>mask50-95</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        | ----------- | --------------------------- | -------------------------- | --------------------------- | ------------------------------------ | --------------------------------------------------- | ------------------------ | ----------------------- |
    ...
    === "Semantic Segmentation (Cityscapes)"
        ...
        | Model       | size<sup>(pixels)</sup> | mIoU<sup>val</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        | ----------- | --------------------------- | ------------------ | ------------------------------------ | --------------------------------------------------- | ------------------------ | ----------------------- |
    ...
    === "Depth Estimation (NYU Depth V2)"
        ...
        | Model         | size<sup>(pixels)</sup> | delta1<sup>NYU</sup> | delta1<sup>KITTI-580</sup> | delta1<sup>bench mean</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        | ------------- | --------------------------- | -------------------- | -------------------------- | --------------------------- | ------------------------------------ | --------------------------------------------------- | ------------------------ | ----------------------- |
    ...
    === "Classification (ImageNet)"
        ...
        | Model       | size<sup>(pixels)</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B) at 224</sup> |
        | ----------- | --------------------------- | ------------------------------------ | --------------------------------------------------- | ------------------------ | ------------------------------ |
    ...
    === "Pose (COCO)"
        ...
        | Model        | size<sup>(pixels)</sup> | mAP<sup>pose50-95</sup> | mAP<sup>pose50</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        | ------------ | --------------------------- | --------------------------- | ------------------------ | ------------------------------------ | --------------------------------------------------- | ------------------------ | ----------------------- |
    ...
    === "OBB (DOTAv1)"
        ...
        | Model       | size<sup>(pixels)</sup> | mAP<sup>test50-95</sup> | mAP<sup>test50</sup> | Speed<sup>CPU ONNX(ms)</sup> | Speed<sup>RTX PRO 6000 TensorRT11(ms)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        | ----------- | --------------------------- | --------------------------- | ------------------------ | ------------------------------------ | --------------------------------------------------- | ------------------------ | ----------------------- |

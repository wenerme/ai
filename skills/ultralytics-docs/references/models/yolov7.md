...
!!! tip "Performance"
    ...
    === "Detection (COCO)"
        ...
        | Model                 | Params<sup>(M)</sup> | FLOPs<sup>(G)</sup> | Size<sup>(pixels)</sup> | FPS     | AP<sup>test / val50-95</sup> | AP<sup>test50</sup> | AP<sup>test75</sup> | AP<sup>testS</sup> | AP<sup>testM</sup> | AP<sup>testL</sup> |
        | --------------------- | ------------------ | ----------------- | --------------------- | ------- | -------------------------- | ----------------- | ----------------- | ---------------- | ---------------- | ---------------- |

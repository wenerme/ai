...
![YOLOE Prompting Options](https://cdn.ul.run/i/b144f94979e9ca2ae30bcbb41c69816d.avif)
...
!!! tip "YOLOE-26 Performance"
    ...
    === "Text/Visual Prompts"
        ...
        | Model         | size<sup>(pixels)</sup> | Prompt Type | mAP<sup>minival50-95(e2e)</sup> | mAP<sup>minival50-95</sup> | mAP<sub>r</sub> | mAP<sub>c</sub> | mAP<sub>f</sub> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        |---------------|-----------------------------|-------------|-------------------------------------|----------------------------|-----------------|-----------------|-----------------|--------------------------|-------------------------|
    ...
    === "Prompt-free"
        ...
        | Model            | size<sup>(pixels)</sup> | mAP<sup>minival50-95(e2e)</sup> | mAP<sup>minival50(e2e)</sup> | params<sup>(M)</sup> | FLOPs<sup>(B)</sup> |
        |------------------|-----------------------------|-------------------------------------|------------------------------|--------------------------|-------------------------|

...
| Model         | Task     | size<sup>(pixels)</sup> | CPU<sup>w8a32 LiteRT(ms)</sup> | GPU<sup>w8a32 LiteRT(ms)</sup>  |
| ------------- | -------- | --------------------------- | -------------------------------------- | --------------------------------------- |
| YOLO26n       | Detect   | 640                         | 52.2<sup>1.8 / 48.1 / 2.4</sup>    | **15.8**<sup>2.3 / 8.9 / 4.6</sup>  |
| YOLO26n-seg   | Segment  | 640                         | 73.4<sup>1.8 / 65.6 / 6.0</sup>    | **33.2**<sup>1.8 / 23.8 / 7.6</sup> |
| YOLO26n-sem   | Semantic | 640                         | 61.2<sup>1.8 / 51.1 / 8.3</sup>    | **34.2**<sup>1.8 / 24.0 / 8.3</sup> |
| YOLO26n-depth | Depth    | 640                         | 124.4<sup>1.9 / 115.1 / 7.4</sup>  | **23.0**<sup>1.8 / 13.5 / 7.7</sup> |
| YOLO26n-cls   | Classify | 224                         | 4.4<sup>0.4 / 4.0 / 0.0</sup>      | **3.1**<sup>0.8 / 2.1 / 0.2</sup>   |
| YOLO26n-pose  | Pose     | 640                         | 57.4<sup>1.8 / 53.8 / 1.8</sup>    | **16.6**<sup>2.7 / 10.1 / 3.9</sup> |
| YOLO26n-obb   | OBB      | 640                         | 50.3<sup>1.8 / 47.2 / 1.4</sup>    | **11.7**<sup>1.8 / 7.8 / 2.0</sup>  |
...
| Model         | Task     | size<sup>(pixels)</sup> | CPU<sup>w8a32 LiteRT(ms)</sup>  | GPU<sup>w8a32 LiteRT(ms)</sup>   |
| ------------- | -------- | --------------------------- | --------------------------------------- | ---------------------------------------- |
| YOLO26n       | Detect   | 640                         | 53.3<sup>1.5 / 50.2 / 1.6</sup>     | **45.5**<sup>3.8 / 37.7 / 4.0</sup>  |
| YOLO26n-seg   | Segment  | 640                         | 87.7<sup>1.8 / 78.5 / 7.5</sup>     | **50.9**<sup>3.0 / 36.9 / 10.9</sup> |
| YOLO26n-sem   | Semantic | 640                         | **68.6**<sup>1.5 / 59.0 / 8.0</sup> | 71.6<sup>1.5 / 59.5 / 10.6</sup>     |
| YOLO26n-depth | Depth    | 640                         | 120.3<sup>1.5 / 112.5 / 6.3</sup>   | **52.5**<sup>2.0 / 37.5 / 13.0</sup> |
| YOLO26n-cls   | Classify | 224                         | **4.0**<sup>0.3 / 3.4 / 0.2</sup>   | 17.6<sup>0.9 / 16.7 / 0.1</sup>      |
| YOLO26n-pose  | Pose     | 640                         | 59.7<sup>1.5 / 57.0 / 1.2</sup>     | **46.6**<sup>3.8 / 39.2 / 3.5</sup>  |
| YOLO26n-obb   | OBB      | 640                         | 52.0<sup>1.5 / 48.9 / 1.7</sup>     | **45.5**<sup>4.0 / 38.5 / 2.9</sup>  |
...
| Model         | Task     | size<sup>(pixels)</sup> | CPU<sup>w8a32 LiteRT(ms)</sup> | GPU<sup>w8a32 LiteRT(ms)</sup>  |
| ------------- | -------- | --------------------------- | -------------------------------------- | --------------------------------------- |
| YOLO26n       | Detect   | 640                         | 36.7<sup>1.3 / 33.8 / 1.7</sup>    | **16.4**<sup>1.4 / 12.3 / 2.6</sup> |
| YOLO26n-seg   | Segment  | 640                         | 54.6<sup>1.2 / 48.0 / 5.3</sup>    | **32.8**<sup>1.3 / 24.5 / 7.0</sup> |
| YOLO26n-sem   | Semantic | 640                         | 47.8<sup>1.2 / 38.4 / 8.1</sup>    | **34.2**<sup>1.3 / 24.9 / 8.0</sup> |
| YOLO26n-depth | Depth    | 640                         | 92.9<sup>1.2 / 84.8 / 6.9</sup>    | **33.5**<sup>1.3 / 22.4 / 9.8</sup> |
| YOLO26n-cls   | Classify | 224                         | 2.7<sup>0.2 / 2.3 / 0.2</sup>      | **2.6**<sup>0.2 / 2.4 / 0.0</sup>   |
| YOLO26n-pose  | Pose     | 640                         | 42.8<sup>1.3 / 40.5 / 1.0</sup>    | **18.4**<sup>1.4 / 14.1 / 2.9</sup> |
| YOLO26n-obb   | OBB      | 640                         | 37.5<sup>1.3 / 35.1 / 1.2</sup>    | **18.8**<sup>2.5 / 14.6 / 1.8</sup> |
...
| Model         | Task     | size<sup>(pixels)</sup> | CPU<sup>w8a32 LiteRT(ms)</sup> | GPU<sup>w8a32 LiteRT(ms)</sup>   |
| ------------- | -------- | --------------------------- | -------------------------------------- | ---------------------------------------- |
| YOLO26n       | Detect   | 640                         | 45.4<sup>1.3 / 42.1 / 2.0</sup>    | **26.6**<sup>1.9 / 22.0 / 2.7</sup>  |
| YOLO26n-seg   | Segment  | 640                         | 126.2<sup>2.6 / 113.9 / 9.7</sup>  | **46.7**<sup>2.6 / 33.3 / 10.8</sup> |
| YOLO26n-sem   | Semantic | 640                         | 117.9<sup>2.6 / 98.8 / 16.5</sup>  | **74.3**<sup>2.6 / 54.7 / 17.0</sup> |
| YOLO26n-depth | Depth    | 640                         | 182.4<sup>2.5 / 167.6 / 12.3</sup> | **47.8**<sup>2.5 / 32.3 / 12.9</sup> |
| YOLO26n-cls   | Classify | 224                         | **6.2**<sup>0.4 / 5.3 / 0.4</sup>  | 7.4<sup>0.4 / 6.9 / 0.1</sup>        |
| YOLO26n-pose  | Pose     | 640                         | 97.6<sup>2.5 / 93.3 / 1.8</sup>    | **28.6**<sup>2.5 / 23.3 / 2.8</sup>  |
| YOLO26n-obb   | OBB      | 640                         | 91.5<sup>2.6 / 85.8 / 3.2</sup>    | **27.5**<sup>2.7 / 21.8 / 2.9</sup>  |

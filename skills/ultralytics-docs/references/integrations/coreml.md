...
| Model         | Task     | size<sup>(pixels)</sup> | CPU<sup>Core ML `.cpuOnly`(ms)</sup> | CPU + ANE preferred<sup>Core ML `.cpuAndNeuralEngine`(ms)</sup> |
| ------------- | -------- | --------------------------- | -------------------------------------------- | ----------------------------------------------------------------------- |
| YOLO26n       | Detect   | 640                         | 9.2<sup>0.0 / 9.2 / 0.0</sup>            | **3.2**<sup>0.0 / 3.2 / 0.0</sup>                                   |
| YOLO26n-seg   | Segment  | 640                         | 12.6<sup>0.0 / 12.0 / 0.5</sup>          | **4.8**<sup>0.0 / 4.2 / 0.6</sup>                                   |
| YOLO26n-sem   | Semantic | 640                         | 9.7<sup>0.0 / 9.2 / 0.5</sup>            | **4.6**<sup>0.0 / 4.2 / 0.5</sup>                                   |
| YOLO26n-depth | Depth    | 640                         | 25.0<sup>0.0 / 24.1 / 0.9</sup>          | **5.3**<sup>0.0 / 4.5 / 0.9</sup>                                   |
| YOLO26n-cls   | Classify | 224                         | 2.2<sup>0.0 / 2.2 / 0.0</sup>            | **1.9**<sup>0.0 / 1.9 / 0.0</sup>                                   |
| YOLO26n-pose  | Pose     | 640                         | 11.9<sup>0.0 / 11.9 / 0.0</sup>          | **3.9**<sup>0.0 / 3.9 / 0.0</sup>                                   |
| YOLO26n-obb   | OBB      | 640                         | 10.6<sup>0.0 / 10.6 / 0.0</sup>          | **3.4**<sup>0.0 / 3.4 / 0.0</sup>                                   |

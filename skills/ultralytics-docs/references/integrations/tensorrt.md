...
!!! tip "Performance"
    ...
    === "Detection (COCO)"
        ...
        | Precision | Eval test    | mean(ms) | min \| max(ms) | mAP<sup>val</sup>50(B) | mAP<sup>val</sup>50-95(B) | `batch` | size<sup>(pixels)</sup> |
        |-----------|--------------|--------------|--------------------|----------------------|-------------------------|---------|-----------------------|
    ...
    === "Segmentation (COCO)"
        ...
        | Precision | Eval test    | mean(ms) | min \| max(ms) | mAP<sup>val</sup>50(B) | mAP<sup>val</sup>50-95(B) | mAP<sup>val</sup>50(M) | mAP<sup>val</sup>50-95(M) | `batch` | size<sup>(pixels)</sup> |
        |-----------|--------------|--------------|--------------------|----------------------|-------------------------|----------------------|-------------------------|---------|-----------------------|
    ...
    === "Classification (ImageNet)"
        ...
        | Precision | Eval test        | mean(ms) | min \| max(ms) | top-1 | top-5 | `batch` | size<sup>(pixels)</sup> |
        |-----------|------------------|--------------|--------------------|-------|-------|---------|-----------------------|
    ...
    === "Pose (COCO)"
        ...
        | Precision | Eval test    | mean(ms) | min \| max(ms) | mAP<sup>val</sup>50(B) | mAP<sup>val</sup>50-95(B) | mAP<sup>val</sup>50(P) | mAP<sup>val</sup>50-95(P) | `batch` | size<sup>(pixels)</sup> |
        |-----------|--------------|--------------|--------------------|----------------------|-------------------------|----------------------|-------------------------|---------|-----------------------|

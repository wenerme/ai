...
| Model        | Task     | size<sup>(pixels)</sup> | CPU<sup>INT8 TFLite(ms)</sup> | GPU Adreno<sup>INT8 TFLite(ms)</sup> | NPU Hexagon<sup>QNN A16W8(ms)</sup>      |
| ------------ | -------- | --------------------------- | ------------------------------------- | -------------------------------------------- | ------------------------------------------------ |
...
| Model        | Task     | size<sup>(pixels)</sup> | CPU<sup>PT FP32(ms)</sup>      | NPU Hexagon<sup>QNN A16W8(ms)</sup> |
| ------------ | -------- | --------------------------- | -------------------------------------- | ------------------------------------------- |

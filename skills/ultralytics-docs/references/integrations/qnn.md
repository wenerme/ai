...
| Model        | Task     | size<sup>(pixels)</sup> | CPU<sup>INT8 TFLite(ms)</sup> | GPU Adreno<sup>INT8 TFLite(ms)</sup> | NPU Hexagon<sup>QNN W8A16(ms)</sup>      |
| ------------ | -------- | --------------------------- | ------------------------------------- | -------------------------------------------- | ------------------------------------------------ |
| YOLO26n      | Detect   | 640                         | 53.3<sup>3.6 / 47.4 / 2.4</sup>   | 17.2<sup>3.6 / 9.1 / 4.5</sup>           | **11.3**<sup>3.5 / 5.6 / 2.2</sup>           |
| YOLO26n-seg  | Segment  | 640                         | 76.0<sup>3.6 / 64.7 / 7.7</sup>   | 23.9<sup>3.6 / 11.8 / 8.6</sup>          | **21.3**<sup>3.5 / 7.9 / 10.0</sup>          |
| YOLO26n-sem  | Semantic | 1024                        | 66.6<sup>3.6 / 46.3 / 16.8</sup>  | **37.7**<sup>3.6 / 17.4 / 16.7</sup>     | 49.1<sup>1</sup><sup>8.8 / 20.8 / 19.5</sup> |
| YOLO26n-cls  | Classify | 224                         | 5.2<sup>0.8 / 4.0 / 0.5</sup>     | 4.5<sup>1.6 / 2.2 / 0.7</sup>            | **2.4**<sup>1.1 / 0.6 / 0.7</sup>            |
| YOLO26n-pose | Pose     | 640                         | 57.7<sup>3.5 / 52.4 / 1.8</sup>   | 15.2<sup>3.6 / 9.7 / 1.9</sup>           | **10.8**<sup>3.5 / 5.6 / 1.8</sup>           |
| YOLO26n-obb  | OBB      | 1024                        | 50.3<sup>3.6 / 45.4 / 1.3</sup>   | **13.9**<sup>3.8 / 8.2 / 1.8</sup>       | 21.0<sup>8.8 / 10.9 / 1.3</sup>              |

...
| Model         | Task     | size<sup>(pixels)</sup> | CPU<sup>w8a32 LiteRT(ms)</sup> | GPU<sup>w8a32 LiteRT(ms)</sup>  | NPU<sup>QNN W8A16(ms)</sup>    |
| ------------- | -------- | --------------------------- | -------------------------------------- | --------------------------------------- | -------------------------------------- |
| YOLO26n       | Detect   | 640                         | 52.2<sup>1.8 / 48.1 / 2.4</sup>    | 15.8<sup>2.3 / 8.9 / 4.6</sup>      | **10.7**<sup>1.8 / 6.7 / 2.2</sup> |
| YOLO26n-seg   | Segment  | 640                         | 73.4<sup>1.8 / 65.6 / 6.0</sup>    | 33.2<sup>1.8 / 23.8 / 7.6</sup>     | **17.4**<sup>1.8 / 9.9 / 5.7</sup> |
| YOLO26n-sem   | Semantic | 640                         | 61.2<sup>1.8 / 51.1 / 8.3</sup>    | 34.2<sup>1.8 / 24.0 / 8.3</sup>     | **11.5**<sup>1.8 / 7.1 / 2.6</sup> |
| YOLO26n-depth | Depth    | 640                         | 124.4<sup>1.9 / 115.1 / 7.4</sup>  | **23.0**<sup>1.8 / 13.5 / 7.7</sup> | 35.2<sup>1.8 / 26.1 / 7.3</sup>    |
| YOLO26n-cls   | Classify | 224                         | 4.4<sup>0.4 / 4.0 / 0.0</sup>      | 3.1<sup>0.8 / 2.1 / 0.2</sup>       | **1.2**<sup>0.6 / 0.6 / 0.0</sup>  |
| YOLO26n-pose  | Pose     | 640                         | 57.4<sup>1.8 / 53.8 / 1.8</sup>    | 16.6<sup>2.7 / 10.1 / 3.9</sup>     | **10.9**<sup>1.8 / 7.0 / 2.0</sup> |
| YOLO26n-obb   | OBB      | 640                         | 50.3<sup>1.8 / 47.2 / 1.4</sup>    | 11.7<sup>1.8 / 7.8 / 2.0</sup>      | **8.6**<sup>1.8 / 5.7 / 1.1</sup>  |
...
| Model        | Task     | size<sup>(pixels)</sup> | CPU<sup>PT FP32(ms)</sup>      | NPU Hexagon<sup>QNN W8A16(ms)</sup> |
| ------------ | -------- | --------------------------- | -------------------------------------- | ------------------------------------------- |
| YOLO26n      | Detect   | 640                         | 91.4<sup>4.3 / 75.2 / 0.1</sup>    | **27.2**<sup>4.9 / 19.4 / 0.9</sup>     |
| YOLO26n-seg  | Segment  | 640                         | 138.8<sup>4.5 / 127.1 / 2.8</sup>  | **34.3**<sup>5.0 / 24.0 / 5.1</sup>     |
| YOLO26n-sem  | Semantic | 1024                        | 295.8<sup>9.1 / 189.2 / 94.8</sup> | **133.0**<sup>8.8 / 37.4 / 83.9</sup>   |
| YOLO26n-cls  | Classify | 224                         | 15.4<sup>3.0 / 9.8 / 0.0</sup>     | **11.7**<sup>2.7 / 5.5 / 0.0</sup>      |
| YOLO26n-pose | Pose     | 640                         | 109.6<sup>4.6 / 102.9 / 0.2</sup>  | **28.9**<sup>5.3 / 23.3 / 0.6</sup>     |
| YOLO26n-obb  | OBB      | 1024                        | 267.8<sup>8.1 / 254.6 / 0.1</sup>  | **64.8**<sup>8.9 / 54.7 / 0.6</sup>     |

...
!!! tip "Use Docker"
    ...
    The **Ultralytics Docker image** is recommended for all multi-GPU training runs. See the [Docker Quickstart Guide](../environments/docker-image-quickstart-tutorial.md). <a href="https://hub.docker.com/r/ultralytics/yolov5">[Docker Pulls]</a>
...
<p align="center">[YOLOv5 Models]</p>
...
| GPUsA100 | batch-size | CUDA_mem<sup>device0 (G)</sup> | COCO<sup>train</sup> | COCO<sup>val</sup> |
| ------------ | ---------- | ---------------------------------- | ------------------------ | ---------------------- |

...
Activate GitLab Enterprise Edition with an activation code to unlock paid features. Learn to activate your subscription for new, scaled, or offline instances.
...
**Help** () > **Help**. The GitLab edition and version are listed

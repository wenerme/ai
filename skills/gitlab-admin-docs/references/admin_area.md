...
Manage your GitLab instance and configure features in the UI.
...
1. Find the project you want to edit and select **Actions** () > **Edit**.
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Projects**.
1. Find the project you want to delete and select **Actions** () > **Delete**.
...
- Through the UI:
  ...
  1. To stop impersonating, in the upper-right corner, select **Stop impersonating** ().
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Users**.
1. In the upper right, select **Export permissions as CSV** ().
...
1. Find the group you want to edit and select **Actions** () > **Edit**.
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Groups**.
1. Find the group you want to delete and select **Actions** () > **Delete**.

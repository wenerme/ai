...
Resolve installation, sign-in, and data sync errors when administering the GitLab for Jira Cloud app.
...
- If you [installed the app from the official Atlassian Marketplace listing](jira_cloud_app.md#install-the-gitlab-for-jira-cloud-app-from-the-atlassian-marketplace),
  ...
  1. In Jira, select the horizontal ellipsis () beside **Apps** and select **Manage your apps**.
  ...
  1. Go to the app by using one of these methods:
     ...
     **For instances with centralized app management**:
     ...
     1. In the **Installed apps** tab, locate the **GitLab for Jira (gitlab.com)** app, select the horizontal ellipsis () and then select **Get started**.

     **For instances with legacy app management**:

     1. Locate the **GitLab for Jira (gitlab.com)** app, select the chevron () and then select **Get started**.

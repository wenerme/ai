...
Configure a standalone Redis server with the Linux package. Use this setup for small GitLab installations that do not require Redis replication or failover.

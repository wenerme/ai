...
Administrator's guide to managing a GitLab dependency proxy for frequently-accessed upstream artifacts, including container images and packages.
...
issuing the client a JWT to use for the pull requests. The token expiration time is configurable

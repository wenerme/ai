...
Deploy and scale a GitLab Self-Managed instance for up to 10,000 users or 200 RPS with high availability, database replication, and infrastructure sizing.
...
|----------------------|-------------------------|-----------------|--------------|
| Webservice           | 80 vCPU100 GB memory (request)140 GB memory (limit) | 3 x `n1-standard-32` | 3 x `c5.9xlarge` |

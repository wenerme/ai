...
Deploy a GitLab Self-Managed instance for up to 50,000 users or 1000 RPS with high availability, database replication, and infrastructure sizing.
...
|----------------------|-------------------------|-----------------|--------------|
| Webservice           | 308 vCPU385 GB memory (request)539 GB memory (limit) | 11 x `n1-standard-32` | 11 x `c5.9xlarge` |

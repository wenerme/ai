...
Deploy a GitLab Self-Managed instance for up to 3,000 users or 60 RPS with high-availability components and recommended sizing.
...
|----------------------|-------------------------|-----------------|--------------|
| Webservice           | 16 vCPU20 GB memory (request)28 GB memory (limit) | 2 x `n1-standard-16` | 2 x `c5.4xlarge` |

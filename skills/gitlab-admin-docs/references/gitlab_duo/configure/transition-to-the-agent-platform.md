...
| GitLab Duo Code Review | [Code Review Flow](../../../user/duo_agent_platform/flows/foundational_flows/code_review/_index.md) <sup>1</sup>   Automate code review tasks and enforce coding standards across your team. |
| Root cause analysis | [Fix CI/CD pipeline flow](../../../user/duo_agent_platform/flows/foundational_flows/fix_pipeline.md) <sup>1</sup>  Diagnose and automatically fix failing CI/CD pipelines. |
| Vulnerability explanation and resolution | [SAST vulnerability resolution flow](../../../user/duo_agent_platform/flows/foundational_flows/agentic_sast_vulnerability_resolution.md) <sup>1</sup>  Automatically generate fixes and remediation steps for SAST vulnerabilities. |

...
| GitLab Duo Code Review | [Code Review Flow](../../../user/duo_agent_platform/flows/foundational_flows/code_review.md) <sup>1</sup>   Automate code review tasks and enforce coding standards across your team. |

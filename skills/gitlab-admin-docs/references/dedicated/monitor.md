...
Manage access to application logs for your GitLab Dedicated instance.
...
1. Under **Application logs**, in the **Log access ARNs** section:
   ...
   - To edit access: Next to an ARN, select the pencil icon (),
     update the ARN, then select **Save**.
   - To remove access: Next to an ARN, select the trash icon (),
     then select **Delete**.

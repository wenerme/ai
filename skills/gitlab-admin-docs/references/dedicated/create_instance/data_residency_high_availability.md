...
Available AWS regions, data isolation, and high availability for GitLab Dedicated.
...
| ------------------------- | ---------------- | ------------------------------------------- | ------------------------------------------- | --------------------- |
| Africa (Cape Town)        | `af-south-1`     |  Yes |  Yes | F                     |
| Asia Pacific (Hong Kong)  | `ap-east-1`      |  No          |  No          | E                     |
| Asia Pacific (Hyderabad)  | `ap-south-2`     |  No          |  Yes | E                     |
| Asia Pacific (Jakarta)    | `ap-southeast-3` |  No          |  Yes | F                     |
| Asia Pacific (Melbourne)  | `ap-southeast-4` |  No          |  No          | F                     |
| Asia Pacific (Mumbai)     | `ap-south-1`     |  Yes |  Yes | E                     |
| Asia Pacific (Osaka)      | `ap-northeast-3` |  No          |  Yes | E                     |
| Asia Pacific (Seoul)      | `ap-northeast-2` |  Yes |  Yes | E                     |
| Asia Pacific (Singapore)  | `ap-southeast-1` |  Yes |  Yes | E                     |
| Asia Pacific (Sydney)     | `ap-southeast-2` |  Yes |  Yes | E                     |
| Asia Pacific (Tokyo)      | `ap-northeast-1` |  Yes |  Yes | E                     |
| Canada (Central)          | `ca-central-1`   |  Yes |  Yes | A+                    |
| Europe (Frankfurt)        | `eu-central-1`   |  Yes |  Yes | D                     |
| Europe (Ireland)          | `eu-west-1`      |  Yes |  Yes | D                     |
| Europe (London)           | `eu-west-2`      |  Yes |  Yes | B                     |
| Europe (Milan)            | `eu-south-1`     |  No          |  Yes | C                     |
| Europe (Paris)            | `eu-west-3`      |  No          |  Yes | A+                    |
| Europe (Spain)            | `eu-south-2`     |  No          |  No          | B                     |
| Europe (Stockholm)        | `eu-north-1`     |  Yes |  Yes | A+                    |
| Europe (Zurich)           | `eu-central-2`   |  No          |  Yes | A+                    |
| Israel (Tel Aviv)         | `il-central-1`   |  No          |  Yes | E                     |
| Middle East (Bahrain)     | `me-south-1`     |  No          |  Yes | E                     |
| Middle East (UAE)         | `me-central-1`   |  No          |  No          | D                     |
| South America (São Paulo) | `sa-east-1`      |  Yes |  Yes | B                     |
| US East (N. Virginia)     | `us-east-1`      |  Yes |  Yes | D                     |
| US East (Ohio)            | `us-east-2`      |  Yes |  Yes | D                     |
| US West (N. California)   | `us-west-1`      |  No          |  Yes | C                     |
| US West (Oregon)          | `us-west-2`      |  Yes |  Yes | C                     |

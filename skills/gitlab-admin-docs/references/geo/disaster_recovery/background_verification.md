...
1. Expand **Verification information** tab for that site to view automatic checksumming
   ...
   [Verification information tab with an overview of a healthy primary Geo instance.]
...
1. Expand **Verification information** tab for that site to view automatic checksumming
   ...
   [Verification information tab with an overview of a healthy secondary Geo instance.]
...
1. Select **Edit** for the primary site to customize the minimum
   ...
   [Window with configuration attributes of a Geo node.]

...
Finalize your secondary Geo site setup by replicating secrets, SSH keys, and adding the new site to the primary to begin data synchronization.
...
1. Go to the primary node GitLab instance:
   ...
   1. Select **Add site**.
      [Adding a secondary site in Geo configuration interface]

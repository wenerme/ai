...
| [User uploads](../../uploads.md)                                                                                           | Yes                                                                 | Yes                                                                 | Yes                                                                        | Yes <sup>1</sup>                                                      | Replication is behind feature flag `geo_upload_replication`, enabled by default. |
| [LFS objects](../../lfs/_index.md)                                                                                    | Yes                                                                   | Yes                                                                   | Yes                                                                     | Yes <sup>1</sup>                                                        | Replication is behind feature flag `geo_lfs_object_replication`, enabled by default. |
...
| [CI job artifacts](../../../ci/jobs/job_artifacts.md)                                                              | Yes                                                                 | Yes                                                                | Yes                                                                     | Yes <sup>1</sup>                                                          | Replication is behind feature flag `geo_job_artifact_replication`, enabled by default. On the primary site, checksumming continues unless `geo_job_artifact_force_primary_checksumming` is also disabled. See [Enable or disable replication](#enable-or-disable-replication-for-some-data-types). |
| Pipeline artifacts                                                                                                 | Yes                                                                      | Yes                                                                      | Yes                                                                             | Yes <sup>1</sup>                                                          | Replication is behind feature flag `geo_pipeline_artifact_replication`, enabled by default. Persists additional artifacts after a pipeline completes. |
| [CI Secure Files](https://gitlab.com/gitlab-org/gitlab/-/blob/master/app/models/ci/secure_file.rb)                    | Yes                                                                      | Yes                                                                      | Yes                                                                       | Yes <sup>1</sup>                                                                | Replication is behind feature flag `geo_ci_secure_file_replication`, enabled by default. |
...
| [Terraform Module Registry](../../../user/packages/terraform_module_registry/_index.md)                                | Yes                                                                       | Yes                                                                       | Yes                                                                             | Yes <sup>1</sup>                                                                 | Replication is behind feature flag `geo_package_file_replication`, enabled by default. |
| [Project designs repository](../../../user/project/issues/design_management.md)                                       | Yes                                                                       | Yes                                                                       | Yes <sup>1</sup>                                                                 | Yes <sup>1</sup>                                                                 | Replication is behind feature flag `geo_design_management_repository_replication`, enabled by default. Designs also require replication of LFS objects and Uploads. |
| [Package registry](../../../user/packages/package_registry/_index.md)                                                  | Yes                                                                       | Yes                                                                       | Yes                                                                         | Yes <sup>1</sup>                                                                | Replication is behind feature flag `geo_package_file_replication`, enabled by default. |
...
| [Versioned Terraform State](../../terraform_state.md)                                                                 | Yes                                                                       | Yes                                                                       | Yes                                                                              | Yes <sup>1</sup>                                                                 | Replication is behind feature flag `geo_terraform_state_version_replication`, enabled by default. |
| [External merge request diffs](../../merge_request_diffs.md)                                                          | Yes                                                                       | Yes                                                                       | Yes                                                                              | Yes <sup>1</sup>                                                                 | Replication is behind feature flag `geo_merge_request_diff_replication`, enabled by default. |
| [Versioned Snippets](../../../user/snippets.md#versioned-snippets)                                                    | Yes                                                                           | Yes                                                                   | Yes <sup>1</sup>                                                                 | Yes <sup>1</sup>                                                                | Replication is behind feature flag `geo_snippet_repository_replication`, enabled by default. |
| [Pages](../../pages/_index.md)                                                                                  | Yes                                                                          | Yes                                                                       | Yes                                                                             | Yes <sup>1</sup>                                                               | Replication is behind feature flag `geo_pages_deployment_replication`, enabled by default. |
| [Project-level CI Secure Files](../../../ci/secure_files/_index.md)                                                       | Yes                                                                       | Yes                                                                       | Yes                                                                         | Yes <sup>1</sup>                                                             | None |
| [Incident Metric Images](../../../operations/incident_management/incidents.md#metrics)                                | Yes                                                                       | Yes                                                                       | Yes                                                                         | Yes <sup>1</sup>                                                                 | Replication and verification are handled through the Uploads data type. |
| [Alert Metric Images](../../../operations/incident_management/alerts.md#metrics-tab)                                  | Yes                                                                       | Yes                                                                       | Yes                                                                         | Yes <sup>1</sup>                                                                 | Replication and verification are handled through the Uploads data type. |
...
| [Dependency Proxy Images](../../../user/packages/dependency_proxy/_index.md)                                           | Yes                                                       | Yes                                                                           | Yes                                                                           | Yes <sup>1</sup>                                                                 | None |
| [Packages NuGet Symbol](../../../user/packages/nuget_repository/_index.md#symbol-packages)                                                                                                 | [Yes (18.10)](https://gitlab.com/gitlab-org/gitlab/-/issues/422929)           | [Yes (18.10)](https://gitlab.com/gitlab-org/gitlab/-/issues/422929)           | Yes                                                                           | Yes <sup>1</sup>  | Replication is behind feature flag `geo_packages_nuget_symbol_replication`, enabled by default.   |
...
1. Object storage verification is behind a feature flag named `geo_object_storage_verification`. Enabled by default.

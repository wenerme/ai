...
| [Project-level CI Secure Files](../../../ci/secure_files/_index.md)                    | Yes                                                                      | Yes                                                                      | Yes                                                                       | Yes <sup>1</sup>                                                                | Replication is behind feature flag `geo_ci_secure_file_replication`, enabled by default. |
...
| [Dependency Proxy Images](../../../user/packages/dependency_proxy/_index.md)                                           | Yes                                                       | Yes                                                                           | Yes                                                                           | Yes <sup>1</sup>                                                                 | Replication is behind feature flags `geo_dependency_proxy_blob_replication` and `geo_dependency_proxy_manifest_replication`, enabled by default. |
...
1. See [Object storage verification](object_storage.md#object-storage-verification) for information about the feature flag `geo_object_storage_verification`, which is enabled by default.

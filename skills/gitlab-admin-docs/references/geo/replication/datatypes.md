...
| [Packages NuGet Symbol](../../../user/packages/nuget_repository/_index.md#symbol-packages)                             | Yes                                                                  | Yes                                                                      | Yes                                                                           | Yes[^object-storage-verification]                                               | Replication is behind feature flag `geo_packages_nuget_symbol_replication`, enabled by default. [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/422929) in GitLab 18.10. |
...
| Packages Debian ProjectComponentFile                                                                                  | Yes                                                                   | Yes                                                                      | Yes                                                                        | Yes                                                                        | Behind feature flag `geo_packages_debian_project_component_file_replication`, disabled by default. [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/333611) in GitLab 19.1. |

...
1. In the left sidebar, select **Overview** > **Users**.
1. In the search box, filter by **State=Pending approval** and press <kbd>Enter</kbd>.
1. For the new user account you want to approve or reject, select the vertical ellipsis (), then **Approve** or **Reject**.
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Users**.
1. For the user you want to block, select the vertical ellipsis (), then **Block**.
...
1. For the user you want to unblock, select the vertical ellipsis (), then **Unblock**.
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Users**.
1. For the user you want to deactivate, select the vertical ellipsis () and then **Deactivate**.
...
1. For the user you want to reactivate, select the vertical ellipsis (), then **Activate**.
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Users**.
1. Next to the member you want to ban, select the vertical ellipsis ().
...
1. In the upper-right corner, select **Admin**.
1. In the left sidebar, select **Overview** > **Users**.
1. For the user you want to delete, select the vertical ellipsis (), then **Delete user**.
1. Type the username.
1. Select either:

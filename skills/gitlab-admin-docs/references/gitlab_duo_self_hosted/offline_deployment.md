# Deploy GitLab Duo Agent Platform Self-Hosted in an offline environment

Transfer container images and LLM model weights to your internal infrastructure to run GitLab Duo Self-Hosted without internet access

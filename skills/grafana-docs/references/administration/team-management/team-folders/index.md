...
[Folder detail page showing a team folder.]
...
[New team page with the Team folder section visible and Auto-create a team folder selected.]
...
[New folder drawer with Assign an owner to the folder enabled and a team selected in the Team field.]
...
[Folder page header showing the Owned by label and the Manage folder owner modal open from Folder actions.]
...
[Dashboards page with the My team folders section expanded and two team-owned folders listed.]
...
[Folder picker in a save or move flow with Team folders shown at the top of the tree and one team folder selected.]

### Review folders owned by a team

Each team page includes a **Folders** tab that lists all the folders owned by that team.

[Team details page on the Folders tab showing the owned folders table with Name and Full path columns.]

...
[The value 10 mapped to the text Perfection!]
...
[Ranges of numbers mapped to the text Low and High with colors yellow and red]
...
[A regular expression used to truncate full URLs to the text wwww]
...
[The value null mapped to the text N/A]

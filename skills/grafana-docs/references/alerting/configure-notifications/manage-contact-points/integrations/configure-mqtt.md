...
| Option                   | Description                                                                                                                                                                                                                                                                                                            |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Message format           | If set to `json` (default), the notification message uses the [default JSON payload](#default-json-payload).  If set to `text`, the notification message is fully customizable.                                                                                                                                   |
| Message                  | Depends on the **Message format** option.  In `json` format, defines only the `message` field of the [default JSON payload](#default-json-payload).  In `text` format, defines the [entire custom payload](#custom-payload).  This field supports [notification templates](ref:notification-templates). |
...
| `message`           | string                           | Custom message configured in **Message** (**Optional Settings**).  Supports [notification templates](ref:notification-templates); the output is formatted as a string. |

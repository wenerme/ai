...
Check [`EXPORT` documentation](https://duckdb.org/docs/current/sql/statements/export.html) for more details on the syntax.
...
[DuckDB v1.2.0 introduced the `STORAGE_VERSION` option](https://duckdb.org/2025/02/05/announcing-duckdb-120.html#explicit-storage-versions), which allows explicitly specifying the storage version.
...
With the [command line client](https://duckdb.org/docs/current/clients/cli/overview.html), you can use the `-storage-version` argument:

```batch
duckdb -storage-version v1.2.0 my_database.duckdb
```

To create a database with the latest storage version, use:
...
The `storage_compatibility_version` [configuration option](https://duckdb.org/docs/current/configuration/overview.html#configuration-reference) can also be used to specify the storage version to use. It can be specified in various ways.
...
DuckDB uses [lightweight compression](https://duckdb.org/2022/10/28/lightweight-compression.html).
By default, compression is only applied to persistent databases and is **not applied to in-memory instances**.
To turn on compression for in-memory databases, use `ATTACH` with the [`COMPRESS` option](https://duckdb.org/docs/current/sql/statements/attach.html#options).
...
* [Constant Encoding](https://duckdb.org/2022/10/28/lightweight-compression.html#constant-encoding)
* [Run-Length Encoding (RLE)](https://duckdb.org/2022/10/28/lightweight-compression.html#run-length-encoding-rle)
* [Bit Packing](https://duckdb.org/2022/10/28/lightweight-compression.html#bit-packing)
* [Frame of Reference (FOR)](https://duckdb.org/2022/10/28/lightweight-compression.html#frame-of-reference)
* [Dictionary Encoding](https://duckdb.org/2022/10/28/lightweight-compression.html#dictionary-encoding)
* [Fast Static Symbol Table (FSST)](https://duckdb.org/2022/10/28/lightweight-compression.html#fsst) – [VLDB 2020 paper](https://www.vldb.org/pvldb/vol13/p2649-boncz.pdf)
* [Adaptive Lossless Floating-Point Compression (ALP)](https://duckdb.org/2024/02/13/announcing-duckdb-0100.html#adaptive-lossless-floating-point-compression-alp) – [SIGMOD 2024 paper](https://ir.cwi.nl/pub/33334/33334.pdf)
* [Chimp](https://duckdb.org/2022/10/28/lightweight-compression.html#chimp--patas) – [VLDB 2022 paper](https://www.vldb.org/pvldb/vol15/p3058-liakos.pdf)
* [Patas](https://duckdb.org/2022/11/14/announcing-duckdb-060.html#compression-improvements)
* [Zstd](https://duckdb.org/2025/02/05/announcing-duckdb-120.html#zstd-compression)
...
Several features in DuckDB, including [parallelism](https://duckdb.org/docs/current/guides/performance/how_to_tune_workloads.html) and [compression](https://duckdb.org/2022/10/28/lightweight-compression.html) are based on row groups.
...
2. Open the database with the latest version of DuckDB, export it to a standard format (e.g., Parquet), then import it to any version of DuckDB. See the [`EXPORT/IMPORT DATABASE` statements](https://duckdb.org/docs/current/sql/statements/export.html) for details.

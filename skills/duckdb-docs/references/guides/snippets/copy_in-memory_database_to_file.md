...
To achieve this, **attach to a new disk-based database** and use the [`COPY FROM DATABASE ... TO` command](https://duckdb.org/docs/current/sql/statements/copy.html#copy-from-database--to):

...
To view the schema of an individual table, use the [`DESCRIBE` command](https://duckdb.org/docs/current/guides/meta/describe.html).

## See Also

The SQL-standard [`information_schema`](https://duckdb.org/docs/current/sql/meta/information_schema.html) views are also defined. Moreover, DuckDB defines `sqlite_master` and many [PostgreSQL system catalog tables](https://www.postgresql.org/docs/16/catalogs.html) for compatibility with SQLite and PostgreSQL respectively.

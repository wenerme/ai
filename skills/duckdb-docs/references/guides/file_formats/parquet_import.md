...
To create a new table using the result from a query, use the [`CREATE TABLE ... AS SELECT` statement](https://duckdb.org/docs/current/sql/statements/create_table.html#create-table--as-select-ctas):
...
For additional options, see the [Parquet loading reference](https://duckdb.org/docs/current/data/parquet/overview.html).

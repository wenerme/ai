...
DuckDB can also [import Excel files](https://duckdb.org/docs/current/guides/file_formats/excel_import.html).
For additional details on Excel support, see the [`excel` extension page](https://duckdb.org/docs/current/core_extensions/excel.html).

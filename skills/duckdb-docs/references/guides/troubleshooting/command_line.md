...
On Linux and macOS, DuckDB v1.5.0 has a known issue that the [command line client](https://duckdb.org/docs/current/clients/cli/overview.html) does not interpret piped scripts ([#21243](https://github.com/duckdb/duckdb/issues/21243)).
...
If you are piping from a file, you can also use the [`-f` argument](https://duckdb.org/docs/current/clients/cli/arguments.html):

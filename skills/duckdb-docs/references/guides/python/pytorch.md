...
To learn more about querying Arrow objects directly, see the [“SQL on Apache Arrow” guide](https://duckdb.org/docs/current/guides/python/sql_on_arrow.html) and the [“Export to Apache Arrow” guide](https://duckdb.org/docs/current/guides/python/export_arrow.html).

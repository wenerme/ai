...
This requires the [`httpfs` extension](https://duckdb.org/docs/current/core_extensions/httpfs/overview.html), which can be installed using the `INSTALL` SQL command. This only needs to be run once.

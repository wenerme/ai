...
For implementation details, see the [blog post “DuckDB's AsOf joins: Fuzzy Temporal Lookups”](https://duckdb.org/2023/09/15/asof-joins-fuzzy-temporal-lookups.html).

...
To run a query directly on a running PostgreSQL database, the [`postgres` extension](https://duckdb.org/docs/current/core_extensions/postgres/overview.html) is required.
...
For more information see the [PostgreSQL extension documentation](https://duckdb.org/docs/current/core_extensions/postgres/overview.html).

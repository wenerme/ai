...
To run a query directly on a running MySQL database, the [`mysql` extension](https://duckdb.org/docs/current/core_extensions/mysql.html) is required.
...
For a list of supported operations, see the [MySQL extension documentation](https://duckdb.org/docs/current/core_extensions/mysql.html#supported-operations).

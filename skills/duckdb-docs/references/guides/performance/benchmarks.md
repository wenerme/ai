...
For several of the recommendations in our performance guide, we use microbenchmarks to back up our claims. For these benchmarks, we use datasets from the [TPC-H benchmark](https://duckdb.org/docs/current/core_extensions/tpch.html) and the [LDBC Social Network Benchmark’s BI workload](https://github.com/ldbc/ldbc_snb_bi/blob/main/snb-bi-pre-generated-data-sets.md#compressed-csvs-in-the-composite-merged-fk-format).
...
The TPC datasets used in the benchmark are generated with the DuckDB [tpch extension](https://duckdb.org/docs/current/core_extensions/tpch.html).

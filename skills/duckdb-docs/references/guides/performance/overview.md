...
The guides include several microbenchmarks. You may find details about these on the [Benchmarks page](https://duckdb.org/docs/current/guides/performance/benchmarks.html).

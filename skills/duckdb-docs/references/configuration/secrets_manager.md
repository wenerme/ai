...
| ------------- | -------------------- | --------------------------------------------------------------------------------- |
| `azure`       | Azure Blob Storage   | [`azure`](https://duckdb.org/docs/current/core_extensions/azure.html)                       |
...
Secrets can be created using the [`CREATE SECRET` SQL statement](https://duckdb.org/docs/current/sql/statements/create_secret.html).
...
Secrets can be deleted using the [`DROP SECRET` statement](https://duckdb.org/docs/current/sql/statements/create_secret.html#syntax-for-drop-secret), e.g.:
...
Secrets can be listed using the built-in table-producing function, e.g., by using the [`duckdb_secrets()` table function](https://duckdb.org/docs/current/sql/meta/duckdb_table_functions.html#duckdb_secrets):

...
- npm: `npm create refine-app@latest -- --preset refine-antd`
- yarn: `yarn create refine-app@latest -- --preset refine-antd`
- pnpm: `pnpm create refine-app@latest -- --preset refine-antd`

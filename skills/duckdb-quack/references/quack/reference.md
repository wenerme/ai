...
This page lists every function, setting, and log type exposed by the [quack extension](https://duckdb.org/docs/current/core_extensions/quack.html).
For a tour of the protocol, start with the [Overview](https://duckdb.org/docs/current/quack/overview.html).
...
You can plug in your own auth by creating any scalar function with the expected signature and pointing the setting at it. See [Security](https://duckdb.org/docs/current/quack/security.html) for examples.

...
The Quack server speaks plain HTTP only and binds to localhost by default. See [Security](https://duckdb.org/docs/current/quack/security.html) for the rationale behind these configurations.

...
> **note**: To rapidly deploy large HA clusters, see [Related Projects](/related-projects)
...
> **note**: The same installation options available to single-server installs are also available for high-availability installs. For more details, see the [Configuration Options](../installation/configuration.md) documentation.

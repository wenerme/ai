...
> **info**: Operators must manage network policies as normal for additional namespaces that are created.
...
> **note**: Remediation to achieve passing score is only needed for cis-1.9

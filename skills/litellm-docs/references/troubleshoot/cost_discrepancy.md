...
[LiteLLM dashboard date range picker]
...
[Navigate to Model activity in the LiteLLM UI]

Scroll the **Model** list and select the model you are reconciling with your provider bill.

[Scroll to your model in the Model activity table]
...
[LiteLLM usage breakdown by token category]

...
Fields `contents[]` ``object (`https://ai.google.dev/api/generate-content#v1beta.Content`)`` Optional. The input given to the model as a prompt. This field is ignored when `generateContentRequest` is set.

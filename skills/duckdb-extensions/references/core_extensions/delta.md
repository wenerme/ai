...
> To connect to Unity Catalog, DuckDB has the [`unity_catalog` extension](https://duckdb.org/docs/current/core_extensions/unity_catalog.html).

## Installing and Loading

The `delta` extension will be transparently [autoloaded](https://duckdb.org/docs/current/extensions/overview.html#autoloading-extensions) on first use from the official extension repository.
...
To scan a Delta table in an [S3 bucket](https://duckdb.org/docs/current/core_extensions/httpfs/s3api.html), run:
...
For authenticating to S3 buckets, DuckDB [Secrets](https://duckdb.org/docs/current/configuration/secrets_manager.html) are supported:
...
To scan a Delta table in an [Azure Blob Storage bucket](https://duckdb.org/docs/current/core_extensions/azure.html#azure-blob-storage), run:
...
For authenticating to Azure Blob Storage, DuckDB [Secrets](https://duckdb.org/docs/current/configuration/secrets_manager.html) are supported:
...
To scan a Delta table in a [GCS bucket](https://duckdb.org/docs/current/core_extensions/httpfs/s3api.html), use [HMAC keys](https://console.cloud.google.com/storage/settings;tab=interoperability) and create a secret:

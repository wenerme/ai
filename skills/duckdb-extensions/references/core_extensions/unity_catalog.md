...
[`Delta Lake`](https://delta.io/) format and [DuckDB Delta extension](https://duckdb.org/docs/current/core_extensions/delta.html).

The [`delta` extension](https://duckdb.org/docs/current/core_extensions/delta.html) adds support for the [Delta Lake open-source storage format](https://delta.io/). It is built using the [Delta Kernel](https://github.com/delta-incubator/delta-kernel-rs). The extension offers **read support** for Delta tables, both local and remote.

For implementation details, see the [announcement blog post](https://duckdb.org/2024/06/10/delta.html).
...
Support for the [other DuckDB platforms](https://duckdb.org/docs/current/extensions/extension_distribution.html#platforms) is work-in-progress.

...
Using the [DuckDB CLI client](https://duckdb.org/docs/current/clients/cli/overview.html),
you can start the UI with a CSV available as a view using the [`-cmd` argument](https://duckdb.org/docs/current/clients/cli/arguments.html):

...
The [`spatial` extension](https://duckdb.org/docs/current/core_extensions/spatial/overview.html) provides support for spatial indexing through the R-tree extension index type.

...
S3 Tables is an Iceberg REST Catalog. For the full list of `ATTACH` options — and details on the compatibility flags — see [Iceberg REST Catalogs](https://duckdb.org/docs/current/core_extensions/iceberg/iceberg_rest_catalogs.html#attach-options).

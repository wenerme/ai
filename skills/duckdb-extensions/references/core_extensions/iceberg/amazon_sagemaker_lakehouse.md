...
> follow the [extension documentation](https://duckdb.org/docs/current/extensions/installing_extensions.html#force-installing-to-upgrade-extensions).
...
You can learn more about the `WITH` clause at [Table Properties](https://duckdb.org/docs/current/core_extensions/iceberg/writing.html#table-properties).

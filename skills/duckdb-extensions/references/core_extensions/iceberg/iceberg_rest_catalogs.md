...
This page covers connecting to Iceberg REST Catalogs: authentication, the full set of `ATTACH` options, and setup instructions for specific catalogs. For the basics of attaching a catalog and querying it, see [Catalog Managed Tables](https://duckdb.org/docs/current/core_extensions/iceberg/overview.html#catalog-managed-tables); for write operations, see [Writing to Iceberg](https://duckdb.org/docs/current/core_extensions/iceberg/writing.html).

If you are attaching to an Iceberg REST Catalog managed by Amazon, please see the instructions for attaching to [Amazon S3 Tables](https://duckdb.org/docs/current/core_extensions/iceberg/amazon_s3_tables.html) or [Amazon SageMaker Lakehouse](https://duckdb.org/docs/current/core_extensions/iceberg/amazon_sagemaker_lakehouse.html).
...
* [Amazon S3 Tables](https://duckdb.org/docs/current/core_extensions/iceberg/amazon_s3_tables.html)
* [Amazon SageMaker Lakehouse (AWS Glue)](https://duckdb.org/docs/current/core_extensions/iceberg/amazon_sagemaker_lakehouse.html)

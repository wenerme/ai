...
## Migrate from Desktop Legacy

If you're still using the older Desktop Legacy version (single-install desktop app), you can migrate your custom nodes, workflows, and models to the new Comfy Desktop. Your existing data is preserved — no manual migration needed.

  
    Step-by-step guide to migrate from Desktop Legacy to Comfy Desktop.

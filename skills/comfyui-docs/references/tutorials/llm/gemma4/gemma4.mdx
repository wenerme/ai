...
description: "Run Google's lightweight open Gemma 4 LLM in ComfyUI for text generation, image understanding, video analysis, and audio transcription with up to 256K context."
---

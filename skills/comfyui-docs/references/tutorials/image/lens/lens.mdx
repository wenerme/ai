...
description: "Run Lens, Microsoft's 3.8B open text-to-image model, in ComfyUI: a dual-stream MMDiT backbone, GPT-OSS-20B text features, and the FLUX.2 semantic VAE."
---

...
[Qwen-Image text-to-image workflow preview]
...
[Qwen-Image InstantX ControlNet workflow preview]
...
[Qwen-Image ControlNet model patch workflow preview]
...
[Qwen-Image Union Control workflow preview]
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  [Input image]
  [Qwen-Image Union Control example output]
</div>

...
[Qwen-Image-2.1 text to image workflow preview]
...
[Qwen-Image-2.1 image edit workflow preview]
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  [Input image]
  [Qwen-Image-2.1 image edit example output]
</div>
...
[Qwen-Image-2.1 background removal workflow preview]

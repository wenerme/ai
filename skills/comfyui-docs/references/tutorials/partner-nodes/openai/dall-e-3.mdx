...
---
  ...
  **Deprecated**: OpenAI has discontinued the DALL·E 3 model. The **OpenAI DALL·E 3** node has been retired and removed from ComfyUI. Use the **GPT Image** node instead. This page is kept for reference only.
...
[OpenAI DALL·E 3 node screenshot]
...
[ComfyUI openai-dall-e-3 workflow]

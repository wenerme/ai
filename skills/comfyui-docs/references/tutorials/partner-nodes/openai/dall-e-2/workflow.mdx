---
title: "DALL·E 2 Workflows in ComfyUI"
description: "How to run the DALL·E 2 text-to-image and inpainting workflows in ComfyUI, locally or on Comfy Cloud"
---

This guide shows how to run the DALL·E 2 workflows in ComfyUI. For what the model is and what it does best, see the [DALL·E 2 overview](/tutorials/partner-nodes/openai/dall-e-2).
...
[ComfyUI openai-dall-e-2 workflow example]

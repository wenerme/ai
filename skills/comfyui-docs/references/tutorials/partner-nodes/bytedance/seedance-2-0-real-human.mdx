...
description: "Generate videos of real people in Seedance 2.0 with consistent identity and native audio sync, after a one-time liveness check in ComfyUI."
---

[Seedance 2.0 Real Human Cover]
...
[ByteDance Create Image/Video Asset nodes used to generate Group ID and Asset ID]
...
[Upload your portrait and run to start liveness verification]

**Step 2: Get the verification link**

[Workflow run returns a verification link to open in browser]

**Step 3: Complete liveness check in the H5 page**

[Complete identity authentication in the H5 verification page]

**Step 4: Return to ComfyUI and save IDs (no extra credits)**

[After verification, ComfyUI outputs Asset ID and Group ID to save for reuse]
...
[Reuse an existing Group ID to skip liveness verification when the person matches]
...
[Seedance 2.0 Real Human R2V workflow preview]
...
[Seedance 2.0 Real Human FLF2V workflow preview]

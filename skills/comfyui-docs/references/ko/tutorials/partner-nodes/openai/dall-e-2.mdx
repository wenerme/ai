...
translationSourceHash: 7ac6e06c
translationFrom: tutorials/partner-nodes/openai/dall-e-2.mdx
translationBlockHashes:
  "_intro": 91dc3db1
  "What DALL·E 2 is good at": c23d3c01
  "Example outputs": f895b34e
  "Parameter Description": 20ac288b
  "Workflow Examples": 9c7f54e4
  "FAQs": 2b8e1938
---

  **지원 중단**: OpenAI가 DALL·E 2 모델 제공을 중단하여 **OpenAI DALL·E 2** 노드는 더 이상 지원되지 않으며 ComfyUI에서 제거되었습니다. 대신 **GPT Image** 노드를 사용하세요. 이 페이지는 참고용으로만 유지됩니다.

[OpenAI DALL·E 2 노드 스크린샷]

OpenAI DALL·E 2는 ComfyUI 파트너 노드 시리즈의 일부로, 사용자가 OpenAI의 **DALL·E 2** 모델을 통해 이미지를 생성할 수 있도록 합니다.

**OpenAI DALL·E 2** 노드는 OpenAI의 이미지 생성 API를 통해 이미지를 동기적으로 생성합니다. 텍스트 프롬프트를 입력받아 설명과 일치하는 이미지를 반환합니다.
...
텍스트 프롬프트를 기반으로 입력 이미지의 마스크된 영역을 교체하는 inpainting:
...
해당 예시는 매우 간단합니다.
[ComfyUI openai-dall-e-2 워크플로우 예시]

...
### 텍스트 기반 비디오 생성 (Omni Flash) {#api_google_gemini_omni_flash_t2v}

프리뷰 버전 Gemini Omni Flash 모델을 사용해 단일 텍스트 프롬프트에서 비디오를 생성합니다. 하나의 프롬프트에 장면, 길이, 화면 비율을 설명하면 네이티브 오디오 트랙이 포함된 클립을 렌더링합니다.

[Gemini Omni Flash 텍스트 비디오 워크플로 미리보기]

  
    Comfy Cloud에서 열기
  
  
    JSON을 다운로드하거나 템플릿 라이브러리에서 "Gemini Omni"를 검색하세요
  

프리뷰 Omni Flash 모델은 2026년 9월 30일에 종료될 예정입니다. GA 모델은 아래의 Omni Flash 1.1 워크플로를 사용하세요.
...
[Gemini Omni Flash 1.1 텍스트 기반 비디오 생성 워크플로 미리보기]
...
[Gemini Omni Flash 1.1 이미지 기반 비디오 생성 워크플로 미리보기]
...
[Gemini Omni Flash 1.1 참조 이미지 기반 비디오 생성 워크플로 미리보기]
...
[Gemini Omni Flash 1.1 비디오 편집 워크플로 미리보기]
...
[Gemini Omni Flash 1.1 비디오 확장 워크플로 미리보기]

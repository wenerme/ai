...
description: "ComfyUI에서 Wan2.1 비디오 워크플로 실행: 1.3B 모델로 텍스트 기반 비디오, 14B 모델로 이미지 기반 비디오 생성, 모델 설치 포함."
...
**텍스트 인코더**에서 하나의 버전을 선택해 다운로드하세요:
    ...
    FP16 정밀도 텍스트 인코더. <code>ComfyUI/models/text_encoders/</code>에 배치하세요.
  
  
    FP8 스케일링된 텍스트 인코더. <code>ComfyUI/models/text_encoders/</code>에 배치하세요.
...
**CLIP Vision**
    ...
    이미지 조건화를 위한 CLIP Vision 모델. <code>ComfyUI/models/clip_vision/</code>에 배치하세요.
...
### Wan 2.1 텍스트 기반 비디오 생성 {#text_to_video_wan}

Wan 2.1을 사용하여 텍스트 프롬프트에서 비디오를 생성합니다.

[Wan 2.1 텍스트 기반 비디오 생성 워크플로 미리보기]
...
### 모델 다운로드
    ...
    Wan2.1 텍스트 기반 비디오 생성용 확산 모델입니다. <code>ComfyUI/models/diffusion_models/</code>에 배치하세요.
...
### Wan 2.1 이미지 기반 비디오 생성 {#image_to_video_wan}

Wan 2.1을 사용해 이미지로부터 비디오를 생성합니다.

[Wan 2.1 이미지 기반 비디오 생성 워크플로 미리보기]

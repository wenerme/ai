---
title: "라이프사이클"
description: "ComfyUI가 init.py를 통해 커스텀 노드를 로드하는 방식. NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS, 클라이언트 JavaScript 배포용 WEB_DIRECTORY를 설명합니다."
translationSourceHash: 100574a9

---
title: "컴피 후크"
description: "ComfyUI 프론트엔드 JavaScript hooks 종합 레퍼런스. app.registerExtension 사용법, nodeCreated와 beforeRegisterNodeDef 처리, UI 동작 커스터마이징을 배웁니다."
translationSourceHash: 98c9763b

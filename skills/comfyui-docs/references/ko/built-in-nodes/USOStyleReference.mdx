...
description: "USOStyleReference 노드는 CLIP 비전 출력에서 인코딩된 이미지 특징을 사용하여 모델에 스타일 참조 패치를 적용합니다. 시각적 입력에서 추출된 스타일 정보를 통합하여 입력 모델의 수정된 버전을 생성함으로써, 스타일 전이 또는 참조 기반 생성 기능을 가능하게 합니다."
mode: wide
---

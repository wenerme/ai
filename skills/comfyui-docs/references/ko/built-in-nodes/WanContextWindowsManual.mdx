...
| `컨텍스트 스케줄` | 컨텍스트 윈도우의 보폭입니다. | COMBO | 예 | `"static_standard"``"uniform_standard"``"uniform_looped"``"batched"` |
...
| `퓨즈 방법` | 컨텍스트 윈도우를 융합하는 데 사용할 방법입니다(기본값: "pyramid"). | COMBO | 예 | `"pyramid"``"gaussian"``"average"``"overlap"` |

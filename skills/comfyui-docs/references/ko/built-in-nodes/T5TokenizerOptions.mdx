...
description: "T5TokenizerOptions 노드를 사용하면 다양한 T5 모델 유형에 대한 토크나이저 설정을 구성할 수 있습니다. 이 노드는 t5xxl, pilet5xl, t5base, mt5xl, umt5xxl 등 여러 T5 모델 변형에 대한 최소 패딩 및 최소 길이 매개변수를 설정합니다."
mode: wide
---

...
| `attention` | 적용할 밀집 어텐션 백엔드입니다. Comfy Kitchen 어텐션은 양자화된 INT8 어텐션을 사용하며 Nvidia 및 AMD GPU에서만 사용할 수 있습니다. 기본값: "pytorch attention". 선택한 백엔드를 사용할 수 없으면 PyTorch 어텐션이 대체로 사용됩니다. | COMBO | 예 | "pytorch attention""comfy kitchen attention" |

...
description: "PhotoMakerLoader 노드는 사용 가능한 모델 파일에서 PhotoMaker 모델을 로드합니다. 지정된 모델 파일을 읽고 신원 기반 이미지 생성 작업에 사용할 PhotoMaker ID 인코더를 준비합니다. 이 노드는 실험적 기능으로 표시되어 있으며 테스트 목적으로 사용됩니다."
mode: wide
---

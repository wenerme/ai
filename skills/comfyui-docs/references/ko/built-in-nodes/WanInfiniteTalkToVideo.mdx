...
| --- | --- | --- | --- | --- |
| `mode` | 오디오 입력 모드입니다. `single_speaker`는 하나의 오디오 입력을 사용합니다. `two_speakers`는 두 화자 입력 섹션에 나열된 추가 오디오 입력과 마스크를 활성화합니다. | DYNAMIC_COMBO | 예 | `"single_speaker"``"two_speakers"` |

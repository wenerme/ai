...
description: "ModelPatchLoader 노드는 modelpatches 폴더에서 특화된 모델 패치를 로드합니다. 패치 파일의 유형을 자동으로 감지하여 적절한 모델 아키텍처를 로드한 후, 워크플로에서 사용할 수 있도록 ModelPatcher로 래핑합니다. 이 노드는 controlnet 블록, 특징 임베더 모델 및 기타 특수 아키텍처"
mode: wide
---

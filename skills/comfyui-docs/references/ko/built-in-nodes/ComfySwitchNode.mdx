...
description: "Switch 노드는 불리언 조건에 따라 두 개의 입력 중 하나를 선택합니다. switch가 활성화된 경우 ontrue 입력을 출력하고, switch가 비활성화된 경우 onfalse 입력을 출력합니다. 이를 통해 워크플로우에서 조건부 로직을 생성하고 서로 다른 데이터 경로를 선택할 수 있습니다."
mode: wide
---

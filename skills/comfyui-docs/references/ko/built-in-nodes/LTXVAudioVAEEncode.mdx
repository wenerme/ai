...
description: "LTXV 오디오 VAE 인코딩 노드는 오디오 입력을 받아 지정된 오디오 VAE 모델을 사용하여 더 작은 잠재 표현으로 압축합니다. 이 프로세스는 원시 오디오 데이터를 파이프라인의 다른 노드가 이해하고 처리할 수 있는 형식으로 변환하므로, 잠재 공간 워크플로우 내에서 오디오를 생성하거나 조작하는 데 필수적입니다."
mode: wide
---

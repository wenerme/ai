...
description: "Boolean 노드는 워크플로우에서 부울(true/false) 값을 전달하는 간단한 방법을 제공합니다. 부울 입력값을 받아 변경 없이 동일한 값을 출력함으로써, 다른 노드의 부울 매개변수를 제어할 수 있도록 합니다."
mode: wide
---
...
| --- | --- | --- | --- | --- |
| `값` | 노드를 통해 전달할 부울 값입니다. | BOOLEAN | 예 | truefalse |

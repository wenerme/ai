...
description: "ImageHistogram 노드는 입력 이미지의 색상 분포를 분석합니다. 이 노드는 이미지에서 각 가능한 강도 값에 해당하는 픽셀 수를 보여주는 그래프인 여러 히스토그램을 계산하여 출력합니다. 빨간색, 녹색, 파란색 채널에 대한 개별 히스토그램, 복합 RGB 히스토그램, 그리고 표준 밝기 공식을 기반으로 한 휘도 히스토그"
mode: wide
---

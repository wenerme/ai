...
| `upscaler_model` | 비디오 업스케일에 사용되는 AI 모델입니다. | COMBO | 예 | `"Starlight (Astra) Fast"``"Starlight (Astra) Creative"``"Starlight Precise 2.5"` |
| `upscaler_resolution` | 업스케일된 비디오의 대상 해상도입니다. | COMBO | 예 | `"FullHD (1080p)"``"4K (2160p)"` |

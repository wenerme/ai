...
description: "SD4XUpscaleConditioning 노드는 확산 모델을 사용하여 이미지를 업스케일링하기 위한 컨디셔닝 데이터를 준비합니다. 입력 이미지와 컨디셔닝 데이터를 받아 스케일링과 노이즈 증강을 적용하여 업스케일링 과정을 안내하는 수정된 컨디셔닝을 생성합니다. 이 노드는 업스케일된 차원에 대한 잠재 표현과 함께 양성 및"
mode: wide
---

...
description: "ComboOptionTestNode는 콤보 박스 선택을 테스트하고 전달하는 로직 노드입니다. 두 개의 콤보 박스 입력을 받으며, 각 입력에는 미리 정의된 옵션 집합이 있습니다. 선택된 값을 수정 없이 그대로 출력합니다."
mode: wide
---
...
| --- | --- | --- | --- | --- |
| `combo` | 세 가지 테스트 옵션 중 첫 번째 선택입니다. | COMBO | 예 | `"option1"``"option2"``"option3"` |
| `combo2` | 다른 세 가지 테스트 옵션 중 두 번째 선택입니다. | COMBO | 예 | `"option4"``"option5"``"option6"` |

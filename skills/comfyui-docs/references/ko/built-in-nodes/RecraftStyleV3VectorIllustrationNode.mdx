...
description: "이 노드는 Recraft API에서 사용할 스타일을 구성하며, 특히 vectorillustration 스타일을 선택합니다. 해당 카테고리 내에서 더 구체적인 하위 스타일을 선택적으로 지정할 수 있습니다. 이 노드는 다른 Recraft API 노드에 전달할 수 있는 스타일 구성 객체를 출력합니다."
mode: wide
---

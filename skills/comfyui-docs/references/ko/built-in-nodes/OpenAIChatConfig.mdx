...
|-----------|-------------|-----------|----------|-------|
| `트렁케이션` | 모델 응답에 사용할 잘림 전략입니다. auto: 이 응답과 이전 응답의 컨텍스트가 모델의 컨텍스트 창 크기를 초과하면, 모델은 대화 중간의 입력 항목을 삭제하여 컨텍스트 창에 맞게 응답을 잘라냅니다. disabled: 모델 응답이 모델의 컨텍스트 창 크기를 초과하게 되면 요청이 400 오류와 함께 실패합니다. (기본값: "auto") | COMBO | 예 | "auto""disabled" |

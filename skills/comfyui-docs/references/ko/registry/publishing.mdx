---
title: "노드 게시하기"
description: "Comfy Registry 계정 설정, publisher 생성, API 키 발급, 메타데이터 추가, Comfy CLI 또는 GitHub Actions로 커스텀 노드를 게시하는 방법을 알아보세요."
...
comfy-cli를 설치하셨나요? [먼저 설치하세요](/ko/comfy-cli/getting-started).

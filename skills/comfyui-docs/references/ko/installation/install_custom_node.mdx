...
| 방법                        | 장점                                                    | 단점                                                |
| ---------------------------- | ------------------------------------------------------------- | ----------------------------------------------------------- |
| **ComfyUI 매니저**(권장) | 1. 자동 설치2. 종속성 관리3. GUI 인터페이스 | 레지스트리에 등록되지 않은 노드를 직접 검색할 수 없음 |
| **Git 복제**                | 레지스트리에 등록되지 않은 노드도 설치 가능               | 1. Git 지식 필요2. 수동 종속성 관리3. 설치 위험 |
| **레포지토리 ZIP 다운로드**   | 1. Git 필요 없음2. 수동 제어                      | 1. 수동 종속성 관리2. 버전 관리 없음3. 설치 위험 |

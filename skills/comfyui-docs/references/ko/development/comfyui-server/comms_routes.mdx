---
title: "경로"
description: "ComfyUI Server API 경로. prompt, 큐, 히스토리, 모델, 사용자 데이터를 다루는 내장 GET / POST / WebSocket 엔드포인트 레퍼런스와 클라이언트-서버 통신용 커스텀 경로 추가 방법."
translationSourceHash: 35dc2d03

...
# Partner Nodes를 포함하는 프롬프트/작업("API 형식" 워크플로우)이 있습니다.
...
payload = {
    "prompt": prompt,
    # payload에 `api_key_comfy_org`를 추가합니다.
    # 여러 클라이언트를 처리하는 경우 먼저 연결된 사용자로부터 키를 받을 수 있습니다.
    "extra_data": {
        "api_key_comfy_org": "comfyui-87d01e28d*******************************************************"  # 실제 키로 교체
    },
}

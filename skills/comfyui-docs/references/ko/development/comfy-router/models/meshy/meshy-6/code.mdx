...
<ParamField body="ultra_mode" type="boolean" default="false">
  더 세밀한 표면 디테일과 높은 충실도의 지오메트리를 위한 Ultra 생성을 활성화합니다. ai_model이 meshy-7 또는 latest일 때만 지원됩니다.
</ParamField>
...
<ParamField body="enable_pbr" type="boolean" default="false">
  기본 색상에 더해 PBR 맵(metallic, roughness, normal)을 생성합니다. Sculpture 스타일을 사용할 때는 enable_pbr을 거짓으로 설정해야 합니다.
</ParamField>

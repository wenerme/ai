...
ComfyUI Desktop 버전은 이미 설치 과정에서 ComfyUI-Manager와 그 종속성이 설치되어 있으며, 이 가이드에서도 ComfyUI Manager를 커스텀 노드 설치 예제로 사용하므로, Desktop 버전에서는 실제로 ComfyUI Manager 종속성 설치를 수행할 필요가 없습니다.

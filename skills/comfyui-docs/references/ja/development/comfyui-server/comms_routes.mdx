---
title: "ComfyUI サーバールート（HTTP と WebSocket API）"
description: "ComfyUI Server API ルート：prompt、キュー、履歴、モデル、ユーザーデータをカバーする組み込み GET / POST / WebSocket エンドポイントと、カスタムルートの追加方法。"

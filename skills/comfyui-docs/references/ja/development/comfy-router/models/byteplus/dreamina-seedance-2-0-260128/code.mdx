...
translationSourceHash: f406084c
...
Router が `GET /v2/models/byteplus/dreamina-seedance-2-0-260128/openapi.json` で提供するスキーマから生成されており、これはリクエストがプロバイダーに到達する前に Router が呼び出しを検証する際に使用する同じドキュメントです。
### 出力

...
with Comfy() as client:
    ...
    print("request_id:", handle.request_id)  # モデル ID とあわせれば、別のプロセスに必要なものはこれだけです
...
console.log("requestId:", handle.requestId); // モデル ID とあわせれば、別のプロセスに必要なものはこれだけです
...
print("requestId:", handle.requestId)  // モデル ID とあわせれば、別のプロセスに必要なものはこれだけです

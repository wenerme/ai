...
description: "ComfyUI ワークフローテンプレートの使い方：ネイティブ対応のモデルワークフローとカスタムノードのサンプル、テンプレートを開いて読み込み、必要なモデルをダウンロードする手順。"
translationSourceHash: c03d3809
translationFrom: interface/features/template.mdx
translationBlockHashes:
  "_intro": f6b21755
  "How to open Templates in ComfyUI": fcb9a998
  "How to use templates": 8d5c0bc3
  "How to update templates?": 3eff7e06
  "How to contribute templates to the ComfyUI repository?": 5717554a
  "Custom node templates": 16edae72
  "How to add templates for custom nodes?": f022e0b7
---
...
ComfyUI を更新した後、ドキュメントや新たに発表されたテンプレートが表示されない場合は、対応する依存関係を更新する必要があるかもしれません。[`ComfyUI/requirements.txt`](https://github.com/Comfy-Org/ComfyUI/blob/master/requirements.txt) でバージョンを確認できます。
...
正しい更新方法がわからない場合は、ComfyUI およびその依存関係の更新方法について [Update ComfyUI](/ja/installation/update_comfyui) を参照してください。
...
カスタムノード用にワークフローテンプレートを追加する方法については、[Custom Node Templates](/ja/custom-nodes/workflow_templates) を参照してください。

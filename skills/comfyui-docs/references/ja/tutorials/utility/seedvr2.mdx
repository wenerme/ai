...
[SeedVR2 3B Int8 画像拡大ワークフローのプレビュー]
...
[SeedVR2 7B Int8 拡大ワークフローのプレビュー]
...
[SeedVR2 3B Int8によるビデオアップスケールワークフローのプレビュー]

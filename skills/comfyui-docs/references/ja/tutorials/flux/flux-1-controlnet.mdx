...
translationSourceHash: 7511ec98
translationFrom: tutorials/flux/flux-1-controlnet.mdx
translationBlockHashes:
  "_intro": a69fbfae
  "FLUX.1 ControlNet Model Introduction": c242319b
  "FLUX.1-Canny-dev Complete Version Workflow": c8623b99
  "FLUX.1-Depth-dev-lora Workflow": bf2160c6
...
以前に [Flux 関連ワークフローの完全版](/ja/tutorials/flux/flux-1-text-to-image) を使用済みの場合、**flux1-canny-dev.safetensors** のみをダウンロードすれば十分です。  

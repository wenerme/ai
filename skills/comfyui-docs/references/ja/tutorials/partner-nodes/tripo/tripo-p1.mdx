...
translationSourceHash: 27ea41b5
translationFrom: tutorials/partner-nodes/tripo/tripo-p1.mdx
translationBlockHashes:
  "_intro": bf4f6386
  "What Tripo P1 is good at": 9da5d668
  "Tripo P1: Text to Model": a2d68fe4
  "Tripo P1: Image to Model": d2f6e40c
  "Tripo P1: Multiview to Model": d2196b7d
---

[Tripo P1](/ja/built-in-nodes/TripoP1ImageToModelNode) パートナーノードを使用すると、テキストプロンプト、単一画像、またはマルチビュー参照から、高速かつ高品質な 3D モデルを生成できます。生成済みモデルは、クリーンなトポロジと最適化されたポリゴン数を備え、テクスチャリング、リギング、リターゲティングをサポートしています。ゲームエンジンや 3D アプリケーションですぐに使用できます。

## Tripo P1 の強み

- **柔軟な入力**：テキストプロンプト、単一画像、またはマルチビュー参照から3Dモデルを生成します
- **クリーンなトポロジー**：モデルはクリーンなトポロジーと最適化されたポリゴン数を備えています
- **テクスチャリング、リギング、リターゲティング**：生成済みモデルはテクスチャリング、リギング、リターゲティングをサポートしています
- **ゲーム対応の出力**：アセットはゲームエンジンや3Dアプリケーションですぐに使用できます

...
Luma は Uni-1 を拡散モデルではないデコーダのみの自己回帰モデルとして説明しており、生成前にプロンプトを推論します。キャンバス上で最も重要なのは、**Create と Modify の選択**、参照への明確なラベル付け、シードによる反復です。
...
- **フォトリアリズム**：マテリアルの正確な再現
- **イラスト＆スタイライズドアート**：強力な美的コントロール
- **古い写真の修復**とビンテージ風の再現
- **シュールでコンセプチュアル**な構図
- **テキストレンダリング**：画像内で読みやすいテキスト。インフォグラフィックやポスターに最適
- **画像編集**とマルチターンのリファインメント
- **参照ガイドによる生成**：アイデンティティを保持
- **マルチパネル出力**：複数のフレームにわたる一貫したキャラクターやシーン
...
[Luma Uni-1 Image Create ワークフローのプレビュー]
...
[Luma Uni-1 Image Edit ワークフローのプレビュー]

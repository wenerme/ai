...
translationSourceHash: 2ebe58cb
translationFrom: tutorials/video/zai/scail2.mdx
translationBlockHashes:
  "_intro": a41dfa9a
  "SCAIL-2 Character Replacement Workflow": b5cdb9a9
  "How the Workflow Works": fad0cdce
  "Two Modes": 639623de
  "Inputs and Parameters": 5762889f
  "Model Installation": afc8e5d3
---
...
### SCAIL-2 キャラクター置換 {#video_wan21_scail2_character_replacement}

ビデオ内のキャラクターを、動きとシーンのコンテキストを維持したまま置き換えます。

[SCAIL-2 キャラクター置換ワークフローのプレビュー]

  
    Comfy Cloud で開く
  
  
    JSON をダウンロードするか、テンプレートライブラリで &quot;SCAIL-2 キャラクター置換&quot; を検索
  

**入力素材**

  
    デフォルトの参照キャラクター画像をダウンロードするか、ご自身の画像を使用してください。
  
  
    デフォルトの駆動ビデオをダウンロードするか、ご自身のビデオを使用してください。

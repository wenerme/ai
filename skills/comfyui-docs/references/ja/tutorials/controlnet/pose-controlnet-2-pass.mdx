...
description: "ComfyUI で Pose ControlNet を学びましょう。OpenPose のスケルトンでキャラクターのポーズを制御し、2パス生成ワークフローで大判画像を作成します。"
translationSourceHash: b939c04c
translationFrom: tutorials/controlnet/pose-controlnet-2-pass.mdx
translationBlockHashes:
  "Introduction to OpenPose": 3dd3b023
  "ComfyUI 2-Pass Pose ControlNet Usage Example": 89bf8647
  "Explanation of the Pose ControlNet 2-Pass Workflow": 8396d044
  "Advantages of 2-Pass Image Generation": fba5db79
---
...
以下のワークフロー画像をダウンロードし、ComfyUI へドラッグ＆ドロップすることで、ワークフローを読み込むことができます：
...
[ComfyUI ワークフロー - Pose ControlNet フローダイアグラム]
...
複数の ControlNet を組み合わせるテクニックについて詳しく知りたい場合は、[ControlNet モデルの混合](/ja/tutorials/controlnet/mixing-controlnets) のチュートリアルをご参照ください。

---
title: "ComfyUI JavaScript フック"
description: "ComfyUI フロントエンドの JavaScript フックのリファレンス。app.registerExtension、nodeCreated、beforeRegisterNodeDef と UI をカスタマイズするコールバックを解説します。"
...
フックが呼び出される[順序](#呼び出し順序)も参照してください。

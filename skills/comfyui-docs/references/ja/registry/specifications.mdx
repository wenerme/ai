...
description: "ComfyUI カスタムノードの pyproject.toml 完全仕様。[project] と [tool.comfy] セクション、必須フィールド、バージョニング、完全な例を掲載しています。"
translationSourceHash: 89a4bc1e
translationFrom: registry/specifications.mdx
translationBlockHashes:
  "_intro": 2bd726bd
  "[project] Section": 00ed6e04
  "[tool.comfy] Section": 54d126bc
  "Complete Example": 24cf243a
---
...
公開アーカイブからファイルを除外する（`includes` の逆）には、公開ページの [`.comfyignore`](/ja/registry/publishing) を参照してください。

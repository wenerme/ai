...
translationFrom: installation/comfyui_portable_windows.mdx, zh/installation/comfyui_portable_windows.mdx
translationMismatches:
  - "The Chinese source includes a section \"Community Distributed Version\" (Akiya Integration Pack) which is absent in the English source. The Chinese source uses  for the warning about closing the command line, while the English source uses ."
---

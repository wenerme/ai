...
translationFrom: manager/troubleshooting.mdx, zh/manager/troubleshooting.mdx
translationMismatches:
  - "The internal link for \"Configuration\" uses \"/manager/configuration\" in English but \"/zh/manager/configuration\" in Chinese (locale-specific path)."
---

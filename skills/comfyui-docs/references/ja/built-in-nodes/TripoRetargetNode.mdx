...
| `animation` | 3Dモデルに適用するアニメーションプリセット。オプションには、人型アニメーション（待機、歩行、走行、潜水、登攀、ジャンプ、斬撃、射撃、被ダメージ、落下、旋回）とクリーチャーアニメーション（四足歩行、六足歩行、八足歩行、蛇行移動、水生移動）が含まれます。 | STRING | はい | "preset:idle""preset:walk""preset:run""preset:dive""preset:climb""preset:jump""preset:slash""preset:shoot""preset:hurt""preset:fall""preset:turn""preset:quadruped:walk""preset:hexapod:walk""preset:octopod:walk""preset:serpentine:march""preset:aquatic:march" |

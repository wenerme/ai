...
| `aspect_ratio` | リフレーミング後の動画のターゲットアスペクト比（デフォルト："16:9"）。 | STRING | はい | "16:9""9:16""1:1""4:3""3:4""21:9" |
| `resolution` | リフレーミング後の動画の出力解像度（デフォルト："720p"）。 | STRING | はい | "360p""540p""720p""1080p" |

...
description: "SamplerLCMUpscale ノードは、潜在整合性モデル（LCM）サンプリングと画像アップスケーリング機能を組み合わせた、特殊なサンプリング手法を提供します。"
mode: wide
---
...
| `アップスケール方法` | 画像のアップスケーリングに使用する補間方式 | COMBO | はい | "bislerp""nearest-exact""bilinear""area""bicubic" |

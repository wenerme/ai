...
description: "SetUnionControlNetType ノードを使用すると、条件付けに使用するコントロールネットワークのタイプを指定できます。"
mode: wide
---
...
| `タイプ` | 適用するコントロールネットワークのタイプ。自動タイプ検出には "auto" を使用するか、利用可能なオプションから特定のコントロールネットワークタイプを選択します | STRING | はい | `"auto"`利用可能なすべての UNION_CONTROLNET_TYPES キー |

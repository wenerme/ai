...
| `duration` | COMBO | はい | `"5"``"10"` | 動画の長さ（秒単位）（デフォルト: "5"） |
| `ratio` | COMBO | はい | `"1024:1024"``"1280:720"``"720:1280"``"1920:1080"``"1080:1920"``"2048:1080"``"1080:2048"` | 生成される動画のアスペクト比（デフォルト: "1024:1024"） |

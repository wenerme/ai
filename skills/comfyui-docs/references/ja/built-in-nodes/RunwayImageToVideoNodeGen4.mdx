...
| `duration` | 動画の長さ（秒単位）（デフォルト: "5"） | COMBO | はい | `"5"``"10"` |
| `ratio` | 生成される動画のアスペクト比（デフォルト: "1024:1024"） | COMBO | はい | `"1024:1024"``"1280:720"``"720:1280"``"1920:1080"``"1080:1920"``"2048:1080"``"1080:2048"` |

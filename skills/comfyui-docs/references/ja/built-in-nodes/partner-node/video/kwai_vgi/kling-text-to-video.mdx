...
translationFrom: built-in-nodes/partner-node/video/kwai_vgi/kling-text-to-video.mdx, zh/built-in-nodes/partner-node/video/kwai_vgi/kling-text-to-video.mdx
translationMismatches:
  - "description"
---

[ComfyUI 組み込み Kling Text to Video ノード]

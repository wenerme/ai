...
translationFrom: built-in-nodes/partner-node/image/recraft/recraft-image-to-image.mdx, zh/built-in-nodes/partner-node/image/recraft/recraft-image-to-image.mdx
---

[ComfyUI ネイティブ Recraft Image to Image ノード]

...
translationFrom: built-in-nodes/partner-node/image/recraft/recraft-crisp-upscale.mdx, zh/built-in-nodes/partner-node/image/recraft/recraft-crisp-upscale.mdx
---

[ComfyUI ネイティブ Recraft Crisp Upscale ノード]

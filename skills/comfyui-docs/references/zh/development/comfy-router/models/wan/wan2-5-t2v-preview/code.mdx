...
<ParamField body="input.img_url" type="string">
  首帧图像 URL 或 Base64 编码数据。I2V 模型必填。图像格式：JPEG、JPG、PNG、BMP、WEBP。分辨率：360-2000 像素。文件大小：最大 10MB。
</ParamField>
...
<ParamField body="input.media[].url" type="string" required>
  媒体文件的 URL（公开 HTTP/HTTPS URL 或 OSS 临时 URL）
</ParamField>

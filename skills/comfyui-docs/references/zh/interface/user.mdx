...
translationSourceHash: 26dc9788
translationFrom: interface/user.mdx
translationBlockHashes:
  "_intro": f32b58a5
  "ComfyUI Version Requirements": 77a6239c
  "Network Requirements": 2df7e7dd
  "How to Log In": 782e97ce
  "Login Methods": 1fdad41e
  "Post-Login Status": dfa24225
  "Frequently Asked Questions": 348d1032
---

<SettingsMenuContext />

使用 `Partner Nodes` 节点需要消耗积分，所以我们的账号系统提供了积分管理和认证支持，让用户能够便捷地访问前沿闭源模型的 API。
...
你可能至少需要使用 [ComfyUI v0.3.0](https://github.com/Comfy-Org/ComfyUI/releases/tag/v0.3.30) 版本才能使用账号系统,确保对应前端版本至少为`1.17.11`,有时候前端可能会安装失败而导致回滚到旧版本，所以请在`设置` -> `关于` 查看前端版本是否大于`1.17.11`

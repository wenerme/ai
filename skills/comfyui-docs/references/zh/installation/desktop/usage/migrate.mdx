...
translationSourceHash: b8c702d3
...
如果您的现有安装完全未被 Chooser 检测到，您也可以通过 Manage 面板直接添加。有关说明，请参阅 [**追踪已有安装**](/zh/installation/desktop/usage/instance-management#追踪已有安装)。

### 迁移失败

- **查看日志**：在 Manage 面板的 Terminal 选项卡中查看错误详情
...
1. 打开迁移后安装的 **Manage** 面板
2. 进入 **存储** 标签页并打开 **模型目录**
3. 检查旧模型文件夹是否在列表中。如果没有，请手动添加。

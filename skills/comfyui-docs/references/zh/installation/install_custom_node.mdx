...
| 方法                          | 优点                                                        | 缺点                                                        |
| ---------------------------- | ------------------------------------------------------------- | ----------------------------------------------------------- |
| **ComfyUI Manager**（推荐）   | 1. 自动化安装2. 依赖项处理3. 图形界面               | 无法直接搜索未在注册表中注册的节点                             |
| **Git Clone**                | 可以安装未在注册表中注册的节点                                 | 1. 需要 Git 知识2. 手动处理依赖项3. 安装风险        |
| **仓库 ZIP 下载**             | 1. 无需 Git2. 手动控制                                   | 1. 手动处理依赖项2. 无版本控制3. 安装风险           |

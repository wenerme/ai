---
title: "设置"
description: "了解如何使用 app.registerExtension 添加、读取、写入 ComfyUI 扩展设置并响应变更。涵盖所有设置类型，包括 boolean、text、number、slider、combo、color、image。"
...
如果你没有[指定分类](#分类（categories）)，那么 `id` 会通过 `.` 分割来决定它在设置面板中的显示位置。

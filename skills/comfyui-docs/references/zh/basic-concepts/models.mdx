...
translationSourceHash: 5c8abb13
translationFrom: basic-concepts/models.mdx
translationBlockHashes:
  "_intro": 4250b37b
  "Models in plain terms": 0218127d
  "Use models in ComfyUI": 12a2c06a
  "Beyond the main checkpoint": 7d0b4849
  "Uninstalling models": 00257b00
  "Common issues": 88dbe2f2
  "Want a bit more background?": ef511cd4
---
...
## 常见问题
    ...
    - 确认路径与文件夹是否正确：
      - 默认路径为 `ComfyUI/models/`（如 `checkpoints`、`loras`、`vae`）
      - **Comfy Desktop**：点击桌面应用顶部的胶囊菜单，打开 **存储（Storage）** 标签页查看模型目录。胶囊菜单仅桌面应用内存在，浏览器访问的 Web 版没有此项

      [Comfy Desktop capsule menu: Storage tab showing model directory settings]

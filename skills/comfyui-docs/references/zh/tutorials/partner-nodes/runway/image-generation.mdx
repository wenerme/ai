...
translationSourceHash: bbed84ca
translationFrom: tutorials/partner-nodes/runway/image-generation.mdx
translationBlockHashes:
  "_intro": b4e053c3
  "What Runway Image Generation is good at": 63f66108
...
- **文生图**：使用 `Runway 文生图` 节点，根据文本提示词生成图像，输出宽高比可调
- **参考生图**：在输入的参考图像和文本提示词的引导下生成图像
- **风格迁移、图像扩展和细节控制**：Runway 的模型支持这些图像生成功能

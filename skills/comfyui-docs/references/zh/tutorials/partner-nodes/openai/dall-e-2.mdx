...
---
  ...
  **已弃用**：OpenAI 已停止提供 DALL·E 2 模型，**OpenAI DALL·E 2** 节点已退役并从 ComfyUI 中移除。请改用 **GPT Image** 节点。本页面仅作参考保留。

[OpenAI DALL·E 2 节点截图]

OpenAI DALL·E 2 是 ComfyUI 合作伙伴节点系列中的一员，它允许用户通过 OpenAI 的 **DALL·E 2** 模型生成图像。

**OpenAI DALL·E 2** 节点通过 OpenAI 的图像生成 API 同步生成图像。它接收文本提示词，并返回与描述匹配的图像。

...
[Stability AI Stable Diffusion 3.5 文生图步骤图]
...
[Stability AI Stable Diffusion 3.5 图生图步骤图]
...
[Stability AI Stable Diffusion 3.5 有无图像输入对比]

**图像去噪强度(Image Denoise)**：这个参数决定了生成过程中保留原始图像特征的程度，是图生图模式中最关键的调节参数,下图是不同的去噪强度下生成的图像效果：

[Stability AI Stable Diffusion 3.5 图生图去噪强度说明]

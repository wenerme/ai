...
translationSourceHash: ba2705b1
translationFrom: tutorials/partner-nodes/anthropic/claude.mdx
---

Anthropic Claude 是 Anthropic 推出的强大 AI 模型系列，以其出色的推理能力、安全性和长上下文处理能力而闻名。ComfyUI 已通过合作节点集成了 Anthropic Claude API，让你可以直接在工作流中使用 Claude 进行对话和图像分析。
...
[Anthropic Claude Chat workflow preview]
    ...
    下载 JSON 工作流，或从模板库中搜索 "Anthropic Claude"
...
- `seed` 参数仅控制节点是否重新运行，无论 seed 值如何，结果都是非确定性的
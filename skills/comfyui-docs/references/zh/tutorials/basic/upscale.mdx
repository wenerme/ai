...
想了解更多高级放大选项？请查看我们的综合[图像放大指南](/zh/tutorials/utility/image-upscale)，涵盖各种模型和使用场景，包括人像增强、产品摄影等。
...
在完成了简单的放大工作流后，我们就可以尝试结合[文生图](/zh/tutorials/basic/text-to-image)的工作流来完成一个完整放大工作的流程，关于文生图的基础部分及相关模型要求，请参考[文生图](/zh/tutorials/basic/text-to-image)的部分的说明完成。

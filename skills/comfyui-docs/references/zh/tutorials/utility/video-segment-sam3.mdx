...
translationSourceHash: 0c841cfc
translationFrom: tutorials/utility/video-segment-sam3.mdx
translationBlockHashes:
  "_intro": b6c2c7f7
  "SAM 3.1 Segment Workflows": fc6d066f
...
请更新你的 ComfyUI 到最新版本，然后前往 `工作流` -> `浏览模板`，在 Utility 类别下找到 SAM 3.1 工作流。

### SAM3：视频分割 {#utility_video_segment_sam3}
...
将以下文件上传到对应的 `LoadVideo` 节点：
    ...
    `LoadVideo` 节点 115 · `drinking_unicorn.mp4`
...
### SAM3：图像分割 {#utility_image_segment_sam3}
...
| 提示 | 作用 |
|------|------|
| SAM3 物体提示 | 描述要分割的**内容**。最多 32 个 token。 |

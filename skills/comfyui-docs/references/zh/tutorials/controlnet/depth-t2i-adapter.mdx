...
translationSourceHash: 714f297f
translationFrom: tutorials/controlnet/depth-t2i-adapter.mdx
translationBlockHashes:
  "Introduction to T2I Adapter": 7d6ccb67
  "Value of Depth T2I Adapter Applications": 081df4a9
  "ComfyUI Depth T2I Adapter Workflow Example Explanation": 5b20ca66
  "General Tips for Using T2I Adapter": 06f12cb9
  "Characteristics of T2I Adapter Usage": d485c810
---
...
- [t2iadapter_depth_sd15v2.pth](https://huggingface.co/TencentARC/T2I-Adapter/blob/main/models/t2iadapter_depth_sd15v2.pth?download=true)
...
[ComfyUI 工作流 - Depth T2I Adapter 流程图]

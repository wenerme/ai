...
| `质量` | 图像质量，影响费用和生成时间（默认值："low"） | COMBO | 否 | "low""medium""high" |
| `背景` | 返回图像时是否包含背景（默认值："auto"） | COMBO | 否 | "auto""opaque""transparent" |
| `尺寸` | 图像尺寸。选择 "Custom" 以使用自定义宽度和高度（仅 GPT Image 2）（默认值："auto"） | COMBO | 否 | "auto""1024x1024""1024x1536""1536x1024""2048x2048""2048x1152""1152x2048""3840x2160""2160x3840""Custom" |

...
| `提示优化器` | 在需要时优化提示词以提高生成质量（默认值：True）。 | BOOLEAN | 否 | TrueFalse |
| `时长` | 输出视频的时长（秒，默认值：6）。 | COMBO | 否 | 610 |
| `分辨率` | 视频显示尺寸。1080p 为 1920x1080，768p 为 1366x768（默认值："768P"）。 | COMBO | 否 | "768P""1080P" |

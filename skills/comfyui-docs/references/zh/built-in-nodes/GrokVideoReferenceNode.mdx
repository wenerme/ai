...
description: "Grok 参考转视频节点根据文本提示生成视频，并使用最多七张参考图像来引导输出的风格和内容。"
mode: wide
---
...
| `model.resolution` | 输出视频的分辨率。 | COMBO | 是 | `"480p"``"720p"` |
| `model.aspect_ratio` | 输出视频的宽高比。 | COMBO | 是 | `"16:9"``"4:3"``"3:2"``"1:1"``"2:3"``"3:4"``"9:16"` |

...
description: "Runway 图像转视频（Gen4 Turbo）节点使用 Runway 的 Gen4 Turbo 模型，从单个起始帧生成视频。"
mode: wide
---
...
| `时长` | 视频时长（秒）（默认："5"） | COMBO | 是 | `"5"``"10"` |
| `比例` | 生成视频的宽高比（默认："1024:1024"） | COMBO | 是 | `"1024:1024"``"1280:720"``"720:1280"``"1920:1080"``"1080:1920"``"2048:1080"``"1080:2048"` |

...
| `model` | 用于生成的模型。选择模型会改变可用的 `size` 选项。 | COMBO | 是 | `"recraftv4"``"recraftv4_pro"` |
| `size` | 生成图像的大小。可用选项取决于所选的 `model`。`recraftv4` 的默认值为 `"1024x1024"`，`recraftv4_pro` 的默认值为 `"2048x2048"`。 | COMBO | 是 | 对于 `recraftv4`：`"1024x1024"`、`"1152x896"`、`"896x1152"`、`"1216x832"`、`"832x1216"`、`"1344x768"`、`"768x1344"`、`"1536x640"`、`"640x1536"`对于 `recraftv4_pro`：`"2048x2048"`、`"2304x1792"`、`"1792x2304"`、`"2432x1664"`、`"1664x2432"`、`"2688x1536"`、`"1536x2688"`、`"3072x1280"`、`"1280x3072"` |

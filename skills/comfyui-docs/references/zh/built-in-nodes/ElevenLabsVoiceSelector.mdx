...
description: "ElevenLabs 语音选择器节点允许您从预定义的 ElevenLabs 文本转语音语音列表中选择特定语音。"
mode: wide
---
...
| --- | --- | --- | --- | --- |
| `voice` | 从预定义的 ElevenLabs 语音中选择一个语音。 | STRING | 是 | `"Adam"``"Antoni"``"Arnold"``"Bella"``"Domi"``"Elli"``"Josh"``"Rachel"``"Sam"` |

...
description: "通过 OpenAI 的 DALL·E 3 端点同步生成图像。"
mode: wide
---
...
| `质量` | 图像质量（默认值："standard"） | COMBO | 否 | "standard""hd" |
| `风格` | 生动风格会使模型倾向于生成超现实且富有戏剧性的图像。自然风格则使模型生成更自然、超现实感较弱的图像。（默认值："natural"） | COMBO | 否 | "natural""vivid" |
| `尺寸` | 图像尺寸（默认值："1024x1024"） | COMBO | 否 | "1024x1024""1024x1792""1792x1024" |

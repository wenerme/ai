...
| `模型` | 用于生成回复的 Gemini 模型。默认值：gemini-3-1-pro。 | COMBO | 是 | `gemini-2.5-pro-preview-05-06``gemini-2.5-flash-preview-04-17``gemini-2.5-pro``gemini-2.5-flash``gemini-3-pro-preview``gemini-3-1-pro``gemini-3-1-flash-lite` |

...
| `model` | COMBO | 是 | `gemini-2.0-flash-exp``gemini-2.0-flash-thinking-exp``gemini-2.5-pro-exp``gemini-2.0-flash``gemini-2.0-flash-thinking``gemini-2.5-pro``gemini-2.0-flash-lite``gemini-1.5-flash``gemini-1.5-flash-8b``gemini-1.5-pro``gemini-1.0-pro` | 用于生成响应的 Gemini 模型。默认值：gemini-2.5-pro。 |

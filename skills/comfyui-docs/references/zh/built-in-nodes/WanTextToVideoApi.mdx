...
| --- | --- | --- | --- | --- |
| `模型` | 使用的模型（默认值："wan2.6-t2v"） | COMBO | 是 | "wan2.5-t2v-preview""wan2.6-t2v" |
| `提示词` | 描述元素和视觉特征的提示词。支持中文和英文（默认值：""） | STRING | 是 | - |
| `负面提示词` | 描述需要避免内容的负面提示词（默认值：""） | STRING | 否 | - |
| `尺寸` | 视频分辨率和宽高比（默认值："720p: 1:1 (960x960)"） | COMBO | 否 | "480p: 1:1 (624x624)""480p: 16:9 (832x480)""480p: 9:16 (480x832)""720p: 1:1 (960x960)""720p: 16:9 (1280x720)""720p: 9:16 (720x1280)""720p: 4:3 (1088x832)""720p: 3:4 (832x1088)""1080p: 1:1 (1440x1440)""1080p: 16:9 (1920x1080)""1080p: 9:16 (1080x1920)""1080p: 4:3 (1632x1248)""1080p: 3:4 (1248x1632)" |
...
| `镜头类型` | 指定生成视频的镜头类型，即视频是单一连续镜头还是包含剪辑的多镜头。此参数仅在 prompt_extend 为 True 时生效（默认值："single"） | COMBO | 否 | "single""multi" |

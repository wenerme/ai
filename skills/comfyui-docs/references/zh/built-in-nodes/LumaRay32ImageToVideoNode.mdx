...
description: "使用 Luma 的 Ray 3.2 模型，根据起始帧和/或结束帧生成视频。"
mode: wide
---
...
| `resolution` | 生成视频的输出分辨率（默认值："720p"）。 | COMBO | 是 | "360p""540p""720p""1080p" |
| `循环` | 使视频无缝循环播放。当设置了结束帧时不可用。 | BOOLEAN | 是 | TrueFalse |

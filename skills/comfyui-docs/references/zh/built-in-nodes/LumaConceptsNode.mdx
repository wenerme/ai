...
| 参数 | 数据类型 | 必需 | 取值范围 | 描述 |
|-----------|-----------|----------|-------|-------------|
| `concept1` | STRING | 是 | 提供多个选项包含"None"选项 | 从可用的 Luma 概念中选择第一个相机概念 |
| `concept2` | STRING | 是 | 提供多个选项包含"None"选项 | 从可用的 Luma 概念中选择第二个相机概念 |
| `concept3` | STRING | 是 | 提供多个选项包含"None"选项 | 从可用的 Luma 概念中选择第三个相机概念 |
| `concept4` | STRING | 是 | 提供多个选项包含"None"选项 | 从可用的 Luma 概念中选择第四个相机概念 |

...
| `aspect_ratio` | COMBO | 否 | "1:1""16:9""9:16""4:3""3:4""3:2""2:3" | 图像生成的宽高比。如果分辨率未设置为自动，则忽略此参数（默认："1:1"） |
| `resolution` | COMBO | 否 | "Auto""1024x1024""1152x896""896x1152""1216x832""832x1216""1344x768""768x1344""1536x640""640x1536" | 图像生成的分辨率。如果未设置为自动，将覆盖 aspect_ratio 设置（默认："Auto"） |
...
| `rendering_speed` | COMBO | 否 | "DEFAULT""TURBO""QUALITY" | 控制生成速度与质量之间的权衡（默认："DEFAULT"） |

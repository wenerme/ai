...
| `模型` | 用于生成回复的模型（默认：`gpt-5`） | COMBO | 是 | `gpt-6-astra``gpt-5.6-sol``gpt-5.6-terra``gpt-5.6-luna``gpt-5.5-pro``gpt-5.5``gpt-5``gpt-5-mini``gpt-5-nano``gpt-4.1``gpt-4.1-mini``gpt-4.1-nano``o4-mini``o3``o1-pro``o1` |

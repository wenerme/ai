...
[Mask Editor main interface with tool panel, canvas, and settings side panel]
...
[Mask Editor tool panel with 5 numbered tools]
...
[Mask Editor TopBar actions labeled 1–10]

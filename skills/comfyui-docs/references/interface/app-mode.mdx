...
[Enter APP mode via top-left menu]
...
[Selecting output nodes with right-panel preview]
...
[Preview mode showing input and output layout]
...
[Set default view step with App/Node Graph options]
...
[Confirmation prompt with View app button]
...
[APP mode interface with inputs panel and Run button]
...
[APP mode mobile layout with inputs, outputs, and assets tabs]

While running, a **Cancel this run** button appears at the top to stop the current execution.

[Running state with cancel option and results panel]
...
[Left sidebar showing saved APP workflows]
...
[Share dialog prompting to save the workflow]
...
[Share dialog with Create a link button]

Click **Create a link** to generate a shareable URL for the workflow.

[Share dialog showing the generated link with Copy button]

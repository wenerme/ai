...
To exclude files from the published archive (the inverse of `includes`), see [`.comfyignore`](/registry/publishing#exclude-files-with-comfyignore) on the publishing page.

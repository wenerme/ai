...
description: "Learn how to set up a Comfy Registry account, create a publisher, generate an API key, add metadata, and publish custom nodes via Comfy CLI or GitHub Actions."
---
...
Have you installed the comfy-cli? [Do that first](/comfy-cli/getting-started).

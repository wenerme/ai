...
[**Comfy Skills**](https://github.com/Comfy-Org/comfy-skills) is the home of skills and plugins for coding agents. Skills are packaged knowledge an agent loads on demand: model guidance, workflow patterns, and ready-made commands.

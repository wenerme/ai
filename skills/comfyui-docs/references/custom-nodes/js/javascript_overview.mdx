...
All Javascript `.js` files will be loaded by the browser as the Comfy webpage loads. You don't need to specify the file 
...
That path does _not_ include the name of the subfolder. The value of `WEB_DIRECTORY` is inserted by the server.

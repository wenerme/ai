---
title: "Comfy Hooks"
description: "Comprehensive reference for ComfyUI frontend JavaScript hooks. Learn how to use app.registerExtension, handle nodeCreated & beforeRegisterNodeDef, and customize UI behavior."
---

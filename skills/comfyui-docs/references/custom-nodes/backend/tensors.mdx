...
description: "Learn the torch.Tensor basics needed for ComfyUI custom nodes: tensor shapes, squeeze/unsqueeze, notation, elementwise operations, and tensor truthiness."
---

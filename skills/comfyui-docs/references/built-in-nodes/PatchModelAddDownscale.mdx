...
| `downscale_method` | COMBO | No | "bicubic""nearest-exact""bilinear""area""bislerp" | The interpolation method used for downscaling operations |
| `upscale_method` | COMBO | No | "bicubic""nearest-exact""bilinear""area""bislerp" | The interpolation method used for upscaling operations |

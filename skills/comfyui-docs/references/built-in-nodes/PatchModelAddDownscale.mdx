...
| `downscale_method` | The interpolation method used for downscaling operations | COMBO | Yes | "bicubic""nearest-exact""bilinear""area""bislerp" |
| `upscale_method` | The interpolation method used for upscaling operations | COMBO | Yes | "bicubic""nearest-exact""bilinear""area""bislerp" |

...
| `render_style` | What the image output shows. Options are: color (full color rendering), clay (neutral-albedo shaded), depth (near objects appear bright), normal (OpenGL normal map) (default: "color") | COMBO | Yes | "color""clay""depth""normal" |

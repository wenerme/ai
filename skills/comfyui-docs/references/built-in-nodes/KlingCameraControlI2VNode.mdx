...
description: "The Kling Image to Video Camera Control Node transforms still images into cinematic videos with professional camera movements."
mode: wide
---
...
| `aspect_ratio` | The aspect ratio of the generated video (default: "16:9") | COMBO | No | `"16:9"``"9:16"``"1:1"` |

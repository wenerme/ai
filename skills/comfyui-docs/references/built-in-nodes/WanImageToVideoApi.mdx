...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | "wan2.5-i2v-preview""wan2.5-i2v-preview" | Model to use (default: "wan2.5-i2v-preview") |
...
| `resolution` | COMBO | No | "480P""720P""1080P" | Video resolution quality (default: "480P") |

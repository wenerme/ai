...
The Load 3D (Advanced) node loads a 3D model file from your ComfyUI input directory and provides the model data along with camera and viewport information. It supports common 3D file formats and allows you to specify the output image dimensions for rendering.
...
| `width` | The width of the output image in pixels (default: 1024) | INT | Yes | Min: 1Max: 4096Step: 1 |
| `height` | The height of the output image in pixels (default: 1024) | INT | Yes | Min: 1Max: 4096Step: 1 |

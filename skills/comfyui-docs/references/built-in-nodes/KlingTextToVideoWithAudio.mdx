...
| `aspect_ratio` | COMBO | Yes | `"16:9"``"9:16"``"1:1"` | The desired width-to-height ratio for the generated video. |
| `duration` | COMBO | Yes | `5``10` | The length of the video in seconds. |

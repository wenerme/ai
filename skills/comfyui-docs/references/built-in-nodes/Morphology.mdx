...
description: "The Morphology node applies various morphological operations to images, which are mathematical operations used to process and analyze shapes in images."
mode: wide
---
...
| `operation` | The morphological operation to apply (default: "erode") | STRING | Yes | `"erode"``"dilate"``"open"``"close"``"gradient"``"bottom_hat"``"top_hat"` |

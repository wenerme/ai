...
| --- | --- | --- | --- | --- |
| `model` | The AI model to use for video generation. "LTX-2 (Pro)" offers higher quality, while "LTX-2 (Fast)" is optimized for speed. | COMBO | Yes | `"LTX-2 (Pro)"``"LTX-2 (Fast)"` |
...
| `duration` | The length of the generated video in seconds (default: 8). | COMBO | Yes | `6``8``10``12``14``16``18``20` |
| `resolution` | The pixel dimensions (width x height) of the output video. | COMBO | Yes | `"1920x1080"``"2560x1440"``"3840x2160"` |
| `fps` | The frames per second for the video (default: 25). | COMBO | Yes | `25``50` |

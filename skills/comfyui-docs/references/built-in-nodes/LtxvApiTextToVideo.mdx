...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"LTX-2 (Pro)"``"LTX-2 (Fast)"` | The AI model to use for video generation. "LTX-2 (Pro)" offers higher quality, while "LTX-2 (Fast)" is optimized for speed. |
...
| `duration` | COMBO | Yes | `6``8``10``12``14``16``18``20` | The length of the generated video in seconds (default: 8). |

...
| `aspect_ratio` | COMBO | No | "16:9""9:16""1:1" | The aspect ratio for the generated video (default: "16:9") |
| `mode` | COMBO | No | "pro mode / 5s duration / kling-v1-5""pro mode / 10s duration / kling-v1-5""pro mode / 5s duration / kling-v1-6""pro mode / 10s duration / kling-v1-6""pro mode / 5s duration / kling-v2-1""pro mode / 10s duration / kling-v2-1""pro mode / 5s duration / kling-v2-5-turbo""pro mode / 10s duration / kling-v2-5-turbo" | The configuration to use for the video generation following the format: mode / duration / model_name. (default: "pro mode / 5s duration / kling-v2-5-turbo") |

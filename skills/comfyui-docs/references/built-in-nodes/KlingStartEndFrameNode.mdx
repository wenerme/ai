...
| `aspect_ratio` | The aspect ratio for the generated video (default: "16:9") | COMBO | Yes | "16:9""9:16""1:1" |
| `mode` | The configuration to use for the video generation following the format: mode / duration / model_name. (default: "pro mode / 5s duration / kling-v2-5-turbo") | COMBO | Yes | "pro mode / 5s duration / kling-v2-5-turbo""pro mode / 10s duration / kling-v2-5-turbo" |

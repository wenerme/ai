...
description: "This node uses the Tencent Hunyuan3D API to automatically analyze a 3D model and generate or identify its components based on its structure."
mode: wide
---

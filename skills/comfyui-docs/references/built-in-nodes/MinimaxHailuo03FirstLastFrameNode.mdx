...
| `watermark` | Whether to add an AIGC watermark to the video. This is an advanced parameter. Only supported by the `MiniMax H3` model. Default: False. | BOOLEAN | Yes | TrueFalse |

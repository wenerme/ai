...
|-----------|-------------|-----------|----------|-------|
| `model_3d` | 3D model file from Load 3D or another 3D node. FBX/USDZ are not supported - convert to GLB first. | File3DGLBFile3DGLTFFile3DOBJFile3DSTLFile3DAny | Yes | GLBGLTFOBJSTL |

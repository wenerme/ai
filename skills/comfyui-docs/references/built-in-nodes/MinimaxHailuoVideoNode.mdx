...
| `duration` | COMBO | No | `6``10` | The length of the output video in seconds (default: 6). |
| `resolution` | COMBO | No | `"768P"``"1080P"` | The dimensions of the video display. 1080p is 1920x1080, 768p is 1366x768 (default: "768P"). |

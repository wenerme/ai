...
| --- | --- | --- | --- | --- |
| `model` | The OpenAI GPT Image model to use. Selecting a model reveals additional parameters specific to that model. | DYNAMIC_COMBO | Yes | `"gpt-image-2"``"gpt-image-1.5"``"gpt-image-1"` |

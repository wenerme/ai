...
| `position` | Vertical position of the text on the image (default: "top") | COMBO | Yes | "top""bottom" |
| `align` | Horizontal alignment of the text (default: "left") | COMBO | Yes | "left""center""right" |
| `outline` | Draw a black outline around the text (default: True) | BOOLEAN | Yes | TrueFalse |

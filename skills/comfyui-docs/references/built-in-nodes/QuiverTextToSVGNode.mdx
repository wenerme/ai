...
| `model` | COMBO | Yes | `"Quiver SVG v1"``"Quiver SVG v1 Max"``"Quiver SVG v1 Preview"` | Model to use for SVG generation. The available options are determined by the Quiver API. |

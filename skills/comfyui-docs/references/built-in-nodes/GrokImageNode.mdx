...
|-----------|-------------|-----------|----------|-------|
| `model` | The specific Grok model to use for image generation. Different models may offer varying quality, speed, or features. | COMBO | Yes | `"grok-imagine-image-2.0"``"grok-imagine-image-quality"``"grok-imagine-image-pro"``"grok-imagine-image"` |

...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"grok-imagine-image-quality"``"grok-imagine-image-pro"``"grok-imagine-image"``"grok-imagine-image-beta"` | The specific Grok model to use for image generation. Different models may offer varying quality, speed, or features. |
...
| `aspect_ratio` | COMBO | Yes | `"1:1"``"2:3"``"3:2"``"3:4"``"4:3"``"9:16"``"16:9"``"9:19.5"``"19.5:9"``"9:20"``"20:9"``"1:2"``"2:1"` | The desired width-to-height ratio for the generated image. |
...
| `resolution` | COMBO | No | `"1K"``"2K"` | The desired output resolution for the generated images (default: "1K"). |

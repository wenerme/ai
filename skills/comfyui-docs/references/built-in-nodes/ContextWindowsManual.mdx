...
| `context_schedule` | Step-dependent scheduling algorithm for context windows (default: STATIC_STANDARD). | COMBO | Yes | `STATIC_STANDARD``UNIFORM_STANDARD``UNIFORM_LOOPED``BATCHED` |

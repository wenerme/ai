...
| `context_schedule` | COMBO | No | `STATIC_STANDARD``UNIFORM_STANDARD``UNIFORM_LOOPED``BATCHED` | The stride of the context window. |
...
| `fuse_method` | COMBO | No | `PYRAMID``LIST_STATIC` | The method to use to fuse the context windows (default: PYRAMID). |

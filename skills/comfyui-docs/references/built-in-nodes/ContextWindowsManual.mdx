...
description: "The Context Windows (Manual) node allows you to manually configure context windows for models during sampling."
mode: wide
---
...
| `context_schedule` | The stride of the context window. | COMBO | No | `STATIC_STANDARD``UNIFORM_STANDARD``UNIFORM_LOOPED``BATCHED` |
...
| `fuse_method` | The method to use to fuse the context windows (default: PYRAMID). | COMBO | No | `PYRAMID``LIST_STATIC` |

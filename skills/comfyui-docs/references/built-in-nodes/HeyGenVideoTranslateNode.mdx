...
| `output_language` | Target language for the translated video. | COMBO | Yes | "Arabic""Bengali""Chinese""Danish""Dutch""English""French""German""Greek""Hindi""Indonesian""Italian""Japanese""Korean""Malay""Polish""Portuguese""Russian""Spanish""Swedish""Tamil""Telugu""Thai""Turkish""Ukrainian""Vietnamese" |
| `mode` | 'speed' is faster; 'precision' produces higher-quality lip sync at a higher price. (default: "speed") | COMBO | Yes | "speed""precision" |

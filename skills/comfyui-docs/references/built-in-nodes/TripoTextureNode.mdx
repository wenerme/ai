...
| `texture_quality` | COMBO | No | "standard""detailed" | Quality level for texture generation (default: "standard"). The "detailed" option costs $0.20 USD, while "standard" costs $0.10 USD. |

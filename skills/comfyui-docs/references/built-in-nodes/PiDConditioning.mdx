...
| `latent_format` | COMBO | Yes | `"flux"``"sd3"` | The format of the latent. Flux1 and Flux2 latents are auto-detected from the channel dimension. SD3 must be selected manually (default: "flux"). |

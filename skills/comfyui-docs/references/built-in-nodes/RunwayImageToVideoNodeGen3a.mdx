...
| `duration` | Duration of the generated video, in seconds (default: "5") | COMBO | Yes | `"5"``"10"` |
| `ratio` | Aspect ratio of the generated video (default: "768:1280") | COMBO | Yes | `"768:1280"``"1280:768"` |

...
description: "The GeminiImage node generates text and image responses from Google's Gemini AI models."
mode: wide
---
...
| `model` | The Gemini model to use for generating responses | COMBO | required | gemini_2_5_flash_image_preview | Available Gemini modelsOptions extracted from GeminiImageModel enum |

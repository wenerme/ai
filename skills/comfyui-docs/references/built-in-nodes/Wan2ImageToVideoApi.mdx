...
| `prompt_extend` | Whether to enhance the prompt with AI assistance (default: True). This is an advanced setting. | BOOLEAN | Yes | TrueFalse |
| `watermark` | Whether to add an AI-generated watermark to the result (default: False). This is an advanced setting. | BOOLEAN | Yes | TrueFalse |

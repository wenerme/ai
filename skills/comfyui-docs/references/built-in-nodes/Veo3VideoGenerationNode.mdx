...
| `resolution` | Output video resolution. 4K is not available for the veo-3.1-lite model. (default: "720p") | COMBO | No | "720p""1080p""4k" |
...
| `model` | Veo 3 model to use for video generation (default: "veo-3.1-generate") | COMBO | No | "veo-3.1-generate""veo-3.1-fast-generate""veo-3.1-lite" |

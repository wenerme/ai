...
|-----------|-------------|-----------|----------|-------|
| `model` | The Gemini model used to generate the response. Selecting a model reveals its own set of inputs below. | DYNAMIC_COMBO | Yes | `"Gemini 3.8 Flash"``"Gemini 3.7 Flash"``"Gemini 3.5 Flash"``"Gemini 3.1 Pro"``"Gemini 3.1 Flash-Lite"` |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `thinking_level` | How hard the model reasons internally before answering. HIGH improves quality on difficult tasks but costs more (thinking) tokens and is slower. (default: "MEDIUM") | COMBO | Yes | `"LOW"``"MEDIUM"``"HIGH"` |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `thinking_level` | How hard the model reasons internally before answering. HIGH improves quality on difficult tasks but costs more (thinking) tokens and is slower. (default: "MEDIUM") | COMBO | Yes | `"MINIMAL"``"LOW"``"MEDIUM"``"HIGH"` |
| `temperature` | Controls randomness. Lower is more focused/deterministic, higher is more creative. (default: 1.0) | FLOAT | Yes | 0.0 to 2.0 |
| `top_p` | Nucleus sampling: sample from the smallest token set whose cumulative probability reaches top_p. (default: 0.95) | FLOAT | Yes | 0.0 to 1.0 |
| `max_output_tokens` | Maximum tokens to generate, including the model's internal thinking. With thinking_level HIGH, a low value can leave no room for the answer; raise this if responses come back empty or truncated. The model stops early when finished, so a higher cap costs nothing extra for short replies. (default: 32768) | INT | Yes | 16 to 65536 |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `thinking_level` | How hard the model reasons internally before answering. HIGH improves quality on difficult tasks but costs more (thinking) tokens and is slower. (default: "HIGH") | COMBO | Yes | `"LOW"``"HIGH"` |
| `temperature` | Controls randomness. Lower is more focused/deterministic, higher is more creative. (default: 1.0) | FLOAT | Yes | 0.0 to 2.0 |
| `top_p` | Nucleus sampling: sample from the smallest token set whose cumulative probability reaches top_p. (default: 0.95) | FLOAT | Yes | 0.0 to 1.0 |
| `max_output_tokens` | Maximum tokens to generate, including the model's internal thinking. With thinking_level HIGH, a low value can leave no room for the answer; raise this if responses come back empty or truncated. The model stops early when finished, so a higher cap costs nothing extra for short replies. (default: 32768) | INT | Yes | 16 to 65536 |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `thinking_level` | How hard the model reasons internally before answering. HIGH improves quality on difficult tasks but costs more (thinking) tokens and is slower. (default: "LOW") | COMBO | Yes | `"LOW"``"HIGH"` |
| `temperature` | Controls randomness. Lower is more focused/deterministic, higher is more creative. (default: 1.0) | FLOAT | Yes | 0.0 to 2.0 |
| `top_p` | Nucleus sampling: sample from the smallest token set whose cumulative probability reaches top_p. (default: 0.95) | FLOAT | Yes | 0.0 to 1.0 |
| `max_output_tokens` | Maximum tokens to generate, including the model's internal thinking. With thinking_level HIGH, a low value can leave no room for the answer; raise this if responses come back empty or truncated. The model stops early when finished, so a higher cap costs nothing extra for short replies. (default: 32768) | INT | Yes | 16 to 65536 |

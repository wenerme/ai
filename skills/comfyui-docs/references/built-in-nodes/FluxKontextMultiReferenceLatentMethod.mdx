...
| `reference_latents_method` | STRING | Yes | `"offset"``"index"``"uxo/uno"` | The method to use for reference latents processing. If "uxo" or "uso" is selected, it will be converted to "uxo" |

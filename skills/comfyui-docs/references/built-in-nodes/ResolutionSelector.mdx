...
|-----------|-----------|----------|-------|-------------|
| `aspect_ratio` | COMBO | Yes | `"1:1 (Square)"``"3:2 (Photo)"``"4:3 (Standard)"``"16:9 (Widescreen)"``"21:9 (Ultrawide)"``"2:3 (Portrait Photo)"``"3:4 (Portrait Standard)"``"9:16 (Portrait Widescreen)"` | The aspect ratio for the output dimensions (default: `"1:1 (Square)"`). |

...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"viduq2-pro"``"viduq2-turbo"` | The AI model to use for video extension. Selecting a model reveals its specific duration and resolution settings. |
...
| `model.resolution` | COMBO | Yes | `"720p"``"1080p"` | The resolution of the output video. This setting appears after selecting a model. |

...
description: "The Vidu Video Extension node generates additional frames to extend the length of an existing video."
mode: wide
---
...
|-----------|-------------|-----------|----------|-------|
| `model` | Model to use for video extension. Selecting a model reveals its specific duration and resolution settings. | DYNAMIC_COMBO | Yes | `"viduq2-pro"``"viduq2-turbo"` |
...
| `resolution` | Resolution of the output video. This setting appears after selecting a model. | COMBO | Yes | `"720p"``"1080p"` |

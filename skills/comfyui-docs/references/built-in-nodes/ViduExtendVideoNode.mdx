...
|-----------|-------------|-----------|----------|-------|
| `model` | Model to use for video extension. Selecting a model reveals its specific duration and resolution settings. | COMBO | Yes | `"viduq2-pro"``"viduq2-turbo"` |
...
| `model.resolution` | Resolution of the output video. This setting appears after selecting a model. | COMBO | Yes | `"720p"``"1080p"` |

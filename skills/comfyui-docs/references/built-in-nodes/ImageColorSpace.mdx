...
| `source` | Color space of the input pixels. Default: "sRGB". | COMBO | Yes | `"sRGB"``"HDR"``"HDR PQ"``"linear"` |
| `destination` | Color space of the output pixels. Set the save node to this same color space. Default: "sRGB". | COMBO | Yes | `"sRGB"``"HDR"``"HDR PQ"``"linear"` |

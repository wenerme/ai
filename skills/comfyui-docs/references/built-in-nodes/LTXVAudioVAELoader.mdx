...
|-----------|-----------|----------|-------|-------------|
| `ckpt_name` | STRING | Yes | All files in the `checkpoints` folder.*Example: `"audio_vae.safetensors"`* | Audio VAE checkpoint to load. This is a dropdown list populated with all the files found in your ComfyUI `checkpoints` directory. |

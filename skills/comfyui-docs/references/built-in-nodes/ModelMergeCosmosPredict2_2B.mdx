...
description: "The ModelMergeCosmosPredict22B node merges two diffusion models using a block-based approach with fine-grained control over different model components."
mode: wide
---

...
| `keyscale` | The musical key and scale (major or minor). | COMBO | No | `"C major"``"C# major"``"Db major"``"D major"``"D# major"``"Eb major"``"E major"``"F major"``"F# major"``"Gb major"``"G major"``"G# major"``"Ab major"``"A major"``"A# major"``"Bb major"``"B major"``"C minor"``"C# minor"``"Db minor"``"D minor"``"D# minor"``"Eb minor"``"E minor"``"F minor"``"F# minor"``"Gb minor"``"G minor"``"G# minor"``"Ab minor"``"A minor"``"A# minor"``"Bb minor"``"B minor"` |

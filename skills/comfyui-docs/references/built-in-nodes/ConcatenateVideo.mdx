...
| `codec` | Codec used to encode video tensors. Auto uses H.264; already encoded videos remain unchanged. Default: "auto" | COMBO | Yes | `"auto"`Other options are defined by the available video codec types. |

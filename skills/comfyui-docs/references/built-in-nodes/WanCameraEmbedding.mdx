...
|-----------|-----------|----------|-------|-------------|
| `camera_pose` | COMBO | Yes | "Static""Pan Up""Pan Down""Pan Left""Pan Right""Zoom In""Zoom Out""Anti Clockwise (ACW)""ClockWise (CW)" | The type of camera movement to simulate (default: "Static") |

...
| --- | --- | --- | --- | --- |
| `camera_pose` | The type of camera movement to simulate (default: "Static") | COMBO | Yes | "Static""Pan Up""Pan Down""Pan Left""Pan Right""Zoom In""Zoom Out""Anti Clockwise (ACW)""ClockWise (CW)" |

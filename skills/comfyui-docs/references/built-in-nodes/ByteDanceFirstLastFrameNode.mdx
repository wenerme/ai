...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"seedance-1-5-pro-251215"``"seedance-1-0-pro-250528"``"seedance-1-0-lite-i2v-250428"` | The model to use for video generation (default: `"seedance-1-0-lite-i2v-250428"`). |
...
| `resolution` | COMBO | Yes | `"480p"``"720p"``"1080p"` | The resolution of the output video. |
| `aspect_ratio` | COMBO | Yes | `"adaptive"``"16:9"``"4:3"``"1:1"``"3:4"``"9:16"``"21:9"` | The aspect ratio of the output video (default: `"adaptive"`). |

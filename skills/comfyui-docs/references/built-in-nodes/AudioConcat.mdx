...
description: "The AudioConcat node combines two audio inputs by joining them together."
mode: wide
---
...
| `direction` | Whether to append audio2 after or before audio1 (default: "after") | COMBO | Yes | `"after"``"before"` |

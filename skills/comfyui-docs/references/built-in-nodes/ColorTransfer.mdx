...
| `method` | The color transfer algorithm to use. | COMBO | Yes | `"reinhard_lab"``"mkl_lab"``"histogram"` |
| `source_stats` | Determines how color statistics are calculated from the source (target) image(s). | DYNAMICCOMBO | Yes | `"per_frame"``"uniform"``"target_frame"` |

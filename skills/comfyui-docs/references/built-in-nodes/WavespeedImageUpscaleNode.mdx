...
|-----------|-------------|-----------|----------|-------|
| `model` | The AI model to use for upscaling. "SeedVR2" and "Ultimate" offer different quality and pricing tiers. | STRING | Yes | `"SeedVR2"``"Ultimate"` |
| `image` | The input image to be upscaled. Exactly one image is required. | IMAGE | Yes | |
| `target_resolution` | The desired output resolution for the upscaled image. | STRING | Yes | `"2K"``"4K"``"8K"` |

...
| `model.aspect_ratio` | The aspect ratio for the edited image. When set to "auto", the aspect ratio is determined automatically. | COMBO | No | `"auto"``"16:9"``"9:16"``"3:2"``"2:3"``"4:3"``"3:4"``"1:1"` |
...
| `upscale` | Controls whether to upscale the generated image. | COMBO | No | `"disabled"``"enabled"` |

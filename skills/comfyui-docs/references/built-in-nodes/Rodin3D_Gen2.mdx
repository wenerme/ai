...
| `Polygon_count` | Target polygon count and mesh type for the generated 3D model. "Quad" options use quad-based meshes, "Triangle" options use triangle-based meshes (default: "500K-Triangle") | COMBO | No | "4K-Quad""8K-Quad""18K-Quad""50K-Quad""2K-Triangle""20K-Triangle""150K-Triangle""500K-Triangle" |

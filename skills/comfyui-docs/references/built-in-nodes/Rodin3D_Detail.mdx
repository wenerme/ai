...
description: "The Rodin 3D Detail node generates detailed 3D assets using the Rodin API."
mode: wide
---
...
| `Polygon_count` | Target polygon count for the generated 3D model. Determines the mesh quality level (default: "18K-Quad") | STRING | No | `"4K-Quad"``"8K-Quad"``"18K-Quad"``"50K-Quad"``"200K-Triangle"` |

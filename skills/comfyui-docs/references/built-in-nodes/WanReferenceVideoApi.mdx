...
| `size` | COMBO | Yes | `"720p: 1:1 (960x960)"``"720p: 16:9 (1280x720)"``"720p: 9:16 (720x1280)"``"720p: 4:3 (1088x832)"``"720p: 3:4 (832x1088)"``"1080p: 1:1 (1440x1440)"``"1080p: 16:9 (1920x1080)"``"1080p: 9:16 (1080x1920)"``"1080p: 4:3 (1632x1248)"``"1080p: 3:4 (1248x1632)"` | The resolution and aspect ratio for the output video. |
...
| `shot_type` | COMBO | Yes | `"single"``"multi"` | Specifies whether the generated video is a single continuous shot or contains multiple shots with cuts. |

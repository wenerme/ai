...
| `resolution` | The output resolution for the video (default: "540p"). This parameter is ignored when using the `ray_1_6` model. | COMBO | Yes | `"540p"``"720p"``"1080p"` |
| `duration` | The duration of the generated video. This parameter is ignored when using the `ray_1_6` model. | COMBO | Yes | `"5s"``"9s"` |

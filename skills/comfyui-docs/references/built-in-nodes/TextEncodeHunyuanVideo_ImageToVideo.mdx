...
description: "The TextEncodeHunyuanVideoImageToVideo node creates conditioning data for video generation by combining text prompts with image embeddings."
mode: wide
---

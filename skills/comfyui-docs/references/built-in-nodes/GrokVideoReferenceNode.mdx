...
| `model.resolution` | The resolution of the output video. | COMBO | Yes | `"480p"``"720p"` |
| `model.aspect_ratio` | The aspect ratio of the output video. | COMBO | Yes | `"16:9"``"4:3"``"3:2"``"1:1"``"2:3"``"3:4"``"9:16"` |

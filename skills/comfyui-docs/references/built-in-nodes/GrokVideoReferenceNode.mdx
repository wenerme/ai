...
|-----------|-------------|-----------|----------|-------|
| `model` | The model to use for video generation. | DYNAMIC_COMBO | Yes | `"grok-imagine-video-1.5"``"grok-imagine-video"` |
...
| `aspect_ratio` | The aspect ratio of the output video. | COMBO | Yes | `"16:9"``"4:3"``"3:2"``"1:1"``"2:3"``"3:4"``"9:16"` |

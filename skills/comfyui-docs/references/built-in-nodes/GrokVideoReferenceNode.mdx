...
| `model.resolution` | COMBO | Yes | `"480p"``"720p"` | The resolution of the output video. |
| `model.aspect_ratio` | COMBO | Yes | `"16:9"``"4:3"``"3:2"``"1:1"``"2:3"``"3:4"``"9:16"` | The aspect ratio of the output video. |

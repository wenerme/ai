...
description: "This node allows you to use two different models during the guided CFG sampling process: one model for the positive (conditional) pass and a separate model for the negative (uncond"
mode: wide
---

...
|-----------|-------------|-----------|----------|-------|
| `mesh` | Mesh or 3D file to save | MESH or FILE3D | Yes | Mesh dataGLBGLTFOBJFBXSTLUSDZPLYSPLATSPZKSPLATAny splat formatAny point cloud formatAny 3D file format |

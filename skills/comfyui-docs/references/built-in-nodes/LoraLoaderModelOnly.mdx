...
description: "This node will detect models located in the ComfyUI/models/loras folder, and it will also read models from additional paths configured in the extramodelpaths.yaml file."
mode: wide
---

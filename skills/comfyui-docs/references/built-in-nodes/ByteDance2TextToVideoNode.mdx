...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"Seedance 2.0"``"Seedance 2.0 Fast"` | The model to use for video generation. Selecting a model will reveal additional required inputs for the prompt, resolution, aspect ratio, duration, and audio generation. "Seedance 2.0" is for maximum quality; "Seedance 2.0 Fast" is for speed optimization. |

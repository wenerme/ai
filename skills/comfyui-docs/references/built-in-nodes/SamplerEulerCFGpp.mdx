...
description: "The SamplerEulerCFGpp node provides an Euler CFG++ sampling method for generating outputs."
mode: wide
---
...
| --- | --- | --- | --- | --- |
| `version` | The implementation version of the Euler CFG++ sampler to use (default: "regular") | STRING | Yes | `"regular"``"alternative"` |

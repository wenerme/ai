...
| `upscale_method` | The interpolation method used for upscaling the image at each upscaling step (default: "bislerp") | COMBO | Yes | "bislerp""nearest-exact""bilinear""area""bicubic" |

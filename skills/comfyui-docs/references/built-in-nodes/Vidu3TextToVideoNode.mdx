...
| --- | --- | --- | --- | --- |
| `model` | Model to use for video generation. Selecting a model reveals additional configuration parameters for aspect ratio, resolution, duration, and audio. | DYNAMIC_COMBO | Yes | `"viduq3-pro"``"viduq3-turbo"` |
...
| Parameter | Description | Data Type | Required | Range |
| --- | --- | --- | --- | --- |
| `aspect_ratio` | The aspect ratio of the output video. | COMBO | Yes | `"16:9"``"9:16"``"3:4"``"4:3"``"1:1"` |

...
| `dtype` | The computational data type to apply to the model (default: "default"). This parameter is marked as an advanced option. | COMBO | Yes | "default""fp32""fp16""bf16" |

...
| `resolution` | COMBO | Yes | `"720p"``"1080p"``"4k"` | The resolution of the output video. |
| `aspect_ratio` | COMBO | No | `"16:9"``"9:16"` | Aspect ratio of the output video (default: "16:9"). |
...
| `model` | COMBO | No | `"veo-3.1-generate"``"veo-3.1-fast-generate"``"veo-3.1-lite"` | The specific Veo 3 model to use for generation (default: "veo-3.1-generate"). |

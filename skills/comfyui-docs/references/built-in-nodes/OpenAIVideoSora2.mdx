...
| --- | --- | --- | --- | --- |
| `model` | The OpenAI Sora model to use for video generation (default: "sora-2") | COMBO | Yes | "sora-2""sora-2-pro" |
| `prompt` | Guiding text; may be empty if an input image is present (default: empty string) | STRING | Yes | - |
| `size` | The resolution of the generated video (default: "1280x720") | COMBO | Yes | "720x1280""1280x720""1024x1792""1792x1024" |
| `duration` | The duration of the generated video in seconds (default: 8) | COMBO | Yes | 4812 |

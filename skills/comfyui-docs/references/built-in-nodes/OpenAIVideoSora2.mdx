...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | "sora-2""sora-2-pro" | The OpenAI Sora model to use for video generation (default: "sora-2") |
| `prompt` | STRING | Yes | - | Guiding text; may be empty if an input image is present (default: empty) |
| `size` | COMBO | Yes | "720x1280""1280x720""1024x1792""1792x1024" | The resolution for the generated video (default: "1280x720") |
| `duration` | COMBO | Yes | 4812 | The duration of the generated video in seconds (default: 8) |

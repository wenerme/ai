...
| `model_name` | Model selection for image generation (default: "kling-v3") | COMBO | Yes | `"kling-v3"``"kling-v2"``"kling-v1-5"` |
| `aspect_ratio` | Aspect ratio for generated images (default: "16:9") | COMBO | Yes | `"16:9"``"9:16"``"1:1"``"4:3"``"3:4"``"21:9"``"9:21"` |

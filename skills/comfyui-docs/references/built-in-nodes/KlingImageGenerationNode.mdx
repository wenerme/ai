...
| `image_type` | COMBO | Yes | `"subject_reference"``"style_reference"` | Image reference type selection (advanced). Required when a reference image is provided. |
...
| `model_name` | COMBO | Yes | `"kling-v3"``"kling-v2"``"kling-v1-5"` | Model selection for image generation (default: "kling-v3") |
| `aspect_ratio` | COMBO | Yes | `"16:9"``"9:16"``"1:1"``"4:3"``"3:4"``"21:9"``"9:21"` | Aspect ratio for generated images (default: "16:9") |

...
| `width` | INT | Yes | 16 to MAX_RESOLUTION | Output video width in pixels (default: 832, must be divisible by 16) |
| `height` | INT | Yes | 16 to MAX_RESOLUTION | Output video height in pixels (default: 480, must be divisible by 16) |
| `length` | INT | Yes | 1 to MAX_RESOLUTION | Number of frames in the generated video (default: 81, must be divisible by 4) |

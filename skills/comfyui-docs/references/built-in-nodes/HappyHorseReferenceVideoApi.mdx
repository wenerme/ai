...
|-----------|-------------|-----------|----------|-------|
| `model` | The HappyHorse reference-to-video model to use for generation. | DYNAMIC_COMBO | Yes | `"happyhorse-1.1-r2v"``"happyhorse-1.0-r2v"` |
...
| `ratio` | The aspect ratio of the generated video. | COMBO | Yes | `"16:9"``"9:16"``"1:1"``"4:3"``"3:4"``"21:9"``"9:21"``"5:4"``"4:5"` |

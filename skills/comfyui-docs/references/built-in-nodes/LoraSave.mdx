...
description: "The LoraSave node extracts and saves LoRA (Low-Rank Adaptation) files from model differences."
mode: wide
---
...
| `lora_type` | The type of LoRA to create. "standard" extracts low-rank matrices via SVD; "full_diff" saves the full weight difference (default: "standard") | COMBO | Yes | `"standard"``"full_diff"` |

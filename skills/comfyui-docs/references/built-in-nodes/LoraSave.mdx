...
| `lora_type` | COMBO | Yes | `"standard"``"full_diff"` | The type of LoRA to create. "standard" extracts low-rank matrices via SVD; "full_diff" saves the full weight difference (default: "standard") |

...
description: "The Kling Image(First Frame) to Video with Audio node uses the Kling AI model to generate a short video from a single starting image and a text prompt."
mode: wide
---
...
| `duration` | The length of the video to generate, in seconds. | COMBO | Yes | `5``10` |

...
|-----------|-------------|-----------|----------|-------|
| `model` | The HappyHorse model to use for video generation. | DYNAMIC_COMBO | Yes | `"happyhorse-1.1-i2v"``"happyhorse-1.0-i2v"` |
...
| `resolution` | The output video resolution. (default: `"720P"`) | COMBO | Yes | `"720P"``"1080P"` |

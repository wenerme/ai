...
|-----------|-----------|----------|-------|-------------|
| `voice` | STRING | Yes | `"Adam (male, american)"``"Antoni (male, british)"``"Arnold (male, american)"``"Bella (female, american)"``"Domi (female, american)"``"Elli (female, american)"``"Josh (male, american)"``"Rachel (female, american)"``"Sam (male, american)"` | Choose a voice from the predefined ElevenLabs voices. |

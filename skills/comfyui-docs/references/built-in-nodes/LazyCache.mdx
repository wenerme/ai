...
description: "LazyCache is a homebrew version of EasyCache that provides an even easier implementation."
mode: wide
---
...
Note: `reuse_threshold`, `start_percent`, `end_percent`, and `verbose` are optional advanced options.

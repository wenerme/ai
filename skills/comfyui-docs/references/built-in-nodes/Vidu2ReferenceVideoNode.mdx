...
| `aspect_ratio` | The shape of the video frame. | COMBO | No | `"16:9"``"9:16"``"4:3"``"3:4"``"1:1"` |
| `resolution` | The pixel resolution of the output video (default: `"720p"`). | COMBO | No | `"720p"``"1080p"` |
| `movement_amplitude` | Controls the movement amplitude of objects in the frame (default: `"auto"`). | COMBO | No | `"auto"``"small"``"medium"``"large"` |

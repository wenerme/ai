...
| `aspect_ratio` | COMBO | No | `"16:9"``"9:16"``"4:3"``"3:4"``"1:1"` | The shape of the video frame. |
| `resolution` | COMBO | No | `"720p"``"1080p"` | The pixel resolution of the output video (default: `"720p"`). |
| `movement_amplitude` | COMBO | No | `"auto"``"small"``"medium"``"large"` | Controls the movement amplitude of objects in the frame (default: `"auto"`). |

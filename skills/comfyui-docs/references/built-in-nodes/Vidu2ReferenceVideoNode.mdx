...
| `resolution` | COMBO | No | `"720p"``"1080p"` | The pixel resolution of the output video. |
| `movement_amplitude` | COMBO | No | `"auto"``"small"``"medium"``"large"` | Controls the movement amplitude of objects in the frame. |

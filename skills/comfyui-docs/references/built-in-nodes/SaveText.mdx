...
| `format` | The file format to save the text as (default: "txt"). When "json" is selected, valid JSON text is pretty-printed with 2-space indentation; otherwise, the text is saved as-is. | COMBO | No | `"txt"``"csv"``"md"``"json"` |

...
| --- | --- | --- | --- | --- |
| `model_type` | The type of diffusion model to use for the noise level calculation. Each option uses its own predefined table of noise levels. | COMBO | Yes | "FLUX""Wan""Chroma" |

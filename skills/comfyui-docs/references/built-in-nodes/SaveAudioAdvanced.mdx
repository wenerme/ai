...
| `format` | The file format in which to save the audio. | DYNAMIC_COMBO | Yes | "flac""mp3""opus" |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `quality` | The encoding quality of the output MP3 file. (default: "V0") | COMBO | No | "V0""128k""320k" |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `quality` | The encoding quality of the output Opus file. (default: "128k") | COMBO | No | "64k""96k""128k""192k""320k" |

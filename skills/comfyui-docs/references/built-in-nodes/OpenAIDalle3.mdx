...
| `style` | Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images. (default: "natural") | COMBO | No | "natural""vivid" |
| `size` | Image size (default: "1024x1024") | COMBO | No | "1024x1024""1024x1792""1792x1024" |

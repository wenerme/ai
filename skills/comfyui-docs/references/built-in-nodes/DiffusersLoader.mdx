...
|-----------|-----------|----------|-------|-------------|
| `model_path` | STRING | Yes | Multiple options available(auto-populated from diffusers folders) | The path to the diffusers model directory to load. The node automatically scans for valid diffusers models in the configured diffusers folders and lists available options. |

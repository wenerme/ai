...
|-----------|-------------|-----------|----------|-------|
| `model_path` | The path to the diffusers model directory to load. The node automatically scans the configured diffusers folders for valid models and lists the available options. | COMBO | Yes | Multiple options available(auto-populated from diffusers folders) |

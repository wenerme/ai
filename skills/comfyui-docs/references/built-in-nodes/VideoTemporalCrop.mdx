...
description: "This node crops a continuous range of frames from a video."
mode: wide
---
...
Note: `start_frame` is limited to the last frame of the video, and `length` is reduced if it would extend beyond the available frames.

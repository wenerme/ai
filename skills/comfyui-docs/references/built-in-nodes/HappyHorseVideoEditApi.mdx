...
| `resolution` | STRING | Yes | `"720P"``"1080P"` | The output resolution. |
| `ratio` | STRING | Yes | `"16:9"``"9:16"``"1:1"``"4:3"``"3:4"` | Aspect ratio. If not changed, approximates the input video ratio. |

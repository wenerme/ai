...
| `watermark` | Whether to add an AI-generated watermark to the result (default: False). | BOOLEAN | No | TrueFalse |
...
| `ratio` | Aspect ratio. If not changed, approximates the input video ratio. | STRING | Yes | `"16:9"``"9:16"``"1:1"``"4:3"``"3:4"` |

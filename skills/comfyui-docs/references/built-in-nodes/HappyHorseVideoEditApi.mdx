...
| `watermark` | Whether to add an AI-generated watermark to the result (default: False). Advanced parameter. | BOOLEAN | Yes | TrueFalse |
...
| `resolution` | The output resolution. | COMBO | Yes | "720P""1080P" |
| `ratio` | Aspect ratio. If not changed, approximates the input video ratio. | COMBO | Yes | "16:9""9:16""1:1""4:3""3:4" |

...
| `weight_dtype` | The numerical precision (data type) for the model weights. The “default” option uses the model’s original precision. (default: “default”) | STRING | No | `"default"``"fp16"``"bf16"``"fp32"` |

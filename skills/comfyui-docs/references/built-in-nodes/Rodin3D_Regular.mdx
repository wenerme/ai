...
| `Polygon_count` | STRING | No | `"4K-Quad"``"8K-Quad"``"18K-Quad"``"50K-Quad"``"200K-Triangle"` | Target polygon count and mesh type for the generated 3D model (default: "18K-Quad"). |

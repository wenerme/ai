...
| `eta` | Stochastic strength of SDEs.When eta=0, they reduce to deterministic ODE.Large eta may cause invalid outputs. If this occurs, try decreasing this value. (default: 1.0) | FLOAT | Yes | 0.0-10.0 (step: 0.01) |

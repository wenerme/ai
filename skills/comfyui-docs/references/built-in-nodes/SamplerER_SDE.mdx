...
|-----------|-----------|----------|-------|-------------|
| `solver_type` | COMBO | Yes | "ER-SDE""Reverse-time SDE""ODE" | The type of solver to use for sampling. Determines the mathematical approach for the diffusion process. |

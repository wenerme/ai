...
description: "ZImageFunControlnet applies a specialized control network to influence the image generation or editing process."
mode: wide
---

ZImageFunControlnet applies a specialized control network to influence the image generation or editing process. It uses a base model, a model patch, and a VAE, allowing you to adjust the strength of the control effect. This node can work with a base image, an inpainting image, and a mask for more targeted edits.

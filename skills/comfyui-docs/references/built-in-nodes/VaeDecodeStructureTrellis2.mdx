...
| `resolution` | The target spatial resolution of the output voxel grid (default: "32"). If the decoded grid has a different resolution, it is downsampled to match. | COMBO | Yes | "32""64" |

...
|-----------|-------------|-----------|----------|-------|
| `model` | The Grok image model to use. The sub-parameters shown below change depending on the selected model. | DYNAMIC_COMBO | Yes | "grok-imagine-image-2.0""grok-imagine-image-quality""grok-imagine-image-pro""grok-imagine-image" |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `resolution` | Output resolution of the edited images. | COMBO | Yes | "1K""2K" |
| `number_of_images` | Number of edited images to generate. (default: 1) | INT | Yes | 1 to 10 |
| `quality` | Quality level of the generated images. | COMBO | Yes | "medium""low" |
| `aspect_ratio` | Aspect ratio of the edited image. (default: "auto") | COMBO | Yes | "auto""1:1""2:3""3:2""3:4""4:3""9:16""16:9""9:19.5""19.5:9""9:20""20:9""1:2""2:1" |
...
| `resolution` | Output resolution of the edited images. | COMBO | Yes | "1K""2K" |
| `number_of_images` | Number of edited images to generate. (default: 1) | INT | Yes | 1 to 10 |
| `aspect_ratio` | Only allowed when multiple images are connected. (default: "auto") | COMBO | Yes | "auto""1:1""2:3""3:2""3:4""4:3""9:16""16:9""9:19.5""19.5:9""9:20""20:9""1:2""2:1" |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `images` | Growable slot: connect 1 to N reference images to edit. The slots use the template names `image_1`, `image_2`, `image_3`; the maximum number of slots depends on the selected model. | IMAGE | Yes | 1 image for `grok-imagine-image-pro`1 to 3 images for `grok-imagine-image-2.0`, `grok-imagine-image-quality`, and `grok-imagine-image` |
...
- The image limit counts every image in the connected inputs, so a batch containing several images counts as several images toward the limit.

...
| `model.resolution` | COMBO | No | `"4k"``"1080p"``"720p"` | The resolution for the generated video. This parameter is only available when the `model` is set to `"kling-v3"` (default: `"1080p"`). |

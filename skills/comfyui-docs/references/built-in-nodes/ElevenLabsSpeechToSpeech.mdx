...
|-----------|-------------|-----------|----------|-------|
| `model` | Model to use for speech-to-speech transformation. The selected model determines the available voice settings listed below. | DYNAMIC_COMBO | Yes | `eleven_multilingual_sts_v2``eleven_english_sts_v2` |
...
| `output_format` | Audio output format (default: "mp3_44100_192"). | COMBO | Yes | `"mp3_44100_192"``"opus_48000_192"` |

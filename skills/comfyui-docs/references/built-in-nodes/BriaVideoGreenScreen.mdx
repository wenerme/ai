...
| `green_shade` | Solid chroma-key shade applied behind the foreground: broadcast_green (#00B140), chroma_green (#00FF00), or blue_screen (#0000FF) | STRING | Yes | `"broadcast_green"``"chroma_green"``"blue_screen"` |

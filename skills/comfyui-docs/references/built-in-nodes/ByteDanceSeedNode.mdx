...
| `model` | The Seed model used to generate the response. This selector also exposes the model's sub-parameters. | DYNAMIC_COMBO | Yes | `"Seed 2.0 Pro"``"Seed 2.0 Lite"``"Seed 2.0 Mini"` |

...
| `aspect_ratio` | COMBO | Yes | `"16:9"``"9:16"``"1:1"` | Aspect ratio for the generated video |
| `quality` | COMBO | Yes | `"540p"``"1080p"` | Video quality setting (default: "540p") |
| `duration_seconds` | COMBO | Yes | `"5"``"10"` | Duration of the generated video in seconds |
| `motion_mode` | COMBO | Yes | `"normal"``"fast"` | Motion style for the video generation |

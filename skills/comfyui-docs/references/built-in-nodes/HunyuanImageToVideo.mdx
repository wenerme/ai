...
| `guidance_type` | Method for incorporating the starting image into video generation (default: "v1 (concat)"). Advanced option | COMBO | Yes | "v1 (concat)""v2 (replace)""custom" |

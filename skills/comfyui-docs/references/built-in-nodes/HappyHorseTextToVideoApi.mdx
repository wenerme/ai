...
|-----------|-------------|-----------|----------|-------|
| `model` | The HappyHorse model used for generation, along with its sub-parameters. Selecting a model determines which sub-parameters are available (see the model sections below). | DYNAMIC_COMBO | Yes | "happyhorse-1.1-t2v""happyhorse-1.0-t2v" |
...
| `ratio` | The aspect ratio of the output video. | COMBO | Yes | "16:9""9:16""1:1""4:3""3:4""21:9""9:21""5:4""4:5" |
...
| `prompt` | Prompt describing the elements and visual features. Supports English and Chinese. (default: ""). | STRING | Yes | - |
| `resolution` | The resolution of the output video. | COMBO | Yes | "720P""1080P" |
| `ratio` | The aspect ratio of the output video. | COMBO | Yes | "16:9""9:16""1:1""4:3""3:4" |
| `duration` | The length of the video in seconds. (default: 5, min: 3, max: 15, step: 1). | INT | Yes | 3 to 15 |

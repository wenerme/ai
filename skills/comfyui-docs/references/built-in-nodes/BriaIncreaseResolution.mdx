...
| `moderation` | Moderation settings. When set to "true", enables the `visual_input_moderation` and `visual_output_moderation` sub-options, both defaulting to False. | COMBO | Yes | "false""true" |

...
|-----------|-------------|-----------|----------|-------|
| `mode` | The rotation mode to use. `"euler_xyz"` applies rotation as X then Y then Z angles about the world axes (in degrees). `"quaternion"` uses a (w, x, y, z) quaternion that is automatically normalized. | DYNAMIC_COMBO | Yes | `"euler_xyz"``"quaternion"` |

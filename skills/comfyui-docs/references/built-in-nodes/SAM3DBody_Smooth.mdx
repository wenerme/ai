...
| `method` | gaussian: symmetric weighted average, best general-purpose smoother.savgol: sliding polynomial fit, preserves sharp peaks. (default: "savgol") | COMBO | Yes | "gaussian""savgol" |

...
| `engine` | COMBO | Yes | `"automatic"``"magnific_illusio"``"magnific_sharpy"``"magnific_sparkle"` | The specific AI engine to use for processing. This is an advanced parameter. |

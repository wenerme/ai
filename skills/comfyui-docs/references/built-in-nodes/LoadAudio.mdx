...
description: "The LoadAudio node loads audio files from the input directory and converts them into a format that can be processed by other audio nodes in ComfyUI."
mode: wide
---

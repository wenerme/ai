...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"viduq3-pro"``"viduq3-turbo"` | Model to use for video generation. |
| `model.resolution` | COMBO | Yes | `"720p"``"1080p"``"2K"` (viduq3-pro only) | Resolution of the output video. The available options depend on the selected model. |

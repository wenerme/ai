...
|-----------|-------------|-----------|----------|-------|
| `model` | Model to use for video generation. | COMBO | Yes | `"viduq3-pro"``"viduq3-turbo"` |
| `model.resolution` | Resolution of the output video. The available options depend on the selected model. | COMBO | Yes | `"720p"``"1080p"``"2K"` (viduq3-pro only) |

...
| Parameter | Description | Data Type | Required | Range |
| --- | --- | --- | --- | --- |
| `model.resolution` | The target resolution for the enhanced video. Selecting `"original"` keeps the input video's resolution. | COMBO | Yes | `"original"``"720p"``"1080p"``"2K/QHD"``"4K/UHD"``"8K"` |

### Generative Model (1x) Inputs

| Parameter | Description | Data Type | Required | Range |
| --- | --- | --- | --- | --- |
| `model.resolution` | The target resolution for the enhanced video. Selecting `"original"` keeps the input video's resolution. The `"8K"` option is not available for this model. | COMBO | Yes | `"original"``"720p"``"1080p"``"2K/QHD"``"4K/UHD"` |

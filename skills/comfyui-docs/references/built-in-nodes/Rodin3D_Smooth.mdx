...
description: "The Rodin 3D Smooth node generates 3D assets using the Rodin API by processing input images and converting them into smooth 3D models."
mode: wide
---
...
| `Polygon_count` | Target polygon count for the generated 3D model. Determines the mesh quality and detail level (default: "18K-Quad"). | STRING | No | "4K-Quad""8K-Quad""18K-Quad""50K-Quad""200K-Triangle" |

...
|-----------|-------------|-----------|----------|-------|
| `model` | The Seedream model version to use for generation. Each model has different capabilities and pricing. | DYNAMIC_COMBO | Yes | `"seedream 5.0 pro"``"seedream 5.0 lite"``"seedream-4-5-251128"``"seedream-4-0-250828"` |

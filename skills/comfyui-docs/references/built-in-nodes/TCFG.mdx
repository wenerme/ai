...
description: "TCFG (Tangential Damping CFG) refines the unconditional (negative) predictions to better align with the conditional (positive) predictions during the sampling process."
mode: wide
---

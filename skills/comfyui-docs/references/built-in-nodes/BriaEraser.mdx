...
| `mask_type` | Selects how the mask was created. "manual" is for hand-drawn or brush masks; "automatic" is for masks produced by segmentation models such as SAM. | COMBO | Yes | "manual""automatic" |
| `moderation` | Moderation settings. Set to "true" to enable visual content moderation on the input and/or output images. | DYNAMIC_COMBO | Yes | "false""true" |

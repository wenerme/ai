...
description: "The Kling Single Image Video Effect Node creates videos with different special effects based on a single reference image."
mode: wide
---
...
| `duration` | The length of the generated video in seconds. | COMBO | Yes | `"5"``"10"` |

...
| `aspect_ratio` | The proportional relationship between the video's width and height. | COMBO | No | `"16:9"``"9:16"``"3:4"``"4:3"``"1:1"` |
| `resolution` | The pixel dimensions of the generated video. This is an advanced parameter. | COMBO | No | `"720p"``"1080p"` |

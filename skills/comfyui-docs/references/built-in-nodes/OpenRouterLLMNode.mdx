...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `reasoning_effort` | Reasoning effort. 'off' disables reasoning entirely. (default: "off") | COMBO | No | "off""low""medium""high" |
...
| Parameter | Description | Data Type | Required | Range |
|-----------|-------------|-----------|----------|-------|
| `search_context_size` | How much web search context to retrieve. Larger = more grounded but slower/pricier. (default: "medium") | COMBO | No | "low""medium""high" |

...
description: "The PikaScenes v2.2 node combines multiple images to create a video that incorporates objects from all the input images."
mode: wide
---
...
| `ingredients_mode` | Mode for combining ingredients (default: "creative") | STRING | No | "creative""precise" |

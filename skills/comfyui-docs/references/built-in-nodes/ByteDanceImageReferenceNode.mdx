...
|-----------|-----------|----------|-------|-------------|
| `model` | STRING | Yes | `"seedance-1-0-pro-250528"``"seedance-1-0-lite-i2v-250428"` | The AI model to use for video generation (default: `"seedance-1-0-lite-i2v-250428"`). |
...
| `resolution` | STRING | Yes | `"480p"``"720p"` | The resolution of the output video. |
| `aspect_ratio` | STRING | Yes | `"adaptive"``"16:9"``"4:3"``"1:1"``"3:4"``"9:16"``"21:9"` | The aspect ratio of the output video (default: `"adaptive"`). |

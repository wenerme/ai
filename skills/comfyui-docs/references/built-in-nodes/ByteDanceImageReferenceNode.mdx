...
| `resolution` | The resolution of the output video. | STRING | Yes | `"480p"``"720p"` |
| `aspect_ratio` | The aspect ratio of the output video (default: `"adaptive"`). | STRING | Yes | `"adaptive"``"16:9"``"4:3"``"1:1"``"3:4"``"9:16"``"21:9"` |

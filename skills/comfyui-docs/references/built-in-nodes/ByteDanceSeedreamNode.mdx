...
|-----------|-----------|----------|-------|-------------|
| `model` | STRING | Yes | "seedream 5.0 lite""seedream-4-5-251128""seedream-4-0-250828" | The Seedream model to use for generation. |
...
| `sequential_image_generation` | STRING | No | "disabled""auto" | Group image generation mode. "disabled" generates a single image. "auto" lets the model decide whether to generate multiple related images (e.g., story scenes, character variations). Default: "disabled". |

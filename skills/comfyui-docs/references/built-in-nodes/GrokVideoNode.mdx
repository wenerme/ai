...
|-----------|-----------|----------|-------|-------------|
| `model` | COMBO | Yes | `"grok-imagine-video"``"grok-imagine-video-beta"` | The model to use for video generation. |
| `prompt` | STRING | Yes | - | Text description of the desired video. |
| `resolution` | COMBO | Yes | `"480p"``"720p"` | The resolution of the output video. |
| `aspect_ratio` | COMBO | Yes | `"auto"``"16:9"``"4:3"``"3:2"``"1:1"``"2:3"``"3:4"``"9:16"` | The aspect ratio of the output video (default: "auto"). |

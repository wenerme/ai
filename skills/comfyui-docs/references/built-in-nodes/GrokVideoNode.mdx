...
| `resolution` | The resolution of the output video. 1080p is only available for grok-imagine-video-1.5. | COMBO | Yes | `"480p"``"720p"``"1080p"` |
| `aspect_ratio` | The aspect ratio of the output video. | COMBO | Yes | `"auto"``"16:9"``"4:3"``"3:2"``"1:1"``"2:3"``"3:4"``"9:16"` |

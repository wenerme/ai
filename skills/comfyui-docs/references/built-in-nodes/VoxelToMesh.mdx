...
| `algorithm` | The algorithm used for surface extraction. "surface net" produces smoother meshes, while "basic" creates simple box-like faces (default: "surface net") | COMBO | Yes | `"surface net"``"basic"` |

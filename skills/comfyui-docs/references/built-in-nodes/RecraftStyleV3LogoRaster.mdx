...
|-----------|-----------|----------|-------|-------------|
| `substyle` | STRING | Yes | `"none"``"bold"``"minimal"``"vibrant"``"handdrawn"``"geometric"``"vintage"``"neon"``"gradient"``"flat"``"outline"``"mascot"``"badge"``"abstract"``"retro"``"modern"``"playful"``"luxury"``"tech"``"nature"``"food"``"sport"``"fashion"``"music"``"travel"``"education"``"health"``"finance"``"realestate"``"nonprofit"` | The specific logo raster substyle to apply for logo generation (default: `"none"`) |

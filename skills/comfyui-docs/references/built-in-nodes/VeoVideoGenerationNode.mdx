...
| `person_generation` | Whether to allow generating people in the video (default: "ALLOW"). This is an advanced parameter. | COMBO | No | "ALLOW""BLOCK" |
...
| `model` | Veo model to use for video generation (default: "veo-2.0-generate-001") | COMBO | No | "veo-2.0-generate-001""veo-3.1-generate""veo-3.1-fast-generate""veo-3.1-lite""veo-3.0-generate-001""veo-3.0-fast-generate-001" |

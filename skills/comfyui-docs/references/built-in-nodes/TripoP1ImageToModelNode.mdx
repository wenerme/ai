...
| `enable_image_autofix` | BOOLEAN | No | TrueFalse | Pre-process the input image for better generation quality. (default: False) |
...
| `auto_size` | BOOLEAN | No | TrueFalse | Automatically determine the optimal size for the generated model. (default: False) |
| `export_uv` | BOOLEAN | No | TrueFalse | Export UV coordinates with the model. (default: True) |
| `compress_geometry` | BOOLEAN | No | TrueFalse | Compress the geometry data to reduce file size. (default: False) |

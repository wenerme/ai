...
| `auto_size` | Automatically determine the optimal size for the generated model. (default: False) | BOOLEAN | No | TrueFalse |
| `export_uv` | Export UV coordinates with the model. (default: True) | BOOLEAN | No | TrueFalse |
| `compress_geometry` | Compress the geometry data to reduce file size. (default: False) | BOOLEAN | No | TrueFalse |

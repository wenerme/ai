...
| --- | --- | --- | --- | --- |
| `combo` | The first selection from a set of three test options. | COMBO | Yes | `"option1"``"option2"``"option3"` |
| `combo2` | The second selection from a different set of three test options. | COMBO | Yes | `"option4"``"option5"``"option6"` |

...
description: "The StringTrim node removes whitespace characters (such as spaces, tabs, and newlines) from the beginning, end, or both sides of a text string."
mode: wide
---
...
| `mode` | Specifies which side(s) of the string to trim. "Both" removes whitespace from both ends, "Left" removes from the beginning only, "Right" removes from the end only. | COMBO | Yes | "Both""Left""Right" |

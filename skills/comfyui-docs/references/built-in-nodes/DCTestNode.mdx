...
| --- | --- | --- | --- | --- |
| `combo` | The main selection that determines which input field is active and what the node will output. | DYNAMIC_COMBO | Yes | `"option1"``"option2"``"option3"``"option4"` |
...
| Parameter | Description | Data Type | Required | Range |
| --- | --- | --- | --- | --- |
| `subcombo` | A secondary dynamic combo selection that appears when `combo` is set to `"option4"`. It determines which nested input fields are active. | DYNAMIC_COMBO | Yes | `"opt1"``"opt2"` |

...
|-----------|-------------|-----------|----------|-------|
| `model` | The AI model used to refine the draft model. | COMBO | Yes | `"meshy-7"``"meshy-6"``"latest"` |
...
| `texture_resolution` | Base color texture resolution. Higher resolutions capture more surface detail. | COMBO | Yes | `"2k"``"4k"``"8k"` |

...
| `mode` | 'creative' restores and invents fine detail, best for generated footage, textures and scenery. 'precise' sharpens the source without changing it, for faces, products and real footage. (default: "creative") | COMBO | Yes | "creative""precise" |
...
| `auto_downscale` | Automatically downscale sources larger than 3840x2160 pixels in area to fit the input limit. Aspect ratio is preserved; smaller videos are untouched. (default: true) | BOOLEAN | Yes | truefalse |

...
| `quality` | Video quality setting (default: `"540p"`) | COMBO | Yes | `"360p"``"540p"``"720p"``"1080p"` |
| `duration_seconds` | Video duration in seconds | COMBO | Yes | `5``8` |
| `motion_mode` | Motion style for the transition (default: `"normal"`) | COMBO | Yes | `"normal"``"fast"` |

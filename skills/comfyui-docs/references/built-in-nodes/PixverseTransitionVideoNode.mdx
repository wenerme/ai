...
| `quality` | COMBO | Yes | `"360p"``"540p"``"720p"``"1080p"` | Video quality setting (default: `"540p"`) |
| `duration_seconds` | COMBO | Yes | `5``8` | Video duration in seconds |
| `motion_mode` | COMBO | Yes | `"normal"``"fast"` | Motion style for the transition (default: `"normal"`) |

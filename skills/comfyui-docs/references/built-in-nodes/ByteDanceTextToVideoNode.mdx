...
|-----------|-----------|----------|-------|-------------|
| `model` | STRING | Yes | `"seedance-1-5-pro-251215"``"seedance-1-0-pro-250528"``"seedance-1-0-lite-t2v-250428"``"seedance-1-0-pro-fast-251015"` | The ByteDance model to use for generation (default: `"seedance-1-0-pro-fast-251015"`). |
...
| `aspect_ratio` | STRING | Yes | `"16:9"``"4:3"``"1:1"``"3:4"``"9:16"``"21:9"` | The aspect ratio of the output video. |

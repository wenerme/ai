...
|-----------|-------------|-----------|----------|-------|
| `model` | The ByteDance model used to generate the video (default: `"seedance-1-0-pro-fast-251015"`). | COMBO | Yes | `"seedance-1-5-pro-251215"``"seedance-1-0-pro-250528"``"seedance-1-0-pro-fast-251015"` |
...
| `aspect_ratio` | The aspect ratio of the output video. | COMBO | Yes | `"16:9"``"4:3"``"1:1"``"3:4"``"9:16"``"21:9"` |

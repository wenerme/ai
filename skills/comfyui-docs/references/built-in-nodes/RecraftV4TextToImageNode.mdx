...
| `style_match` | How closely to follow the style: precise reproduces it in detail, flexible matches the general look. Only used when a style is provided (default: "precise"). | COMBO | No | "precise""flexible" |

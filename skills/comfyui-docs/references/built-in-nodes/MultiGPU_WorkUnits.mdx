...
| `max_gpus` | The maximum number of identical GPUs to use for splitting the workload. Set this to the number of matching GPUs installed in your system. | INT | Yes | Minimum: 1Step: 1Default: 2 |

...
| `max_gpus` | INT | Yes | Minimum: 1Step: 1Default: 2 | The maximum number of identical GPUs to use for splitting the workload. Set this to the number of matching GPUs installed in your system. |

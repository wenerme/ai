...
description: "The Case Converter node transforms text strings into different letter case formats."
mode: wide
---
...
| `mode` | The case conversion mode to apply (default: `"UPPERCASE"`) | STRING | Yes | `"UPPERCASE"``"lowercase"``"Capitalize"``"Title Case"` |

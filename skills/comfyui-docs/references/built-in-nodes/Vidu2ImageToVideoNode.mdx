...
| `resolution` | COMBO | Yes | `"720p"``"1080p"` | The output resolution of the generated video. This parameter is advanced. |
| `movement_amplitude` | COMBO | Yes | `"auto"``"small"``"medium"``"large"` | The movement amplitude of objects in the frame. This parameter is advanced. |

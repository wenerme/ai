...
|-----------|-------------|-----------|----------|-------|
| `model` | The Vidu2 model to use for video generation. Different models offer varying speed and quality trade-offs. | COMBO | Yes | `"viduq2-pro-fast"``"viduq2-pro"``"viduq2-turbo"` |
...
| `resolution` | The output resolution of the generated video. This parameter is advanced. | COMBO | Yes | `"720p"``"1080p"` |
| `movement_amplitude` | The movement amplitude of objects in the frame. This parameter is advanced. | COMBO | Yes | `"auto"``"small"``"medium"``"large"` |

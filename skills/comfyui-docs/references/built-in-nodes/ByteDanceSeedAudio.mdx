...
| `model` | Model version. The multilingual variant supports 20 languages and per-sentence timing via `[5.5s:8.0s]` timestamps. (default: "seed-audio-1.0-multilingual") | COMBO | No | `"seed-audio-1.0-multilingual"``"seed-audio-1.0"` |

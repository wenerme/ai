...
| `duration` | COMBO | Yes | `"5"``"10"` | Video duration in seconds (default: "5") |
| `ratio` | COMBO | Yes | `"1280:720"``"720:1280"``"1104:832"``"832:1104"``"960:960"``"1584:672"` | Aspect ratio for the generated video (default: "1280:720") |

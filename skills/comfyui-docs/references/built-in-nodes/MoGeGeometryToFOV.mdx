...
| `axis` | The axis along which the FOV is computed: "vertical" (fov_y), "horizontal" (fov_x), or "diagonal" (default: "vertical"). | COMBO | Yes | "vertical""horizontal""diagonal" |
| `unit` | Output unit for the FOV (default: "degrees"). | COMBO | Yes | "degrees""radians" |

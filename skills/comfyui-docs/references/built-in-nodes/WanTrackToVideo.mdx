...
| `temperature` | Temperature parameter for motion patching (default: 220.0, step: 0.1). Advanced setting. | FLOAT | Yes | 1.0 to 1000.0 |
| `topk` | Top-k value for motion patching (default: 2). Advanced setting. | INT | Yes | 1 to 10 |

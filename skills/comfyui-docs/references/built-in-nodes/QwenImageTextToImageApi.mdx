...
|-----------|-------------|-----------|----------|-------|
| `model` | Model to use (default: "qwen-image-3.0-pro"). This composite selector also provides the prompt, image width, image height, and optional negative prompt. | MODEL | Yes | "qwen-image-3.0-pro""qwen-image-3.0" |

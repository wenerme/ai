...
| `format` | The format to save the video as (default: "auto"). | STRING | No | `"auto"``"mp4"``"webm"``"mkv"``"gif"` |
| `codec` | The codec to use for the video (default: "auto"). | STRING | No | `"auto"``"h264"``"h265"``"vp9"``"av1"``"prores"` |

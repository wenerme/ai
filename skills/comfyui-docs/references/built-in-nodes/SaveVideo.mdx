...
| `codec` | The output video codec. Auto preserves a compatible source stream. H.264 and AV1 re-encoding support SDR, HDR (HLG), and HDR PQ. Appears after a format is selected (default: `auto`). | DYNAMIC_COMBO | No | `"auto"``"h264"``"av1"` |

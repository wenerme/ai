...
| `format` | STRING | No | `"auto"``"mp4"``"webm"``"mkv"``"gif"` | The format to save the video as (default: "auto"). |
| `codec` | STRING | No | `"auto"``"h264"``"h265"``"vp9"``"av1"``"prores"` | The codec to use for the video (default: "auto"). |

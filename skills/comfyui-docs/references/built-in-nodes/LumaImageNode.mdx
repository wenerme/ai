...
| `model` | COMBO | Yes | `photon-flash-1``photon-1``photon` | Model selection for image generation. Different models have different costs. |
| `aspect_ratio` | COMBO | Yes | `16:9``1:1``4:3``3:2``21:9``9:16``3:4``2:3``9:21` | Aspect ratio for the generated image (default: `16:9`) |

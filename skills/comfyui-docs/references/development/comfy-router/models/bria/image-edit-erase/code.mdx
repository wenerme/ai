---
title: "Use Image Edit Erase with Comfy Router"
description: "Call bria/image-edit-erase through Comfy Router: endpoint, request shape and the response Router returns."
---

---
title: "Use Image Edit Replace Background with Comfy Router"
description: "Call bria/image-edit-replace-background through Comfy Router: endpoint, request shape and the response Router returns."
---
...
**Model ID:** `bria/image-edit-replace-background`

**Endpoint:** `POST https://api.comfy.org/v2/models/bria/image-edit-replace-background`

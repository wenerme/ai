---
title: "Use Recraft V4.1 Utility with Comfy Router"
description: "Call recraft/recraftv4_1_utility through Comfy Router: endpoint, request shape and the response Router returns."
---

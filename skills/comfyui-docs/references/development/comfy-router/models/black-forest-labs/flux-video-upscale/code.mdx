...
description: "Python, TypeScript and cURL snippets for upscaling a video with FLUX Video Upscale through Comfy Router, plus request fields and result shape"
---

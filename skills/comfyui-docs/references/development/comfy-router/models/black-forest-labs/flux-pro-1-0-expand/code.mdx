---
title: "Use FLUX Pro 1.0 Expand with Comfy Router"
description: "Call bfl/flux-pro-1.0-expand through Comfy Router: endpoint, request shape and the response Router returns."
---
...
**Endpoint:** `POST https://api.comfy.org/v2/models/bfl/flux-pro-1.0-expand`

...
description: "Python, TypeScript, Swift and cURL snippets for calling FLUX 1.1 [pro] Ultra and FLUX 1.1 [pro] through Comfy Router, plus request fields and result shape"
---

---
title: "Use Photon Flash 1 with Comfy Router"
description: "Call luma/photon-flash-1 through Comfy Router: endpoint, request shape and the response Router returns."
---

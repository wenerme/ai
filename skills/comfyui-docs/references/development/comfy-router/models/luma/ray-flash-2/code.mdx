---
title: "Use Ray Flash 2 with Comfy Router"
description: "Call luma/ray-flash-2 through Comfy Router: endpoint, request shape and the response Router returns."
---
...
<ParamField body="keyframes.frame0" type="object | object">
  A keyframe can be either a Generation reference, an Image, or a Video
</ParamField>

<ParamField body="keyframes.frame1" type="object | object">
  A keyframe can be either a Generation reference, an Image, or a Video
</ParamField>

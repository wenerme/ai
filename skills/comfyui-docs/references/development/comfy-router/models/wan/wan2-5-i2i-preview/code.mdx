---
title: "Use Wan 2.5 I2I Preview with Comfy Router"
description: "Call wan/wan2.5-i2i-preview through Comfy Router: endpoint, request shape and the response Router returns."
---
...
<ParamField body="parameters.size" type="string" default="&quot;1280*1280&quot;">
  The output image resolution in the format width*height. Default is 1280*1280. The API accepts a pixel area between 589824 (768*768) and 1638400 (1280*1280) with an aspect ratio between 1:4 and 4:1
</ParamField>
...
Generated from the schema Router serves at `GET /v2/models/wan/wan2.5-i2i-preview/openapi.json`, the same document it validates a call against before the request reaches the provider.

...
Generated from the schema Router serves at `GET /v2/models/wan/happyhorse-1.1-r2v/openapi.json`, the same document it validates a call against before the request reaches the provider.

...
description: "Python, TypeScript, Swift and cURL snippets for calling wan/happyhorse-1.1-r2v over HTTP through Comfy Router, plus the request fields and the result shape"
---

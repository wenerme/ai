...
Generated from the schema Router serves at `GET /v2/models/wan/wan2.7-i2v/openapi.json`, the same document it validates a call against before the request reaches the provider.

...
description: "Python, TypeScript, Swift and cURL snippets for calling wan/wan2.7-i2v over HTTP through Comfy Router, plus the request fields and the result shape"
---

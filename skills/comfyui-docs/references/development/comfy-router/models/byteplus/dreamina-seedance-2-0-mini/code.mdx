---
title: "Use Dreamina Seedance 2.0 Mini with Comfy Router"
description: "Call byteplus/dreamina-seedance-2-0-mini through Comfy Router: endpoint, request shape and the response Router returns."
---
...
**Endpoint:** `POST https://api.comfy.org/v2/models/byteplus/dreamina-seedance-2-0-mini`
...
Generated from the schema Router serves at `GET /v2/models/byteplus/dreamina-seedance-2-0-mini/openapi.json`, the same document it validates a call against before the request reaches the provider.

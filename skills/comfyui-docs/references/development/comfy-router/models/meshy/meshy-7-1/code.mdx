---
title: "Use Meshy 7.1 with Comfy Router"
description: "Call meshy/meshy-7.1 through Comfy Router: endpoint, request shape and the response Router returns."
---

API Reference for `meshy/meshy-7.1`, served by Comfy Router from Meshy.
...
**Model ID:** `meshy/meshy-7.1`

**Endpoint:** `POST https://api.comfy.org/v2/models/meshy/meshy-7.1`
...
<ParamField body="geometry_resolution" type="string" default="&quot;standard&quot;">
  Geometry resolution of the generated mesh. 2k and 4k run the Ultra pass for finer surface detail. 2k requires ai_model meshy-7, meshy-7.1 or latest; 4k requires meshy-7.1 or latest.

  Possible values: `standard`, `2k`, `4k`
</ParamField>
...
<ParamField body="ultra_mode" type="boolean" default="false">
  Deprecated. Use geometry_resolution instead; true is equivalent to geometry_resolution 2k. Only supported when ai_model is meshy-7, meshy-7.1 or latest.
</ParamField>
...
<ParamField body="texture_resolution" type="string" default="&quot;2k&quot;">
  Texture resolution of the generated textures. One of 2k, 4k or 8k. 4k and 8k require ai_model meshy-6, meshy-7, meshy-7.1 or latest.

  Possible values: `2k`, `4k`, `8k`
</ParamField>

Generated from the schema Router serves at `GET /v2/models/meshy/meshy-7.1/openapi.json`, the same document it validates a call against before the request reaches the provider.

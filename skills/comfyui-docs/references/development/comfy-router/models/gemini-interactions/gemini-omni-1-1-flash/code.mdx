...
Generated from the schema Router serves at `GET /v2/models/gemini-interactions/gemini-omni-1.1-flash/openapi.json`, the same document it validates a call against before the request reaches the provider.

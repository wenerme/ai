---
title: "Use GPT 6 Luna with Comfy Router"
description: "Call openai/gpt-6-luna through Comfy Router: endpoint, request shape and the response Router returns."
---

API Reference for `openai/gpt-6-luna`, served by Comfy Router from OpenAI.
...
**Endpoint:** `POST https://api.comfy.org/v2/models/openai/gpt-6-luna`
...
Generated from the schema Router serves at `GET /v2/models/openai/gpt-6-luna/openapi.json`, the same document it validates a call against before the request reaches the provider.

---
title: "Use Claude Haiku 4.5 20251001 with Comfy Router"
description: "Call anthropic/claude-haiku-4-5-20251001 through Comfy Router: endpoint, request shape and the response Router returns."
---
...
**Endpoint:** `POST https://api.comfy.org/v2/models/anthropic/claude-haiku-4-5-20251001`
...
Generated from the schema Router serves at `GET /v2/models/anthropic/claude-haiku-4-5-20251001/openapi.json`, the same document it validates a call against before the request reaches the provider.

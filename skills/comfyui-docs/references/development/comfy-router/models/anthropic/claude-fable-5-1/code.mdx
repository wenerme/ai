---
title: "Use Claude Fable 5.1 with Comfy Router"
description: "Call anthropic/claude-fable-5-1 through Comfy Router: endpoint, request shape and the response Router returns."
---
...
**Endpoint:** `POST https://api.comfy.org/v2/models/anthropic/claude-fable-5-1`
...
Generated from the schema Router serves at `GET /v2/models/anthropic/claude-fable-5-1/openapi.json`, the same document it validates a call against before the request reaches the provider.

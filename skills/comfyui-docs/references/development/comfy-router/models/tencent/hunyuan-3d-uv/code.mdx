---
title: "Use Hunyuan 3D Uv with Comfy Router"
description: "Call tencent/hunyuan-3d-uv through Comfy Router: endpoint, request shape and the response Router returns."
---
...
**Endpoint:** `POST https://api.comfy.org/v2/models/tencent/hunyuan-3d-uv`
...
Generated from the schema Router serves at `GET /v2/models/tencent/hunyuan-3d-uv/openapi.json`, the same document it validates a call against before the request reaches the provider.

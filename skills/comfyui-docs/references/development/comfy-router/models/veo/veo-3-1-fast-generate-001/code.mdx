...
Generated from the schema Router serves at `GET /v2/models/veo/veo-3.1-fast-generate-001/openapi.json`, the same document it validates a call against before the request reaches the provider.

...
Unlike a [Comfy API deployment](/development/serverless/overview), which serves one pinned environment that you build and release, Comfy Cloud serves a full, managed ComfyUI that is always on.

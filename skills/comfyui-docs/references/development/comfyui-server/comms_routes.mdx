---
title: "Routes"
description: "ComfyUI Server API Routes: reference for built-in GET, POST, and WebSocket endpoints covering prompts, queue, history, models, and user data, plus how to add custom routes for client-server communication."
---

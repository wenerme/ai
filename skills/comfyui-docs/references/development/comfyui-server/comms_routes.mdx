---
title: "ComfyUI Server Routes (HTTP and WebSocket API)"
description: "ComfyUI Server API routes: built-in GET, POST, and WebSocket endpoints for prompts, queue, history, models, and user data, plus how to add custom routes."
---

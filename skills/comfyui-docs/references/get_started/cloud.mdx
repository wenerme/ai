...
|----------|-------------|------------------------------|
| **Cost** | Free tier and paid subscription plans | Free |
...
| **Models** | Use pre-installed models. Import models from Civitai and Hugging Face. | Use any models you want, but you'll need to download them first. |

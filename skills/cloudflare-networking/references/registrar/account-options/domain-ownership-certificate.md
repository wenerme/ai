...
1. In the Cloudflare dashboard, go to the **Registrations** page. [Go to **Registrations** ↗](https://dash.cloudflare.com/?to=/:account/domains/registrations)

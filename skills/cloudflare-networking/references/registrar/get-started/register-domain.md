...
1. In the Cloudflare dashboard, go to the **Register domains** page. [Go to **Register domains** ↗](https://dash.cloudflare.com/?to=/:account/registrar/register)

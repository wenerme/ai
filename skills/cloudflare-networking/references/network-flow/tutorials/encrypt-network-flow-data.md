...
You can encrypt the network flow data sent from your router to Cloudflare by [routing ↗︎](https://www.cloudflare.com/learning/network-layer/what-is-routing/) your network flow traffic through a device running the Cloudflare One Client. Encrypted network flow traffic is then forwarded from the Cloudflare One Client device to Cloudflare's network flow endpoints.
...
Follow the instructions in the [Network Flow (formerly Magic Network Monitoring) API](https://developers.cloudflare.com/api/resources/magic_network_monitoring/subresources/configs/methods/edit/) to configure your devices.
...
- <code>Magic Network Monitoring Admin</code>
- <code>Magic Network Monitoring Config Write</code>

...
After this period, DCV tokens expire as dictated by the [CA/B Baseline Requirements ↗︎](https://cabforum.org/baseline-requirements-documents/), and new, valid tokens must be placed.

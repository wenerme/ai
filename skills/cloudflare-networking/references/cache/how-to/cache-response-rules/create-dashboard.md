...
1. In the Cloudflare dashboard, go to **Cache** > **Cache Rules**. [Go to **Cache Rules** ↗](https://dash.cloudflare.com/?to=/:account/:zone/caching/cache-rules)

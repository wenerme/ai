...
- [Purge by prefix](https://developers.cloudflare.com/cache/how-to/purge-cache/purge_by_prefix/), which purges all resources under a URL path and is not affected by custom cache keys.

...
Last updated Sep 19, 2026|Copy as Markdown| [View as Markdown](https://developers.cloudflare.com/magic-transit/how-to/configure-routes/index.md)| [Agent setup](https://developers.cloudflare.com/agent-setup/)
...
1. Go to **Routes** page. [Go to **Routes** ↗](https://dash.cloudflare.com/?to=/:account/magic-networks/routes)
...
4. Go to **Interconnects**. [Go to **Interconnects** ↗](https://dash.cloudflare.com/?to=/:account/magic-networks/connections/cni-tunnels)
...
2. Select **WAN configuration**.
3. In **CF Account ASN**, enter Cloudflare's ASN, and select **Update**.
4. Go to **Connectors**. [Go to **Connectors** ↗](https://dash.cloudflare.com/?to=/:account/magic-networks/connections)

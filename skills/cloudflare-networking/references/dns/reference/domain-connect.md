...
2. Add your template. You can create a copy of one of the existing templates and edit it according to your needs.
   ...
   - You must also provide a synchronous public key domain ( `syncPubKeyDomain` <sup>[1](#user-content-fn-1)</sup>). When your template is in use, synchronous calls will be digitally signed.
...
2. Fully qualified domain names to query for the `syncPubKeyDomain`<sup>[1](#user-content-fn-1)</sup> TXT records.

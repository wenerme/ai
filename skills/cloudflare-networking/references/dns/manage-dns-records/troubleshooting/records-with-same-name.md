...
This error can occur due to the special requirements of CNAME records<sup>[1](#user-content-fn-1)</sup>.

## Causes

You will encounter this error if you try to do one of the following:

- Create a CNAME record with a **Name** matching the name of an existing A/AAAA<sup>[2](#user-content-fn-2)</sup> or CNAME record.

...
To reduce the impact of false positives, Cloudflare does not block entire [public suffixes ↗︎](https://publicsuffix.org/) (such as `com`). However, it can block domains directly under them (such as `example.com`).

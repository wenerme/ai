...
* [  wrangler.jsonc ](#tab-panel-8601)
* [  wrangler.toml ](#tab-panel-8602)

JSONC

```
{  "name": "email-routing-worker",  // Set this to today's date  "compatibility_date": "2026-06-24",}
```

TOML

```
name = "email-routing-worker"# Set this to today's datecompatibility_date = "2026-06-24"
```

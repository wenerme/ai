...
In the bundler, Bun handles `.node` files with the `file` loader.
...
The value of `naming.asset` determines the location and file name of the copied file.

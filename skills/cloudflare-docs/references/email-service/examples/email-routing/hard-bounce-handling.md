...
```
{  "name": "bounce-handler",  // Set this to today's date  "compatibility_date": "2026-06-18",  "send_email": [{ "name": "EMAIL" }],  "kv_namespaces": [    {      "binding": "SUPPRESSION_LIST",      "id": "your-kv-namespace-id",    },  ],}
```

TOML

```
name = "bounce-handler"# Set this to today's datecompatibility_date = "2026-06-18"

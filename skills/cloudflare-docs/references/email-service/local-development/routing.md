...
```
{  "name": "email-routing-worker",  // Set this to today's date  "compatibility_date": "2026-06-18",}
```

TOML

```
name = "email-routing-worker"# Set this to today's datecompatibility_date = "2026-06-18"
```

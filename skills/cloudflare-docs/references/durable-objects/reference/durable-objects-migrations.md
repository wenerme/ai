...
1. Add the following lines to your Wrangler configuration file:  
   * [  wrangler.jsonc ](#tab-panel-4531)  
   * [  wrangler.toml ](#tab-panel-4532)  
```  
{  
  "migrations": [  
    {  
...
* [  wrangler.jsonc ](#tab-panel-4537)
* [  wrangler.toml ](#tab-panel-4538)
...
* [  wrangler.jsonc ](#tab-panel-4533)
* [  wrangler.toml ](#tab-panel-4534)
...
3. Add the following lines to your Wrangler configuration file.  
   * [  wrangler.jsonc ](#tab-panel-4535)  
   * [  wrangler.toml ](#tab-panel-4536)  
```  
{  
  "migrations": [  
    {  
...
* [  wrangler.jsonc ](#tab-panel-4539)
* [  wrangler.toml ](#tab-panel-4540)
...
1. Update the previous class name to the new class name by editing your Wrangler configuration file in the following way:  
   * [  wrangler.jsonc ](#tab-panel-4541)  
   * [  wrangler.toml ](#tab-panel-4542)  
```  
{  
  "durable_objects": {  
    "bindings": [  

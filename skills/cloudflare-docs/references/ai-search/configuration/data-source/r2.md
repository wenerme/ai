---
title: R2
description: You can connect a Cloudflare R2 bucket as a data source for your AI Search instance. AI Search indexes the files stored in your bucket automatically.
...
* [ Workers R2 binding ](#tab-panel-5132)
* [ AWS SDK ](#tab-panel-5133)
* [ Wrangler CLI ](#tab-panel-5134)

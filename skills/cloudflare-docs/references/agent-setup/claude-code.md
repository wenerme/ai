...
[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/agent-setup/claude-code.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose) 
...
[ Skills ↗](https://github.com/cloudflare/skills)[ MCP Server ↗](https://github.com/cloudflare/mcp)[ Claude Code Docs ↗](https://docs.anthropic.com/en/docs/claude-code) 
...
Code Mode is how the Cloudflare API MCP server fits all 2,500+ API endpoints into \~1,000 tokens. Instead of exposing every endpoint as a separate tool, it exposes two — `search()` and `execute()` — and Claude writes JavaScript to call them. [Learn more about Code Mode](https://developers.cloudflare.com/agents/api-reference/codemode/).

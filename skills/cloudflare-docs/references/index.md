...
[Jul 02, 2026AI SearchManage AI Search sync jobs with Wrangler CLIUse new Wrangler commands to trigger and monitor sync jobs for AI Search instances connected to a data source.Read update ](https://developers.cloudflare.com/changelog/post/2026-07-02-manage-sync-jobs/)[Jul 02CacheCache multiple versions of a URL with VaryCache Rules now support the origin Vary response header, so the same URL can hold multiple cached versions selected by the request headers your origin varies on.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-vary-for-cache-rules/)[Jul 02Cloudflare OneHostname routing for Cloudflare MeshRoute traffic to a Cloudflare Mesh node by hostname instead of IP.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-mesh-hostname-routing/)[Jul 02WorkersWork across multiple accounts with Wrangler auth profilesMaintain separate logins and switch between Cloudflare accounts per project, without re-running wrangler login.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-wrangler-auth-profiles/)[Jul 01Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.836.0)Cloudflare One Client for Linux (version 2026.6.836.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-warp-linux-ga/)[Jul 01AccessFix redirect URL fragment encoding for single-page applicationsAccess no longer over-encodes URL fragment characters, fixing post-login redirects for single-page applications with fragment-based routing.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-spa-redirect-fragment-fix/)[Jul 01AccessIndependent MFA for infrastructure applicationsAdd hardware-backed multi-factor authentication to SSH connections through Access for Infrastructure.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-ssh-mfa-piv-keys/)[Jul 01BotsNew options to manage AI trafficAll customers can now manage AI crawlers by behavior — Search, Agent, and Training — instead of a single Block AI bots toggle.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-ai-traffic-options/)

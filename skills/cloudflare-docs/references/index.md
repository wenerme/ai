...
[Sep 23, 2026Gateway<h3>Traffic Destination selector in Gateway policies</h3>Gateway HTTP and Network policies now support a Traffic Destination selector to match traffic based on how it exits Cloudflare.Read update](https://developers.cloudflare.com/changelog/post/2026-09-23-traffic-destination-selector/) [Sep 23Cloudflare One<h3>Add Mesh participants with guided onboarding</h3>Deploy Mesh nodes with guided setup, find client installers and your organization name, and manage every participant from one table.Read more](https://developers.cloudflare.com/changelog/post/2026-09-23-mesh-participant-onboarding/) [Sep 22Access<h3>Automatically manage inactive Access service tokens</h3>Disable or delete service tokens that have not authenticated for a specified period.Read more](https://developers.cloudflare.com/changelog/post/2026-09-22-service-token-inactivity-cleanup/) [Sep 22Cloudflare One<h3>Private MCP server support for MCP server portals</h3>MCP server portals can now connect to MCP servers available only on your private network.Read more](https://developers.cloudflare.com/changelog/post/2026-09-22-private-mcp-servers/) [Sep 22Rules<h3>concat() now supports up to 32 arguments</h3>Build richer dynamic values in Rules expressions by combining up to 32 values with concat().Read more](https://developers.cloudflare.com/changelog/post/2026-09-22-concat-argument-limit/) [Sep 22WAF<h3>WAF Release - 2026-09-22</h3>Cloudflare WAF managed rulesets 2026-09-22 releaseRead more](https://developers.cloudflare.com/changelog/post/2026-09-22-waf-release/) [Sep 22WAF<h3>WAF Release - Scheduled changes for 2026-09-29</h3>WAF managed ruleset changes scheduled for 2026-09-29Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/) [Sep 22Workers<h3>Workers Builds now supports Cursor Origin</h3>Connect a Cursor Origin repository to Workers Builds for automatic deployments, branch previews, and build status in Origin.Read more](https://developers.cloudflare.com/changelog/post/2026-09-22-cursor-origin-workers-builds/)

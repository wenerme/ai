...
[Aug 18, 2026Cloudflare TunnelConfigure origin application settings for Cloudflare Tunnel in the dashboardYou can now configure origin parameters such as TLS verification, HTTP Host header, connection timeouts, and more when editing a published application in the Cloudflare dashboard.Read update](https://developers.cloudflare.com/changelog/post/2026-08-18-tunnel-origin-settings-dashboard/)[Aug 17Email securityPost-quantum key exchange for MX deploymentsCloudflare Email Security now supports post-quantum hybrid key exchange on inbound and outbound SMTP connections.Read more](https://developers.cloudflare.com/changelog/post/2026-08-17-post-quantum-key-exchange-mx/)[Aug 17Load BalancingLoad balancing analytics now filters by pool nameThe pool filter in load balancing analytics now queries by pool name instead of pool ID, matching what you see in the UI dropdown.Read more](https://developers.cloudflare.com/changelog/post/2026-08-17-pool-name-analytics-filter/)[Aug 17R2New \`us\` jurisdiction for R2Restrict R2 bucket data storage and processing to the United States.Read more](https://developers.cloudflare.com/changelog/post/2026-08-17-r2-us-jurisdiction/)[Aug 17WAFWAF Release - 2026-08-17Cloudflare WAF managed rulesets 2026-08-17 releaseRead more](https://developers.cloudflare.com/changelog/post/2026-08-17-waf-release/)[Aug 17WAFWAF Release - Scheduled changes for 2026-08-24WAF managed ruleset changes scheduled for 2026-08-24Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Aug 17Workers AIQwen 3.8 27B now available on Workers AIQwen 3.8 27B, Alibaba's 27-billion-parameter vision language model, is now available on Workers AI.Read more](https://developers.cloudflare.com/changelog/post/2026-08-17-qwen-3.8-27b-workers-ai/)[Aug 14AnalyticsWebSocket reporting now includes full connection data transferHTTP Traffic Analytics and HTTP request logs now count data transferred throughout WebSocket connections, not only the initial handshake.Read more](https://developers.cloudflare.com/changelog/post/2026-08-14-websocket-data-transfer-reporting/)

...
[Jun 19, 2026Cloudflare MeshManage all your routes from one page in the dashboardA unified Routes page in the dashboard shows the routes for your Cloudflare Mesh, Cloudflare Tunnel, Cloudflare WAN, and Magic Transit connectors in one place, with an interactive network map.Read update ](https://developers.cloudflare.com/changelog/post/2026-06-19-unified-routes-page/)[Jun 18HyperdriveCreate PlanetScale Postgres and MySQL databases, billed to your Cloudflare accountCloudflare partners with PlanetScale to provide Postgres and MySQL databases for Workers applications with unified billing through your Cloudflare account.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-18-planetscale-databases-cloudflare-billing/)[Jun 18RadarUpdated Workers AI popularity metric in Cloudflare RadarWorkers AI model and task popularity now reflects the number of inferences rather than the number of unique accountsRead more ](https://developers.cloudflare.com/changelog/post/2026-06-18-radar-workers-ai-inference-metric/)[Jun 18SpeedCloudflare Fonts error handling and security improvementsCloudflare Fonts now passes \`/cf-fonts\` requests through to the origin on errors and includes additional input validation for security.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-18-cloudflare-fonts-error-handling-security/)[Jun 17ArtifactsManage Artifacts from the Cloudflare dashboardCreate and manage Artifacts namespaces, repos, files, forks, and repo tokens from the Cloudflare dashboard.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-17-dashboard-management/)[Jun 16AgentsAgents SDK improves browser automation, code execution, and recoveryAgents SDK v0.16.1 adds the Codemode runtime and connector model, rebuilds browser automation on durable CDP sessions, improves Think orchestration, and adds Voice output-device selection.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-16-agents-sdk-v0161/)[Jun 16Cloudflare ImagesNew optimization features in ImagesNew composite modes, percentage-based overlay dimensions, fit modes, and AI upscaling. Read more ](https://developers.cloudflare.com/changelog/post/2026-06-16-new-optimization-features/)[Jun 16WorkersIntroducing GLM-5.2 on Workers AIZ.ai's flagship agentic coding model is now available on Workers AIRead more ](https://developers.cloudflare.com/changelog/post/2026-06-16-glm-52-workers-ai/)

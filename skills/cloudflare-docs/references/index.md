...
[Jul 21, 2026Cloudflare One ClientCloudflare One Client for Windows (version 2026.6.880.0)Cloudflare One Client for Windows (version 2026.6.880.0)Read update ](https://developers.cloudflare.com/changelog/post/2026-07-21-warp-windows-ga/)[Jul 21Cloudflare One ClientCloudflare One Client for macOS (version 2026.6.880.0)Cloudflare One Client for macOS (version 2026.6.880.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-07-21-warp-macos-ga/)[Jul 21Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.880.0)Cloudflare One Client for Linux (version 2026.6.880.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-07-21-warp-linux-ga/)[Jul 21Cloudflare FundamentalsAccount Role API deprecatedAccount Role API is deprecated in favor of the Permission Group API.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-21-account-role-api-deprecated/)[Jul 21Sandbox SDKRun Devin on Cloudflare using Devin OutpostsRun Devin agents on Cloudflare, with each Devin session in its own isolated sandbox backed by Cloudflare Containers.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-21-devin-outposts/)[Jul 21WAFWAF Release - 2026-07-21Cloudflare WAF managed rulesets 2026-07-21Read more ](https://developers.cloudflare.com/changelog/post/2026-07-21-waf-release/)[Jul 21WAFWAF Release - Scheduled changes for 2026-07-27WAF managed ruleset changes scheduled for 2026-07-27Read more ](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Jul 20AccessBrowser-based login for plaintext HTTP private applicationsPlaintext HTTP private apps now use the same in-browser Access login flow as HTTPS apps, instead of the Cloudflare One Client notification.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-20-http-private-apps-l7-auth/)

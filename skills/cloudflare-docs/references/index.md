...
[Jul 14, 2026WAFWAF Release - 2026-07-14Cloudflare WAF managed rulesets 2026-07-14Read update ](https://developers.cloudflare.com/changelog/post/2026-07-14-waf-release/)[Jul 14WAFWAF Release - Scheduled changes for 2026-07-20WAF managed ruleset changes scheduled for 2026-07-20Read more ](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Jul 14Cloudflare Web AnalyticsImproved reliability for account-wide Web Analytics dashboardsWeb Analytics introduces performance optimizations and safety thresholds for accounts tracking a large volume of websites.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-10-improved-reliability-for-web-analytics-dash/)[Jul 14WorkersPlatforms can now create Temporary Accounts via the Cloudflare APIAI agents and platforms can create temporary preview accounts through the Cloudflare REST API and let users claim deployed Workers later.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-14-temporary-accounts-api/)[Jul 13AgentsAgents can respond to MCP elicitation requestsAgents SDK MCP clients can now handle form and URL elicitation requests from connected servers.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-13-mcp-client-elicitation/)[Jul 13ChallengesPrecursor introduces session-based bot detectionPrecursor brings continuous, session-based behavioral detection to Cloudflare Challenges.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-13-precursor-session-based-detection/)[Jul 13Cloudflare FundamentalsOrigin Content Signals for Markdown for AgentsConverted responses now preserve security and cache headers, and respect your origin's content-signal.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-13-markdown-for-agents-header-preservation/)[Jul 13R2R2 Data Catalog now supports read-only API tokensConnect query engines to R2 Data Catalog using read-only API tokensRead more ](https://developers.cloudflare.com/changelog/post/2026-07-09-r2-data-catalog-read-only-tokens/)

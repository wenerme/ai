...
[Sep 01, 2026D1D1 enforces free tier daily query limitsBeginning September 1, 2026, D1 queries on Workers Free accounts that exceed daily row read or row write limits will fail and return errors.Read update](https://developers.cloudflare.com/changelog/post/2026-09-01-d1-free-tier-limit-enforcement/)[Aug 31Browser RunCrawl endpoint now respects the Content Signals \`use\` directiveThe /crawl endpoint accepts a new contentUse parameter that enforces the \`use\` directive in a site's robots.txt Content Signals.Read more](https://developers.cloudflare.com/changelog/post/2026-08-31-crawl-content-use/)[Aug 30AI SearchAI Search now supports GLM-5.3 FlashAI Search now supports the Workers AI GLM-5.3 Flash model for text generation.Read more](https://developers.cloudflare.com/changelog/post/2026-08-30-glm-5.3-flash/)[Aug 28Cloudflare One ClientCloudflare One Client for macOS (version 2026.7.1376.0)Cloudflare One Client for macOS (version 2026.7.1376.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-warp-macos-ga/)[Aug 28Cloudflare One ClientCloudflare One Client for Windows (version 2026.7.1376.0)Cloudflare One Client for Windows (version 2026.7.1376.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-warp-windows-ga/)[Aug 28Cloudflare One ClientCloudflare One Client for Linux (version 2026.7.1377.0)Cloudflare One Client for Linux (version 2026.7.1377.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-warp-linux-ga/)[Aug 28Workers AIZ.ai GLM-5.3 now available on Workers AIGLM-5.3 is now available on Workers AI, Z.ai's flagship agentic coding model with a 1M token context window, reasoning, and function calling.Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-glm-5.3-workers-ai/)[Aug 28WorkersDurable Objects can use up to ten Dynamic Workers concurrentlyEach Durable Object can use up to ten Dynamic Workers with in-flight requests.Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-durable-objects-dynamic-workers-limit/)

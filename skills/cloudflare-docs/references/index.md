...
[Aug 06, 2026AI SearchAI Search makes it easier to build a search engine for your dataIndex a site without a complete sitemap, serve search from a hostname you own, restrict who can query it, and search several instances from one URL.Read update](https://developers.cloudflare.com/changelog/post/2026-08-06-public-endpoint-custom-domains-and-namespaces/)[Aug 06Browser RunIntroducing Kitesurf, an agent-first browser on Browser RunKitesurf is a new stateless browser that runs entirely on Workers and is built for AI agents. It is available for free while in beta.Read more](https://developers.cloudflare.com/changelog/post/2026-08-06-kitesurf/)[Aug 05AI GatewayTrack AI spend and catch anomalous usage with User InsightsSee how much your organization spends on AI, attribute it to identities, and flag anomalous usage that can signal a security risk.Read more](https://developers.cloudflare.com/changelog/post/2026-08-05-user-insights/)[Aug 05AI GatewayIdentity-aware controls are now available in AI GatewayUse Cloudflare Access identity in AI Gateway to set spend limits, control model access, filter logs, and more.Read more](https://developers.cloudflare.com/changelog/post/2026-08-05-access-user-id-metadata/)[Aug 05Cloudflare FundamentalsImproved publisher verification details on OAuth consent screensOAuth consent screens now show publisher verification details inline, so users can more easily understand who owns an application before granting access.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-oauth-consent-shields/)[Aug 04AgentsAgent traces for Think, Flue, and AI SDK instrumented by Agents SDKAgent traces show model calls, tool runs, approvals, token usage, and runtime operations for each turn.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-agent-tracing/)[Aug 04ArtifactsBuild and deploy Artifacts repos on every pushTrigger a Workflow on push to run CI checks and deploy your Artifacts repo to a Worker or User Worker.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-build-and-deploy-on-push/)[Aug 04Cloudflare FundamentalsCreate Free accounts from the dashboardAll users can now create standalone Free accounts directly from the Cloudflare dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-free-dashboard-button/)

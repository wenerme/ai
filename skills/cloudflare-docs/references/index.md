...
[Sep 04, 2026WorkersDeploy larger Workers — up to 64 MiB for both free and paid plansThe compressed Worker size limits (3 MB free / 10 MB paid) have been removed. Cloudflare now only checks the uncompressed bundle size, which is 64 MiB across all plans.Read update](https://developers.cloudflare.com/changelog/post/2026-09-04-increased-worker-size-limit/)[Sep 02Cloudflare One ApplianceDefine custom applications for breakout and prioritized traffic from the Cloudflare One Appliance dashboardCreate, edit, and delete custom applications for Cloudflare One Appliance — matched by hostname, IP subnet, or source subnet.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-appliance-custom-application-traffic-steering/)[Sep 02Cloudflare One ApplianceConfigure DHCP options from the dashboard on Cloudflare One ApplianceAdd custom DHCP options to a LAN's DHCP server directly from the dashboard, no API or Terraform required.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-appliance-dhcp-options-ui/)[Sep 02Cloudflare ImagesNew in Images: text rasterization and updates to the bindingRasterize text, sign private image URLs, create Direct Creator Upload links, filter hosted images by custom metadata, and set response headers directly from a Worker. Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-images-binding-updates/)[Sep 02Cloudflare TunnelCreate multiple Cloudflare Tunnel and Cloudflare Mesh routes at onceThe Routes page now supports adding multiple destinations and queuing up several Cloudflare Tunnel and Cloudflare Mesh routes before creating them in a single action.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-tunnel-mesh-bulk-route-creation/)[Sep 02Sandbox SDKRun Cursor Cloud Agents on Cloudflare via self-hosted machinesRun Cursor Cloud Agents on Cloudflare, with each session in an isolated self-hosted machine backed by Cloudflare Containers.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-cursor-cloud-agents/)[Sep 02WorkersPython Workers now support WSGI web frameworks like Django and FlaskPython Workers now support WSGI web frameworks like Django and Flask.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-python-workers-web-framework-support/)[Sep 01AI GatewayAI Gateway consolidates monthly usage invoice line items and standardizes model namesAI Gateway monthly usage invoices now show the total cost per model, while invoices and logs use consistent model names.Read more](https://developers.cloudflare.com/changelog/post/2026-09-01-billing-and-model-names/)

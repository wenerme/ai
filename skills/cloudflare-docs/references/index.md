...
[Sep 18, 2026Browser Run<h3>Inspect logs, network requests, and DOM in Session Recordings</h3>Browser Run Session Recordings now include an Inspect panel for debugging console output, network activity, and page structure after a session ends.Read update](https://developers.cloudflare.com/changelog/post/2026-09-18-browser-run-session-recording-inspect/) [Sep 18Cloudflare WAN<h3>Unified Routing generally available</h3>One routing fabric across supported WAN on-ramps.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-unified-routing-ga/) [Sep 18Cloudflare Tunnel<h3>cloudflared to deprecate 32-bit Windows and Intel-based macOS builds in 2027</h3>Starting in 2027, Cloudflare will deprecate 32-bit Windows and Intel-based macOS builds of cloudflared and stop publishing releases for either architecture.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-cloudflared-architecture-deprecation/) [Sep 17Workflows<h3>Delete Workflow instances individually or in batches</h3>Delete one or up to 100 Workflow instances and their stored state using a binding or Wrangler.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-instance-delete/) [Sep 17Cloudflare Fundamentals<h3>Create additional Free accounts through the dashboard and API</h3>Users can now create additional Free accounts through the dashboard and API. Organization Super Administrators can create Free accounts within Enterprise Organizations.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-free-account-creation/) [Sep 17Workers AI<h3>Reject busy synchronous inference requests</h3>Fail synchronous inference requests instead of waiting for capacity.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-reject-if-busy/) [Sep 17Workers<h3>Workers traces now automatically include JavaScript RPC session spans</h3>Workers traces now include JavaScript RPC session spans for Worker-to-Worker and Worker-to-Durable Object calls.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-javascript-rpc-session-spans/) [Sep 16Workers<h3>Hyperdrive support for Python Workers</h3>Connect Python Workers to PostgreSQL and MySQL with Hyperdrive's connection pooling and query caching.Read more](https://developers.cloudflare.com/changelog/post/2026-09-16-hyperdrive-python-workers/)

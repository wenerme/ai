...
[Aug 14, 2026Workers AIDeepSeek V4 Flash and Pro now available on Workers AIDeepSeek's latest reasoning models are now on Workers AI, the first models on the platform with a full one million token context window.Read update](https://developers.cloudflare.com/changelog/post/2026-08-14-deepseek-v4-workers-ai/)[Aug 14WorkersYou can now enable Access on a Worker or all Workers at onceTwo new ways to protect Workers with Cloudflare Access. Apply a policy to a single Worker across all its domains, or set a default policy for every Worker in your account.Read more](https://developers.cloudflare.com/changelog/post/2026-08-14-workers-access/)[Aug 13ArtifactsData localization support for ArtifactsEnsure Artifacts stores and processes repo data only within a selected jurisdiction.Read more](https://developers.cloudflare.com/changelog/post/2026-08-13-artifacts-jurisdictions/)[Aug 13GatewayDetect and control software package downloads with package registry securityGateway HTTP policies can now detect and control software package downloads across seven major package ecosystems using pkg.\* selectors.Read more](https://developers.cloudflare.com/changelog/post/2026-08-13-package-protection/)[Aug 13RealtimeControl Realtime SFU DataChannel deliveryConfigure unordered and partially reliable delivery for latency-sensitive Realtime SFU DataChannels.Read more](https://developers.cloudflare.com/changelog/post/2026-08-13-datachannels-reliability-ordering/)[Aug 13SSL/TLSCertificate Transparency Monitoring is now Generally AvailableCT Monitoring is now GA, with automatic filtering of Cloudflare-issued certificates to reduce noise and highlight alerts about certificates Cloudflare did not issue.Read more](https://developers.cloudflare.com/changelog/post/2026-08-13-ct-monitoring-ga/)[Aug 12Email securityBlock emails by content with blocked content rulesCreate plaintext or regular expression rules that block emails based on subject or body content.Read more](https://developers.cloudflare.com/changelog/post/2026-08-12-blocked-content-rules/)[Aug 12Cloudflare OneIndependent MFA supports FIDO2 for infrastructure applicationsEnforce FIDO2 hardware key authentication on SSH connections to infrastructure applications.Read more](https://developers.cloudflare.com/changelog/post/2026-08-12-fido2-keys-infrastructure-ssh/)

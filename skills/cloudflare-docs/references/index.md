...
[Jul 31, 2026Cloudflare One ClientCloudflare One Client for Windows (version 2026.7.1210.1)Cloudflare One Client for Windows (version 2026.7.1210.1)Read update](https://developers.cloudflare.com/changelog/post/2026-07-31-warp-windows-beta/)[Jul 31Cloudflare One ClientCloudflare One Client for macOS (version 2026.7.1210.1)Cloudflare One Client for macOS (version 2026.7.1210.1)Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-warp-macos-beta/)[Jul 31AccessStatic OAuth client credentials for MCP server portalsConnect MCP servers that require a pre-registered OAuth client to an MCP server portal.Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-mcp-portal-manual-oauth/)[Jul 31Browser RunBrowser Run adds a Playground to the Cloudflare dashboardRun screenshots, PDFs, data extraction, and AI extraction against a live browser from the dashboard, then copy the generated code.Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-br-dashboard-playground/)[Jul 31StreamRotate Stream broadcast keys for live inputsRotate credentials for a Stream live input without changing the live input ID or its other configuration.Read more](https://developers.cloudflare.com/changelog/post/2026-07-30-rotate-stream-broadcast-keys/)[Jul 31WorkersInspect Worker startup performance with WranglerWrangler now reports bundle size and local CPU activity when profiling Worker startup.Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-wrangler-startup-profile-summary/)[Jul 30AI SearchUse AI Search with the Agents SDK, AI SDK, and LangChainNew guides show how to use an AI Search instance from the Cloudflare Agents SDK, the Vercel AI SDK, and LangChain.Read more](https://developers.cloudflare.com/changelog/post/2026-07-30-ai-search-agent-sdks/)[Jul 30WorkersNode.js 24 is now the default for Workers BuildsWorkers Builds now uses Node.js 24.18.0 by default while retaining support for explicit Node.js version overrides.Read more](https://developers.cloudflare.com/changelog/post/2026-07-30-workers-builds-nodejs-24/)

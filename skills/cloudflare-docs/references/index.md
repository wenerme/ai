...
[May 28, 2026Browser RunUse Browser Run Quick Actions directly from WorkersCall Browser Run Quick Actions from your Worker using the new quickAction() binding method, with no API tokens or external HTTP requests required.Read update](https://developers.cloudflare.com/changelog/post/2026-05-28-use-browser-run-quick-actions-directly-from-workers/)[May 28Cloudflare MeshHigh availability replica management for Cloudflare MeshView per-replica status, Mesh IPs, and connection details for HA-enabled Mesh nodes. Manually promote a passive replica to active directly from the dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-05-28-mesh-ha-replica-ui/)[May 28Email ServiceSend emails with named recipient addressesYou can now include display names on to, cc, bcc, and from addresses when sending emails via the Workers binding or REST API.Read more](https://developers.cloudflare.com/changelog/post/2026-05-28-named-email-recipients/)[May 28PipelinesPipelines pricing announcedUsage-based pricing for Pipelines with free ingress, SQL transforms at $0.04/GB, and sink delivery starting at $0.03/GB.Read more](https://developers.cloudflare.com/changelog/post/2026-05-11-pipelines-pricing-announced/)[May 28R2 SQLR2 SQL pricing announcedUsage-based pricing for R2 SQL at $2.50/TB of data scanned, with a free tier included on all plans.Read more](https://developers.cloudflare.com/changelog/post/2026-05-11-r2-sql-pricing-announced/)[May 28R2R2 Data Catalog pricing announcedUsage-based pricing for R2 Data Catalog catalog operations and compaction, with a free tier for each dimension.Read more](https://developers.cloudflare.com/changelog/post/2026-05-11-r2-data-catalog-pricing-announced/)[May 28RealtimeRecord specific participant audio tracks in RealtimeKitYou can now record specific participant audio tracks in RealtimeKit with track recording.Read more](https://developers.cloudflare.com/changelog/post/2026-05-28-realtimekit-track-recording/)[May 27Cloudflare OneWrite regex using natural language in Cloudflare OneYou can now use AI to write and explain regex operations in Cloudflare Gateway policies.Read more](https://developers.cloudflare.com/changelog/post/2026-05-27-cloudy-regex-assistance/)

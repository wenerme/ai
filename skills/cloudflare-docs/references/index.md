...
[Sep 21, 2026Cloudflare One Client<h3>Cloudflare One Client for macOS (version 2026.8.1755.1)</h3>Cloudflare One Client for macOS (version 2026.8.1755.1)Read update](https://developers.cloudflare.com/changelog/post/2026-09-21-warp-macos-beta/) [Sep 21Cloudflare One Client<h3>Cloudflare One Client for Windows (version 2026.8.1755.1)</h3>Cloudflare One Client for Windows (version 2026.8.1755.1)Read more](https://developers.cloudflare.com/changelog/post/2026-09-21-warp-windows-beta/) [Sep 21Workers<h3>Give teammates access to specific Workers directly from the dashboard</h3>Super Administrators can now invite account members and grant scoped access to an individual Worker directly from the Workers dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-09-21-invite-members-to-workers/) [Sep 18Browser Run<h3>Inspect logs, network requests, and DOM in Session Recordings</h3>Browser Run Session Recordings now include an Inspect panel for debugging console output, network activity, and page structure after a session ends.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-browser-run-session-recording-inspect/) [Sep 18Cloudflare WAN<h3>Unified Routing generally available</h3>One routing fabric across supported WAN on-ramps.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-unified-routing-ga/) [Sep 18Logpush<h3>Filter DDoS attack traffic from Logpush jobs</h3>Exclude identified DDoS attack traffic from supported Logpush datasets before delivery.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-filter-ddos-attack-traffic/) [Sep 18Cloudflare Tunnel<h3>cloudflared to deprecate 32-bit Windows and Intel-based macOS builds in 2027</h3>Starting in 2027, Cloudflare will deprecate 32-bit Windows and Intel-based macOS builds of cloudflared and stop publishing releases for either architecture.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-cloudflared-architecture-deprecation/) [Sep 17Workflows<h3>Delete Workflow instances individually or in batches</h3>Delete one or up to 100 Workflow instances and their stored state using a binding or Wrangler.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-instance-delete/)

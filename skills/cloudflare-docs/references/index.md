...
[Jun 19, 2026Cloudflare MeshManage all your routes from one page in the dashboardA unified Routes page in the dashboard shows the routes for your Cloudflare Mesh, Cloudflare Tunnel, Cloudflare WAN, and Magic Transit connectors in one place, with an interactive network map.Read update ](https://developers.cloudflare.com/changelog/post/2026-06-19-unified-routes-page/)[Jun 19Durable ObjectsNew Asia-Pacific location hints: apac-ne and apac-seDurable Objects now supports two new location hints for Northeast and Southeast Asia-Pacific, giving you finer-grained control within the \`apac\` region.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-19-apac-ne-apac-se-location-hints/)[Jun 19Durable ObjectsOutbound connections keep Durable Objects aliveActive outbound TCP sockets and outbound WebSocket connections now prevent a Durable Object from being evicted while the connection is open.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-19-outbound-connections-keep-dos-alive/)[Jun 19WorkersTemporary accounts for AI agent deploymentsDeploy Workers from AI agents with \`wrangler deploy --temporary\`, then claim the temporary account within 60 minutes.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-19-temporary-accounts-for-agents/)[Jun 18Cloudflare OneCloudflare identity provider is now the default for new accountsNew Zero Trust organizations get the Cloudflare identity provider as their default login method instead of one-time PIN.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-18-cloudflare-idp-default/)[Jun 18HyperdriveCreate PlanetScale Postgres and MySQL databases, billed to your Cloudflare accountCloudflare partners with PlanetScale to provide Postgres and MySQL databases for Workers applications with unified billing through your Cloudflare account.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-18-planetscale-databases-cloudflare-billing/)[Jun 18RadarUpdated Workers AI popularity metric in Cloudflare RadarWorkers AI model and task popularity now reflects the number of inferences rather than the number of unique accountsRead more ](https://developers.cloudflare.com/changelog/post/2026-06-18-radar-workers-ai-inference-metric/)[Jun 18SpeedCloudflare Fonts error handling and security improvementsCloudflare Fonts now passes \`/cf-fonts\` requests through to the origin on errors and includes additional input validation for security.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-18-cloudflare-fonts-error-handling-security/)

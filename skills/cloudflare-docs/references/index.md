...
[Jul 06, 2026Cloudflare One ApplianceSelf-serve registration of Cloudflare One Virtual Appliance in the dashboardRegister a virtual appliance, generate its license key, and rotate the key directly from the Connectors page.Read update ](https://developers.cloudflare.com/changelog/post/2026-07-06-virtual-appliance-self-serve-ui/)[Jul 03WorkersSimpler runtime types with @cloudflare/workers-types v5Ships only the latest runtime types and drops the dated entrypoints.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-03-workers-types-v5/)[Jul 02AI SearchManage AI Search sync jobs with Wrangler CLIUse new Wrangler commands to trigger and monitor sync jobs for AI Search instances connected to a data source.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-manage-sync-jobs/)[Jul 02CacheCache multiple versions of a URL with VaryCache Rules now support the origin Vary response header, so the same URL can hold multiple cached versions selected by the request headers your origin varies on.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-vary-for-cache-rules/)[Jul 02Cloudflare MeshHostname routing for Cloudflare MeshRoute traffic to a Cloudflare Mesh node by hostname instead of IP.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-mesh-hostname-routing/)[Jul 02WorkersWork across multiple accounts with Wrangler auth profilesMaintain separate logins and switch between Cloudflare accounts per project, without re-running wrangler login.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-02-wrangler-auth-profiles/)[Jul 01Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.836.0)Cloudflare One Client for Linux (version 2026.6.836.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-warp-linux-ga/)[Jul 01AccessFix redirect URL fragment encoding for single-page applicationsAccess no longer over-encodes URL fragment characters, fixing post-login redirects for single-page applications with fragment-based routing.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-spa-redirect-fragment-fix/)

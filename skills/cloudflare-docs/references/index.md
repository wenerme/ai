...
[Jun 09, 2026WAFWAF Release - 2026-06-09Cloudflare WAF managed rulesets 2026-06-09Read update](https://developers.cloudflare.com/changelog/post/2026-06-09-waf-release/)[Jun 09WAFWAF Release - Scheduled changes for 2026-06-15WAF managed ruleset changes scheduled for 2026-06-15Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Jun 08Email ServiceAuthenticated SMTP submission now available in betaSend transactional emails through Cloudflare Email Service from any SMTP-capable application or mail client using authenticated SMTP submission on smtp.mx.cloudflare.net.Read more](https://developers.cloudflare.com/changelog/post/2026-06-08-smtp-submission/)[Jun 08R2 SQLR2 SQL now supports UNION, INTERSECT, EXCEPT, and SELECT DISTINCTCombine query results with set operations and eliminate duplicates with SELECT DISTINCT.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-union-intersect-except-select-distinct/)[Jun 08RealtimePost-meeting transcriptions are now Generally Available in RealtimeKitRealtimeKit post-meeting transcription is now Generally Available for generating transcript files and AI summaries after meetings end.Read more](https://developers.cloudflare.com/changelog/post/2026-06-08-realtimekit-post-meeting-transcription-ga/)[Jun 08Security CenterCreate WAF rules directly from Threat Events saved viewsInstantly block or challenge malicious traffic by generating WAF rules based on the dynamic IP lists from your Threat Events saved viewsRead more](https://developers.cloudflare.com/changelog/post/2026-06-08-create-waf-rules-from-threat-events/)[Jun 05WorkflowsRollback support now available in WorkflowsWorkflows now lets you attach rollback handlers to step.do(), inspect rollback outcomes, and query rollback events in analytics.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-saga-rollbacks/)[Jun 05AI GatewayControl AI costs with spend limitsSet cost-based budgets on your AI Gateway scoped by model, provider, or custom metadata like user or team.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-spend-limits/)

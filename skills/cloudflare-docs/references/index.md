...
[Sep 01, 2026AI GatewayAI Gateway consolidates monthly usage invoice line items and standardizes model namesAI Gateway monthly usage invoices now show the total cost per model, while invoices and logs use consistent model names.Read update](https://developers.cloudflare.com/changelog/post/2026-09-01-billing-and-model-names/)[Sep 01D1D1 enforces free tier daily query limitsBeginning September 1, 2026, D1 queries on Workers Free accounts that exceed daily row read or row write limits will fail and return errors.Read more](https://developers.cloudflare.com/changelog/post/2026-09-01-d1-free-tier-limit-enforcement/)[Sep 01WAFWAF Release - 2026-09-01Cloudflare WAF managed rulesets 2026-09-01 releaseRead more](https://developers.cloudflare.com/changelog/post/2026-09-01-waf-release/)[Sep 01WAFWAF Release - Scheduled changes for 2026-09-08WAF managed ruleset changes scheduled for 2026-09-08Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Aug 31Browser RunCrawl endpoint now respects the Content Signals \`use\` directiveThe /crawl endpoint accepts a new contentUse parameter that enforces the \`use\` directive in a site's robots.txt Content Signals.Read more](https://developers.cloudflare.com/changelog/post/2026-08-31-crawl-content-use/)[Aug 30AI SearchAI Search now supports GLM-5.3 FlashAI Search now supports the Workers AI GLM-5.3 Flash model for text generation.Read more](https://developers.cloudflare.com/changelog/post/2026-08-30-glm-5.3-flash/)[Aug 28Cloudflare One ClientCloudflare One Client for macOS (version 2026.7.1376.0)Cloudflare One Client for macOS (version 2026.7.1376.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-warp-macos-ga/)[Aug 28Cloudflare One ClientCloudflare One Client for Windows (version 2026.7.1376.0)Cloudflare One Client for Windows (version 2026.7.1376.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-28-warp-windows-ga/)

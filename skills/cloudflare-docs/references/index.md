...
[Sep 22, 2026Rules<h3>concat() now supports up to 32 arguments</h3>Build richer dynamic values in Rules expressions by combining up to 32 values with concat().Read update](https://developers.cloudflare.com/changelog/post/2026-09-22-concat-argument-limit/) [Sep 22Workers<h3>Workers Builds now supports Cursor Origin</h3>Connect a Cursor Origin repository to Workers Builds for automatic deployments, branch previews, and build status in Origin.Read more](https://developers.cloudflare.com/changelog/post/2026-09-22-cursor-origin-workers-builds/) [Sep 22Workers<h3>Test every pull request in an isolated environment with Worker Previews</h3>Worker Previews gives every pull request its own URL, configuration, observability, and isolated Durable Objects and Containers.Read more](https://developers.cloudflare.com/changelog/post/2026-09-22-worker-previews/) [Sep 21Cloudflare One Client<h3>Cloudflare One Client for macOS (version 2026.8.1755.1)</h3>Cloudflare One Client for macOS (version 2026.8.1755.1)Read more](https://developers.cloudflare.com/changelog/post/2026-09-21-warp-macos-beta/) [Sep 21Cloudflare One Client<h3>Cloudflare One Client for Windows (version 2026.8.1755.1)</h3>Cloudflare One Client for Windows (version 2026.8.1755.1)Read more](https://developers.cloudflare.com/changelog/post/2026-09-21-warp-windows-beta/) [Sep 21Browser Run<h3>Browser Run adds session and DevTools methods to browser bindings</h3>Browser Run browser bindings now support typed session management, outbound Worker routing, and DevTools methods.Read more](https://developers.cloudflare.com/changelog/post/2026-09-21-browser-binding-methods/) [Sep 21Workers<h3>Give teammates access to specific Workers directly from the dashboard</h3>Super Administrators can now invite account members and grant scoped access to an individual Worker directly from the Workers dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-09-21-invite-members-to-workers/) [Sep 18Browser Run<h3>Inspect logs, network requests, and DOM in Session Recordings</h3>Browser Run Session Recordings now include an Inspect panel for debugging console output, network activity, and page structure after a session ends.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-browser-run-session-recording-inspect/)

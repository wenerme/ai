...
[Sep 18, 2026Browser Run<h3>Inspect logs, network requests, and DOM in Session Recordings</h3>Browser Run Session Recordings now include an Inspect panel for debugging console output, network activity, and page structure after a session ends.Read update](https://developers.cloudflare.com/changelog/post/2026-09-18-browser-run-session-recording-inspect/) [Sep 18Cloudflare WAN<h3>Unified Routing generally available</h3>One routing fabric across supported WAN on-ramps.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-unified-routing-ga/) [Sep 18Logpush<h3>Filter DDoS attack traffic from Logpush jobs</h3>Exclude identified DDoS attack traffic from supported Logpush datasets before delivery.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-filter-ddos-attack-traffic/) [Sep 18Cloudflare Tunnel<h3>cloudflared to deprecate 32-bit Windows and Intel-based macOS builds in 2027</h3>Starting in 2027, Cloudflare will deprecate 32-bit Windows and Intel-based macOS builds of cloudflared and stop publishing releases for either architecture.Read more](https://developers.cloudflare.com/changelog/post/2026-09-18-cloudflared-architecture-deprecation/) [Sep 17Workflows<h3>Delete Workflow instances individually or in batches</h3>Delete one or up to 100 Workflow instances and their stored state using a binding or Wrangler.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-instance-delete/) [Sep 17Cloudflare Fundamentals<h3>Create additional Free accounts through the dashboard and API</h3>Users can now create additional Free accounts through the dashboard and API. Organization Super Administrators can create Free accounts within Enterprise Organizations.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-free-account-creation/) [Sep 17Rules<h3>Validate Rulesets changes before deployment</h3>Catch invalid rule configurations before publishing them by using automatic dashboard validation or the Rulesets API dry-run option.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-rulesets-dry-run-validation/) [Sep 17Workers AI<h3>Reject busy synchronous inference requests</h3>Fail synchronous inference requests instead of waiting for capacity.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-reject-if-busy/)

...
[Aug 22, 2026AgentsChoose OAuth scopes for Wrangler and the Cloudflare API MCP serverWrangler and the Cloudflare API MCP server now let users choose which optional OAuth scopes to grant during authorization.Read update](https://developers.cloudflare.com/changelog/post/2026-08-22-wrangler-mcp-optional-oauth-scopes/)[Aug 21CASBAutomatically remediate Microsoft 365 and Google Workspace findings with API-based CASB remediation policiesCASB remediation policies automatically fix Microsoft 365 and Google Workspace file-sharing findings and send webhooks, without manual intervention.Read more](https://developers.cloudflare.com/changelog/post/2026-08-21-casb-policies/)[Aug 21Cloudflare FundamentalsEnriched 403 responses for the Cloudflare APICloudflare API 403 responses now include a documentation\_url that points directly to the denied endpoint's API documentation, where you can review the roles required for access.Read more](https://developers.cloudflare.com/changelog/post/2026-08-20-contextual-403s/)[Aug 21Cloudflare FundamentalsSaved login profiles for returning usersReturning Dashboard users can now save login profiles on a device for faster sign-in.Read more](https://developers.cloudflare.com/changelog/post/2026-08-21-one-click-login/)[Aug 21Cloudflare Web AnalyticsWeb Analytics improves soft navigation measurement for Single Page Applications (SPAs)Cloudflare Web Analytics now uses the native Soft Navigation API (where available) to more accurately measure pageviews and Core Web Vitals for Single Page Applications. Pageview counts may increase as a result.Read more](https://developers.cloudflare.com/changelog/post/2026-08-21-improved-soft-navigation-measurement-for-single-page-applications/)[Aug 20Browser RunRun more headless browsers concurrently with Browser RunScale browser automation with more concurrent browsers, faster launches, and higher Quick Actions request throughput by default.Read more](https://developers.cloudflare.com/changelog/post/2026-08-20-limits-increase/)[Aug 20ContainersUse FUSE in local Containers developmentLocal Containers support FUSE with compatible Docker configurations.Read more](https://developers.cloudflare.com/changelog/post/2026-08-20-fuse-local-development/)[Aug 20Durable ObjectsView deployments for Durable Objects in the dashboardDurable Object namespaces now have a Deployments tab showing the backing Worker's active versions, traffic split (actual and configured), and per-version request, error, and wall time metrics.Read more](https://developers.cloudflare.com/changelog/post/2026-08-20-durable-objects-deployments-tab/)

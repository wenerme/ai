...
[Aug 03, 2026AccessControl authorization cookies for multi-domain Access applicationsAccess administrators can control whether self-hosted applications preemptively set authorization cookies across their public hostnames.Read update](https://developers.cloudflare.com/changelog/post/2026-08-03-eager-redirect-cookie-setting/)[Aug 03AgentsPreview: @cloudflare/computer agent runtimeAn agent runtime that dynamically orchestrates between isolates and containers, giving every agent a virtual filesystem and execution environment.Read more](https://developers.cloudflare.com/changelog/post/2026-08-03-cloudflare-computer/)[Aug 03WorkersPython and JavaScript Workers can now call each other via RPCWorkers RPC now supports cross-language calls between Python and JavaScript Workers without additional dependencies or schema definitions.Read more](https://developers.cloudflare.com/changelog/post/2026-08-03-python-javascript-rpc/)[Jul 31Cloudflare One ClientCloudflare One Client for Windows (version 2026.7.1210.1)Cloudflare One Client for Windows (version 2026.7.1210.1)Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-warp-windows-beta/)[Jul 31Cloudflare One ClientCloudflare One Client for macOS (version 2026.7.1210.1)Cloudflare One Client for macOS (version 2026.7.1210.1)Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-warp-macos-beta/)[Jul 31AccessStatic OAuth client credentials for MCP server portalsConnect MCP servers that require a pre-registered OAuth client to an MCP server portal.Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-mcp-portal-manual-oauth/)[Jul 31Browser RunBrowser Run adds a Playground to the Cloudflare dashboardRun screenshots, PDFs, data extraction, and AI extraction against a live browser from the dashboard, then copy the generated code.Read more](https://developers.cloudflare.com/changelog/post/2026-07-31-br-dashboard-playground/)[Jul 31StreamRotate Stream broadcast keys for live inputsRotate credentials for a Stream live input without changing the live input ID or its other configuration.Read more](https://developers.cloudflare.com/changelog/post/2026-07-30-rotate-stream-broadcast-keys/)

...
[Aug 20, 2026WAFLeaked credentials detection now scans Authorization headersLeaked credentials detection can now detect Basic Authentication credentials sent in the Authorization header.Read update](https://developers.cloudflare.com/changelog/post/2026-08-20-leaked-credentials-authorization-header/)[Aug 19Cloudflare One ClientCloudflare One Client for Windows (version 2026.7.1343.0)Cloudflare One Client for Windows (version 2026.7.1343.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-warp-windows-ga/)[Aug 19Cloudflare One ClientCloudflare One Client for macOS (version 2026.7.1343.0)Cloudflare One Client for macOS (version 2026.7.1343.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-warp-macos-ga/)[Aug 19Cloudflare One ClientCloudflare One Client for Linux (version 2026.7.1343.0)Cloudflare One Client for Linux (version 2026.7.1343.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-warp-linux-ga/)[Aug 19AI GatewayGet 50% off GPT-5.6 Sol through AI GatewaySave 50% on GPT-5.6 Sol routed through AI Gateway Unified Billing until September 18, 2026.Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-gpt-5-6-sol-discount/)[Aug 18Cloudflare TunnelConfigure origin application settings for Cloudflare Tunnel in the dashboardYou can now configure origin parameters such as TLS verification, HTTP Host header, connection timeouts, and more when editing a published application in the Cloudflare dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-08-18-tunnel-origin-settings-dashboard/)[Aug 17Email securityPost-quantum key exchange for MX deploymentsCloudflare Email Security now supports post-quantum hybrid key exchange on inbound and outbound SMTP connections.Read more](https://developers.cloudflare.com/changelog/post/2026-08-17-post-quantum-key-exchange-mx/)[Aug 17Load BalancingLoad balancing analytics now filters by pool nameThe pool filter in load balancing analytics now queries by pool name instead of pool ID, matching what you see in the UI dropdown.Read more](https://developers.cloudflare.com/changelog/post/2026-08-17-pool-name-analytics-filter/)

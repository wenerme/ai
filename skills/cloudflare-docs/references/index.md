...
[Jun 10, 2026AI SearchManage AI Search namespaces with Wrangler CLIUse new namespace-level Wrangler commands to create, list, update, and delete AI Search namespaces from the CLI.Read update](https://developers.cloudflare.com/changelog/post/2026-06-10-ai-search-namespace-wrangler-commands/)[Jun 10DNSAccount-level DNS records quotaEnterprise accounts now have a single DNS records quota across all of their zones.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-account-level-record-quota/)[Jun 10Cloudflare ImagesManage hosted images with the Images bindingUpload, list, retrieve, update, and delete hosted images directly from a Worker using the Images binding.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-hosted-images-binding/)[Jun 09WAFWAF Release - 2026-06-09Cloudflare WAF managed rulesets 2026-06-09Read more](https://developers.cloudflare.com/changelog/post/2026-06-09-waf-release/)[Jun 09WAFWAF Release - Scheduled changes for 2026-06-15WAF managed ruleset changes scheduled for 2026-06-15Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Jun 08Email ServiceAuthenticated SMTP submission now available in betaSend transactional emails through Cloudflare Email Service from any SMTP-capable application or mail client using authenticated SMTP submission on smtp.mx.cloudflare.net.Read more](https://developers.cloudflare.com/changelog/post/2026-06-08-smtp-submission/)[Jun 08R2 SQLR2 SQL now supports UNION, INTERSECT, EXCEPT, and SELECT DISTINCTCombine query results with set operations and eliminate duplicates with SELECT DISTINCT.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-union-intersect-except-select-distinct/)[Jun 08RealtimePost-meeting transcriptions are now Generally Available in RealtimeKitRealtimeKit post-meeting transcription is now Generally Available for generating transcript files and AI summaries after meetings end.Read more](https://developers.cloudflare.com/changelog/post/2026-06-08-realtimekit-post-meeting-transcription-ga/)

...
[Sep 25, 2026Browser Run<h3>Subscribe to Browser Run crawl events</h3>Receive crawl lifecycle events through Cloudflare Queues.Read update](https://developers.cloudflare.com/changelog/post/2026-09-25-crawl-event-subscriptions/) [Sep 25Cloudflare Network Firewall<h3>Managed Rulesets supported in Unified Routing</h3>Cloudflare Advanced Network Firewall Managed Rulesets now work with Unified Routing mode.Read more](https://developers.cloudflare.com/changelog/post/2026-09-25-unified-routing-managed-rulesets/) [Sep 25Email Service<h3>Suppress recipients for one sending domain</h3>Email Sending suppressions can now apply to one sending domain instead of every sending domain in your account.Read more](https://developers.cloudflare.com/changelog/post/2026-09-25-sending-domain-suppressions/) [Sep 25WAF<h3>WAF Release - 2026-09-25 - Emergency</h3>Cloudflare WAF managed rulesets 2026-09-25 emergency releaseRead more](https://developers.cloudflare.com/changelog/post/2026-09-25-emergency-waf-release/) [Sep 25Workers<h3>Workers tracing — new getActiveSpan(), recordException(), startSpan(), and setAttributes() APIs</h3>Create spans without changing the active context, annotate the current span from anywhere, record exceptions, and set multiple attributes at once.Read more](https://developers.cloudflare.com/changelog/post/2026-09-25-custom-span-apis/) [Sep 25Workers<h3>See every release and gradual deployment on Workers Metrics charts</h3>Workers Metrics charts now show all releases in the selected time range, including each traffic allocation change in a gradual deployment.Read more](https://developers.cloudflare.com/changelog/post/2026-09-25-release-flows-workers-metrics/) [Sep 241.1.1.1 (DNS Resolver)<h3>RFC 8509 root key trust anchor sentinel support</h3>1.1.1.1 supports RFC 8509 root key trust anchor sentinels to help diagnose DNSSEC root key rollovers.Read more](https://developers.cloudflare.com/changelog/post/2026-09-24-root-key-trust-anchor-sentinel/) [Sep 24Access<h3>MCP server portals are now generally available</h3>MCP server portals are now generally available to connect, secure, and monitor approved MCP servers through one endpoint.Read more](https://developers.cloudflare.com/changelog/post/2026-09-24-mcp-portals-ga/)

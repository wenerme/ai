...
[Jun 02, 2026WorkflowsSchedule Workflow instances directly from your Workflow bindingAdd cron schedules to a Workflow binding in wrangler.jsonc to create Workflow instances automatically on a recurring interval.Read update](https://developers.cloudflare.com/changelog/post/2026-06-02-cron-workflows/)[Jun 02AgentsAgents SDK v0.14.0: Agent Skills, messengers, scheduled tasks, Workflows, and hardened chat recoveryAgents SDK v0.14.0 adds experimental Agent Skills, chat messengers with a Telegram provider, declarative scheduled tasks, and durable Think reasoning steps inside Workflows, plus a major production-hardening pass on durable chat recovery.Read more](https://developers.cloudflare.com/changelog/post/2026-06-02-agents-sdk-v0140/)[Jun 02Cloudflare WANCisco IOS XECisco IOS XE third-party configuration guide now includes Post-Quantum Cryptography, Policy-Based Routing, and IP SLARead more](https://developers.cloudflare.com/changelog/post/2026-06-02-cisco-ios-xe/)[Jun 01LogsNew Turnstile Events Logpush dataset in Cloudflare LogsThe Turnstile Events Logpush dataset is now available in Cloudflare Logs.Read more](https://developers.cloudflare.com/changelog/post/2026-06-01-log-fields-updated/)[May 29Cloudflare One ClientCloudflare One Client for macOS (version 2026.5.1155.1)Cloudflare One Client for macOS (version 2026.5.1155.1)Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-warp-macos-beta/)[May 29Cloudflare One ClientCloudflare One Client for Windows (version 2026.5.1155.1)Cloudflare One Client for Windows (version 2026.5.1155.1)Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-warp-windows-beta/)[May 29AgentsShare sandbox previews through Cloudflare TunnelExpose Sandbox services on public preview URLs with sandbox.tunnels — zero-config quick tunnels on \*.trycloudflare.com, plus named tunnels that bind a persistent custom hostname backed by a Cloudflare Tunnel.Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-sandbox-named-tunnels/)[May 29LogsUpdated fields across multiple Logpush datasets in Cloudflare LogsFields have been updated across multiple Logpush datasets in Cloudflare Logs.Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-log-fields-updated/)

...
[Jun 29, 2026Cloudflare One ClientCloudflare One Client for Windows (version 2026.6.822.0)Cloudflare One Client for Windows (version 2026.6.822.0)Read update ](https://developers.cloudflare.com/changelog/post/2026-06-29-warp-windows-ga/)[Jun 29Cloudflare One ClientCloudflare One Client for macOS (version 2026.6.822.0)Cloudflare One Client for macOS (version 2026.6.822.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-29-warp-macos-ga/)[Jun 29Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.822.0)Cloudflare One Client for Linux (version 2026.6.822.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-29-warp-linux-ga/)[Jun 26AgentsAgents SDK adds background sub-agents and a unified turn entry pointAgents SDK v0.17.0 adds durable background sub-agent runs with live progress, a single runTurn entry point, and a large round of recovery and reliability fixes for production chat agents.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-26-agents-sdk-v0170/)[Jun 26Durable ObjectsNew \`us\` jurisdiction for Durable ObjectsRestrict Durable Objects to run and store data within the United States.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-26-durable-objects-us-jurisdiction/)[Jun 25Cloudflare FundamentalsSearch API tokens by nameYou can now search through user and account API tokens by name in the dashboard and via the API.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-25-api-token-search/)[Jun 25Durable ObjectsTest Durable Object eviction with new cloudflare:test helpersevictDurableObject and evictAllDurableObjects let you test how Durable Objects behave across evictions in your Vitest tests.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-25-durable-object-eviction-test-helpers/)[Jun 24Cloudflare One ClientCloudflare One Client for macOS (version 2026.6.782.1)Cloudflare One Client for macOS (version 2026.6.782.1)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-warp-macos-beta/)

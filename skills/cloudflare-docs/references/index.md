...
[Sep 17, 2026Workflows<h3>Delete Workflow instances individually or in batches</h3>Delete one or up to 100 Workflow instances and their stored state using a binding or Wrangler.Read update](https://developers.cloudflare.com/changelog/post/2026-09-17-instance-delete/) [Sep 17Cloudflare Fundamentals<h3>Create additional Free accounts through the dashboard and API</h3>Users can now create additional Free accounts through the dashboard and API. Organization Super Administrators can create Free accounts within Enterprise Organizations.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-free-account-creation/) [Sep 17Workers AI<h3>Reject busy synchronous inference requests</h3>Fail synchronous inference requests instead of waiting for capacity.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-reject-if-busy/) [Sep 17Workers<h3>Workers traces now automatically include JavaScript RPC session spans</h3>Workers traces now include JavaScript RPC session spans for Worker-to-Worker and Worker-to-Durable Object calls.Read more](https://developers.cloudflare.com/changelog/post/2026-09-17-javascript-rpc-session-spans/) [Sep 16Workers<h3>Hyperdrive support for Python Workers</h3>Connect Python Workers to PostgreSQL and MySQL with Hyperdrive's connection pooling and query caching.Read more](https://developers.cloudflare.com/changelog/post/2026-09-16-hyperdrive-python-workers/) [Sep 16R2<h3>R2 Data Catalog adds table maintenance visibility and manual queueing</h3>View table maintenance schedules and run history, queue compaction from the dashboard, and browse catalogs with an updated layout.Read more](https://developers.cloudflare.com/changelog/post/2026-09-16-table-maintenance-dashboard/) [Sep 15Workflows<h3>Stream Workflow instance events in your Worker or via the API with .subscribe()</h3>Workflow instances now support a .subscribe() method, which let Workers and applications consume events as instances run.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-instance-event-subscriptions/) [Sep 15Cloudflare One<h3>Access for Infrastructure now supports tagged targets and tag-based target criteria</h3>Add tags to targets and define infrastructure applications based on tag values.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-infrastructure-target-tags/)

...
[Jun 12, 2026AI GatewayView the user agent of requests in AI Gateway logsAI Gateway logs now capture the user agent of the client that made each request.Read update](https://developers.cloudflare.com/changelog/post/2026-06-12-user-agent-logging/)[Jun 12Durable ObjectsFilter Durable Objects metrics by object ID or nameFilter the Durable Objects metrics charts to a single object by its ID or name.Read more](https://developers.cloudflare.com/changelog/post/2026-06-12-durable-objects-metrics-filter-by-id-name/)[Jun 12Workers AIMoonshot AI Kimi K2.7 Code now available on Workers AIKimi K2.7 Code is now available on Workers AI, a code-optimized 1T MoE model with 262.1k context, vision, and agentic capabilities.Read more](https://developers.cloudflare.com/changelog/post/2026-06-12-kimi-k2-7-code-workers-ai/)[Jun 11Browser RunNew formats parameter for the Browser Run /snapshot endpointBrowser Run's /snapshot endpoint now accepts a formats parameter to return Markdown and the accessibility tree alongside HTML and screenshots.Read more](https://developers.cloudflare.com/changelog/post/2026-06-11-browser-run-snapshot-formats/)[Jun 11Data Loss PreventionDefine custom topics for AI prompt protectionCloudflare DLP now supports custom AI prompt protection topics. Define concepts in natural language to detect content unique to your organization.Read more](https://developers.cloudflare.com/changelog/post/2026-06-11-custom-ai-prompt-topics/)[Jun 11WorkersTrack Dynamic Workers usage from the dashboard and GraphQL APIView the number of billable Dynamic Workers invoked during your billing period from the dashboard or GraphQL Analytics API.Read more](https://developers.cloudflare.com/changelog/post/2026-06-11-dynamic-workers-count/)[Jun 10AI SearchManage AI Search namespaces with Wrangler CLIUse new namespace-level Wrangler commands to create, list, update, and delete AI Search namespaces from the CLI.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-ai-search-namespace-wrangler-commands/)[Jun 10DNSAccount-level DNS records quotaEnterprise accounts now have a single DNS records quota across all of their zones.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-account-level-record-quota/)

...
[Sep 08, 2026RadarRadar search now includes Internet eventsCloudflare Radar search now includes Internet events and outages, with links to relevant pages and historical context.Read update](https://developers.cloudflare.com/changelog/post/2026-09-08-radar-search-events/)[Sep 08WAFWAF Release - 2026-09-08Cloudflare WAF managed rulesets 2026-09-08 releaseRead more](https://developers.cloudflare.com/changelog/post/2026-09-08-waf-release/)[Sep 08WAFWAF Release - Scheduled changes for 2026-09-15WAF managed ruleset changes scheduled for 2026-09-15Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Sep 08WorkersMiniflare v5 prepares local development for the cf CLIMiniflare v5 updates internal local development APIs without requiring changes for Wrangler or Vite plugin users.Read more](https://developers.cloudflare.com/changelog/post/2026-09-08-miniflare-v5/)[Sep 08WorkersPython 3.14 for Python WorkersPython 3.14 for Python WorkersRead more](https://developers.cloudflare.com/changelog/post/2026-09-08-python-workers-314/)[Sep 04WorkersDeploy larger Workers — up to 64 MiB for both free and paid plansThe compressed Worker size limits (3 MB free / 10 MB paid) have been removed. Cloudflare now only checks the uncompressed bundle size, which is 64 MiB across all plans.Read more](https://developers.cloudflare.com/changelog/post/2026-09-04-increased-worker-size-limit/)[Sep 02Cloudflare One ApplianceDefine custom applications for breakout and prioritized traffic from the Cloudflare One Appliance dashboardCreate, edit, and delete custom applications for Cloudflare One Appliance — matched by hostname, IP subnet, or source subnet.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-appliance-custom-application-traffic-steering/)[Sep 02Cloudflare One ApplianceConfigure DHCP options from the dashboard on Cloudflare One ApplianceAdd custom DHCP options to a LAN's DHCP server directly from the dashboard, no API or Terraform required.Read more](https://developers.cloudflare.com/changelog/post/2026-09-02-appliance-dhcp-options-ui/)

...
[Aug 21, 2026Cloudflare FundamentalsEnriched 403 responses for the Cloudflare APICloudflare API 403 responses now include a documentation\_url that points directly to the denied endpoint's API documentation, where you can review the roles required for access.Read update](https://developers.cloudflare.com/changelog/post/2026-08-20-contextual-403s/)[Aug 20Browser RunRun more headless browsers concurrently with Browser RunScale browser automation with more concurrent browsers, faster launches, and higher Quick Actions request throughput by default.Read more](https://developers.cloudflare.com/changelog/post/2026-08-20-limits-increase/)[Aug 20Cloudflare FundamentalsOptional OAuth scopesOAuth clients can now mark scopes as required or optionalRead more](https://developers.cloudflare.com/changelog/post/2026-08-20-oauth-optional-scopes/)[Aug 20WAFLeaked credentials detection now scans Authorization headersLeaked credentials detection can now detect Basic Authentication credentials sent in the Authorization header.Read more](https://developers.cloudflare.com/changelog/post/2026-08-20-leaked-credentials-authorization-header/)[Aug 19Cloudflare One ClientCloudflare One Client for Windows (version 2026.7.1343.0)Cloudflare One Client for Windows (version 2026.7.1343.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-warp-windows-ga/)[Aug 19Cloudflare One ClientCloudflare One Client for macOS (version 2026.7.1343.0)Cloudflare One Client for macOS (version 2026.7.1343.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-warp-macos-ga/)[Aug 19Cloudflare One ClientCloudflare One Client for Linux (version 2026.7.1343.0)Cloudflare One Client for Linux (version 2026.7.1343.0)Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-warp-linux-ga/)[Aug 19AccessAccess resource lists now support resource-scoped rolesMembers with resource-scoped Access roles can list only the applications, policies, service tokens, and identity providers they can manage.Read more](https://developers.cloudflare.com/changelog/post/2026-08-19-granular-permissions-resource-lists/)

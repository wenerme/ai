...
[Jun 24, 2026AI SearchControl AI Search similarity cache freshnessSet how long AI Search reuses cached responses and purge cached responses when source content changes.Read update ](https://developers.cloudflare.com/changelog/post/2026-06-24-ai-search-similarity-cache-controls/)[Jun 24RadarPrecise IP location and richer AS details on the Cloudflare Radar IP pageThe Cloudflare Radar IP page now pinpoints your IPv4 and IPv6 locations alongside the Cloudflare data centers you connect to, and the AS card shows more network details.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-radar-ip-page-improvements/)[Jun 23WorkflowsWorkflows rollback handlers now include step contextWorkflows rollback handlers now receive the original step context, and rollbackConfig is limited to retry and timeout settings.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-16-rollback-options/)[Jun 23WAFWAF Release - 2026-06-23Cloudflare WAF managed rulesets 2026-06-23Read more ](https://developers.cloudflare.com/changelog/post/2026-06-23-waf-release/)[Jun 23WAFWAF Release - Scheduled changes for 2026-06-29WAF managed ruleset changes scheduled for 2026-06-29Read more ](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Jun 22R2 SQLR2 SQL now supports window functions, DISTINCT, and set operationsUse window functions, QUALIFY, SELECT DISTINCT, set operations, and exact aggregates in R2 SQL.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-21-window-functions-distinct-set-operations/)[Jun 19Cloudflare MeshManage all your routes from one page in the dashboardA unified Routes page in the dashboard shows the routes for your Cloudflare Mesh, Cloudflare Tunnel, Cloudflare WAN, and Magic Transit connectors in one place, with an interactive network map.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-19-unified-routes-page/)[Jun 19Durable ObjectsNew Asia-Pacific location hints: apac-ne and apac-seDurable Objects now supports two new location hints for Northeast and Southeast Asia-Pacific, giving you finer-grained control within the \`apac\` region.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-19-apac-ne-apac-se-location-hints/)

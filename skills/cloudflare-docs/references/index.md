...
[May 27, 2026Cloudflare ImagesTransformation flows in ImagesSet up automated rules to optimize remote images across your zone without writing code or changing URLs.Read update](https://developers.cloudflare.com/changelog/post/2026-05-27-transformation-flows/)[May 27Cloudflare TunnelCloudflare Tunnel now runs connectivity pre-checks at startupStarting with cloudflared 2026.5.2, Cloudflare Tunnel automates the connectivity pre-check workflow at startup — no more manual dig and netcat commands.Read more](https://developers.cloudflare.com/changelog/post/2026-05-27-cloudflared-connectivity-prechecks/)[May 26Cloudflare One ClientCloudflare One Client for macOS (version 2026.4.1390.0)Cloudflare One Client for macOS (version 2026.4.1390.0)Read more](https://developers.cloudflare.com/changelog/post/2026-05-26-warp-macos-ga/)[May 26Cloudflare One ClientCloudflare One Client for Windows (version 2026.4.1390.0)Cloudflare One Client for Windows (version 2026.4.1390.0)Read more](https://developers.cloudflare.com/changelog/post/2026-05-26-warp-windows-ga/)[May 26Cloudflare One ClientCloudflare One Client for Linux (version 2026.4.1390.0)Cloudflare One Client for Linux (version 2026.4.1390.0)Read more](https://developers.cloudflare.com/changelog/post/2026-05-26-warp-linux-ga/)[May 26CacheBYPASS status now returned for uncacheable responsesResponses that Cloudflare chooses not to cache now consistently return a BYPASS cache status instead of a mix of BYPASS and MISS, giving you a clearer signal in logs and more accurate cache hit ratios in analytics.Read more](https://developers.cloudflare.com/changelog/post/2026-05-26-bypass-status-for-uncacheable-responses/)[May 26FlagshipFlagship now in public betaEvaluate feature flags at the edge directly from Cloudflare Workers with Flagship, Cloudflare's native feature flag service.Read more](https://developers.cloudflare.com/changelog/post/2026-05-26-public-beta/)[May 21AI GatewayCall any AI model through AI Gateway's new REST APICall third-party and Workers AI models through one Cloudflare REST API, with AI Gateway features applied automatically.Read more](https://developers.cloudflare.com/changelog/post/2026-05-21-rest-api/)

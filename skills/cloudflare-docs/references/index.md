...
[Sep 16, 2026Workers<h3>Hyperdrive support for Python Workers</h3>Connect Python Workers to PostgreSQL and MySQL with Hyperdrive's connection pooling and query caching.Read update](https://developers.cloudflare.com/changelog/post/2026-09-16-hyperdrive-python-workers/) [Sep 15Workflows<h3>Stream Workflow instance events in your Worker or via the API with .subscribe()</h3>Workflow instances now support a .subscribe() method, which let Workers and applications consume events as instances run.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-instance-event-subscriptions/) [Sep 15Cloudflare One<h3>Access for Infrastructure now supports tagged targets and tag-based target criteria</h3>Add tags to targets and define infrastructure applications based on tag values.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-infrastructure-target-tags/) [Sep 15WAF<h3>WAF Release - 2026-09-15</h3>Cloudflare WAF managed rulesets 2026-09-15 releaseRead more](https://developers.cloudflare.com/changelog/post/2026-09-15-waf-release/) [Sep 15WAF<h3>WAF Release - Scheduled changes for 2026-09-22</h3>WAF managed ruleset changes scheduled for 2026-09-22Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/) [Sep 15Workers<h3>Grant teammates and agents access to specific Workers</h3>Four new roles let you control what members, User Groups, and API tokens can do across all Workers or within a specific Worker.Read more](https://developers.cloudflare.com/changelog/post/2026-09-15-granular-worker-permissions/) [Sep 14Access<h3>Require fresh authentication for SAML identity providers</h3>Configure Cloudflare Access to request fresh identity provider authentication for each SAML login.Read more](https://developers.cloudflare.com/changelog/post/2026-09-14-saml-force-authentication/) [Sep 14AI Gateway<h3>Prevent Unified Billing fallback for BYOK third-party providers</h3>Prevent third-party provider requests from falling back to Unified Billing when provider credentials are unavailable.Read more](https://developers.cloudflare.com/changelog/post/2026-09-14-require-provider-credentials/)

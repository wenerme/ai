...
[Aug 13, 2026ArtifactsData localization support for ArtifactsEnsure Artifacts stores and processes repo data only within a selected jurisdiction.Read update](https://developers.cloudflare.com/changelog/post/2026-08-13-artifacts-jurisdictions/)[Aug 13RealtimeControl Realtime SFU DataChannel deliveryConfigure unordered and partially reliable delivery for latency-sensitive Realtime SFU DataChannels.Read more](https://developers.cloudflare.com/changelog/post/2026-08-13-datachannels-reliability-ordering/)[Aug 13SSL/TLSCertificate Transparency Monitoring is now Generally AvailableCT Monitoring is now GA, with automatic filtering of Cloudflare-issued certificates to reduce noise and highlight alerts about certificates Cloudflare did not issue.Read more](https://developers.cloudflare.com/changelog/post/2026-08-13-ct-monitoring-ga/)[Aug 12Email securityBlock emails by content with blocked content rulesCreate plaintext or regular expression rules that block emails based on subject or body content.Read more](https://developers.cloudflare.com/changelog/post/2026-08-12-blocked-content-rules/)[Aug 12Cloudflare OneIndependent MFA supports FIDO2 for infrastructure applicationsEnforce FIDO2 hardware key authentication on SSH connections to infrastructure applications.Read more](https://developers.cloudflare.com/changelog/post/2026-08-12-fido2-keys-infrastructure-ssh/)[Aug 11PagesPages now skips superseded queued buildsPages now skips a queued build when a newer build for the same project, branch, and deployment target is queued.Read more](https://developers.cloudflare.com/changelog/post/2026-08-11-skip-superseded-builds/)[Aug 11SupportNew Cloudflare Status pageThe Cloudflare Status page has a new design, Markdown output for AI agents, and a notification system that runs independently of Cloudflare.Read more](https://developers.cloudflare.com/changelog/post/2026-08-11-new-status-page/)[Aug 11Cloudflare TunnelHostname routing is now generally available, with a new public IP range for initial resolved IPsHostname routing is now GA. Initial resolved IPs are moving to a public Cloudflare IP range instead of CGNAT, resolving a conflict with Chromium's Local Network Access restrictions.Read more](https://developers.cloudflare.com/changelog/post/2026-08-11-hostname-routing-ga-public-initial-resolved-ips/)

...
[Jun 11, 2026Browser RunNew formats parameter for the Browser Run /snapshot endpointBrowser Run's /snapshot endpoint now accepts a formats parameter to return Markdown and the accessibility tree alongside HTML and screenshots.Read update](https://developers.cloudflare.com/changelog/post/2026-06-11-browser-run-snapshot-formats/)[Jun 11Data Loss PreventionDefine custom topics for AI prompt protectionCloudflare DLP now supports custom AI prompt protection topics. Define concepts in natural language to detect content unique to your organization.Read more](https://developers.cloudflare.com/changelog/post/2026-06-11-custom-ai-prompt-topics/)[Jun 11WorkersTrack Dynamic Workers usage from the dashboard and GraphQL APIView the number of billable Dynamic Workers invoked during your billing period from the dashboard or GraphQL Analytics API.Read more](https://developers.cloudflare.com/changelog/post/2026-06-11-dynamic-workers-count/)[Jun 10AI SearchManage AI Search namespaces with Wrangler CLIUse new namespace-level Wrangler commands to create, list, update, and delete AI Search namespaces from the CLI.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-ai-search-namespace-wrangler-commands/)[Jun 10DNSAccount-level DNS records quotaEnterprise accounts now have a single DNS records quota across all of their zones.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-account-level-record-quota/)[Jun 10Cloudflare ImagesManage hosted images with the Images bindingUpload, list, retrieve, update, and delete hosted images directly from a Worker using the Images binding.Read more](https://developers.cloudflare.com/changelog/post/2026-06-10-hosted-images-binding/)[Jun 10Security CenterAutomated Cease and Desist templates for Brand ProtectionCustomizable Cease and Desist letter generation for external threats.Read more](https://developers.cloudflare.com/changelog/post/2026-06-08-brand-protection-cease-and-desist-letters/)[Jun 09Sandbox SDKDeprecating Sandbox SDK featuresThe RPC transport becomes the recommended default, and several legacy Sandbox SDK features are deprecated ahead of removal.Read more](https://developers.cloudflare.com/changelog/post/2026-06-09-deprecating-sandbox-sdk-features/)

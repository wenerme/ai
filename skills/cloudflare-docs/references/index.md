...
[Aug 26, 2026AccessAccess service token secrets use a scannable formatNew Access service token secrets include a recognizable prefix and checksum for credential scanning tools.Read update](https://developers.cloudflare.com/changelog/post/2026-08-26-service-token-secret-format/)[Aug 26AI SearchNew Workers AI text generation models in AI SearchAI Search adds six Workers AI models for text generation.Read more](https://developers.cloudflare.com/changelog/post/2026-08-26-new-workers-ai-models/)[Aug 26FlagshipCreate app-scoped API tokens for FlagshipScope a Cloudflare API token to selected Flagship apps instead of every app in the account.Read more](https://developers.cloudflare.com/changelog/post/2026-08-26-app-scoped-tokens/)[Aug 26Log ExplorerDelete Log Explorer datasetsPermanently delete account and zone Log Explorer datasets from the Cloudflare dashboard or API.Read more](https://developers.cloudflare.com/changelog/post/2026-08-26-dataset-deletion/)[Aug 26Logpush ConnectorsAzure Functions-based Microsoft Sentinel connector deprecationCloudflare Enterprise customers must migrate to the Cloudflare for Microsoft Sentinel CCF connector by 2026-09-14.Read more](https://developers.cloudflare.com/changelog/post/2026-08-26-sentinel-functions-connector-deprecation/)[Aug 26RadarRadar Researcher adds richer sources and URL Scanner explanationsRadar Researcher can now link to Radar pages, reports, and Cloudflare Blog posts, explain URL Scanner reports, and open shared sessions in fullscreen.Read more](https://developers.cloudflare.com/changelog/post/2026-08-26-radar-researcher-improvements/)[Aug 26WAFWAF Release - 2026-08-26 - EmergencyCloudflare WAF managed rulesets 2026-08-26 emergency releaseRead more](https://developers.cloudflare.com/changelog/post/2026-08-26-emergency-waf-release/)[Aug 26Workers AIZ.ai GLM-5.3 Flash now available on Workers AIGLM-5.3 Flash is now available on Workers AI, a 320B MoE model with vision, reasoning, and function calling.Read more](https://developers.cloudflare.com/changelog/post/2026-08-26-glm-5.3-flash-workers-ai/)

...
[Jul 23, 2026AgentsAgents SDK packages support AI SDK v6 and v7Agents SDK packages now support AI SDK v6 and v7, so applications can update without a forced AI SDK migration.Read update](https://developers.cloudflare.com/changelog/post/2026-07-23-ai-sdk-v6-v7-support/)[Jul 22AgentsAgents SDK reduces MCP schema conversion, adds exposure controls for MCP in Think and Code Mode SDK adds direct host APIsAgents SDK reduces repeated MCP schema conversion and adds direct Code Mode runtime APIs for hosts that do not use the AI SDK.Read more](https://developers.cloudflare.com/changelog/post/2026-07-22-mcp-codemode-updates/)[Jul 21Cloudflare One ClientCloudflare One Client for Windows (version 2026.6.880.0)Cloudflare One Client for Windows (version 2026.6.880.0)Read more](https://developers.cloudflare.com/changelog/post/2026-07-21-warp-windows-ga/)[Jul 21Cloudflare One ClientCloudflare One Client for macOS (version 2026.6.880.0)Cloudflare One Client for macOS (version 2026.6.880.0)Read more](https://developers.cloudflare.com/changelog/post/2026-07-21-warp-macos-ga/)[Jul 21Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.880.0)Cloudflare One Client for Linux (version 2026.6.880.0)Read more](https://developers.cloudflare.com/changelog/post/2026-07-21-warp-linux-ga/)[Jul 21Cloudflare FundamentalsAccount Role API deprecatedAccount Role API is deprecated in favor of the Permission Group API.Read more](https://developers.cloudflare.com/changelog/post/2026-07-21-account-role-api-deprecated/)[Jul 21Sandbox SDKRun Devin on Cloudflare using Devin OutpostsRun Devin agents on Cloudflare, with each Devin session in its own isolated sandbox backed by Cloudflare Containers.Read more](https://developers.cloudflare.com/changelog/post/2026-07-21-devin-outposts/)[Jul 21SSL/TLSFaster and more secure TLS handshakes to your origins, automaticallyCloudflare now automatically finds the most secure key agreement algorithm preferred by your origin servers, helping establish TLS 1.3 connections faster via Post-Quantum Encryption.Read more](https://developers.cloudflare.com/changelog/post/2026-07-21-automatic-origin-key-exchange/)

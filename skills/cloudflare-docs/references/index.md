...
[Jun 26, 2026AgentsAgents SDK adds background sub-agents and a unified turn entry pointAgents SDK v0.17.0 adds durable background sub-agent runs with live progress, a single runTurn entry point, and a large round of recovery and reliability fixes for production chat agents.Read update ](https://developers.cloudflare.com/changelog/post/2026-06-26-agents-sdk-v0170/)[Jun 26Durable ObjectsNew \`us\` jurisdiction for Durable ObjectsRestrict Durable Objects to run and store data within the United States.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-26-durable-objects-us-jurisdiction/)[Jun 25Cloudflare FundamentalsSearch API tokens by nameYou can now search through user and account API tokens by name in the dashboard and via the API.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-25-api-token-search/)[Jun 24Cloudflare One ClientCloudflare One Client for macOS (version 2026.6.782.1)Cloudflare One Client for macOS (version 2026.6.782.1)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-warp-macos-beta/)[Jun 24AI SearchControl AI Search similarity cache freshnessSet how long AI Search reuses cached responses and purge cached responses when source content changes.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-ai-search-similarity-cache-controls/)[Jun 24Audit LogsAudit Logs v2 — Organization-level audit logs in Cloudflare dashboardOrganization Super Administrators can now view organization-level audit logs directly in the Cloudflare dashboard.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-audit-logs-v2-organization-dashboard-ui/)[Jun 24LogsNew WebSocket Analytics Logpush dataset and updated fieldsThe WebSocket Analytics Logpush dataset is now available, the Firewall events dataset is now available for account-scope Logpush, and new fields have been added to Email Security Alerts.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-log-fields-updated/)[Jun 24RadarPrecise IP location and richer AS details on the Cloudflare Radar IP pageThe Cloudflare Radar IP page now pinpoints your IPv4 and IPv6 locations alongside the Cloudflare data centers you connect to, and the AS card shows more network details.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-24-radar-ip-page-improvements/)

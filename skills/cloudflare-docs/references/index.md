...
[Aug 25, 2026AccessGrace periods for service token rotationKeep the previous service token secret active while you deploy its replacement.Read update](https://developers.cloudflare.com/changelog/post/2026-08-25-service-token-rotation-grace-periods/)[Aug 25AccessTemporarily turn off Access service tokensStop a service token from authenticating without deleting its configuration.Read more](https://developers.cloudflare.com/changelog/post/2026-08-25-service-token-status-controls/)[Aug 25Cloudflare OneMCP server portals support MCP 2026-07-28 specificationMCP server portals support the latest stateless MCP specification while retaining compatibility with 2025 clients and servers.Read more](https://developers.cloudflare.com/changelog/post/2026-08-25-mcp-portals-mcp-2026-07-28/)[Aug 24Cloudflare One ApplianceDownload the Cloudflare One Virtual Appliance for your hypervisor from the dashboardSelect your hypervisor and download the virtual appliance image or install script directly from the Connectors page.Read more](https://developers.cloudflare.com/changelog/post/2026-08-24-virtual-appliance-self-serve-download/)[Aug 24RadarRPKI ASPA path validation on Cloudflare RadarA new Cloudflare Radar tool validates any BGP AS path against the RPKI ASPA records currently published, showing the verdict, the provider authorizations behind it, and a step-by-step trace of the verification algorithm.Read more](https://developers.cloudflare.com/changelog/post/2026-08-24-radar-aspa-validation/)[Aug 22AgentsChoose OAuth scopes for Wrangler and the Cloudflare API MCP serverWrangler and the Cloudflare API MCP server now let users choose which optional OAuth scopes to grant during authorization.Read more](https://developers.cloudflare.com/changelog/post/2026-08-22-wrangler-mcp-optional-oauth-scopes/)[Aug 21CASBAutomatically remediate Microsoft 365 and Google Workspace findings with API-based CASB remediation policiesCASB remediation policies automatically fix Microsoft 365 and Google Workspace file-sharing findings and send webhooks, without manual intervention.Read more](https://developers.cloudflare.com/changelog/post/2026-08-21-casb-policies/)[Aug 21Data Loss PreventionTest Data Loss Prevention profiles without sending traffic through GatewayTest scan lets you test text, files, and HAR data against DLP profiles and inspect match details — no Gateway traffic required.Read more](https://developers.cloudflare.com/changelog/post/2026-08-21-dlp-test-scan/)

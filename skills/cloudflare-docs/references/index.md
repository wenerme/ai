...
[Jun 17, 2026ArtifactsManage Artifacts from the Cloudflare dashboardCreate and manage Artifacts namespaces, repos, files, forks, and repo tokens from the Cloudflare dashboard.Read update](https://developers.cloudflare.com/changelog/post/2026-06-17-dashboard-management/)[Jun 16AgentsAgents SDK improves browser automation, code execution, and recoveryAgents SDK v0.16.1 adds the Codemode runtime and connector model, rebuilds browser automation on durable CDP sessions, improves Think orchestration, and adds Voice output-device selection.Read more](https://developers.cloudflare.com/changelog/post/2026-06-16-agents-sdk-v0161/)[Jun 16Cloudflare ImagesNew optimization features in ImagesNew composite modes, percentage-based overlay dimensions, fit modes, and AI upscaling.Read more](https://developers.cloudflare.com/changelog/post/2026-06-16-new-optimization-features/)[Jun 16WorkersIntroducing GLM-5.2 on Workers AIZ.ai's flagship agentic coding model is now available on Workers AIRead more](https://developers.cloudflare.com/changelog/post/2026-06-16-glm-52-workers-ai/)[Jun 16Workers VPCTCP connections via connect() over VPC NetworksVPC Network bindings now support the connect() Socket API for raw TCP connections, in addition to HTTP traffic via fetch(). Workers can open TCP sockets to any private destination reachable through the bound Cloudflare Tunnel, Cloudflare Mesh, or Cloudflare WAN on-ramp.Read more](https://developers.cloudflare.com/changelog/post/2026-06-16-tcp-connect-vpc-networks/)[Jun 16WorkersWorkers tracing now supports custom spansCreate custom trace spans in your Workers code to instrument application-specific logic alongside automatic platform instrumentation.Read more](https://developers.cloudflare.com/changelog/post/2026-06-16-custom-spans/)[Jun 15WAFUse Cloudforce One threat intelligence in WAF rulesNew cf.intel.ip fields available in custom rules and rate limiting rules for threat intelligence matching.Read more](https://developers.cloudflare.com/changelog/post/2026-06-15-threat-intelligence-fields/)[Jun 15WAFWAF Release - 2026-06-15Cloudflare WAF managed rulesets 2026-06-15Read more](https://developers.cloudflare.com/changelog/post/2026-06-15-waf-release/)

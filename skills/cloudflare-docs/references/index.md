...
[Jun 08, 2026R2 SQLR2 SQL now supports UNION, INTERSECT, EXCEPT, and SELECT DISTINCTCombine query results with set operations and eliminate duplicates with SELECT DISTINCT.Read update](https://developers.cloudflare.com/changelog/post/2026-06-05-union-intersect-except-select-distinct/)[Jun 08RealtimePost-meeting transcriptions are now Generally Available in RealtimeKitRealtimeKit post-meeting transcription is now Generally Available for generating transcript files and AI summaries after meetings end.Read more](https://developers.cloudflare.com/changelog/post/2026-06-08-realtimekit-post-meeting-transcription-ga/)[Jun 05WorkflowsRollback support now available in WorkflowsWorkflows now lets you attach rollback handlers to step.do(), inspect rollback outcomes, and query rollback events in analytics.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-saga-rollbacks/)[Jun 05AI GatewayControl AI costs with spend limitsSet cost-based budgets on your AI Gateway scoped by model, provider, or custom metadata like user or team.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-spend-limits/)[Jun 05RadarFiner-grained chart granularity on Cloudflare Radar for longer time rangesHTTP and NetFlows traffic charts on Cloudflare Radar now show daily data for 1-3 month views and weekly data for 6+ month views, replacing the previous coarser defaults.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-radar-traffic-chart-granularity/)[Jun 05GatewayFilter Workers' public Internet traffic using Gateway policiesWorkers using cf1:network now egress to the public Internet through Cloudflare Gateway — with policies enforced and DNS, HTTP, and Network logging.Read more](https://developers.cloudflare.com/changelog/post/2026-06-05-gateway-egress/)[Jun 04AccessShare identity providers across accounts with IdP federationOrganizations with multiple Cloudflare accounts can now share a single identity provider configuration across accounts using IdP federation.Read more](https://developers.cloudflare.com/changelog/post/2026-06-04-idp-federation/)[Jun 04Cloudflare FundamentalsBillable usage and budget alerts now in product sidebarsView current spend and create budget alerts without leaving the product page.Read more](https://developers.cloudflare.com/changelog/post/2026-06-04-billable-usage-product-sidebar/)

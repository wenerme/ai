...
[Jul 07, 2026Cloudflare One ClientCloudflare One Client for Windows (version 2026.6.850.0)Cloudflare One Client for Windows (version 2026.6.850.0)Read update ](https://developers.cloudflare.com/changelog/post/2026-07-07-warp-windows-ga/)[Jul 07WorkflowsWorkflows pricing adds per-step billing. Step and storage billing to start no earlier than August 10, 2026.Cloudflare Workflows adds per-step pricing, with step and storage billing starting no earlier than August 10, 2026.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-workflows-billing-updates/)[Jul 07AccessFile transfer controls for browser-based RDP (beta)Administrators can now configure whether users can transfer files between their local machine and their browser-based RDP session.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-rdp-file-transfer-beta/)[Jul 07Browser IsolationBrowser Isolation support for authorization proxy endpointsYou can now apply HTTP Isolate policies to traffic routed through authorization proxy endpoints.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-authorization-proxy-endpoint-support/)[Jul 07Browser RunNew Browser Run endpoint for accessibility treesBrowser Run now supports a standalone /accessibilityTree endpoint for capturing the semantic structure of rendered webpages.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-browser-run-accessibility-tree-endpoint/)[Jul 07R2R2 Data Catalog warns before you delete data manuallyThe dashboard and Wrangler now warn you before manual delete operations that could corrupt an R2 Data Catalog.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-06-r2-data-catalog-delete-warnings/)[Jul 06Cloudflare One ApplianceSelf-serve registration of Cloudflare One Virtual Appliance in the dashboardRegister a virtual appliance, generate its license key, and rotate the key directly from the Connectors page.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-06-virtual-appliance-self-serve-ui/)[Jul 06WAFWAF Release - Scheduled changes for 2026-07-13WAF managed ruleset changes scheduled for 2026-07-13Read more ](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)

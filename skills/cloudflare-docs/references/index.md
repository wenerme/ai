...
[Jun 04, 2026AccessShare identity providers across accounts with IdP federationOrganizations with multiple Cloudflare accounts can now share a single identity provider configuration across accounts using IdP federation.Read update](https://developers.cloudflare.com/changelog/post/2026-06-04-idp-federation/)[Jun 04Cloudflare FundamentalsBillable usage and budget alerts now in product sidebarsView current spend and create budget alerts without leaving the product page.Read more](https://developers.cloudflare.com/changelog/post/2026-06-04-billable-usage-product-sidebar/)[Jun 04PipelinesPipeline binding configuration field renamed to streamThe pipeline field in Wrangler pipeline binding configuration has been renamed to stream. The old field is deprecated but still accepted.Read more](https://developers.cloudflare.com/changelog/post/2026-05-27-pipeline-binding-stream-field/)[Jun 03AccessSAML assertion encryption for identity providersEncrypt SAML assertions from your identity provider to Cloudflare Access for enhanced security.Read more](https://developers.cloudflare.com/changelog/post/2026-06-03-saml-assertion-encryption/)[Jun 03Cloudflare FundamentalsIntroducing self-managed OAuth clientsDevelopers can now create self-managed OAuth clients that integrate with Cloudflare.Read more](https://developers.cloudflare.com/changelog/post/2026-06-03-public-oauth-clients/)[Jun 03WorkersNew Workers bulk secrets API endpointA new API endpoint lets you create, update, and delete multiple Worker secrets in a single request.Read more](https://developers.cloudflare.com/changelog/post/2026-06-03-bulk-secrets-api/)[Jun 02WorkflowsSchedule Workflow instances directly from your Workflow bindingAdd cron schedules to a Workflow binding in wrangler.jsonc to create Workflow instances automatically on a recurring interval.Read more](https://developers.cloudflare.com/changelog/post/2026-06-02-cron-workflows/)[Jun 02AgentsAgents SDK v0.14.0: Agent Skills, messengers, scheduled tasks, Workflows, and hardened chat recoveryAgents SDK v0.14.0 adds experimental Agent Skills, chat messengers with a Telegram provider, declarative scheduled tasks, and durable Think reasoning steps inside Workflows, plus a major production-hardening pass on durable chat recovery.Read more](https://developers.cloudflare.com/changelog/post/2026-06-02-agents-sdk-v0140/)

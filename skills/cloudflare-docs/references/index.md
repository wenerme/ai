...
[Aug 26, 2026FlagshipCreate app-scoped API tokens for FlagshipScope a Cloudflare API token to selected Flagship apps instead of every app in the account.Read update](https://developers.cloudflare.com/changelog/post/2026-08-26-app-scoped-tokens/)[Aug 25AccessGrace periods for service token rotationKeep the previous service token secret active while you deploy its replacement.Read more](https://developers.cloudflare.com/changelog/post/2026-08-25-service-token-rotation-grace-periods/)[Aug 25AccessTemporarily turn off Access service tokensStop a service token from authenticating without deleting its configuration.Read more](https://developers.cloudflare.com/changelog/post/2026-08-25-service-token-status-controls/)[Aug 25Cloudflare OneMCP server portals support MCP 2026-07-28 specificationMCP server portals support the latest stateless MCP specification while retaining compatibility with 2025 clients and servers.Read more](https://developers.cloudflare.com/changelog/post/2026-08-25-mcp-portals-mcp-2026-07-28/)[Aug 25WAFWAF Release - 2026-08-25Cloudflare WAF managed rulesets 2026-08-25 releaseRead more](https://developers.cloudflare.com/changelog/post/2026-08-25-waf-release/)[Aug 25WAFWAF Release - Scheduled changes for 2026-09-01WAF managed ruleset changes scheduled for 2026-09-01Read more](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Aug 24Cloudflare One ApplianceDownload the Cloudflare One Virtual Appliance for your hypervisor from the dashboardSelect your hypervisor and download the virtual appliance image or install script directly from the Connectors page.Read more](https://developers.cloudflare.com/changelog/post/2026-08-24-virtual-appliance-self-serve-download/)[Aug 24RadarRPKI ASPA path validation on Cloudflare RadarA new Cloudflare Radar tool validates any BGP AS path against the RPKI ASPA records currently published, showing the verdict, the provider authorizations behind it, and a step-by-step trace of the verification algorithm.Read more](https://developers.cloudflare.com/changelog/post/2026-08-24-radar-aspa-validation/)

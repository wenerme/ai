...
[Jul 01, 2026Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.836.0)Cloudflare One Client for Linux (version 2026.6.836.0)Read update ](https://developers.cloudflare.com/changelog/post/2026-07-01-warp-linux-ga/)[Jul 01AccessFix redirect URL fragment encoding for single-page applicationsAccess no longer over-encodes URL fragment characters, fixing post-login redirects for single-page applications with fragment-based routing.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-spa-redirect-fragment-fix/)[Jul 01AccessIndependent MFA for infrastructure applicationsAdd hardware-backed multi-factor authentication to SSH connections through Access for Infrastructure.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-ssh-mfa-piv-keys/)[Jul 01BotsNew options to manage AI trafficAll customers can now manage AI crawlers by behavior — Search, Agent, and Training — instead of a single Block AI bots toggle.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-ai-traffic-options/)[Jul 01BotsMore visibility into bot traffic with BotBase and Attribution Business InsightsEnterprise Bot Management gains a searchable directory of every tracked bot and a dashboard showing crawl-to-referral ratios.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-botbase-attribution-business-insights/)[Jul 01ContainersUse Google Artifact Registry images with ContainersUse private Google Artifact Registry imagesRead more ](https://developers.cloudflare.com/changelog/post/2026-07-01-google-artifact-registry-images/)[Jul 01VectorizeReduced end-to-end latency for vector changesImprovements to Vectorize WAL throughput reduce p99 end-to-end latency for vector changes to under 2 minutes.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-30-improved-wal-throughput/)[Jul 01WAFWAF Release - 2026-07-01Cloudflare WAF managed rulesets 2026-07-01Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-waf-release/)

...
[Jul 01, 2026VectorizeReduced end-to-end latency for vector changesImprovements to Vectorize WAL throughput reduce p99 end-to-end latency for vector changes to under 2 minutes.Read update ](https://developers.cloudflare.com/changelog/post/2026-06-30-improved-wal-throughput/)[Jul 01WAFWAF Release - 2026-07-01Cloudflare WAF managed rulesets 2026-07-01Read more ](https://developers.cloudflare.com/changelog/post/2026-07-01-waf-release/)[Jul 01WAFWAF Release - Scheduled changes for 2026-07-06WAF managed ruleset changes scheduled for 2026-07-06Read more ](https://developers.cloudflare.com/changelog/post/scheduled-waf-release/)[Jun 29Cloudflare One ClientCloudflare One Client for Windows (version 2026.6.822.0)Cloudflare One Client for Windows (version 2026.6.822.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-29-warp-windows-ga/)[Jun 29Cloudflare One ClientCloudflare One Client for macOS (version 2026.6.822.0)Cloudflare One Client for macOS (version 2026.6.822.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-29-warp-macos-ga/)[Jun 29Cloudflare One ClientCloudflare One Client for Linux (version 2026.6.822.0)Cloudflare One Client for Linux (version 2026.6.822.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-06-29-warp-linux-ga/)[Jun 26AgentsAgents SDK adds background sub-agents and a unified turn entry pointAgents SDK v0.17.0 adds durable background sub-agent runs with live progress, a single runTurn entry point, and a large round of recovery and reliability fixes for production chat agents.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-26-agents-sdk-v0170/)[Jun 26Durable ObjectsNew \`us\` jurisdiction for Durable ObjectsRestrict Durable Objects to run and store data within the United States.Read more ](https://developers.cloudflare.com/changelog/post/2026-06-26-durable-objects-us-jurisdiction/)

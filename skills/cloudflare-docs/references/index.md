...
[May 29, 2026Cloudflare One ClientCloudflare One Client for macOS (version 2026.5.1155.1)Cloudflare One Client for macOS (version 2026.5.1155.1)Read update](https://developers.cloudflare.com/changelog/post/2026-05-29-warp-macos-beta/)[May 29Cloudflare One ClientCloudflare One Client for Windows (version 2026.5.1155.1)Cloudflare One Client for Windows (version 2026.5.1155.1)Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-warp-windows-beta/)[May 29LogsUpdated fields across multiple Logpush datasets in Cloudflare LogsFields have been updated across multiple Logpush datasets in Cloudflare Logs.Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-log-fields-updated/)[May 29RadarTLS bug detection in the Cloudflare Radar post-quantum checkerThe Radar post-quantum TLS support checker now surfaces detected TLS bugs with descriptions and remediation guidanceRead more](https://developers.cloudflare.com/changelog/post/2026-05-29-radar-pq-tls-bug-detection/)[May 29RealtimeCloudflare's Realtime WebSocket adapter now auto-reconnects and buffers WebRTC mediaRealtime SFU WebSocket adapters now automatically reconnect and buffer media after brief endpoint disconnects or restarts when using Stream mode.Read more](https://developers.cloudflare.com/changelog/post/2026-05-29-websocket-adapter-auto-reconnect/)[May 28Browser RunUse Browser Run Quick Actions directly from WorkersCall Browser Run Quick Actions from your Worker using the new quickAction() binding method, with no API tokens or external HTTP requests required.Read more](https://developers.cloudflare.com/changelog/post/2026-05-28-use-browser-run-quick-actions-directly-from-workers/)[May 28Cloudflare MeshHigh availability replica management for Cloudflare MeshView per-replica status, Mesh IPs, and connection details for HA-enabled Mesh nodes. Manually promote a passive replica to active directly from the dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-05-28-mesh-ha-replica-ui/)[May 28ContainersWrangler supports SSH ProxyCommand for ContainersUse OpenSSH ProxyCommand with wrangler containers ssh.Read more](https://developers.cloudflare.com/changelog/post/2026-05-28-ssh-proxy-command/)

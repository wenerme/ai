...
[Aug 05, 2026AI GatewayTrack AI spend and catch anomalous usage with User InsightsSee how much your organization spends on AI, attribute it to identities, and flag anomalous usage that can signal a security risk.Read update](https://developers.cloudflare.com/changelog/post/2026-08-05-user-insights/)[Aug 05AI GatewayIdentity-aware controls are now available in AI GatewayUse Cloudflare Access identity in AI Gateway to set spend limits, control model access, filter logs, and more.Read more](https://developers.cloudflare.com/changelog/post/2026-08-05-access-user-id-metadata/)[Aug 05Cloudflare FundamentalsImproved publisher verification details on OAuth consent screensOAuth consent screens now show publisher verification details inline, so users can more easily understand who owns an application before granting access.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-oauth-consent-shields/)[Aug 04AgentsAgent traces for Think, Flue, and AI SDK instrumented by Agents SDKAgent traces show model calls, tool runs, approvals, token usage, and runtime operations for each turn.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-agent-tracing/)[Aug 04ArtifactsBuild and deploy Artifacts repos on every pushTrigger a Workflow on push to run CI checks and deploy your Artifacts repo to a Worker or User Worker.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-build-and-deploy-on-push/)[Aug 04Cloudflare FundamentalsCreate Free accounts from the dashboardAll users can now create standalone Free accounts directly from the Cloudflare dashboard.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-free-dashboard-button/)[Aug 04VectorizeVectorize indexes now support up to 20 million vectorsVectorize indexes now support up to 20 million vectors.Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-index-capacity-20-million/)[Aug 04WAFWAF Release - 2026-08-04Cloudflare WAF managed rulesets 2026-08-04Read more](https://developers.cloudflare.com/changelog/post/2026-08-04-waf-release/)

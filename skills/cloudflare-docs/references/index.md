...
[Jul 08, 2026AI SearchFilter AI Search list items by exact object keyThe list items endpoint now accepts a key query parameter to return the item matching an exact object key.Read update ](https://developers.cloudflare.com/changelog/post/2026-07-08-ai-search-list-items-key-filter/)[Jul 08Workers AIWorkers AI toMarkdown and AI Search now supports GIF and BMP image conversionConvert GIF and BMP image files to searchable text with Workers AI Markdown conversion (toMarkdown), so AI Search can index them automatically.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-08-gif-bmp-image-support/)[Jul 08Cloudflare OneIPsec downgrade protection (beta)Cloudflare IPsec now supports the IKE\_SA\_INIT\_FULL\_TRANSCRIPT\_AUTH extension to prevent quantum downgrade attacks on IKEv2 tunnels.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-08-ipsec-downgrade-protection/)[Jul 08Workers AIMoondream 3.1 now available on Workers AIMoondream 3.1, a fast and efficient vision language model with frontier-level visual reasoning, is now available on Workers AI.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-08-moondream31-workers-ai/)[Jul 08WorkersCloudflare DropDeploy a static site by dragging a folder or ZIP file to Cloudflare, preview it for one hour, then claim it to keep the deployment.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-08-cloudflare-drag-and-drop/)[Jul 07Cloudflare One ClientCloudflare One Client for Windows (version 2026.6.850.0)Cloudflare One Client for Windows (version 2026.6.850.0)Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-warp-windows-ga/)[Jul 07WorkflowsWorkflows pricing adds per-step billing. Step and storage billing to start no earlier than August 10, 2026.Cloudflare Workflows adds per-step pricing, with step and storage billing starting no earlier than August 10, 2026.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-workflows-billing-updates/)[Jul 07AccessFile transfer controls for browser-based RDP (beta)Administrators can now configure whether users can transfer files between their local machine and their browser-based RDP session.Read more ](https://developers.cloudflare.com/changelog/post/2026-07-07-rdp-file-transfer-beta/)

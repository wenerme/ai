...
description: In this tutorial, you will learn how to deliver SUSPICIOUS and BULK messages to the user's junk folder, and SPAM and SPOOF messages to the user managed quarantine.
...
[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/email-security/deployment/inline/setup/office-365-area1-mx/use-cases/two-junk-user-quarantine.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose) 

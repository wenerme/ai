...
* [ REST API ](#tab-panel-10899)
* [ Workers Binding API ](#tab-panel-10900)

* [ cURL ](#tab-panel-10895)
...
const video = await client.stream.copy.create({  account_id: '<ACCOUNT_ID>',  url: 'https://storage.googleapis.com/zaid-test/Watermarks%20Demo/cf-ad-original.mp4',});
```
...
* [ index.ts ](#tab-panel-10897)
* [ wrangler.jsonc ](#tab-panel-10898)

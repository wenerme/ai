...
**Cloudflare Exposed Credentials Check (deprecated)**
...
**Link:** [Client-side security](https://developers.cloudflare.com/client-side-security/)
...
* **Pro Plus:** 0
* **Business:** 1
* **Enterprise:** 1 (default)_With advanced:_Custom (can purchase more)
...
* **Enterprise:** First In First Out (FIFO) (default)_With advanced:_FIFO, Random, Reject, Passthrough
...
* **Enterprise:** Invisible (default)_With advanced:_Invisible, Managed, Non Interactive
...
* **Pro Plus:** No
* **Business:** Log only
* **Enterprise:** Log only (default)_With advanced:_Log only & Infinite queue
...
```json
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"/directory/","name":"Directory"}},{"@type":"ListItem","position":2,"item":{"@id":"/plans/","name":"plans"}}]}
```

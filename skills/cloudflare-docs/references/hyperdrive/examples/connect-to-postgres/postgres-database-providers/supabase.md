...
* [ Dashboard ](#tab-panel-4831)
* [ Wrangler CLI ](#tab-panel-4832)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):  
   * [  wrangler.jsonc ](#tab-panel-4829)  
   * [  wrangler.toml ](#tab-panel-4830)  
JSONC  
```  
{  
...
* [  wrangler.jsonc ](#tab-panel-4833)
* [  wrangler.toml ](#tab-panel-4834)

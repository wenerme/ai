...
* [ Dashboard ](#tab-panel-6123)
* [ Wrangler CLI ](#tab-panel-6124)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):  
   * [  wrangler.jsonc ](#tab-panel-6121)  
   * [  wrangler.toml ](#tab-panel-6122)  
JSONC  
```  
{  
...
* [  wrangler.jsonc ](#tab-panel-6125)
* [  wrangler.toml ](#tab-panel-6126)

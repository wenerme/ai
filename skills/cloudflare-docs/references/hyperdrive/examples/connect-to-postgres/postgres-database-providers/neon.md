...
* [ Dashboard ](#tab-panel-6157)
* [ Wrangler CLI ](#tab-panel-6158)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):  
   * [  wrangler.jsonc ](#tab-panel-6155)  
   * [  wrangler.toml ](#tab-panel-6156)  
JSONC  
```  
{  
...
* [  wrangler.jsonc ](#tab-panel-6159)
* [  wrangler.toml ](#tab-panel-6160)

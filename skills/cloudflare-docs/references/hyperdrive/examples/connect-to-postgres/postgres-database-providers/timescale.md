...
* [ Dashboard ](#tab-panel-4837)
* [ Wrangler CLI ](#tab-panel-4838)
...
2. This command outputs a binding for the [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/):  
   * [  wrangler.jsonc ](#tab-panel-4835)  
   * [  wrangler.toml ](#tab-panel-4836)  
JSONC  
```  
{  
...
* [  wrangler.jsonc ](#tab-panel-4839)
* [  wrangler.toml ](#tab-panel-4840)

...
In your project root, create a Wrangler configuration file with the following content:
  ...
  * [  wrangler.jsonc ](#tab-panel-11801)
  * [  wrangler.toml ](#tab-panel-11802)  
JSONC  
```  
{  "name": "my-astro-app",  // Set this to today's date  "compatibility_date": "2026-06-19",  "assets": {    "directory": "./dist"  }}  
```  
TOML  
```  
name = "my-astro-app"# Set this to today's datecompatibility_date = "2026-06-19"  
...
In your project root, create a Wrangler configuration file with the following content:
  ...
  * [  wrangler.jsonc ](#tab-panel-11805)
  * [  wrangler.toml ](#tab-panel-11806)  
JSONC  
```  
{  "name": "my-astro-app",  "main": "./dist/_worker.js/index.js",  // Update to today's date  // Set this to today's date  "compatibility_date": "2026-06-19",  "compatibility_flags": ["nodejs_compat"],  "assets": {    "binding": "ASSETS",    "directory": "./dist"  },  "observability": {    "enabled": true  }}  
```  
TOML  
```  
name = "my-astro-app"main = "./dist/_worker.js/index.js"# Set this to today's datecompatibility_date = "2026-06-19"compatibility_flags = [ "nodejs_compat" ]  
...
* [  wrangler.jsonc ](#tab-panel-11803)
* [  wrangler.toml ](#tab-panel-11804)

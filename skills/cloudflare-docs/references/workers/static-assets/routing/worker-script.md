...
* [  wrangler.jsonc ](#tab-panel-12168)
* [  wrangler.toml ](#tab-panel-12169)

JSONC

```
{  "name": "my-worker",  // Set this to today's date  "compatibility_date": "2026-06-19",  "main": "./worker/index.ts",  "assets": {    "directory": "./dist/",    "binding": "ASSETS",    "run_worker_first": true  }}
```
...
* [  wrangler.jsonc ](#tab-panel-12170)
* [  wrangler.toml ](#tab-panel-12171)

JSONC

```
{  "name": "my-worker",  // Set this to today's date  "compatibility_date": "2026-06-19",  "main": "./worker/index.ts",  "assets": {    "directory": "./dist/",    "not_found_handling": "single-page-application",    "binding": "ASSETS",    "run_worker_first": ["/oauth/callback"]  }}
```

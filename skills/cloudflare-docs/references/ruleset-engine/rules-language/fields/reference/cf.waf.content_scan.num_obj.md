---
title: cf.waf.content_scan.num_obj
...
```
# Check if requests to a specific endpoint contain more than two content objectscf.waf.content_scan.num_obj > 2 and http.request.uri.path eq "/upload"
```
...
```json
{"@context":"https://schema.org","@type":"TechArticle","@id":"https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/cf.waf.content_scan.num_obj/#page","headline":"cf.waf.content_scan.num_obj · Cloudflare Ruleset Engine docs","description":"The number of content objects detected in the request (zero or greater).","url":"https://developers.cloudflare.com/ruleset-engine/rules-language/fields/reference/cf.waf.content_scan.num_obj/","inLanguage":"en","image":"https://developers.cloudflare.com/core-services-preview.png","publisher":{"@type":"Organization","name":"Cloudflare","url":"https://www.cloudflare.com/"},"isPartOf":{"@type":"WebSite","@id":"https://developers.cloudflare.com/#website","name":"Cloudflare Docs","url":"https://developers.cloudflare.com/"}}

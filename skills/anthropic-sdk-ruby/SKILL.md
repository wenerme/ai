...
description: "Use when writing Ruby code with the Anthropic SDK: creating messages, streaming responses, batch processing, token counting, file uploads, model listing, or any Ruby-specific Anthropic API integration."
---

# Anthropic Ruby SDK Reference

Ruby SDK API reference for the Anthropic API (sourced from [platform.claude.com](https://platform.claude.com/docs/en/api/ruby/messages)).

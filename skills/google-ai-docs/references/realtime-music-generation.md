...
> [!NOTE]
> **Objective:** For a more complete code sample, refer to the [Lyria RealTime - Get Started](https://colab.sandbox.google.com/github/google-gemini/cookbook/blob/main/quickstarts/Get_started_LyriaRealTime.ipynb) file in the cookbooks repository.
...
- `WeightedPrompt`: A text string describing a musical idea, genre, instrument, mood, or characteristic. Multiple prompts can potentially be supplied to blend influences. See [above](https://ai.google.dev/gemini-api/docs/realtime-music-generation#steer-music) for more details on how to best prompt Lyria RealTime.

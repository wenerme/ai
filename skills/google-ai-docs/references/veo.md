...
available Veo model variants, see the [Model Versions](https://ai.google.dev/gemini-api/docs/veo#model-versions) section.
...
see the [Veo prompt guide](https://ai.google.dev/gemini-api/docs/veo#prompt-guide)

## Text to video generation

The following examples show how you can generate a video with [dialogue](https://ai.google.dev/gemini-api/docs/veo#dialogue), [cinematic realism](https://ai.google.dev/gemini-api/docs/veo#realism), or [creative animation](https://ai.google.dev/gemini-api/docs/veo#style):
...
are also more expensive (see [pricing](https://ai.google.dev/gemini-api/docs/pricing#veo-3.1)).

[Video extension](https://ai.google.dev/gemini-api/docs/veo#extending_veo_videos) is also limited to 720p videos.
...
[well-written prompt](https://ai.google.dev/gemini-api/docs/veo#use-reference-images) creates the following video:
...
for video generation, see the [Veo prompt guide](https://ai.google.dev/gemini-api/docs/veo#use-reference-images).
...
the [Veo prompt guide](https://ai.google.dev/gemini-api/docs/veo#extend-prompt).
...
Veo's [image-to-video](https://ai.google.dev/gemini-api/docs/veo#generate-from-images)
...
Veo 3.1 lets you [reference images](https://ai.google.dev/gemini-api/docs/veo#reference-images) or
...
frames](https://ai.google.dev/gemini-api/docs/veo#using-first-and-last-video-frames) of the video.
...
To [extend](https://ai.google.dev/gemini-api/docs/veo#extending_veo_videos) your Veo-generated
...
[prompt writing basics](https://ai.google.dev/gemini-api/docs/veo#basics) in your prompt.

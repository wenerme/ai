...
description: "Use when writing Python code with the Anthropic SDK: creating messages, streaming responses, batch processing, token counting, file uploads, model listing, or any Python-specific Anthropic API integration."
---

# Anthropic Python SDK Reference

Python SDK API reference for the Anthropic API (sourced from [platform.claude.com](https://platform.claude.com/docs/en/api/python/messages)).

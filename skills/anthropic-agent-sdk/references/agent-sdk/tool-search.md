...
For details on the underlying API mechanism, see [Tool search in the API](/docs/en/agents-and-tools/tool-use/tool-search-tool).
...
- [Tool search in the API](/docs/en/agents-and-tools/tool-use/tool-search-tool): Full API documentation for tool search, including custom implementations
